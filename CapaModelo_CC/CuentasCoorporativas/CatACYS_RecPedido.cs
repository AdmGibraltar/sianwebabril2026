...
namespace CapaModelo_CC.CuentasCoorporativas
{
    ...
    public partial class CatACYS_RecPedido
    {
        public int Id { get; set; }
        public Nullable<bool> Email { get; set; }
        public Nullable<bool> Fax { get; set; }
        public Nullable<bool> Telefono { get; set; }
        public Nullable<bool> RepVenta { get; set; }
        public string PedidoOtro { get; set; }
        public string PedidoEncargarEnviar { get; set; }
        public string PedidoPuesto { get; set; }
        public string PedidoTelefono { get; set; }
        public string PedidoEmail { get; set; }
        public Nullable<bool> RecDocOrdenCompra { get; set; }
        public Nullable<bool> RecDocReposicion { get; set; }
        public Nullable<bool> RecDocFolio { get; set; }
        public string RecDocOtro { get; set; }

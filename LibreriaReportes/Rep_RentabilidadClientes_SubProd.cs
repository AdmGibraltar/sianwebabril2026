namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_RentabilidadClientes_SubProd : Telerik.Reporting.Report
    {
        public Rep_RentabilidadClientes_SubProd()
        {
            /// <summary>
        ...
        private void ValProyectoImpresion_SubProd_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@Id_Ter"].Value = this.Id_Ter == "" ? "0" : this.Id_Ter;
        ...
        private void PartidasCalcularPrecioLista(ref DataTable tabla)
        {
            foreach (DataRow row in tabla.Rows)
            {
                ...
                long Id_Prd = Convert.ToInt32(row[3]);

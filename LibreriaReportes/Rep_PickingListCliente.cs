...
{
    public partial class Rep_PickingListCliente : Telerik.Reporting.Report
    {
        public Rep_PickingListCliente()
        {
            InitializeComponent();
        }

        public Rep_PickingListCliente(IContainer container)
        {
            container.Add(this);
        ...
        protected void Rep_PickingListCliente_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@Rut_Descripcion"].Value = this.ReportParameters["Ruta"].Value;

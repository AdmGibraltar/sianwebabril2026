namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_VenEstadisticaVentasAmbos : Telerik.Reporting.Report
    {
        public Rep_VenEstadisticaVentasAmbos()
        {
            /// <summary>
        ...
        private void Rep_VenEstadisticaVentas_NeedDataSource(object sender, EventArgs e)
        {
            try
            {
                ...
                this.sqlDataAdapter1.SelectCommand.Parameters["@CategoriaProducto"].Value = this.ReportParameters["CategoriaProducto"].Value;

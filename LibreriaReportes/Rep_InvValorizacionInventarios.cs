namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_InvValorizacionInventarios : Telerik.Reporting.Report
    {
        public Rep_InvValorizacionInventarios()
        {
            /// <summary>
        ...
        private void Rep_InvValorizacionInventarios_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@TipoReporte"].Value = this.ReportParameters["TipoReporte"].Value.ToString();

namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class Rep_SerProductividadSisPropietariosPeriodos2 : Telerik.Reporting.Report
    {
        public Rep_SerProductividadSisPropietariosPeriodos2()
        {
            /// <summary>
        ...
        private void Rep_InvValorizacionInventarios_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@Id_Categoria"].Value = this.ReportParameters["Id_Categoria"].Value.ToString() == string.Empty ? (object)null : this.ReportParameters["Id_Categoria"].Value.ToString();
            this.sqlDataAdapter1.SelectCommand.Parameters["@Id_Grupo"].Value = this.ReportParameters["Id_Grupo"].Value.ToString() == string.Empty ? (object)null : this.ReportParameters["Id_Grupo"].Value.ToString();
            ...
            this.sqlDataAdapter1.SelectCommand.Parameters["@TipoCliente"].Value = Convert.ToInt32(this.ReportParameters["TipoCliente"].Value);

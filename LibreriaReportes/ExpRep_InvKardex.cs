namespace LibreriaReportes
{
    ...
    /// </summary>
    public partial class ExpRep_InvKardex : Telerik.Reporting.Report
    {
        static Int64 id_prd = 0;
        static int inventario = 0;

        public ExpRep_InvKardex()
        {
            /// <summary>
        ...
        public static double calculainventario(Int64 producto, int inicial, int ent, int sal)
        {
            if (id_prd != producto)
            {
                inventario = inicial;

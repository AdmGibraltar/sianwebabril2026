...
namespace CapaDatos
{
    public class CD_CatMeta
    {
        ...
        public void Consultar_PorRik(int Id_Rik, ref Meta meta, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRMMeta_Consultar_PorRik", ref dr, Parametros, Valores);

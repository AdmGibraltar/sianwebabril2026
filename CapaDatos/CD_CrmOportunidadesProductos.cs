...
namespace CapaDatos
{
    public class CD_CrmOportunidadesProductos
    {
        ...
        public int Update_CrmOportunidadesProductos(
            int Id_Emp, int Id_Cd, int Id_Op, int Id_Val, int Id_Cte, long Id_Prd, decimal Cantidad,
        ...
        //JUN04-2020 RFH 
        // Inserta de Producto en Lisado de Producto de Proyecto en CRM

        public int spCrmOportunidadesProductos_InsertUpdate(
            eCrmOportunidadesProducto P,
            int Accion, // 1 .- Insert Update ,2 .- Update 
            string Conexion)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            SqlDataReader dr = null;
            ...
            try
            {
                ...
                string[] Parametros = {
                                         ...
                                         "@COP_CostoEnUso",
                                         "@COP_ConsumoMensual",
                                         "@COP_DilucionAntecedente",
                                         "@COP_DilucionConsecuente",
                                         "@AplDilucion",
                                         "@Tipo",
                ...
                object[] Valores = {
                                       ...
                                       P.COP_EsQuimico,
                                       P.COP_CostoEnUso,
                                       P.COP_ConsumoMensual,
                                       P.COP_DilucionAntecedente,
                                       P.COP_DilucionConsecuente,
                                       P.AplDilucion,
                                       P.Tipo,
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCrmOportunidadesProductos_InsertUpdate", ref dr, Parametros, Valores);
        ...
        //  Eliminar con sp 
        //
        public List<eCrmOportunidadesProducto> ConsultarPorOportunidadYCliente_ver2(
            int Id_Emp, int Id_Cd, int Id_Op, int Id_Cte, string Conexion)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_CrmOportunidadesProductos", ref dr, Parametros.ToArray(), Valores.ToArray());

                while (dr.Read())
                {
                    eCrmOportunidadesProducto obj = new eCrmOportunidadesProducto();
                    ...
                    obj.Id_SubFam = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_SubFam")));
                    obj.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    obj.COP_Cantidad = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("COP_Cantidad")));

                    obj.COP_Dilucion = dr["COP_Dilucion"].ToString();

                    //obj.COP_EsQuimico = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("COP_Dilucion")));
                    obj.COP_CostoEnUso = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("COP_CostoEnUso")));
                    obj.COP_ConsumoMensual = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("COP_ConsumoMensual")));
                    obj.COP_DilucionAntecedente = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("COP_DilucionAntecedente")));
                    obj.COP_DilucionConsecuente = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("COP_DilucionConsecuente")));
                    obj.AplDilucion = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("AplDilucion")));

                    obj.Nombre = dr["Nombre"].ToString();
                    obj.Tipo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Tipo")));

                    obj.ImagenProductoBajaRes = dr["ImagenProductoBajaRes"].ToString();
                    obj.ImagenProductoAltaRes = dr["ImagenProductoAltaRes"].ToString();
                    obj.Prd_Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Prd_Activo"))); //Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Activo"))) ? false : dr.GetBoolean(dr.GetOrdinal("Prd_Activo"));
                    lst.Add(obj);
                }
        ...
        public void Eliminar(int idEmp, int idCd, int idCte, int idRik, int idOp, long idPrd, string cadenaConexionEF)
        {
            using (sianwebmty_gEntities ctx = new sianwebmty_gEntities(cadenaConexionEF))
            {
                var regs = (from cop in ctx.CrmOportunidadesProductos
        ...
        // 19 Sep 2018 RFH
        //  Eliminar con sp 
        public int Sp_Eliminar(int Id_Emp, int Id_Cd, int Id_Op, int Id_Cte, int Id_Rik, long Id_Prd, string Conexion)
        {
            int iResult = 0;
            ...
            try
            {
                ...
                string[] Parametros = {
                    "@Id_Emp", "@Id_Cd","@Id_Op", "@Id_Cte", "@Id_Rik", "Id_Prd"
                };
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_CrmOportunidadesProductos_Eliminar", ref dr, Parametros, Valores);

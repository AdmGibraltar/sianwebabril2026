...
namespace CapaDatos
{
    ...
    {
        public void ConsultaVentanaPrecioEspecial_ComboCliente(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion, ref string Cte_NomComercial, bool vTerritorio)
        {
        ...
        public void ConsultaVentanaPrecioEspecial_ComboProducto(int Id_Emp, int Id_Cd, long Id_Prd, string Conexion, ref string Prd_Descripcion)
        {
        ...
        public void PrecioEspecialProductoCliente_Consulta(ref VentanaPrecioEspecialPro precioEspecialPro, string Conexion, int id_Emp, int id_Cd, int id_Cli, long id_Prd)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void PrecioEspecialSolicitudesVencidas_Consulta(ref List<VentanaPrecioEspecialPro> lista, string Conexion, int id_Emp, int id_Cd, int id_Cli, long id_Prd/*, int id_Mon*/)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void PrecioEspecialProductoCliente_Consulta(ref VentanaPrecioEspecialPro precioEspecialPro, ICD_Contexto icdCtx, int id_Emp, int id_Cd, int id_Cli, long id_Prd)
        {
            try
            {

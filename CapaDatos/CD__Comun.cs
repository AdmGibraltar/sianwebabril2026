...
namespace CapaDatos
{
    public class CD__Comun
    {
        ...
        public void LlenaCombo64(Int32 Id1, Int32 Id2, int? Id3, string SP, string Conexion, ref System.Collections.Generic.List<Comun64> list)
        {
            ...
            try
            {
                ...
                Comun64 Comun = default(Comun64);
                while (dr.Read())
                {
                    Comun = new Comun64();
                    Comun.Id = dr.GetInt64(dr.GetOrdinal("Id"));
                    Comun.Descripcion = dr.GetString(dr.GetOrdinal("Descripcion"));
                    try
                    {
                        Comun.Relacion = dr.IsDBNull(dr.GetOrdinal("Relacion")) ? "" : dr.GetValue(dr.GetOrdinal("Relacion")).ToString();
        ...
        public void LlenaComboStr(string SP, string Conexion, ref System.Collections.Generic.List<Comun> list)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                {
                    Comun = new Comun();
                    Comun.IdStr = dr.GetString(dr.GetOrdinal("Id"));
                    Comun.Descripcion = dr.GetString(dr.GetOrdinal("Descripcion"));
                    try
                    {
                        Comun.Relacion = dr.IsDBNull(dr.GetOrdinal("Relacion")) ? "" : dr.GetValue(dr.GetOrdinal("Relacion")).ToString();
        ...
        public void Maximo(int Id_Emp, int Id_Cd, int Id_Cte, string Tabla, string Columna, string SP, string Conexion, ref string maximo)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cte", "@Tabla", "@Columna" };

                object[] Valores = { Id_Emp, Id_Cd, Id_Cte, Tabla, Columna };
        ...
        public void DevLlenaCombo64(string SP, string conexion, ref List<Comun64> list)
        {
            try
            {
                SqlDataReader dr = null;

...
namespace CapaDatos
{
    public class CD_ProEntradaVirtual
    {
        ...
        public void ConsultaVentanaProEntradaVirtual_ComboProducto(int Id_Emp, int Id_Cd, long Id_Prd, string Conexion, ref string Prd_Descripcion)
        {
        ...
        public void ConsultaVentanaProEntradaVirtualDet(EntradaVirtual Ev, string Conexion, ref List<EntradaVirtualDet> List)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    ev_prd.Id_EvPro = a++;
                    ev_prd.Id_Prd = (Int64)dr.GetValue(dr.GetOrdinal("Id_Prd"));                  

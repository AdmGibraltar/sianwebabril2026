...
namespace CapaDatos
{
    public class CD_ProductoPrecios
    {
        ...
        public List<ProductoPrecios> CL_ConsultaListaProductoPrecios(ProductoPrecios productoPrecios, string Conexion)
        {
            List<ProductoPrecios> Lst = new List<ProductoPrecios>();
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spProductoPreciosCL_Consulta", ref dr, Parametros, Valores);

                while (dr.Read())
                {
                    ProductoPrecios obj = new ProductoPrecios();
                    ...
                    obj.Id_Pre = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Pre")));
                    obj.Prd_Actual = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Actual"))) ? false : dr.GetBoolean(dr.GetOrdinal("Prd_Actual"));
                    obj.Prd_PreDescripcion = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_PreDescripcion"))) ? string.Empty : dr.GetString(dr.GetOrdinal("Prd_PreDescripcion"));
                    obj.Pre_Descripcion = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Pre_Descripcion"))) ? string.Empty : dr.GetString(dr.GetOrdinal("Pre_Descripcion"));
                    obj.Prd_Pesos = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Pesos"))) ? 0 : Convert.ToSingle(dr.GetValue(dr.GetOrdinal("Prd_Pesos")));
        ...
        public void ConsultaListaProductoPreciosCL(ProductoPrecios productoPrecios, string Conexion, ref List<ProductoPrecios> List)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spProductoPrecios_Consulta_CL", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    productoPrecios.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, Sesion sesion, long Id_Prd, ref int Id_Pre)
        {
            //ric
            try
            {
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, Sesion sesion, long Id_Prd, ref int Id_Pre, ICD_Contexto icdCtx)
        {
            //ric
            try
            {
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, Sesion sesion, long Id_Prd)
        {
            //ric
            try
            {
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, int Id_Emp, int Id_Cd, long Id_Prd, string Conexion)
        {
            //ric
            try
            {
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, int Id_Emp, int Id_Cd, long Id_Prd, ICD_Contexto idcCtx)
        {
            //ric
            try
            {
        ...
        public void ConsultaListaProductoPrecioPUBLICO(ref float precio, Sesion sesion, long Id_Prd)
        {
            //ric
            try
            {
        ...
        public void ConsultarPrecios(ref double precioAAA, ref double precioLista, Sesion sesion, int Id_Cte, long Id_Prd)
        {
        ...
        public void ConsultarPrecios(ref double precioAAA, ref double precioLista, Sesion sesion, long Id_Prd)
        {
        ...
        public void ConsultarPrecios(ref double precioAAA, ref double precioLista, Sesion sesion, long Id_Prd, ICD_Contexto icdCtx)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        //RBM
        //Marzo 2024
        public List<PreciosComprasLocales> spCL_ProductoConsultaPreciosCL(PreciosComprasLocales productoPrecios, string Conexion)
        {
            List<PreciosComprasLocales> Lst = new List<PreciosComprasLocales>();
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    PreciosComprasLocales obj = new PreciosComprasLocales();
                    obj.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                    obj.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    obj.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    obj.Id_Pre = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Pre")));
                    obj.Prd_Actual = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Actual"))) ? false : dr.GetBoolean(dr.GetOrdinal("Prd_Actual"));
                    //obj.Prd_FechaInicio = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_FechaInicio"))) ? (object)null : dr.GetDateTime(dr.GetOrdinal("Prd_FechaInicio"));
                    //obj.Prd_FechaFin = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_FechaFin"))) ? (object)null : dr.GetDateTime(dr.GetOrdinal("Prd_FechaFin"));
                    obj.Prd_PreDescripcion = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_PreDescripcion"))) ? string.Empty : dr.GetString(dr.GetOrdinal("Prd_PreDescripcion"));
                    obj.Pre_Descripcion = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Pre_Descripcion"))) ? string.Empty : dr.GetString(dr.GetOrdinal("Pre_Descripcion"));
                    obj.Prd_Pesos = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Pesos"))) ? 0 : Convert.ToSingle(dr.GetValue(dr.GetOrdinal("Prd_Pesos")));

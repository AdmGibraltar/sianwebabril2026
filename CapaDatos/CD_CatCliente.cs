...
namespace CapaDatos
{
    ...
    public class CD_CatCliente
    {
        ...
        public void ConsultarSolicitudesPdtesClienteTerr(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion, ref int Existe)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("SP_ConsultaSolicitudesPdtesAutorizarClientesTerritorio", ref dr, Parametros, Valores);

                if (dr.Read())
                {
                    Existe = (int)dr.GetValue(dr.GetOrdinal("Existe"));
                }
        ...
        public void InsertarClientes(Clientes clientes, string Conexion, ref int verificador, ICD_Contexto idcCtx, bool vTerritorio)
        {
            //CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            ...
            try
            {
                ...
                if (vTerritorio)
                {
                    ...
                    Valores = new object[] {
                        ...
                        clientes.Cte_PagoIdBan,
                        clientes.Cte_PagoNumeroCuenta,
                        clientes.Cte_PagoCorreos,
                        clientes.Cte_NCUsoCFDI,
                        clientes.Cte_NCMetodoPago,
                        clientes.Cte_NCFormaPago,
                        clientes.Cte_RegimenFiscal,
                        clientes.Cte_VersionCFDI
                ...
                sqlcmd = CD_Datos.GenerarSqlCommandComillas(vTerritorio ? "spCatCliente_InsertarVTerritorio" : "spCatCliente_Insertar", ref verificador, Parametros, Valores, null, sqlcmd);
                //sqlcmd = CD_Datos.GenerarSqlCommandComillas("spCatCliente_Insertar", ref verificador, Parametros, Valores, null, sqlcmd);
        ...
        public void InsertarClientes(Clientes clientes, string Conexion, ref int verificador, bool vTerritorio)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            ...
            try
            {
                ...
                //SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_Insertar", ref verificador, Parametros, Valores);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommandComillas(vTerritorio ? "spCatCliente_InsertarVTerritorio" : "spCatCliente_Insertar", ref verificador, Parametros, Valores);
        ...
        public void ModificarClientes(Clientes clientes, string Conexion, ref int verificador, bool vTerritorio)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                if (vTerritorio)
                {
                    ...
                    Valores = new object[] {
                        ...
                        clientes.Id_Cd,
                        clientes.Id_Cte,
                        clientes.Id_Uen == null ? -1 : clientes.Id_Uen,
                        clientes.Id_Seg == null ? -1 : clientes.Id_Seg,
                        clientes.Id_Cfe == -1 ? (object)null : clientes.Id_Cfe,
                        clientes.Id_Corp == -1 ? (object)null : clientes.Id_Corp,
                        clientes.Cte_NomComercial,
                        clientes.Cte_NomCorto,
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommandComillas(vTerritorio ? "spCatCliente_ModificarVTerritorio" : "spCatCliente_Modificar", ref verificador, Parametros, Valores);
        ...
        public void ConsultarCliente(Clientes cte, string Conexion, bool vTerritorio)
        {
            ...
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cte", "@Id_Rik", "@Id_Ter", "@Ignora_Activo", "@Id_Rem" };
                object[] Valores = {
                                       cte.Id_Emp,
                                       cte.Id_Cd,
                                       cte.Id_Cte,
                                       ...
                                       cte.Ignora_Inactivo,
                                       cte.Cte_RemisionElectronica
                                   };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand(vTerritorio ? "spCatCliente_ConsultaVTerritorio" : "spCatCliente_Consulta", ref dr, Parametros, Valores);
                ...
                if (dr.HasRows)
                {
                    ...
                    if (vTerritorio)
                    {
                        cte.Id_Uen = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Uen"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_Uen"));
                        cte.Id_Seg = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Seg"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_Seg"));
                    }
                    ...
                    cte.Cte_PagoNumeroCuenta = dr.IsDBNull(dr.GetOrdinal("Cte_PagoNumeroCuenta")) ? "" : dr.GetValue(dr.GetOrdinal("Cte_PagoNumeroCuenta")).ToString();
                    cte.Cte_PagoIdBan = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_PagoIdBan"))) ? -1 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_PagoIdBan")));
                    cte.Cte_PagoBanco = dr.IsDBNull(dr.GetOrdinal("Cte_PagoBanco")) ? "" : dr.GetValue(dr.GetOrdinal("Cte_PagoBanco")).ToString();
                    ...
                    cte.Vinculado = dr.GetValue(dr.GetOrdinal("Vinculado")).ToString();
                    cte.Cte_NCUsoCFDI = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_NCrUsoCFDI"))) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrUsoCFDI")).ToString();
                    cte.Cte_NCMetodoPago = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_NCrMetodoPago"))) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrMetodoPago")).ToString();
                    cte.Cte_NCFormaPago = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_NCrFormaPago"))) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrFormaPago")).ToString();
                    cte.Cte_RegimenFiscal = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_RegimenFiscal"))) ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RegimenFiscal")));
                    cte.Cte_VersionCFDI = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("Cte_VersionCFDI")));

                    cte.Id_CtePais = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_CtePais"))) ? -1 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_CtePais")));
                    cte.Id_CteEstado = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_CteEstado"))) ? -1 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_CteEstado")));
                    try
                    {
                        cte.RevPago = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_RevPago"))) ? "" : Convert.ToString(dr.GetValue(dr.GetOrdinal("Cte_RevPago")));
                    }
                    catch { }
                    cte.Id_Fpa = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Fpa"))) ? -1 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fpa")));
                    CapaDatos.LimpiarSqlcommand(ref sqlcmd);
                }
        ...
        public void ConsultarClienteCaptacion(Clientes cte, string Conexion)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_Consultacaptacion", ref dr, Parametros, Valores);
        ...
        public void ConsultarClienteOtraBD(Clientes cte, string serie, string Conexion)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    cte.Cte_NCUsoCFDI = dr.IsDBNull(dr.GetOrdinal("Cte_NCrUsoCFDI")) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrUsoCFDI")).ToString();
                    cte.Cte_NCMetodoPago = dr.IsDBNull(dr.GetOrdinal("Cte_NCrMetodoPago")) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrMetodoPago")).ToString();
                    cte.Cte_NCFormaPago = dr.IsDBNull(dr.GetOrdinal("Cte_NCrFormaPago")) ? "" : dr.GetValue(dr.GetOrdinal("Cte_NCrFormaPago")).ToString();
        ...
        // 19AGO-2021 RFH 
        public List<CapaEntidad.CatFormaPago> CatClienteFPago_Consultar(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion)
        {
            List<CatFormaPago> lst = new List<CatFormaPago>();
            try
            {
                SqlDataReader dr = null;
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
                ...
                string[] Parametros = new string[] { "@Id_Emp", "@Id_Cd", "@Id_Cte" };
                object[] Valores = new object[] { Id_Emp, Id_Cd, Id_Cte };
                ...
                while (dr.Read())
                {
                    CatFormaPago Obj = new CatFormaPago();
                    Obj.Id_Fpa = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fpa")));
                    Obj.Fpa_Descripcion = dr.GetValue(dr.GetOrdinal("Fpa_Descripcion")).ToString();
                    lst.Add(Obj);
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        public void ConsultarClienteMetodoFormaPago(ref Clientes cte, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
                Clientes Metodo = new Clientes();
                string[] Parametros = new string[] { "@Id_Emp", "@Id_Cd", "@Id_Cte" };
                object[] Valores = new object[] { cte.Id_Emp, cte.Id_Cd, cte.Id_Cte };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("CatClienteMetodoPago_Consultar", ref dr, Parametros, Valores);

                while (dr.Read())
                {
                    Metodo.Cte_PagoMetodoPago = dr.GetValue(dr.GetOrdinal("Cte_PagoMetodoPago")).ToString();
                }

                cte.Cte_MetodoPago = Metodo.Cte_PagoMetodoPago;
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)
            {
        ...
        public void ConsultarClienteDet(ClienteDet clientedet, string Conexion, ref DataTable dt, bool vTerritorio)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand(vTerritorio ? "spCatClienteDet_Consulta_ExpVTerritorio" : "spCatClienteDet_Consulta_Exp", ref dr, Parametros, Valores);
                ...
                if (vTerritorio)
                {
                    while (dr.Read())
                    {
                        ...
                        dr.GetValue(dr.GetOrdinal("RIKServ")),
                         dr.GetValue(dr.GetOrdinal("Id_TerServTecnico")),
                        dr.GetValue(dr.GetOrdinal("TerServTecnico")),
                        dr.GetValue(dr.GetOrdinal("Id_RIKServTecnico")),
                        dr.GetValue(dr.GetOrdinal("RikServTecnico")),
                        dr.GetValue(dr.GetOrdinal("Fec_Solicitud")),
                        dr.GetValue(dr.GetOrdinal("Fec_Autorizacion")),
                        dr.GetValue(dr.GetOrdinal("Fec_Rechazo")),
                        dr.GetValue(dr.GetOrdinal("Cte_Activo")),
                        dr.GetValue(dr.GetOrdinal("TerritorioPadre")),
                        false,
                        false,
                        false
        ...
        public void ConsultarClienteDirEntrega(ClienteDirEntrega clienteDirEntrega, string Conexion)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spSelClienteDirEntrega", ref dr, Parametros, Valores);
                Comun cliente;
                while (dr.Read())
                {
        ...
        public void ConsultarClienteDirEntrega(ClienteDirEntrega clienteDirEntrega, string Conexion, ref DataTable dt, bool vTerritorio)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                if (vTerritorio)
                {
                    while (dr.Read())
                    {
                        ...
                        dr.GetValue(dr.GetOrdinal("Ruta_Entrega")),
                        dr.GetValue(dr.GetOrdinal("Ruta_EntregaId_Rut")),
                        dr.GetValue(dr.GetOrdinal("Id_EPais")),
                        dr.GetValue(dr.GetOrdinal("Id_EEstado")),
                        dr.GetValue(dr.GetOrdinal("Nom_Pais")),
                        dr.GetValue(dr.GetOrdinal("Nom_Estado"))
                        });
                    }
                }
                else
                {
                    while (dr.Read())
                    {
                        ...
                        dr.GetValue(dr.GetOrdinal("Id_EEstado")),
                        dr.GetValue(dr.GetOrdinal("Nom_Estado")),
                        dr.GetValue(dr.GetOrdinal("Accion"))
                        });
                    }
                }
        ...
        public void InsertarClienteDet(Clientes clientes, DataTable dt, string Conexion, bool vTerritorio)
        {
            ...
            try
            {
                ...
                if (vTerritorio)
                {
                    ...
                    {
                        bool territorioPadre = bool.Parse(dt.Rows[x]["TerritorioPadre"].ToString());
                        Valores = new object[] {
                            clientes.Id_Emp,
                            clientes.Id_Cd,
                            clientes.Id_Cte,
                            dt.Rows[x]["Id_CteDet"],
                            dt.Rows[x]["Id_Ter"],
                            3, //dt.Rows[x]["Ter_Tipo"],
                            DBNull.Value, //dt.Rows[x]["Id_Seg"],
                            DBNull.Value,
                            DBNull.Value, //dt.Rows[x]["Cte_UnidadDim"],
                            DBNull.Value, //dt.Rows[x]["Cte_Dimension"],
                            DBNull.Value,//dt.Rows[x]["Cte_Pesos"],
                            DBNull.Value, //dt.Rows[x]["Cte_Potencial"],
                            DBNull.Value, //dt.Rows[x]["Cte_ManoObra"],
                            DBNull.Value, //dt.Rows[x]["Cte_GastoTerritorio"],
                            DBNull.Value, //dt.Rows[x]["Cte_FletePaga"],
                            DBNull.Value, //dt.Rows[x]["Cte_PorcComision"],
                        ...
                        sqlcmd = CapaDatos.GenerarSqlCommand(vTerritorio ? "spCatClienteDet_InsertarVTerritorio" : "spCatClienteDet_Insertar", ref verificador, Parametros, Valores);
                    }
                }
                else
                {
        ...
        public void InsertarClienteDirEntrega(Clientes clientes, DataTable dt, string Conexion, bool vTerritorio)
        {
            if (dt.Rows.Count == 0) return;
                ...
                if (vTerritorio)
                {
                    for (int x = 0; x < dt.Rows.Count; x++)
                    {
                        Valores = new object[] {
                            ...
                            x,
                            dt.Rows[x]["Ruta_EntregaId_Rut"],
                            dt.Rows[x]["Id_EPais"],
                            dt.Rows[x]["Id_EEstado"]
                        };

                        sqlcmd = CapaDatos.GenerarSqlCommand("spCatClienteDirEntrega_InsertarVTerritorio", ref verificador, Parametros, Valores);
                    }
                }
                else
                {
                    for (int x = 0; x < dt.Rows.Count; x++)
                    {
                        Valores = new object[] {
                            ...
                            dt.Rows[x]["Accion"],
                            dt.Rows[x]["Ruta_EntregaId_Rut"],
                            dt.Rows[x]["EntregaIdPais"],
                            dt.Rows[x]["EntregaIdEstado"]
                        };
        ...
        public void ConsultaClienteValidoFacturaSinPedido(int id_cliente, CapaEntidad.Sesion sesion, ref String SiValida)
        {//RM
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spClienteValidoFacturaSinPedido", ref dr, parametros, Valores);
                if (dr.Read())
                {
                    SiValida = dr.GetString(dr.GetOrdinal("SiValida"));
                }
                dr.Close();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            ...
            string TextoBuscar, string Conexion)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    obj.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Activo")));
                    if (Convert.ToInt32(dr.GetValue(dr.GetOrdinal("TipoCuenta"))) == 1)
                        obj.tipoCliente = "CN";
                    else if (Convert.ToInt32(dr.GetValue(dr.GetOrdinal("TipoCuenta"))) == 2)
                        obj.tipoCliente = "CC";
                    else
                        obj.tipoCliente = "L";
                    lst.Add(obj);
        ...
        //  
        // FEB28-2020 RFH
        // ACYS - Buscar clientes para rik (Cliente->Territorio->Rik)
        // 
        public List<eClienteBuscar> ListarBusqueda_PorRik(int Id_Emp, int Id_Cd, int Id_Uen, int Id_Seg, int Id_Terr, int Id_Rik,
            string TextoBuscar, string Conexion)
        {
            List<eClienteBuscar> lst = new List<eClienteBuscar>();
            try
            {
                ...
                /*Para bennetts esto cambia*/
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRMCliente_ListaBusqueda_PorRik", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    obj.UEN = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("UEN")));
                    obj.Segmento = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Segmento")));
                    obj.IdTer = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Ter")));
                    obj.TerNombre = Convert.ToString(dr.GetValue(dr.GetOrdinal("TerritorioNombre")));
                    obj.RegistrosEcontrados = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("RegistrosEncontrados")));
                    obj.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Activo")));
                    lst.Add(obj);
        ...
        public List<eClienteBuscar> spCrmInt_Clientes(int Id_Emp, int Id_Cd, int Id_Rik, string Conexion)
        {
            List<eClienteBuscar> lst = new List<eClienteBuscar>();
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCrmInt_Clientes", ref dr, Parametros, Valores);
                while (dr.Read())
                {
                    eClienteBuscar obj = new eClienteBuscar();
                    obj.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id")));
                    obj.NomComercial = Convert.ToString(dr.GetValue(dr.GetOrdinal("Descripcion")));
                    lst.Add(obj);
                }
                dr.Close();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        // Gestio Comercial Consulta Clientes
        // 04MAR-2021 - Datos para Reporte Dinamico
        public List<eClienteBuscar> spGC_CatCiente_Listar(
            int PageNumber, int PageSize, int Anio, int Mes, int Id_Emp, int Id_Cd, int Id_U, int Id_Rik, string TextoBuscar, string Conexion)
        {
            List<eClienteBuscar> lst = new List<eClienteBuscar>();
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spGC_CatCiente_Listar", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    obj.Cte_FacRfc = Convert.ToString(dr.GetValue(dr.GetOrdinal("Cte_FacRfc")));
                    obj.VPObservado = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("VPOObservado")));
                    ...
                    obj.Ter_Nombre = Convert.ToString(dr.GetValue(dr.GetOrdinal("Ter_Nombre")));
                    obj.RegistrosEcontrados = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("RegistrosEncontrados")));
                    obj.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Activo")));

                    obj.VtaINstaladaConsolidada = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("VtaINstaladaConsolidada")));
                    obj.VtaMesFacturada = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("VtaMesFacturada")));
                    obj.VtaDelMesvsVI = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("VtaDelMesvsVI")));
                    obj.CumplimientoVIMes = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("CumplimientoVIMes")));
                    obj.VtaTotalMes = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("VtaTotalMEs")));
        ...
        // 18MAR-2021
        public List<eClienteBuscar> spRepCumplimientoVI_Dinamico(eClenteBuscar_Params Pms)
        {
            List<eClienteBuscar> lst = new List<eClienteBuscar>();
            try
            {
                ...
                object[] Valores = {
                    //Pms.PageNumber, Pms.PageSize, Pms.Id_Emp,
        ...
        // 11MAR-2022 RFH
        public List<eClienteBuscar> spRepCumplimientoVI_ver3(eClenteBuscar_Params Pms)
        {
            List<eClienteBuscar> lst = new List<eClienteBuscar>();
            try
            {
                ...
                object[] Valores = {
                    ...
                    Pms.OrdenDir,
                    0,
                    Pms.tipoCliente <= -1 ? (object)null : Pms.tipoCliente,
                    Pms.NombreCliente == null? "" : Pms.NombreCliente,
                    Pms.TipoRep
                };
                ...
                while (dr.Read())
                {
                    ...
                    if (Pms.Tipo == 1)
                    {
                        try
                        {
                            obj.tipoCliente = dr.IsDBNull(dr.GetOrdinal("TipoCliente")) ? "" : Convert.ToString(dr.GetValue(dr.GetOrdinal("TipoCliente")));
                            obj.TipoCuenta = dr.IsDBNull(dr.GetOrdinal("TipoCuenta")) ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("TipoCuenta")));

                            if (obj.TipoCuenta == 0)
                            {
                                obj.descripcionTipoCuenta = "L";
                            }
                            if (obj.TipoCuenta == 1)
                            {
                                obj.descripcionTipoCuenta = "CN";
                            }
                            if (obj.TipoCuenta == 2)
                            {
                                obj.descripcionTipoCuenta = "CC";
                            }
                        }
                        catch (Exception ex)
                        {
        ...
        public void ConsultaClientesDirectosSP(ref Clientes cte, ref int EsClienteDirectoSP, string Conexion)
        {
            try
            {
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);

                EsClienteDirectoSP = 0;

                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cte" };
                object[] valores = { cte.Id_Emp, cte.Id_Cd, cte.Id_Cte };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spConsulta_ClienteDirectoSP", ref EsClienteDirectoSP, Parametros, valores);
        ...
        public void ConsultaClienteCorrreos(int Id_Cd, int Id_Fac, ref Clientes cte, string Conexion)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    cte.Cte_PagoCorreos = dr["Cte_PagoCorreos"].ToString();
                }
        ...
        public eCliente Consultar_PorId_Cte(int Id_Emp, int Id_Cd, int Id_Cte, string conexion)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    obj.Cte_Email = dr.GetValue(dr.GetOrdinal("Cte_Email")).ToString();
                    obj.Cte_FacCalle = dr.GetValue(dr.GetOrdinal("Cte_FacCalle")).ToString();
                    obj.Cte_FacNumero = dr.GetValue(dr.GetOrdinal("Cte_FacNumero")).ToString();
                    obj.Cte_FacColonia = dr.GetValue(dr.GetOrdinal("Cte_FacColonia")).ToString();
                    obj.Cte_FacMunicipio = dr.GetValue(dr.GetOrdinal("Cte_FacMunicipio")).ToString();
                    obj.Cte_FacEstado = dr.GetValue(dr.GetOrdinal("Cte_FacEstado")).ToString();
                    obj.Cte_FacCP = dr.GetValue(dr.GetOrdinal("Cte_FacCP")).ToString();
                    obj.Cte_FacTelefonos = dr.GetValue(dr.GetOrdinal("Cte_FacTel")).ToString();

                    obj.Cte_FacTel = dr.GetValue(dr.GetOrdinal("Cte_FacTel")).ToString();
                    obj.Cte_FacRfc = dr.GetValue(dr.GetOrdinal("Cte_FAcRfc")).ToString();
                    obj.Id_Ter = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Ter")));

                    // JUN19-2020 RFH
                    obj.Id_TCte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_TCte")));

                    /*
                    obj.Cte_Credito = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Credito")));
                    obj.Cte_Contado = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Contado")));
                     * */

                    obj.Cte_CondPago = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CondPago")));
                    obj.Cte_LimCobr = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_LimCobr")));

                    obj.Cte_Efectivo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Efectivo")));
                    obj.Cte_Factoraje = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Factoraje")));
                    obj.Cte_Transferencia = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Transferencia")));
                    obj.Cte_Cheque = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Cheque")));
                    obj.Cte_Cheque = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Cheque")));

                    obj.Cte_Credito = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Credito")));

                    obj.Cte_RHoraam1 = dr.GetValue(dr.GetOrdinal("Cte_RHoraam1")).ToString();
                    obj.Cte_RHoraam2 = dr.GetValue(dr.GetOrdinal("Cte_RHoraam2")).ToString();
                    obj.Cte_RHorapm1 = dr.GetValue(dr.GetOrdinal("Cte_RHorapm1")).ToString();
                    obj.Cte_RHorapm2 = dr.GetValue(dr.GetOrdinal("Cte_RHorapm2")).ToString();

                    obj.Cte_CPLunes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPLunes")));
                    obj.Cte_CPMartes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPMartes")));
                    obj.Cte_CPMiercoles = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPMiercoles")));
                    obj.Cte_CPJueves = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPJueves")));
                    obj.Cte_CPViernes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPViernes")));
                    obj.Cte_CPSabado = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPSabado")));
                    obj.Cte_CPSabado = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_CPSabado")));

                    obj.Cte_PHoraam1 = dr.GetValue(dr.GetOrdinal("Cte_PHoraam1")).ToString();
                    obj.Cte_PHoraam2 = dr.GetValue(dr.GetOrdinal("Cte_PHoraam2")).ToString();
                    obj.Cte_PHorapm1 = dr.GetValue(dr.GetOrdinal("Cte_PHorapm1")).ToString();
                    obj.Cte_PHorapm2 = dr.GetValue(dr.GetOrdinal("Cte_PHorapm2")).ToString();

                    obj.Cte_RLunes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RLunes")));
                    obj.Cte_RMartes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RMartes")));
                    obj.Cte_RMiercoles = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RMiercoles")));
                    obj.Cte_RJueves = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RJueves")));
                    obj.Cte_RViernes = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RViernes")));
                    obj.Cte_RSabado = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_RSabado")));

                    obj.Efectivo_1 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Efectivo_1")));
                    obj.Cheque_2 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cheque_2")));
                    obj.TransferenciaE_3 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("TransferenciaE_3")));
                    obj.TarjetaDebito_4 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("TarjetaDebito_4")));
                    obj.MonederoE_5 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("MonederoE_5")));
                    obj.DineroE_6 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("DineroE_6")));
                    obj.ValdesDesp_7 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ValdesDesp_7")));
        ...
        public void ValidaSucursal(Sesion sesion, string conexion, ref int respuesta)
        {
            try
            {
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(conexion);
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spValidarSucursal", ref respuesta, Parametros, Valores);
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        public void ConsultarDireccionesEntrega(Sesion sesion, CartaPorte carta, ref DataSet dsDirecciones, int Tipo)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cte", "@Tipo" };
                object[] Valores = { carta.Id_Emp, carta.Id_Cd, carta.Id_Cte, Tipo };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spConsultaDireccionesEntrega", ref dsDirecciones, Parametros, Valores);
        ...
        public void ConsultaClienteCDFI(int Id_Emp, int Id_Cd, CartaPorte carta, string Emp_Cnx, ref Clientes Cliente)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Emp_Cnx);

            string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Cte", "@CodigoPostal", "@Colonia" };
            object[] Valores = { Id_Emp, Id_Cd, carta.Id_Cte, Cliente.Cte_Cp, Cliente.Cte_FacColonia };

            SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spConsultaClienteCFDI_V2", ref dr, Parametros, Valores);

            while (dr.Read())
            {
                Cliente.Id_Cte = dr.GetInt32(dr.GetOrdinal("Id_Cte"));
                Cliente.Cte_NomComercial = dr.GetString(dr.GetOrdinal("Cte_NomComercial"));
                Cliente.Cte_FacRfc = dr.GetString(dr.GetOrdinal("Cte_FacRfc"));
                Cliente.Cte_FacCalle = dr.GetString(dr.GetOrdinal("Cte_FacCalle"));
                Cliente.Cte_FacNumero = dr.GetString(dr.GetOrdinal("Cte_FacNumero"));
                Cliente.Cte_FacCp = dr.GetString(dr.GetOrdinal("Cte_FacCp"));
                //Datos del Sat para Carta Porte
                Cliente.Cte_FacColonia = dr.GetString(dr.GetOrdinal("c_Colonia"));
                Cliente.Cte_FacMunicipio = dr.GetString(dr.GetOrdinal("c_Municipio"));
                Cliente.Cte_Estado = dr.GetString(dr.GetOrdinal("c_Estado"));
                Cliente.Cte_Pais = dr.GetString(dr.GetOrdinal("c_Pais"));
                //Fin
                Cliente.Cte_PagoMetodoPago = dr.GetString(dr.GetOrdinal("Cte_PagoMetodoPago"));
                Cliente.Cte_Email = dr.GetString(dr.GetOrdinal("Cte_Email"));
                Cliente.Id_Mon = dr.GetInt32(dr.GetOrdinal("Id_Mon"));
                Cliente.Cte_MetodoPago = dr.GetString(dr.GetOrdinal("Cte_MetodoPago"));
                Cliente.Cte_UsoCFDI = dr.GetString(dr.GetOrdinal("Cte_UsoCFDI"));
            }
            dr.Close();
            CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        }

        public void CargarEstados(Sesion sesion, int Id_Pais, ref DataSet Datos)
        {
            try
            {
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(sesion.Emp_Cnx);

                string[] Parametros = { "@Id_Pais" };
                object[] Valores = { Id_Pais };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatEstados_Combo", ref Datos, Parametros, Valores);
        ...
        public bool ConsultaClienteDirecto(Clientes cte, string conexion)
        {
            var capaDatos = new CD_Datos(conexion);
            bool clienteDirecto = false;
            ...
            {
                SqlDataReader dr = null;
                var sqlcmd = capaDatos.GenerarSqlCommand("spCatCliente_ConsultaEstbicentral", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    clienteDirecto = (int)dr.GetValue(dr.GetOrdinal("_exists")) == 1;
                }
                capaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch { }
        ...
        public void ConsultaClientesDetRecibe(ref ClienteDetRecibe entClienteDetRecibe, string Conexion)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                                       entClienteDetRecibe.Id_Emp,
                                       entClienteDetRecibe.Id_Cd,
                                       entClienteDetRecibe.Id_Cte,
                                       entClienteDetRecibe.Id_Ter

                                   };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatClienteDetRecibe_Consulta", ref dr, Parametros, Valores);

                if (dr.HasRows)
                {
                    dr.Read();
                    entClienteDetRecibe.Id_Emp = (int)dr.GetValue(dr.GetOrdinal("Id_Emp"));
                    entClienteDetRecibe.Id_Cd = (int)dr.GetValue(dr.GetOrdinal("Id_Cd"));
                    entClienteDetRecibe.Id_Cte = (int)dr.GetValue(dr.GetOrdinal("Id_Cte"));

                    entClienteDetRecibe.Cte_Recibe = dr.GetString(dr.GetOrdinal("Cte_Recibe"));
                    entClienteDetRecibe.Cte_HorarioEntrega = dr.GetString(dr.GetOrdinal("Cte_HorarioEntrega"));
                    entClienteDetRecibe.Cte_DiaRecepcion = dr.GetString(dr.GetOrdinal("Cte_DiaRecepcion"));
                    entClienteDetRecibe.Cte_AreaRecibo = dr.GetString(dr.GetOrdinal("Cte_AreaRecibo"));
                    entClienteDetRecibe.Cte_DocAdicional = dr.GetString(dr.GetOrdinal("Cte_DocAdicional"));
                    entClienteDetRecibe.Cte_Revicion = dr.GetString(dr.GetOrdinal("Cte_Revicion"));
                    entClienteDetRecibe.Cte_Pago = dr.GetString(dr.GetOrdinal("Cte_Pago"));
                    entClienteDetRecibe.Cte_RevisionDocAdicional = dr.GetString(dr.GetOrdinal("Cte_RevisionDocAdicional"));
                    entClienteDetRecibe.Cte_PagoPresencial = dr.GetString(dr.GetOrdinal("Cte_PagoPresencial"));

                    /*
                     Id_Cte	Id_Emp	Id_Cd	Recibe	Horario	Dias de recepcion	Area de recibo	Adicionales
                     */
                }
                else
                {
                    entClienteDetRecibe.Cte_Recibe = "";
                    entClienteDetRecibe.Cte_HorarioEntrega = "";
                    entClienteDetRecibe.Cte_DiaRecepcion = "";
                    entClienteDetRecibe.Cte_AreaRecibo = "";
                    entClienteDetRecibe.Cte_DocAdicional = "";
                    entClienteDetRecibe.Cte_Revicion = "";
                    entClienteDetRecibe.Cte_Pago = "";
                    entClienteDetRecibe.Cte_RevisionDocAdicional = "";
                    entClienteDetRecibe.Cte_PagoPresencial = "";
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        // 
        public void ConsultarCatalogoDinamico(int IdEmp, int IdCd, string Conexion, ref List<Comun> lstCatalogo, ref List<Comun> lstCatalogoDetalle, ref List<Comun> lstCampos)
        {
            ...
            try
            {
                SqlDataReader dr = null;
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
                Comun itemCatalogo = new Comun();
                Comun itemCampos = new Comun();
                Comun itemDetalle = new Comun();
                int intTipoCampo = 0;
                string[] Parametros = { "@Id_Cd" };
                object[] Valores = {
                                IdCd
                                   };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_CatGenerico_Consultar", ref dr, Parametros, Valores);

                while (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        if (ExisteColumna(dr, "campo_tipo"))
                        {
                            intTipoCampo = dr.GetInt32(dr.GetOrdinal("campo_tipo"));
                            if (intTipoCampo == 1)
                            {
                                itemCampos = new Comun();
                                itemCampos.Id = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico"));
                                itemCampos.Descripcion = dr.GetString(dr.GetOrdinal("cat_nombre"));
                                lstCampos.Add(itemCampos);
                            }
                            else if (intTipoCampo == 2)
                            {
                                itemCatalogo = new Comun();
                                itemCatalogo.Id = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico"));
                                itemCatalogo.Descripcion = dr.GetString(dr.GetOrdinal("cat_nombre"));
                                lstCatalogo.Add(itemCatalogo);
                            }
                        }

                        if (ExisteColumna(dr, "Id_CatGenerico_Detalle"))
                        {
                            itemDetalle = new Comun();
                            itemDetalle.Id = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico"));
                            itemDetalle.ValorInt = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico_Detalle"));
                            itemDetalle.Descripcion = dr.GetString(dr.GetOrdinal("texto"));
                            lstCatalogoDetalle.Add(itemDetalle);
                        }
        ...
        //
        public void GuardarSeleccionCatalogoAdicional(string Conexion, int IdCd, int[] lstParametro, int intIdCampo, string strValor)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_GuardarCatAdicional", ref dr, Parametros, Valores);
        ...
        //
        public void ConsultarSeleccionCatalogoAdicional(string Conexion, int IdCd, int intIdCte, ref List<Comun> lstCatalogoSeleccion)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_ConsultaCatAdicional", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    itemDetalle.Id = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico"));
                    itemDetalle.ValorInt = dr.GetInt32(dr.GetOrdinal("Id_CatGenerico_Detalle"));
                    itemDetalle.ValorStr = dr.GetString(dr.GetOrdinal("value_str"));
                    lstCatalogoSeleccion.Add(itemDetalle);
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        // 
        public void ModificarTerritorioAcys(string Conexion, int intIdU, ClienteDet entCliente, int intIdCteDetPadreAnterior, int intIdCteDetPadreNuevo)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                    ...
                    entCliente.Id_Cd,
                    entCliente.Id_Cte,
                    intIdCteDetPadreAnterior,
                    intIdCteDetPadreNuevo,
                    intIdU
                };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_ModificarTerritorioAcys", ref dr, Parametros, Valores);

                if (dr.Read())
                {
                    itemDetalle.Id = dr.GetInt32(dr.GetOrdinal("Respuesta"));
                    itemDetalle.ValorStr = dr.GetString(dr.GetOrdinal("Mensaje"));
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        public void ActualizaTerritorioActivo(string Conexion, ClienteDet entCliente, int intIdTerActivo, int intIdU)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                object[] Valores = {
                    ...
                    entCliente.Id_Cd,
                    entCliente.Id_Cte,
                    entCliente.Id_CteDet,
                    intIdTerActivo,
                    intIdU
                };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCliente_CambiarTerritorioAcys", ref dr, Parametros, Valores);

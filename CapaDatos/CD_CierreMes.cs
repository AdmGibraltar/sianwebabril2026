...
namespace CapaDatos
{
    public class CD_CierreMes
    {
        ...
        public void ValidaCierre(int Id_Emp, int Id_Cd, string Conexion, ref string MensajeAlerta)
        {
            ...
            SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spProCierreMensualValida", ref dr, Parametros, Valores);

            if (dr.Read())
            {

                MensajeAlerta = dr[0].ToString();
            }

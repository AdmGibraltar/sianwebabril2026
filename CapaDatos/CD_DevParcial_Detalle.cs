        ...
        public void InsertarDevParcial(Sesion Sesion, DevParcial_Detalle devparcial, List<DevParcial_Detalle> devparcialList, ref int verificador)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                                        ...
                                        "I",
                                        null,
                                        devparcial.Ncr_UsoCFDI,
                                        devparcial.Ncr_MetodoPago,
                                        devparcial.Ncr_FormaPago
        ...
        public void ConsultaDevParcialDetalleFactura(Sesion Sesion, int factura, int devolucion, ref List<DevParcial_Detalle> List)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    devParcialDetalle.Ncr_UsoCFDI = (string)dr.GetValue(dr.GetOrdinal("Ncr_UsoCFDI"));
                    devParcialDetalle.Ncr_MetodoPago = (string)dr.GetValue(dr.GetOrdinal("Ncr_MetodoPago"));
                    devParcialDetalle.Ncr_FormaPago = (string)dr.GetValue(dr.GetOrdinal("Ncr_FormaPago"));
        ...
        public void ConsultaDetalleFactura(Sesion Sesion, int factura, int id, ref List<DevParcial_DetalleFactura> List)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    devParcial.Id_Prod = (Int64)dr.GetValue(dr.GetOrdinal("Id_Prd"));

...
namespace CapaDatos
{
    public class CD_CapValuacionProyecto
    {
        ...
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
        // 28 Sep 2018 RFH
        public void ConsultarValuacionProyecto2(ref ValuacionProyecto valuacionProyecto, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                if (dr.HasRows)
                {
                    ...
                    valuacionProyecto.Cte_NomComercial = dr.GetValue(dr.GetOrdinal("Cte_NomComercial")).ToString();
                    valuacionProyecto.Vap_Nota = dr.IsDBNull(dr.GetOrdinal("Vap_Nota")) ? string.Empty : dr.GetValue(dr.GetOrdinal("Vap_Nota")).ToString();
                    valuacionProyecto.Vap_Estatus2 = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Vap_Estatus2")));
                    valuacionProyecto.Vap_Estatus = dr.GetValue(dr.GetOrdinal("Vap_Estatus")).ToString();
                    valuacionProyecto.Estatus = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Estatus")));
                    valuacionProyecto.MotivoParaAutorizacion = dr.GetValue(dr.GetOrdinal("MotivoParaAutorizacion")).ToString();
                }
                ...
                while (dr.Read())
                {
                    ...
                    valuacionProyectoDetalle.Estatus = dr.GetValue(dr.GetOrdinal("Det_Estatus")).ToString();
                    valuacionProyectoDetalle.Vap_PrecioEspecial = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("Vap_PrecioEspecial")));
                    valuacionProyectoDetalle.Vap_PrecioObjetivo = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("Vap_PrecioObjetivo")));
        ...
        public ValuacionProyecto InsertarValuacionProyecto_ver2(
            int Id_Emp, int Id_Cd, int Id_Op, int Id_Cte, int Folio, int TipoValuacion,
            ValuacionProyecto VPro, ValuacionParametros VPara, ValuacionParametrosActual VPActual,
            string Conexion)
        {
            ValuacionProyecto VPResult = new ValuacionProyecto();
            int verificador = 0;
            int iId_Val = 0;
            int iResulta_CrmValuacionOportunidades_Insert = 0;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            ...
            try
            {
                ...
                object[] Valores = {
                                        ...
                                        ,VPro.Vap_Nota
                                        ,VPro.Vap_Estatus
                                        ,VPro.Vap_UtilidadRemanente
                                        ,VPro.Vap_ValorPresenteNeto
                                        ,VPro.Vap_Estatus2
                                        ,VPro.Id_Rik
                                        ,VPro.Id_Ter
                                        ,VPro.MotivoParaAutorizacion
                                        ,TipoValuacion
                                   };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapValProyecto_InsertUpdate_ver2", ref verificador, Parametros, Valores);
                VPro.Id_Vap = verificador; //clave de val. proyecto
                iId_Val = verificador;
                ...
                if (TipoValuacion == 1)
                {
                    //
                    // CatCrmOportunidad
                    // Si es tipo VALUACION GLOBAL debe GUARDAR primero para general el Id_Op
                    // 
                    string[] P1 = {
                                             "@Id_Emp",
                                             "@Id_Cd",
                    ...
                    object[] V1 = {
                                            ...
                                            Id_Cte,
                                            VPro.Id_Rik,
                                            1 // Establecemos a 3 para identificar Tipo VALUACION GLOBAL
                                       };

                    sqlcmd = CapaDatos.GenerarSqlCommand("spCatCrmPromocion_InsertarUpdate_ver2", ref verificador, P1, V1);
                    Id_Op = verificador;

                    //
                    // CrmOportunidadesAplicacion 
                    //
                    ...
                    sqlcmd = CapaDatos.GenerarSqlCommand("spCrmOprotunidadApl_InsertUpdate_Ver2", ref verificador, P2, V2);
                    iResulta = verificador;

                }


                // INSERT CrmValuacionOportunidades
                Parametros = new string[] {
                                        "@Id_Emp"
                                        ,"@Id_Cd"
                                        ,"@Id_Cte"
                ...
                verificador = 0;
                sqlcmd = CapaDatos.GenerarSqlCommand("spCrmValuacionOportunidades_Insert", ref verificador, Parametros, Valores);
                iResulta_CrmValuacionOportunidades_Insert = verificador;
                ...
                Valores = new object[] {
                                            ...
                                            iId_Val,
                                            VPara.Vap_Vigencia ,
                                            VPara.Vap_Participacion ,
                                            VPara.Vap_Mano_Obra ,
                                            VPara.Vap_Amortizacion ,
                                            VPara.Vap_Numero_Entregas ,
                                            VPara.Vap_Costo_Entregas ,
                                            VPara.Vap_Comision_Factoraje ,
                                            VPara.Vap_Comision_Anden ,
                                            VPara.Vap_Gasto_Flete_Locales ,
                                            VPara.Vap_IVA ,
                                            VPara.Vap_Plazo_Pago_Cliente ,
                                            VPara.Vap_Inventario_Key ,
                                            VPara.Vap_Inventario_Consignacion ,
                                            VPara.Vap_Inventario_Papel ,
                                            VPara.Vap_Consignacion_Papel ,
                                            VPara.Vap_Credito_Key ,
                                            VPara.Vap_Credito_Papel ,
                                            VPara.Vap_ISR ,
                                            VPara.Vap_Ucs ,
                                            VPara.Vap_Cetes ,
                                            VPara.Vap_Adicional_Cetes ,
                                            VPara.Vap_Costos_Fijos_No_Papel ,
                                            VPara.Vap_Costos_Fijos_Papel ,
                                            VPara.Vap_Gastos_Admin ,
                                            VPara.Vap_Inversion_Activos,
                                            VPara.txtGastosVarAplTerr,
                                            VPara.txtFletesPagadosalCliente,
                                            VPActual.txtCuentasPorCobrar,
                                            VPActual.txtInventario,
                                            VPActual.txtGastosServirCliente,
                                            VPActual.txtVigencia,
                ...
                verificador = 0;
                sqlcmd = CapaDatos.GenerarSqlCommand("CapValProyectoParams_InsertUpdate_Ver2", ref verificador, Parametros, Valores);
                ...
                sqlcmd = CapaDatos.GenerarSqlCommand("spCapValProyectoDetalle_DeleteAll_ver2", ref verificador, Parametros, Valores);
                ...
                int i = 1;
                foreach (ValuacionProyectoDetalle ValuacionProyectoDetalle in VPro.ListaProductosValuacionProyecto)
                {
                    ValuacionProyectoDetalle.Id_VapDet = i;
                    object[] ValoresDet = {
                                        ValuacionProyectoDetalle.Id_Emp
                                        ...
                                        ,ValuacionProyectoDetalle.Vap_Precio
                                        ,ValuacionProyectoDetalle.Vap_PrecioEspecial
                                        ,ValuacionProyectoDetalle.Id_Op
                                   };
                    sqlcmd = CapaDatos.GenerarSqlCommand("spCapValProyectoDetalle_Insertar_ver2", ref verificador, ParametrosDet, ValoresDet);
                    i += 1;
                }
                CapaDatos.CommitTrans();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        //
        //  20 Sep 2018 RFH
        //  Se requiere modificar SP para modificar la forma en la que se crea la lista de productos
        //  El anterior eliminar el detalle completo luego agrega uno por uno.
        //  Ahora:
        // 1.- Se marcara el detalle con un flag eliminado 
        // 2.- Se Activarn y actualizaran los productos 
        // 3.- Se eliminaran los que quedarina.

        public void CRM2_ModificarValuacionProyecto(ref ValuacionProyecto valuacionProyecto, ValuacionParametros vp, string Conexion, ref int verificador, int[] idOps, string conexionEF, int idRik, ICD_Contexto icdCtx)
        {
            ICD_Contexto<sianwebmty_gEntities> ctx = ((ICD_Contexto<sianwebmty_gEntities>)icdCtx);
            IDbTransaction transaction = ctx.Contexto.Database.CurrentTransaction.UnderlyingTransaction;
            SqlCommand sqlcmd = null;
            ...
            try
            {
                ...
                sqlcmd = transaction.Connection.CreateCommand() as SqlCommand;
                sqlcmd.Transaction = (System.Data.SqlClient.SqlTransaction)transaction;
                sqlcmd = CD_Datos.GenerarSqlCommand("spCRM_CapValProyecto_Modificar", ref verificador, Parametros, Valores, transaction.Connection, sqlcmd);
                sqlcmd.Dispose();

                // Marca los registros de detalle a borrado
                //valuacionProyecto.Id_Vap = verificador; //clave de val. proyecto
                ...
                foreach (ValuacionProyectoDetalle ValuacionProyectoDetalle in valuacionProyecto.ListaProductosValuacionProyecto)
                {
                    ...
                    sqlcmd = transaction.Connection.CreateCommand() as SqlCommand;
                    sqlcmd.Transaction = (System.Data.SqlClient.SqlTransaction)transaction;
                    sqlcmd = CD_Datos.GenerarSqlCommand("spCRM_CapValProyectoDetalle_Insertar", ref verificador, ParametrosDet, ValoresDet, transaction.Connection, sqlcmd);
                    sqlcmd.Dispose();
                    i += 1;
                }

                // Eliminar los Registos marcados para borrar
                /* 27 Sep 2018 RFH
                 *  no se aplic por el momento 
                Parametros = new string[] { 
                                            "@Id_Emp", "@Id_Cd", "@Id_Vap"
                                            
                                        };
                Valores = new object[] { 
                                            vp.Id_Emp, vp.Id_Cd, valuacionProyecto.Id_Vap                                            
                                          };
                verificador = 0;
                sqlcmd = transaction.Connection.CreateCommand() as SqlCommand;
                sqlcmd.Transaction = (System.Data.SqlClient.SqlTransaction)transaction;
                sqlcmd = CD_Datos.GenerarSqlCommand("spCRM_CapValProyectoDet_AplicarBorrar", ref verificador, Parametros, Valores, transaction.Connection, sqlcmd);
                sqlcmd.Dispose();
                */
        ...
        //
        // 19 Sep 2018 RFH 
        // Actualiza los datos de una Valuacion

        public int CRM2_InsertUpdate_Tipo(eCapValProyecto cVP, string Conexion)
        {
            int iResult = 0;
            try
            {
                ...
                object[] Valores = {
                    ...
                    cVP.Id_U,
                    cVP.Vap_Nota,
                    cVP.Vap_UtilidadRemanente,
                    cVP.Vap_ValorPresenteNeto,
                    cVP.MotivoParaAutorizacion,
                    cVP.Tipo
                };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_CapValProyecto_InsertUpdate", ref dr, Parametros, Valores);

                if (dr.HasRows)
                {
                    dr.Read();
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("AfectedRows")).ToString());
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)

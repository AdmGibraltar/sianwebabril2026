...
namespace CapaDatos
{
    public class CD_CapEntradaSalida
    {
        ...
        public void ConsultarSaldo(Sesion sesion, int Id_Cliente, long Id_Prd, DateTime fecha, int Id_Ter, ref int resultado,
        ...
        public void ConsultarEntradaSalida(Sesion sesion, int Id_Emp, int Id_Cd_Ver, int Id_Es, int Es_Naturaleza, ref EntradaSalida entradaSalida)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    entradaSalida.Id_Ord = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Ord"))) ? -1 : dr.GetInt32(dr.GetOrdinal("Id_Ord"));
                    break;
                }
                dr.Close();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        public void ConsultarDisponible(Sesion sesion, long Id_Prd, ref int Disponible, ref int invFinal, ref int asignado)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void ConsultarEntradaSalidaDetalles(Sesion sesion, EntradaSalida entsal, ref List<EntradaSalidaDetalle> detalles)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    EntSalDetalle.Id_Prd = dr.GetInt64(dr.GetOrdinal("Id_Prd"));
        ...
        public void GuardarEntradaSalida(EntradaSalida entradaSalida, List<EntradaSalidaDetalle> listaDetalle, ref string verificadorStr, int strEmp, string Conexion)
        {
            ...
            try
            {
                ...
                /// para el cambio de precios en compra local
                int iOkk = 0;
                ...
                CD_ComprasLocales CDCompras = new CD_ComprasLocales();
                ...
                foreach (EntradaSalidaDetalle detalle in listaDetalle)
                {
                    ...
                    // se manda llamar el proceso q genera el cambio de precio y su nuevo historial
                    CDCompras.AplicaCambioDeCostoCompraLocal(detalle.Id_Cd, detalle.Id_Prd, detalle.Es_Costo, Conexion, ref iOkk);

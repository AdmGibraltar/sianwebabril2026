...
namespace CapaDatos
{
    public class CD_CatSemana
    {
        ...
        public void ConsultaSemana_Anio(int id_emp, int Anio, string Conexion, ref List<Semana> list)
        {
            ...
            try
            {
                ...
                string[] parametros = { "@Id_Emp", "@Id_anio" };
                object[] Valores = { id_emp, Anio };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatSemana_ConsultaAnio", ref dr, parametros, Valores);

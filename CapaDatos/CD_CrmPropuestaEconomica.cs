...
namespace CapaDatos
{
    public class CD_CrmPropuestaEconomica
    {
        ...
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
        public eCapValProyecto spCRMCapValProyecto(int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, string Conexion)
        {
        ...
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
        public List<ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, string Conexion)
        {
        ...
        // 
        // CRM - Lista de Producos Propuesta TE
        // JUN12-2020
        //
        public List<ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica_Ver2(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, int Id_Ptp, string Conexion)
        {
            List<ePropuestaTecnoEconomicaDetalle> Lst = new List<ePropuestaTecnoEconomicaDetalle>();
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_ObtenerPropuestaEconomica_Ver2", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    obj.Prd_UniEmp = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("Prd_UniEmp")));
                    obj.AplDilucion = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("AplDilucion")));
                    obj.Id_Ptp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Ptp")));
                    obj.Prd_UniNe = dr.GetValue(dr.GetOrdinal("Prd_UniNe")).ToString();
        ...
        // AGO14-2020
        //
        public List<ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica_Ver3(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, int Id_Ptp, string Conexion)
        {
            List<ePropuestaTecnoEconomicaDetalle> Lst = new List<ePropuestaTecnoEconomicaDetalle>();
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_ObtenerPropuestaEconomica_Ver3", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    obj.PrecioDeLista = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("PrecioDeLista")));
                    obj.Vap_Precio = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("Vap_Precio")));
                    obj.Vap_Cantidad = Convert.ToDecimal(dr.GetValue(dr.GetOrdinal("Vap_Cantidad")));

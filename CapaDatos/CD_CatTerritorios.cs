...
namespace CapaDatos
{
    public class CD_CatTerritorios
    {
        ...
        // NOV14-2019 RFH
        public void ConsultaTerritorios_Ver2(
            int PageNumber, int PageSize,
            Territorios territorio, string TextoBuscar,
            int TipoRepresentante, int Ter_Activo,
            string Conexion, ref List<Territorios> List, bool vTerritorio)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                string[] Parametros = { "@PageNumber", "@PageSize", "@Id_Emp", "@Id_Cd",
                                          "@ParametroBusqueda", "@TipoRepresentante", "@Ter_Activo" };

                object[] Valores = { PageNumber, PageSize, territorio.Id_Emp, territorio.Id_Cd,
                                       TextoBuscar, TipoRepresentante, Ter_Activo };

                string query = vTerritorio ? "spCatTerritorio_Consulta_V2" : "spCatTerritorio_Consulta_Ver2";
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand(query, ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    territorio.IdAutorizacion = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("IdAutorizacion")));
                    territorio.Aut_IdRepresentante = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Aut_IdRepresentante")));
                    territorio.Aut_ClaveTerritorio = dr.GetValue(dr.GetOrdinal("Aut_ClaveTerritorio")).ToString();
                    territorio.Aut_Territorio = dr.GetValue(dr.GetOrdinal("Aut_Territorio")).ToString();
                    territorio.RecordCount = (int)dr.GetValue(dr.GetOrdinal("RecordCount"));
        ...
        // NOV14-2019 RFH
        public Territorios ConsultaTerritorios_ById(int Id_Emp, int Id_Cd, string Id_Ter, string Conexion)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatTerritorio_Consulta_ById", ref dr, Parametros, Valores);

                if (dr.HasRows)
                {
                    dr.Read();
                    Terr.Id_Emp = (int)dr.GetValue(dr.GetOrdinal("Id_Emp"));
                    Terr.Id_Cd = (int)dr.GetValue(dr.GetOrdinal("Id_Cd"));
                    Terr.Id_Ter = (int)dr.GetValue(dr.GetOrdinal("Id_Ter"));
                    Terr.Id_TerNuevo = 0;
                    Terr.Id_TerAnt = (int)dr.GetValue(dr.GetOrdinal("Id_TerAnt"));
                    Terr.Descripcion = (string)dr.GetValue(dr.GetOrdinal("Ter_Nombre"));
                    Terr.Id_Uen = (int)dr.GetValue(dr.GetOrdinal("Id_Uen"));
                    Terr.Uen_Descripcion = (string)dr.GetValue(dr.GetOrdinal("Uen_Descripcion"));
                    Terr.Id_Rik = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Rik"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_Rik"));
                    Terr.Rik_Nombre = (string)dr.GetValue(dr.GetOrdinal("Rik_Nombre"));
                    Terr.Id_Seg = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Seg"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_Seg"));
                    Terr.Seg_Nombre = (string)dr.GetValue(dr.GetOrdinal("Seg_Nombre"));
                    Terr.Id_TipoCliente = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_TipoCliente"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_TipoCliente"));
                    Terr.TipoCliente_Nombre = Convert.IsDBNull((string)dr.GetValue(dr.GetOrdinal("TipoCliente_Nombre"))) ? string.Empty : (string)dr.GetValue(dr.GetOrdinal("TipoCliente_Nombre"));
                    Terr.Id_Local = Convert.IsDBNull((string)dr.GetValue(dr.GetOrdinal("Id_Local"))) ? string.Empty : (string)dr.GetValue(dr.GetOrdinal("Id_Local"));
                    Terr.Id_TipoRepresentante = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_TipoRepresentante"))) ? 0 : (int)dr.GetValue(dr.GetOrdinal("Id_TipoRepresentante"));
                    Terr.TipoRepresentante_Nombre = Convert.IsDBNull((string)dr.GetValue(dr.GetOrdinal("TipoRepresentante_Nombre"))) ? string.Empty : (string)dr.GetValue(dr.GetOrdinal("TipoRepresentante_Nombre"));
                    Terr.Estatus = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("Ter_Activo")));
                    Terr.Consecutivo = 0;

                    Terr.IdAutorizacion = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("IdAutorizacion")));
                    Terr.Aut_IdRepresentante = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Aut_IdRepresentante")));
                    Terr.Aut_ClaveTerritorio = dr.GetValue(dr.GetOrdinal("Aut_ClaveTerritorio")).ToString();
                    Terr.Aut_Territorio = dr.GetValue(dr.GetOrdinal("Aut_Territorio")).ToString();
                    Terr.RecordCount = (int)dr.GetValue(dr.GetOrdinal("RecordCount"));

                    if (Convert.ToBoolean(Terr.Estatus))
                    {
                        Terr.EstatusStr = "Activo";
                    }
                    else
                    {
                        Terr.EstatusStr = "Inactivo";
                    }
                    Terr.Territorializacion = dr.GetValue(dr.GetOrdinal("Territorializacion")).ToString();
                }
        ...
        public List<CapaEntidad.eTerritoriosCteDetalle> ConsultaTerritoriosCliente_ById(
            int Id_Emp, int Id_Cd, string Id_Ter, string ParametroBusqueda, string Conexion)
        {
            ...
            try
            {
                SqlDataReader dr = null;
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "Id_Ter", "ParametroBusqueda" };
                object[] Valores = { Id_Emp, Id_Cd, Id_Ter, ParametroBusqueda };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatTerritorio_Clientes", ref dr, Parametros, Valores);
                while (dr.Read())
                {
                    CapaEntidad.eTerritoriosCteDetalle T = new CapaEntidad.eTerritoriosCteDetalle();
                    T.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cte")));
                    T.Id_Terr = dr.GetValue(dr.GetOrdinal("Id_Ter")).ToString();
                    T.Cte_NomComercial = dr.GetValue(dr.GetOrdinal("Cte_NomComercial")).ToString();
                    T.Cte_Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Cte_Activo")));
                    lst.Add(T);
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        public void ConsultaTerritorios(ref Territorios catterr, string Conexion, bool vTerritorio)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand(vTerritorio ? "spCatTerritorio_ConsultarVTerritorio" : "spCatTerritorio_Consultar", ref dr, Parametros, Valores);
        ...
        // 27 Jun 2018                                 
        public List<eTerritorio> spCatTerritorio_PorRik_Ver2(
            int Anio, int Mes, int Id_Emp, int Id_Cd, int Id_Rik, string Conexion)
        {
            List<eTerritorio> lst = new List<eTerritorio>();

            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Rik", "@Anio", "@Mes" };
            object[] Valores = { Id_Emp, Id_Cd, Id_Rik, Anio, Mes };
            SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatTerritorio_PorRik_Ver2", ref dr, Parametros, Valores);
            while (dr.Read())
            {
                eTerritorio obj = new eTerritorio();
                obj.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
        ...
        // 03May-2018
        public List<eTerritorio> spGetTerritoriosAll(int Id_Emp, int Id_Cd, int Id_Rik, string Conexion)
        {
            List<eTerritorio> lst = new List<eTerritorio>();
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spGetTerritoriosAll", ref dr, Parametros, Valores);
        ...
        /// <returns></returns>
        public List<eTerritorio> ConsultarTerritoriosPorClienteYRIK_Ver2(int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, string Conexion)
        {
            List<eTerritorio> lst = new List<eTerritorio>();
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    obj.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                    obj.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    obj.Id_Ter = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Ter")));
        ...
        public void TerritorioCliente_Combo(int Id_Emp, int Id_Cd, int IdCte, int? IdRIk, int? activo, string Conexion, ref List<Territorios> Territorio)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                sqlcmd = CapaDatos.GenerarSqlCommand("spCatTerCte_Combo", ref dr, Parametros, Valores);

                Territorios registro;
                while (dr.Read())
                {
                    registro = new Territorios();
                    registro.Id_Ter = (Int32)dr.GetValue(dr.GetOrdinal("Id"));
                    registro.Descripcion = (string)dr.GetValue(dr.GetOrdinal("Descripcion"));
                    Territorio.Add(registro);
                }
        ...
        public List<CatTipoTerritorio> SelCatTipoTerritorio(int Id_Cd, int Movimiento, string Conexion)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            ...
            try
            {
                ...
                CapaDatos.StartTrans();
                string[] Parametros = { "@Id_Cd", "@Movimiento" };
                object[] Valores = null;
                Valores = new object[] { Id_Cd, Movimiento };
                SqlCommand sqlcmd = null;

                sqlcmd = CapaDatos.GenerarSqlCommand("spConsultaTipoTerritorio", ref dr, Parametros, Valores);

                while (dr.Read())
                {
                    CatTipoTerritorio TipoTer = new CatTipoTerritorio();
                    TipoTer.Id_Tipo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_TipoTer")));
                    TipoTer.Descripcion = (string)dr.GetValue(dr.GetOrdinal("Nom_TipoTer"));

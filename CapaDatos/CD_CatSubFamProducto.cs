...
namespace CapaDatos
{
    ...
    {
        public void ConsultaSubFamProductoCte(SubFamProducto subFamProducto, string Conexion, int id_Emp, ref List<SubFamProducto> List)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spAppAllSubFam_Combo", ref dr, Parametros, Valores);

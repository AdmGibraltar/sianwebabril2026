...
namespace CapaDatos
{
    public class CD_CapFisico
    {
        ...
        public void ConsultaFisicoConsignado(FisicoConsignado FisicoConsignado, long Id_Prd, string Conexion, ref List<FisicoConsignado> List)
        {
            try
            {
        ...
        public void ConsultaFisico(Producto fisico, string Conexion, ref List<Producto> List)
        {
            try
            {
                ...
                {
                    fisico = new Producto();
                    fisico.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));

...
namespace CapaDatos
{
    public class CD_CrmPropuestaTecnica
    {
        ...
        public int  spCRM_PropuestaTecnica_Generar(int Id_Emp, int Id_Cd, int Id_Val, string Conexion)
        {
            int iResult = 0;
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_PropuestaTecnica_Generar", ref dr, Parametros, Valores);

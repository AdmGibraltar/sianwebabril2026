...
namespace CapaDatos
{
    public class CD_Datos
    {
        ...
        public static SqlCommand GenerarSqlCommandComillas(string SP, ref int verificador, string[] parametros, object[] resultados, IDbConnection connection, SqlCommand dbCommand)
        {
            try
            {
                //SqlConnection sqlcnx = default(SqlConnection);
        ...
        public SqlCommand GenerarSqlCommandComillas(string SP, ref int verificador, string[] parametros, object[] resultados)
        {
            SqlCommand functionReturnValue = default(SqlCommand);
            try
            {
                ...
                resultados = Consideracomilla(resultados);
        ...
        private object[] Consideracomilla(object[] resultados)
        {

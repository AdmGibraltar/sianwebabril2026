...
namespace CapaDatos
{
    public class CD_CatUsuario
    {
        ...
        //  25 Jun 2019 RFH
        //  Crea Lista de Representantes        
        public List<eListaGenerica> Exec_spCatRik_Combo(int Id_Emp, int Id_Cd, int Id_TipoRik, string Conexion)
        {
            ...
            try
            {
                ...
                Parametro("@Id1", Id_Emp);
                Parametro("@Id2", Id_Cd);
                Parametro("@Id4", Id_TipoRik);

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatRik_Combo", ref dr, Parametros.ToArray(), Valores.ToArray());
        ...
        // 31AGO-2021
        public List<eListaGenerica> Exec_spCatRik_Combo2(int Id_Emp, int Id_Cd, int Id_TipoRik, string Conexion)
        {
            List<eListaGenerica> lst = new List<eListaGenerica>();

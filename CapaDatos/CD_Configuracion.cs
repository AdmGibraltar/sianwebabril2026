...
namespace CapaDatos
{
    public class CD_Configuracion
    {
            ...
            try
            {
                using (dbAccess oDB = new dbAccess(Conexion))
                {
                    ...
                    if (DS != null && DS.Tables.Count > 0 && DS.Tables[0].Rows.Count > 0)
                    {
                        ...
                        Configuracion.Mail_AdministradorQuejas = item["Mail_AdministradorQuejas"] == DBNull.Value ? "" : (String)item["Mail_AdministradorQuejas"];
                        ...
                        // 4JUL-2019 RFH
                        // 
                        Configuracion.mail_AutorizacionAcys_Gerente = item["Mail_AutorizacionAcys_Gerente"] == DBNull.Value ? "" : (String)item["Mail_AutorizacionAcys_Gerente"];
                        Configuracion.mail_AutorizacionAcys_JefeOperaciones = item["Mail_AutorizacionAcys_JefeOperaciones"] == DBNull.Value ? "" : (String)item["Mail_AutorizacionAcys_JefeOperaciones"];
            ...
            using (dbAccess oDB = new dbAccess(Conexion))
            {
                ...
                try
                {
                    oDB.spExecNonQuery(
                        ...
                        new SqlParameter("@Mail_AdministradorQuejas", Configuracion.Mail_AdministradorQuejas),
        ...
        public CapaModelo.SysConfiguracion Consultar(int idEmp, int idCd, int idConf, string cadenaConexionEF)
        {
            CapaModelo.SysConfiguracion resultado = null;
        ...
        /// <returns>SysConfiguracion</returns>
        public CapaModelo.SysConfiguracion Consultar(int idEmp, int idCd, int idConf, ICD_Contexto icdCtx)
        {
            CapaModelo.SysConfiguracion resultado = null;

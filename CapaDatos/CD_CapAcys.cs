...
acys.ACS_txt63CitaRecCop
        ...
        public int Eliminar(Acys acys, int Id_U_Actual, string Conexion, ref int verificador)
        {
            ...
            try
            {
                ...
                Parametro("@Id_U_Actual", Id_U_Actual);

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_Eliminar", ref dr, Parametros.ToArray(), Valores.ToArray());

                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
                dr.Close();
            }
            catch (Exception ex)
        ...
        public int Actualiza_Estatus(int Id_Emp, int Id_Cd, int Id_Acs, string Acs_Estatus, string Conexion)
        {
            ...
            try
            {
                ...
                Parametro("@Acs_Estatus ", Acs_Estatus);

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_ActualizaEstatus", ref dr, Parametros.ToArray(), Valores.ToArray());
        ...
        //
        // 21 Nov 2018 RFH  
        // Solcita Autrizaion Gerente
        // 
        public int Actualizar_Autorizacion_Gerente(
            int Id_Emp, int Id_Cd, int Id_Acs, int Acs_ReqAutGerente,
            string Conexion)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = default(CD_Datos);
            ...
            try
            {
                ...
                Parametro("@Id_Cd", Id_Cd);
                Parametro("@Id_Acs", Id_Acs);
                Parametro("@Acs_ReqAutGerente", Acs_ReqAutGerente);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_Actualiza_ReqAutGerente", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
        ...
        //
        // 21 Nov 2018 RFH  
        // EJECUTA LA AUTORIZACIO DEL JEFE DE OPERACIONES
        // 
            ...
            string Conexion)
        {
            ...
            try
            {
                ...
                Parametro("@Id_Cd", Id_Cd);
                Parametro("@Id_Acs", Id_Acs);
                Parametro("@Id_AcsVersion", 0);
                Parametro("@Acs_ReqAutJefeOp", Acs_ReqAutGerente);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_Actualiza_ReqAutJefeOp", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
        ...
        //
        // ABR27-2020 RFH  
        // VALIDACIONES PRELIMINARES ACYS A ENVIO DE AUTORIZACION 
        // 
            ...
            int Id_Emp, int Id_Cd, int Id_Acs, int Acs_Version, string Conexion)
        {
            ...
            eAcys2ValiacionesPreAutorizacion Res = new eAcys2ValiacionesPreAutorizacion();
            ...
            try
            {
                ...
                Parametro("@Id_Cd", Id_Cd);
                Parametro("@Id_Acs", Id_Acs);
                Parametro("@Id_AcsVersion", Acs_Version);

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_Valizaciones_PreAutorizacion", ref dr, Parametros.ToArray(), Valores.ToArray());

                if (dr.Read())
                {
                    Res.ErrorSemanal = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorSemanas")));
                    Res.ErrorMensual = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorMensual")));
                    Res.ErrorBimestral = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorBimestral")));
                    Res.ErrorTrimestral = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorTrimestral")));
                    Res.ErrorSemestral = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorSemestral")));
                    Res.Acs_Semana = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Semana")));
                    Res.Prods_SinTipoDoc = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Prods_SinTipoDoc")));
                    //JFCV 25ene2023
                    Res.ErrorAlertaPrecio = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("ErrorAlertaPrecio")));
                }
                dr.Close();
            }
            catch (Exception ex)
        ...
        // 
        //  9JUL-2019         
        // TipoUsuario: Es el usuario que rechaza (1.- Gerente,2.-Jefe Op)
        //
        public int EXEC_spCapAcys_AplicarRechazo_ReqAutJefeOp(
            int Id_Emp, int Id_Cd, int Id_Acs, int Id_AcsVersion, int Id_Usuario, string Nota, int TipoUsuario, string Conexion)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = default(CD_Datos);
            ...
            try
            {
                ...
                Parametro("@Nota", Nota);
                Parametro("@TipoUsuario", TipoUsuario);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_AplicarRechazo_ReqAutJefeOp", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
        ...
        //
        public string EXEC_spCapAcys2_MailDeRik(
            int Id_Emp, int Id_Cd, int Id_Acs, int Acs_Version, string Conexion)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = default(CD_Datos);
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys2_MailDeRik", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    sResult = dr.GetValue(dr.GetOrdinal("Correo")).ToString();
                }
                dr.Close();
            }
            catch (Exception ex)
        ...
        //
        // 8JUL-2019 RFH  
        // EJECUTA EL SP Y SOLO VERIFICA QUE NO HAYA RESULTADO EN ERROR
        // 
        public int EXEC_spCapAcys_GenerarCalendario(int Id_Acs, string Conexion)
        {
            ...
            try
            {
                CapaDatos = new CapaDatos.CD_Datos(Conexion);
                Parametro("@Id_Acs", Id_Acs);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_GenerarCalendario", ref dr, Parametros.ToArray(), Valores.ToArray());
                /*
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
        ...
        public int Es_Autorizable(int Id_Emp, int Id_Cd, int Id_Acs, int Id_AcsVersion, string Conexion)
        {
            ...
            try
            {
                ...
                Parametro("@Id_Acs", Id_Acs);
                Parametro("@Id_AcsVersion", Id_AcsVersion);
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_EsAutorizable", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
        ...
        public int Reactivar(int Id_Emp, int Id_Cd, int Id_Acs, int Id_AcsVersion, int Id_Usuario_Actual, string Conexion)
        {
            ...
            try
            {
                ...
                Parametro("@Id_Acs", Id_Acs);
                Parametro("@Id_AcsVersion", Id_AcsVersion);
                Parametro("@Id_Usuario_Actual", Id_Usuario_Actual);

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcys_Reactivar", ref dr, Parametros.ToArray(), Valores.ToArray());
                if (dr.Read())
                {
                    iResult = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Result")));
                }
        ...
        public void ConsultarCaptarAcys(ref Acys acys, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void Consultar(ref Acys acys, string Conexion)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    acys.Id_Rik = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Rik")));
                    acys.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cte")));
                    acys.Id_U = dr.IsDBNull(dr.GetOrdinal("Id_U")) ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_U")));
                    ...
                    acys.Acs_Telefono = dr.GetValue(dr.GetOrdinal("Acs_Telefono")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono")));
                    ...
                    acys.Acs_Telefono2 = dr.GetValue(dr.GetOrdinal("Acs_Telefono2")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono2")));
                    ...
                    acys.Acs_Telefono3 = dr.GetValue(dr.GetOrdinal("Acs_Telefono3")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono3")));
                    ...
                    acys.Acs_Telefono4 = dr.GetValue(dr.GetOrdinal("Acs_Telefono4")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono4")));
                    ...
                    acys.Acs_Telefono5 = dr.GetValue(dr.GetOrdinal("Acs_Telefono5")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono5")));
                    ...
                    acys.Acs_Telefono6 = dr.GetValue(dr.GetOrdinal("Acs_Telefono6")) == "" ? 0 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Acs_Telefono6")));
        ...
        // 18 Jul 2018 RFH
        // Acys 2
        public List<eAcysDet2> ConsultarDet2(int Id_Emp, int Id_Cd, int Id_Acs, int Id_AcsVersion, string Conexion, int TipoCuenta, ref string ErrorMensaje)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapAcysDet2_Consultar", ref dr, Parametros, Valores);
                ...
                while (dr.Read())
                {
                    ...
                    //MAR31-2020 RFH
                    obj.Acs_FrecuenciaTipo_Nombre = dr.GetValue(dr.GetOrdinal("Acs_FrecuenciaTipo_Nombre")).ToString();
                    ...
                    obj.RequiereOC = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("RequiereOC")));

                    int ordFrecMesIni = dr.GetOrdinal("Acs_FrecMesIni");
                    int ordFrecAnioIni = dr.GetOrdinal("Acs_FrecAnioIni");

                    obj.Acs_FrecMesIni = dr.IsDBNull(ordFrecMesIni) ? 0 : Convert.ToInt32(dr.GetValue(ordFrecMesIni));
                    obj.Acs_FrecAnioIni = dr.IsDBNull(ordFrecAnioIni) ? 0 : Convert.ToInt32(dr.GetValue(ordFrecAnioIni));

                    obj.PrecioLista = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("PrecioLista")));
                    obj.Prd_Activo = Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Activo"))) ? 0 : dr.GetInt32(dr.GetOrdinal("Prd_Activo"));// Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Prd_Activo"))) ? false : dr.GetBoolean(dr.GetOrdinal("Prd_Activo"));
        ...
        public void ConsultarReemplazos(Acys acys, long Id_Prd, ref DataTable dt, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void ModificarEquivalencia(long Id_Prd, long Id_Prd_Original, string Id_Acys, int Id_AcysVersion, int Id_Emp, int Id_Cd, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        //
        // May07-2019 RFH Version SP
        //
        public int CRM_ClienteTieneACYS_ByCteTer(string Conexion, int Id_Emp, int Id_Cd, int Id_Cte, int Id_Ter,
            ref int Acys_Id_Acs, ref int Acys_Id_AcsVersion)
        {
            int iRes = 0;
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCRM_ClienteTieneACYS_ByCteTer", ref dr, Parametros.ToArray(), Valores.ToArray());
                Acys a;
                if (dr.HasRows)
                {
                    dr.Read();
                    Acys_Id_Acs = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Acs")));
                    Acys_Id_AcsVersion = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_AcsVersion")));
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
                iRes = 1;
            }
        ...
        public void ConsultarEstatus(ref Acys acys, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
        ...
        public void ConsultarvalidaracysFrecuencia(Acys acys, ref int verificador, string Conexion)
        {
            try
            {
                CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spProPedidoViDet_Validar", ref verificador, Parametros, Valores);

...
namespace CapaDatos
{
    public class CD_CapNotaCredito
    {
        ...
        public void ConsultarNotaCredito(ref NotaCredito notaCredito, string Conexion, ref List<NotaCreditoDet> ListaNotaCredito)
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Ncr_FolioFiscalCN")))) notaCredito.Ncr_FolioFiscalCN = string.Empty; else notaCredito.Ncr_FolioFiscalCN = dr.GetValue(dr.GetOrdinal("Ncr_FolioFiscalCN")).ToString();
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Ncr_FolioCN")))) { notaCredito.Ncr_FolioCN = null; } else { notaCredito.Ncr_FolioCN = Convert.ToString(dr.GetValue(dr.GetOrdinal("Ncr_FolioCN"))); }


                }
                notaCredito.Ncr_UsoCFDI = dr.IsDBNull(dr.GetOrdinal("Ncr_UsoCFDI")) ? "" : dr.GetValue(dr.GetOrdinal("Ncr_UsoCFDI")).ToString();
                notaCredito.Ncr_MetodoPago = dr.IsDBNull(dr.GetOrdinal("Ncr_MetodoPago")) ? "" : dr.GetValue(dr.GetOrdinal("Ncr_MetodoPago")).ToString();
                notaCredito.Ncr_FormaPago = dr.IsDBNull(dr.GetOrdinal("Ncr_FormaPago")) ? "" : dr.GetValue(dr.GetOrdinal("Ncr_FormaPago")).ToString();
                notaCredito.Ncr_TipoRelacion = dr.IsDBNull(dr.GetOrdinal("NCr_TipoRelacion")) ? "" : dr.GetValue(dr.GetOrdinal("NCr_TipoRelacion")).ToString();
                notaCredito.Ncr_ReferenciaSerie = dr.IsDBNull(dr.GetOrdinal("NCr_ReferenciaSerie")) ? "" : dr.GetValue(dr.GetOrdinal("NCr_ReferenciaSerie")).ToString();
                ...
                while (dr.Read())
                {
                    ...
                    notaCreditoDet.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    ...
                    notaCreditoDet.Ncr_Cant = dr.IsDBNull(dr.GetOrdinal("Ncr_Cant")) ? 1 : Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Ncr_Cant")));
                    notaCreditoDet.Ncr_Precio = dr.IsDBNull(dr.GetOrdinal("Ncr_Precio")) ? 0 : (float)(double)dr.GetValue(dr.GetOrdinal("Ncr_Precio"));
        ...
        public void ConsultaNotaCreditoNacional(ref NotaCredito notaCredito, string Conexion)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);

            string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Ncr" };
            object[] Valores = { notaCredito.Id_Emp, notaCredito.Id_Cd, notaCredito.Id_Ncr };

            SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCreditoNacional_Consultar", ref dr, Parametros, Valores);

            if (dr.Read())
            {
                notaCredito.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                notaCredito.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                notaCredito.Id_Ncr = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_NC")));
                notaCredito.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cte")));
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Cte_NomComercial")))) notaCredito.Cte_NomComercial = string.Empty; else notaCredito.Cte_NomComercial = dr.GetValue(dr.GetOrdinal("Cte_NomComercial")).ToString();

                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteCalle")))) notaCredito.Fac_CteCalle = string.Empty; else notaCredito.Fac_CteCalle = dr.GetValue(dr.GetOrdinal("Fac_CteCalle")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteNumero")))) notaCredito.Fac_CteNumero = string.Empty; else notaCredito.Fac_CteNumero = dr.GetValue(dr.GetOrdinal("Fac_CteNumero")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteColonia")))) notaCredito.Fac_CteColonia = string.Empty; else notaCredito.Fac_CteColonia = dr.GetValue(dr.GetOrdinal("Fac_CteColonia")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteMunicipio")))) notaCredito.Fac_CteMunicipio = string.Empty; else notaCredito.Fac_CteMunicipio = dr.GetValue(dr.GetOrdinal("Fac_CteMunicipio")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteEstado")))) notaCredito.Fac_CteEstado = string.Empty; else notaCredito.Fac_CteEstado = dr.GetValue(dr.GetOrdinal("Fac_CteEstado")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteRfc")))) notaCredito.Fac_CteRfc = string.Empty; else notaCredito.Fac_CteRfc = dr.GetValue(dr.GetOrdinal("Fac_CteRfc")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteCp")))) notaCredito.Fac_CteCp = string.Empty; else notaCredito.Fac_CteCp = dr.GetValue(dr.GetOrdinal("Fac_CteCp")).ToString();
                if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteAdeNombre")))) notaCredito.Fac_CteAdeNombre = string.Empty; else notaCredito.Fac_CteAdeNombre = dr.GetValue(dr.GetOrdinal("Fac_CteAdeNombre")).ToString();
                //if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteAdeId")))) notaCredito.Fac_CteAdeId = 0; else notaCredito.Fac_CteAdeId = Int32.Parse(dr.GetValue(dr.GetOrdinal("Fac_CteAdeNombre")).ToString());
        ...
        public void ConsultarNotaCreditoOptenerNcrSerie(ref NotaCredito notaCredito, string Conexion)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spConsultar_NCredito", ref dr, Parametros, Valores);

                if (dr.HasRows)
                {
                    dr.Read();
                    notaCredito.Id_NcrSerie = dr.GetValue(dr.GetOrdinal("Id_NcrSerie")).ToString();
                }
        ...
        public void ConsultarNotaCreditoSAT(ref NotaCredito notaCredito, string Conexion, ref object resultado, ref object resultadoCN)
        {
            SqlDataReader dr = null;
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                // ------------------------------------
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCredito_ConsultaSAT", ref dr, Parametros, Valores);

                if (dr.Read())
                {
                    resultado = dr["Ncr_Pdf"];
                    resultadoCN = dr["Ncr_PdfCN"];
                }
            }
            catch (Exception ex)
            {
        ...
        public void InsertarNotaCredito(ref NotaCredito notaCredito, string Conexion, ref int verificador, List<AdendaDet> ListCab, DataTable listDet)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                                        ...
                                        ,notaCredito.Ncr_UsoCFDI
                                        ,notaCredito.Ncr_MetodoPago
                                        ,notaCredito.Ncr_FormaPago
                                        ,notaCredito.Ncr_TipoRelacion
                                   };
        ...
        public void InsertarNotaCredito(ref NotaCredito notaCredito, ref Factura facturaNacional, string Conexion, ref int verificador, List<AdendaDet> ListCab, DataTable listDet)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCreditoNacional_Insertar", ref verificador, Parametros, Valores);
                #endregion
                #region nota credito detalle
                string[] ParametrosDet = {
                                        "@Id_Emp"
        ...
        public void ModificarNotaCredito(ref NotaCredito notaCredito, ref Factura facturaNacional, string Conexion, ref int verificador, List<AdendaDet> ListCab, DataTable listDet)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCreditoNacional_Modificar", ref verificador, Parametros, Valores);
                #endregion
        ...
        public void ModificarNotaCreditoSAT(NotaCredito notaCredito, string Conexion, ref int verificador)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                                        ...
                                        ,notaCredito.Ncr_SelloCN
                                        ,notaCredito.Ncr_FolioCN
                                        ,notaCredito.Ncr_XmlCN
                                        ,notaCredito.Ncr_FolioFiscalCN
                                        ,notaCredito.Ncr_PdfCN
                                   };
                ...
                sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCredito_ModificarSAT2", ref verificador, Parametros, Valores);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<NotaCredito> ConsultaProductosNotaCredito(ref NotaCredito notaCredito, string Conexion)
        {
            try
            {
                ...
                {//Id_Clp, c.Id_Prd, c.Clp_descripcion
                    notaCredito = new NotaCredito();
                    notaCredito.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    listaNotaCredito.Add(notaCredito);
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
        ...
        public void ArchivoPdf_Xml(ref NotaCredito notaCredito, string Conexion)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCredito_PDF_XML2", ref dr, Parametros, Valores);
                while (dr.Read())
                {
                    notaCredito = new NotaCredito();
                    notaCredito.Ncr_Xml = Convert.ToString(dr.GetValue(dr.GetOrdinal("Ncr_Xml")));
                    notaCredito.Ncr_XmlCN = Convert.ToString(dr.GetValue(dr.GetOrdinal("Ncr_XmlCN")));
                }
                dr.Close();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        public void InsertarNotaCreditoNacional(ref Factura facturaNacional, string Conexion, ref int verificador)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapNotaCreditoNacional_Insertar", ref verificador, Parametros, Valores);
                #endregion

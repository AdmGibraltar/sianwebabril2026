...
namespace CapaDatos
{
    public class CD_CapAplicacionProducto
    {
        ...
        public IEnumerable<CapAplicacionProducto> ConsultarPorAplicacionYProducto(int idEmp, int idApl, long idPrd, ICD_Contexto icdCtx)
        {
        ...
        /// <param name="icdCtx">Contexto de conexión a la fuente de datos</param>
        /// <returns>IEnumerable[CapAplicacionProducto]</returns>
        public IEnumerable<CapAplicacionProducto> ConsultarPorProducto(int idEmp, long idPrd, ICD_Contexto icdCtx)
        {
            sianwebmty_gEntities ctx = ((ICD_Contexto<sianwebmty_gEntities>)icdCtx).Contexto;

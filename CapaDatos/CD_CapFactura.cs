    ...
    public class CD_CapFactura
    {
        ...
        public void ConsultaFactura(ref Factura factura, string Conexion)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_XMLCN"))))
                    {
                        factura.Fac_XmlCN = null;
                    }
                    else
                    {
                        factura.Fac_XmlCN = (object)dr.GetValue(dr.GetOrdinal("Fac_XMLCN"));
                    }
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_FolioFiscalSust")))) { factura.Fac_FolioFiscSust = string.Empty; } else { factura.Fac_FolioFiscSust = dr.GetValue(dr.GetOrdinal("Fac_FolioFiscalSust")).ToString(); }
        ...
        public void ConsultaFactura(ref Factura factura, ref List<FacturaDet> listaFacturaDet, string Conexion)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_EstatusCanc")))) { factura.Fac_EstatusCanc = null; } else { factura.Fac_EstatusCanc = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Fac_EstatusCanc"))); }
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_AcuseCanc")))) { factura.Fac_AcuseCanc = null; } else { factura.Fac_AcuseCanc = dr.GetValue(dr.GetOrdinal("Fac_AcuseCanc")).ToString(); }
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_FecCanSAT")))) { factura.Fac_FecCanSAT = null; } else { factura.Fac_FecCanSAT = Convert.ToDateTime(dr.GetValue(dr.GetOrdinal("Fac_FecCanSAT"))); }
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_FolioFiscalSust")))) { factura.Fac_FolioFiscSust = string.Empty; } else { factura.Fac_FolioFiscSust = dr.GetValue(dr.GetOrdinal("Fac_FolioFiscalSust")).ToString(); }
                    factura.UsoCFDI = dr.IsDBNull(dr.GetOrdinal("UsoCFDI"))
                        ? ""
                        : dr.GetString(dr.GetOrdinal("UsoCFDI"));
                }
                ...
                while (dr.Read())
                {
                    ...
                    facturaDet.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    ...
                    facturaDet.Producto.Prd_Activo = dr.GetInt32(dr.GetOrdinal("Prd_Activo"));
                ...
                {
                    int Id_Rem = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Rem")));
                    long Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
                    int Fac_Cant = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Fac_Cant")));
                    int Rem_Cant = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Rem_Cant")));
        ...
        public void ConsultaFacturaExiste(ref Factura factura, ref List<FacturaDet> listaFacturaDet, string Conexion)
        {
            try
            {
                ...
                // Consultar encabezado de la factura
                // ------------------------------------
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_ConsultarExiste", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    factura.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                    factura.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
        ...
        public void ConsultaFacturaOtraBDExiste(ref Factura factura, string serie, string Conexion)
        {
            try
            {
                ...
                // Consultar encabezado de la factura
                // ------------------------------------
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_ConsultarOtraBDExiste", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    factura.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                    factura.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
        ...
        public void ConsultaFacturaEncabezado(ref Factura factura, string Conexion, ref bool encontrado)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("TienePagos")))) factura.TienePagos = false; else factura.TienePagos = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("TienePagos")));
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Es")))) factura.Id_Es = null; else factura.Id_Es = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Es")));
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_FolioFiscal")))) factura.Fac_FolioFiscal = string.Empty; else factura.Fac_FolioFiscal = dr.GetValue(dr.GetOrdinal("Fac_FolioFiscal")).ToString();
                }
        ...
        public void ConsultaFacturaEspecialDetalle(ref List<FacturaDet> listaFacturaProductos, string Conexion, int id_Emp, int id_Cd, int id_Fac, int id_Cte)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    facturaDet.Producto = new Producto();
                    facturaDet.Producto.Id_Prd = Convert.ToInt64(dr.GetValue(dr.GetOrdinal("Id_Prd")));
        ...
        public void ConsultaFactura_Buscar(Factura factura, string Conexion, ref List<Factura> List
            ...
            , int id_Ped_fin, bool? acuse, bool? depuracion, int id_U, bool? Complementaria, string OrdenCompra, string EstatusSAT)
        {
            try
            {
                SqlDataReader dr = null;
                ...
                if (EstatusSAT == "Si")
                {
                    cd.ConsultaCentroDistribucion(ref Cd, id_Cd, id_Emp, Conexion);
                }
                ...
                while (dr.Read())
                {
                    ...
                    factura.Fac_CteRfc = dr.GetValue(dr.GetOrdinal("Fac_CteRfc")).ToString();
                    ...
                    if (EstatusSAT == "Si")
                    {
                        ...
                        if (factura.Fac_FolioFiscal != null)
                        {
                            if (factura.Fac_FolioFiscal != "")
                            {

                                factura.Fac_EstatusSAT = consultaCFDI.ServicioConsultaCFDI_Consulta("?re=" + Cd.Cd_Rfc + "&rr=" + WebUtility.HtmlEncode(factura.Fac_CteRfc.Trim()) + "&tt=" + (factura.Fac_SubTotal + factura.Fac_ImporteIva).Value.ToString("0.00") + "&id=" + factura.Fac_FolioFiscal.Trim());
                            }
                            else
                            {
                                factura.Fac_EstatusSAT = "";
                            }
                        }
                    }
                    else
            ...
            ref int verificador, ref int? Id_Ped, ref List<EntradaSalida> listaEntSalRemisiones, List<AdendaDet> listAdendaCabecera, string IdRF, string arrayRemisiones, ref EntradaSalida entSal, ref List<EntradaSalidaDetalle> listaEntSalDetalle, ref FacturaEspecial facturaEsp, ref List<FacturaDet> listaProductosFacturaEspecial, bool actualizar, String TraePicking)
        {
            ...
            try
            {
                ...
                string NCrUsoCFDI = string.Empty, NCrMetodoPago = string.Empty, NCrFormaPago = string.Empty;
                ...
                while (dr.Read())
                {
                    ...
                    NCrUsoCFDI = dr.GetValue(dr.GetOrdinal("Cte_NCrUsoCFDI")).ToString();
                    NCrMetodoPago = dr.GetValue(dr.GetOrdinal("Cte_NCrMetodoPago")).ToString();
                    NCrFormaPago = dr.GetValue(dr.GetOrdinal("Cte_NCrFormaPago")).ToString();
                }
                ...
                if (generarVerificador == 1 && porciento > 0)
                {
                    ...
                    notaCredito.Ncr_UsoCFDI = NCrUsoCFDI;
                    notaCredito.Ncr_MetodoPago = NCrMetodoPago;
                    notaCredito.Ncr_FormaPago = NCrFormaPago;
                    notaCredito.Ncr_TipoRelacion = "01";
    ...
    ref List<EntradaSalida> listaEntSalRemisiones, List<AdendaDet> listAdendaCabecera, string arrayRemisiones, ref EntradaSalida entSal, ref List<EntradaSalidaDetalle> listaEntSalDetalle, ref FacturaEspecial facturaEsp, ref List<FacturaDet> listaProductosFacturaEspecial, bool actualizar)
        {
            ...
            try
            {
                ...
                if (factura.Id_Tm == 51)
                {
                    ...
                    {
                        p = new Producto();
                        List<FacturaDet> a = list.Where(FacturaDet => FacturaDet.Id_Prd == Convert.ToInt64(dr["Id_Prd"])).ToList();
                        if (a.Count > 0)
                        {
                        ...
                        {
                            cn_producto.ConsultaProducto(ref prod, Conexion, factura.Id_Emp, factura.Id_Cd, Convert.ToInt64(dr["Id_Prd"]), 0);
                ...
                if (dr1.Read())
                {
                    ...
                    NCrUsoCFDI = dr1.GetValue(dr1.GetOrdinal("Cte_NCrUsoCFDI")).ToString();
                    NCrMetodoPago = dr1.GetValue(dr1.GetOrdinal("Cte_NCrMetodoPago")).ToString();
                    NCrFormaPago = dr1.GetValue(dr1.GetOrdinal("Cte_NCrFormaPago")).ToString();
                }
        ...
        public void Actualiza_Factura_AcuseCancelacionSAT(Factura factura, string Conexion, ref int verificador)
        {
            ...
            try
            {
                ...
                object[] Valores = {
                                        ...
                                        ,factura.Id_Cd
                                        ,factura.Id_Fac
                                        ,factura.Fac_EstatusCanc
                                        ,factura.Fac_AcuseCanc
                                   };
                // --------------------------------
                // Eliminar factura
                // --------------------------------
                SqlCommand sqlcmd;
                sqlcmd = CapaDatos.GenerarSqlCommand("SP_Actualiza_Factura_AcuseCancelacionSAT", ref verificador, ParametrosEliminar, Valores);
                CapaDatos.CommitTrans();
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)
        ...
        public void ConsultarAdenda(int Id_Emp, int Id_Cd_Ver, int Id_Fac, string Tipo1, string Tipo2, ref List<AdendaDet> listCab, ref List<AdendaDet> listDet, string Conexion)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    adendaDet.Id_Prd = (Int64?)dr.GetValue(dr.GetOrdinal("Id_Prd"));
        ...
        public eDocumentosSinTimbar Consulta_ValidacionFacturas(int Id_Emp, int Id_Cd, string Conexion)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spConsulta_ValidacionFacturas", ref dr, Parametros, Valores);

                DST.DocumentosSinTimbar = 0;
                if (dr.Read())
                {
                    DST.Count_Facturas = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Count_Facturas")));
                    DST.Count_NotasCargo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Count_NotasCargo")));
                    DST.Count_NotasCredito = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Count_NotasCredito")));
                    DST.Count_ComplementosPago = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Count_ComplementosPago")));

                    if (DST.Count_Facturas > 0 && DST.Count_NotasCargo > 0 && DST.Count_NotasCredito > 0 && DST.Count_ComplementosPago > 0)
                    {
                        DST.DocumentosSinTimbar = 1;
                    }
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        //
        public void ModificarMontosFactura(Factura factura, string Conexion, ref int verificador)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            try
            {
                ...
                // -----------------------------------------------------------------
                SqlCommand sqlcmd = new SqlCommand();
                sqlcmd = CapaDatos.GenerarSqlCommand("spFactura_ModificarMontos", ref verificador, Parametros, Valores);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void CancelaFacturaCtaNac(Factura factura, string Conexion, ref int verificador)
        {
            try
            {
                ...
                string[] Parametros = { "@CFD_Folio", "@CFD_Serie", "@CFD_Uuid" };
                object[] Valores = { factura.Fac_FolioCN, "AE", factura.Fac_FolioFiscalCN };

                SqlCommand sqlcmd;
                sqlcmd = CapaDatos.GenerarSqlCommand("CancelaCFDI", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    verificador = 1;
                }
        ...
        public void ConsultaFacturaSegundoPlano(string Conexion, int IdUsuario, string strPath, ref FacturaLite entFacturaLite, ref string strMsjResultado, ref List<FacturaLite> lstFacturaLite)
        {
            CapaDatos.CD_Datos CapaDatos = new CapaDatos.CD_Datos(Conexion);
            SqlDataReader dr = null;
            FacturaLite itemFacturaLite = new FacturaLite();
            try
            {
                string[] Parametros = {
                            "@Id_Emp","@Id_Cd","@Id_U"
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFacturaSegundoPlanoLog_Monitoreo", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                ...
                if (dr.NextResult())
                {
                    while (dr.Read())
                    {
                        itemFacturaLite = new FacturaLite();
                        itemFacturaLite.id_Fac = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fac")));
                        itemFacturaLite.strRstScript = dr.GetValue(dr.GetOrdinal("ResultadoScript")).ToString();
                        itemFacturaLite.strRstAlerta = dr.GetValue(dr.GetOrdinal("ErrorMensaje")).ToString();
                        itemFacturaLite.strUrlPdf = dr.GetValue(dr.GetOrdinal("UrlPdf")).ToString();
                        itemFacturaLite.DescargarPDF = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("DescargarPDF")));

                        if (string.IsNullOrEmpty(itemFacturaLite.strUrlPdf))
                        {
                            itemFacturaLite.strUrlPdf = strPath + itemFacturaLite.strUrlPdf;
                        }
                        lstFacturaLite.Add(itemFacturaLite);
                    }
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
        ...
        public void ConsultaFacturaSegundoPlanoEstatus(string Conexion, ref FacturaLite entFacturaLite)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFacturaSegundoPlanoLog_Estatus", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    entFacturaLite.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Activo")));
        ...
        public void ActivaFacturaSegundoPlano(string Conexion, int idUsuario, int intConDescarga, ref FacturaLite entFacturaLite, ref int idGrupoFac)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFacturaSegundoPlanoLog_Insertar", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    entFacturaLite.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Log")));
                    entFacturaLite.strRstAlerta = dr.GetValue(dr.GetOrdinal("Mensaje")).ToString();
                    idGrupoFac = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("GrupoTimbres")));
        ...
        public void DesactivaFacturaSegundoPlano(string Conexion, ref FacturaLite entFacturaLite, string strUrlPdf, string strErrorMensaje, string strErrorDetalle, int idGrupoFac)
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFacturaSegundoPlanoLog_desactivar", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    entFacturaLite.Activo = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Activo")));
                }
        ...
        public void ConsultaFacturaMin(ref Factura entFactura, string Conexion)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Fac" };
                object[] Valores = { entFactura.Id_Emp, entFactura.Id_Cd, entFactura.Id_Fac };

                // ------------------------------------
                // Consultar solo lo necesario de la factura
                // ------------------------------------
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_Consultar_Min", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    entFactura.Id_Emp = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Emp")));
                    entFactura.Id_Cd = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cd")));
                    entFactura.Id_Fac = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fac")));

                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_SubTotal"))))
                        entFactura.Fac_SubTotal = null;
                    else
                        entFactura.Fac_SubTotal = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("Fac_SubTotal")));

                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_ImporteIva"))))
                        entFactura.Fac_ImporteIva = null;
                    else
                        entFactura.Fac_ImporteIva = Convert.ToDouble(dr.GetValue(dr.GetOrdinal("Fac_ImporteIva")));

                    entFactura.Fac_FPago = dr.GetValue(dr.GetOrdinal("Fac_FPago")).ToString();
                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Fac_CteRfc"))))
                        entFactura.Fac_CteRfc = string.Empty;
                    else
                        entFactura.Fac_CteRfc = dr.GetValue(dr.GetOrdinal("Fac_CteRfc")).ToString();

                    if (Convert.IsDBNull(dr.GetValue(dr.GetOrdinal("Id_Mon"))))
                        entFactura.Id_Mon = null;
                    else
                        entFactura.Id_Mon = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Mon")));
        ...
        public void RastreoDev(ref Factura fac, string Conexion)
        {
            try
            {
                ...
                // Consultar encabezado de la factura
                // ------------------------------------
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spProRastreoDev_Factura", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    fac.Id_Cte = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Cte")));
                    fac.Cte_NomComercial = dr.GetValue(dr.GetOrdinal("Cte_NomComercial")).ToString();
        ...
        public void ConsultarMotivo(string Conexion, int intTipoMotivo, ref List<Comun> lstMotivo)
        {
            try
            {
                ...
                object[] Valores = { intTipoMotivo };

                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCatCausaRefactura_combo", ref dr, Parametros, Valores);
                while (dr.Read())
                {
                    Comun motivo = new Comun();
                    motivo.Id = Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id")));
                    motivo.Descripcion = dr.GetValue(dr.GetOrdinal("Descripcion")).ToString();
                    motivo.Relacion = string.Empty;
        ...
        public void GuardarMotivoCancelacionFactura(string Conexion, int intIdEmp, int intIdCd, int id_Fac, int Id_MotivoBaja, int Id_Fac_Reemplaza)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_GuardarMotivoBaja", ref dr, Parametros, Valores);
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)
            {
        ...
        public void ConsultarFacturaRelacionada(string Conexion, int intIdEmp, int intIdCd, int intIdFac, int Id_Fac_Reemplaza, ref bool boolFolioValido, ref string strMensaje)
        {
            try
            {
                ...
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_ConsultarFacturaRelacionada", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    boolFolioValido = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("boolFolioValido")));
                    strMensaje = dr.GetValue(dr.GetOrdinal("strMensaje")).ToString();
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)
        ...
        public void ConsultarMotivoBaja(string Conexion, ref Factura entFactura)
        {
            try
            {
                ...
                string[] Parametros = { "@Id_Emp", "@Id_Cd", "@Id_Fac" };
                object[] Valores = { entFactura.Id_Emp, entFactura.Id_Cd, entFactura.Id_Fac };
                SqlCommand sqlcmd = CapaDatos.GenerarSqlCommand("spCapFactura_ConsultarMotivoBaja", ref dr, Parametros, Valores);
                if (dr.Read())
                {
                    entFactura.Id_MotivoBaja = dr["Id_MotivoBaja"] != DBNull.Value ? Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_MotivoBaja"))) : 0;
                    entFactura.DescripcionMotivoBaja = dr["DescripcionMotivoBaja"] != DBNull.Value ? dr.GetValue(dr.GetOrdinal("DescripcionMotivoBaja")).ToString() : string.Empty;
                    entFactura.Id_Fac_Reemplaza = dr["Id_Fac_Reemplaza"] != DBNull.Value ? Convert.ToInt32(dr.GetValue(dr.GetOrdinal("Id_Fac_Reemplaza"))) : 0;
                }
                CapaDatos.LimpiarSqlcommand(ref sqlcmd);
            }
            catch (Exception ex)

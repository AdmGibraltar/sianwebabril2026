...
namespace CapaDatos
{
    public class CD_CatTipoMoneda
    {
        public void ConsultaTipoMoneda(TipoMoneda tipoMoneda, string Conexion, int id_Emp, ref List<TipoMoneda> List)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    tipoMoneda.Mon_codigo = dr.IsDBNull(dr.GetOrdinal("Mon_Codigo")) ? "" : dr.GetValue(dr.GetOrdinal("Mon_Codigo")).ToString();
                    List.Add(tipoMoneda);
                }
        ...
        public void ConsultaTipoMonedaXMLFacturacion(int id_Emp, string Conexion, ref List<TipoMoneda> List)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    tipoMoneda.Mon_Activo = Convert.ToBoolean(dr.GetValue(dr.GetOrdinal("Mon_Activo")));
                    tipoMoneda.Mon_ActivoStr = dr.GetValue(dr.GetOrdinal("Mon_ActivoStr")).ToString();
                    tipoMoneda.Mon_codigo = dr.GetValue(dr.GetOrdinal("Mon_Codigo")).ToString();
                    List.Add(tipoMoneda);
                }

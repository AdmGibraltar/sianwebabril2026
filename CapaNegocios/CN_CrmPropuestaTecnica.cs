...
namespace CapaNegocios
{
    public class CN_CrmPropuestaTecnica
    {
        ...
        public int Sp_GenerarAPartirDeValuacion(Sesion s, int idVal)
        {
            int iResult = 0;

            CD_CrmPropuestaTecnica CD = new CD_CrmPropuestaTecnica();

            iResult = CD.spCRM_PropuestaTecnica_Generar(s.Id_Emp, s.Id_Cd, idVal, s.Emp_Cnx);
            return iResult; 

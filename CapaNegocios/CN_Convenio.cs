   ...
   public class CN_Convenio
    {
       ...
       public void ConsultaConvenioHis(int Id_PC, ref ConvenioHis conv, ref List<ConvenioHis> List, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConsultaConvenioHis(Id_PC, ref conv, ref List, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void ConsultaConvenioDetHis(Convenio conv, ref DataTable dt, string Conexion)
       {
           try
           {
               ...
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConsultaConvenioDetHis(conv, ref dt, Conexion);
       ...
       public void ConvenioSolicitud_Atender(int Id_Sol, List<SolConvenioDet> List, int id_Uatendio, string sol_NombreAtendio, ref int Verificador, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConvenioSolicitud_Atender(Id_Sol, List, id_Uatendio, sol_NombreAtendio, ref Verificador, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void Convenio_ConsultaClienteVinculado(ConvenioDet conv, ref ConvenioDet convdet, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.Convenio_ConsultaClienteVinculado(conv, ref convdet, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void Convenio_Concesionarioshabilitados(Convenio conv, ref DataTable dt, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.Convenio_Concesionarioshabilitados(conv, ref dt, Conexion);
       ...
       public void ConvenioSolicitud_ValidaNoExistaClienteDet(SolConvenio sol, List<SolConvenioDet> List, ref int Verificador, ref string mensajeerror, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConvenioSolicitud_ValidaNoExistaClienteDet(sol, List, ref Verificador, ref mensajeerror, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void ConsultarInformacionConvenio(int Id_emp, int Gestion_Tipo, ref  List<CapGestionPrecioInformacion> List, string Conexion)
       {
           ...
           {
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConsultarInformacionConvenio(Id_emp, Gestion_Tipo, ref List, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void ConsultarConvenioCorreos(int Id_emp, int Gestion_Tipo, ref  List<ConvenioCorreos> List, string Conexion)
       {
           try
           {
               ///Obtiene los correos de lso destinatarios 
               ///para el envío de correos
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConsultarConvenioCorreos(Id_emp, Gestion_Tipo, ref List, Conexion);
           }
           catch (Exception ex)
           {
       ...
       public void ConsultaConvenioBonificacion(ConvenioBonificacion conv, ref DataTable dt, string Conexion)
       {
           try
           {
               ...
               CD_Convenio cd_conv = new CD_Convenio();
               cd_conv.ConsultaConvenioBonificacion(conv, ref dt, Conexion);

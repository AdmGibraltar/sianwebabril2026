    ...
    public class CN_ProFactura_Embarque
    {
        ...
        public void VAlidarPedidoEcommerce(Factura factura, string conexion, ref List<Factura> lista)
        {
            try
            {
                ...
                CDProFacturaEmbarque.VAlidarPedidoEcommerce(factura, conexion, ref lista);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void BiscarNumeroPedidoEcommerce(Factura factura, string conexion, ref int verificador)
        {
            try
            {
                ...
                CDProFacturaEmbarque.BiscarNumeroPedidoEcommerce(factura, conexion, ref verificador);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void VAlidarPedidoEcommerce(Remision Remisiones, string conexion, ref int verificador)
        {
            try
            {
                ...
                CDProFacturaEmbarque.VAlidarPedidoEcommerce(Remisiones, conexion, ref verificador);
            }
            catch (Exception ex)
            {
                throw ex;

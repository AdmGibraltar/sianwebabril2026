...
namespace CapaNegocios
{
    public class CN_CatSolucion
    {
        ...
        {
            CD_CatSolucion CD = new CD_CatSolucion();
            return CD.spCatSolucionByArea(Id_Emp, Id_Area, Conexion);
        }

        public IEnumerable<CapaModelo.CatSolucion> ObtenerPorEmpresaYArea(int idEmp, int idArea, Sesion sesion)
        {
        ...
        public IEnumerable<CapaModelo.CatSolucion> ObtenerPorEmpresaYArea(int idEmp, int idArea, Sesion sesion, IBusinessTransaction ibt)
        {
            CD_CatSolucion cdCatSolucion = new CD_CatSolucion();
            var res = cdCatSolucion.ConsultarPorEmpresaYArea(idEmp, idArea, sesion.Emp_Cnx_EF, ibt.DataContext);
            return res;
        }

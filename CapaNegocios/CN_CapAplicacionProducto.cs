...
namespace CapaNegocios
{
    public class CN_CapAplicacionProducto
    {
        ...
        public IEnumerable<CapAplicacionProducto> ObtenerPorAplicacionYProducto(Sesion s, int idApl, long idPrd, IBusinessTransaction ibt)
        {
        ...
        /// <returns>IEnumerable[CapAplicacionProducto]</returns>
        public IEnumerable<CapAplicacionProducto> ObtenerPorProyectoYProducto(Sesion s, int idCte, int idOp, long idPrd, IBusinessTransaction ibt)
        {
            CD_CapAplicacionProducto cdCapAplicacionProducto = new CD_CapAplicacionProducto();
        ...
        /// <param name="ibt">Transacción de la capa de negocio</param>
        /// <returns>IEnumerable[CapAplicacionProducto]</returns>
        public IEnumerable<CapAplicacionProducto> ObtenerPorProducto(Sesion s, long idPrd, IBusinessTransaction ibt)
        {
            CD_CapAplicacionProducto cdCapAplicacionProducto = new CD_CapAplicacionProducto();

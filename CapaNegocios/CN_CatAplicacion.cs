...
namespace CapaNegocios
{
    public class CN_CatAplicacion
    {
        ...
        {
            CD_CatAplicacion CD = new CD_CatAplicacion();
            return CD.spObtenerTodasLasAplicacionesDisponibles(Id_Emp, Id_Cd, Id_Uen, Id_Seg, Id_Area, Id_Sol, Id_Op, Id_Cte, Conexion);
        }

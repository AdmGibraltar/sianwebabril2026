...
namespace CapaNegocios
{
    public class CN_CrmCatalogoUnico
    {
        ...
        public IEnumerable<CrmCatalogoUnico> ObtenerPorProducto(Sesion s, long idPrd, IBusinessTransaction ibt)
        {
            CD_CrmCatalogoUnico cdCrmCatalogoUnico = new CD_CrmCatalogoUnico();
        ...
        /// <param name="ibt">Transacción de capa de negocio</param>
        /// <returns>IEnumerable[CrmCatalogoUnico]</returns>
        public CrmCatalogoUnico ObtenerPorProductoYProyecto(Sesion s, int idCte, int idOp, long idPrd, IBusinessTransaction ibt)
        {
            CD_CrmCatalogoUnico cdCrmCatalogoUnico = new CD_CrmCatalogoUnico();

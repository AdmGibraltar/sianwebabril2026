...
namespace CapaNegocios
{
    public class CN_CrmOportunidadesAplicacion
    {
        ...
        /// <param name="idOp"></param>
        /// <returns></returns>
        public List<eCrmOportunidadesAplicacion> ObtenerPorOportunidad_Ver2(Sesion sesion, int idCte, int idOp)
        {
            CD_CrmOportunidadesAplicacion cdCrmOportunidadesAplicacion = new CD_CrmOportunidadesAplicacion();
            return cdCrmOportunidadesAplicacion.ConsultarPorOportunidad_Ver2(sesion.Id_Emp, sesion.Id_Cd, sesion.Id_Rik, idOp, sesion.Emp_Cnx);
        }

...
namespace CapaNegocios
{
    public class CN__Comun
    {
        ...
        public void LlenaCombo64(Int32 Id1, Int32 Id2, int? Id3, string conexion, string SP, ref Telerik.Web.UI.RadComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun64> Lista = new System.Collections.Generic.List<Comun64>();
                CapaDatos.CD__Comun claseCapaDatos = new CapaDatos.CD__Comun();
                claseCapaDatos.LlenaCombo64(Id1, Id2, Id3, SP, conexion, ref Lista);
                if (Lista.Count > 0)
                {
                    RadComboBox.DataSource = Lista;
                    RadComboBox.DataValueField = "Id";
        ...
        public void LlenaComboStr(string conexion, string SP, ref Telerik.Web.UI.RadComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
                CapaDatos.CD__Comun claseCapaDatos = new CapaDatos.CD__Comun();
                claseCapaDatos.LlenaComboStr(SP, conexion, ref Lista);
        ...
        public void DEvLlenaListBox(Int32 Id1, Int32 Id2, string conexion, string SP, ref BootstrapListBox RadListBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
                ...
                {
                    RadListBox.DataSource = Lista;
                    RadListBox.ValueField = "Id";
                    RadListBox.TextField = "Descripcion";
                    RadListBox.DataBind();
                }
            }
            catch (Exception ex)
        ...
        //Id Sugerido
        public string Maximo(int Id_Emp, int Id_Cd, int Id_Cte, string Tabla, string Columna, string Conexion, string SP)
        {
            try
            {
                string maximo = "";
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
                CapaDatos.CD__Comun claseCapaDatos = new CapaDatos.CD__Comun();
                claseCapaDatos.Maximo(Id_Emp, Id_Cd, Id_Cte, Tabla, Columna, SP, Conexion, ref maximo);
                return maximo;
            }
            catch (Exception ex)
            {
        ...
        public void BoostrapCambiarCdVer(BootstrapComboBox item, ref Sesion sesion)
        {
            try
            {
                sesion.Id_Cd_Ver = Convert.ToInt32(item.Value);
        ...
        #region funciones requeridas devexpress

        public void DevLlenaCombo64(string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun64> Lista = new System.Collections.Generic.List<Comun64>();
                CapaDatos.CD__Comun claseCapaDatos = new CapaDatos.CD__Comun();
                claseCapaDatos.DevLlenaCombo64(SP, conexion, ref Lista);

                //RadComboBox.Items.Clear(); //ric
                if (Lista.Count > 0)
                {
                    RadComboBox.DataSource = Lista;
                    RadComboBox.ValueField = "Id";
                    RadComboBox.TextField = "Descripcion";
                    RadComboBox.DataBind();
                }
            }
            catch (Exception ex)
        ...
        public void DevLlenaCombo(string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
        ...
        public void DevLlenaCombo(string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapTagBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
        ...
        public void DevLlenaCombo(string Id1, int? Id2, int? Id3, int? Id4, int? Id5, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
        ...
        public void DevLlenaCombo(Int32 Id1, Int32 Id2, Int32 Id3, int? Id4, int? Id5, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
                ...
                if (Lista.Count > 0)
                {
                    ...
                    if (Lista.ToArray()[0].Relacion != "sin_relacion")
                    {
                        RadComboBox.TextField = "Relacion";
                    }
                    else
                    {
                        RadComboBox.TextField = "Descripcion";
        ...
        public void DevLlenaCombo(Int32 Id1, Int32 Id2, Int32 Id3, int? Id4, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
                ...
                if (Lista.Count > 0)
                {
                    ...
                    try
                    {
                        foreach (Comun I in Lista)
                        {
                            if (I.ValorBool)
                            {
                                RadComboBox.Value = Convert.ToString(I.Id);
                                break;
                            }
                        }
                    }
        ...
        public void DevLlenaCombo(Int32 Id1, Int32 Id2, int? Id3, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
        ...
        public void DevLlenaCombo(Int32 Id1, Int32 Id2, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox, params bool[] claveString)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();
        ...
        //Leads
        public void DevLlenaCombo(Int32 Id1, string conexion, string SP, ref DevExpress.Web.Bootstrap.BootstrapComboBox RadComboBox)
        {
            try
            {
                System.Collections.Generic.List<Comun> Lista = new System.Collections.Generic.List<Comun>();

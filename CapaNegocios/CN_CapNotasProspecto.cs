...
namespace CapaNegocios
{
    public class CN_CapNotasProspecto
    {
        ...
        public List<eNotasProspecto> CrmNotasProspecto(int Id_Emp, int Id_Cd, int Id_Cte, Sesion s)
        {

            CD_CapNotasProspecto CD = new CD_CapNotasProspecto();
            return CD.spCrmNotasProspecto(Id_Emp, Id_Cd, Id_Cte, s.Emp_Cnx);
        }

...
namespace CapaNegocios
{
    public class CN_EntradaVirtual
    {
        ...
        public void ConsultaVentanaEntradaVirtual_ComboProducto(int Id_Emp, int Id_Cd, long Id_Prd, string Conexion, ref string Prd_Descripcion)
        {
            try
            {
                CD_ProEntradaVirtual claseCapaDatos = new CD_ProEntradaVirtual();
       ...
       /* 
        public void EntradaVirtualProductoCliente_Consulta(ref EntradaVirtualDet EntradaVirtualPro, string Conexion, int id_Emp, int id_Cd, int id_Cli, long id_Prd)
        {
            try
            {
                CD_ProEntradaVirtual claseCapaDatos = new CD_ProEntradaVirtual();

...
namespace CapaNegocios
{
    public class CN_CrmValuacionOportunidades
    {
        ...
        public List<CrmValuacionOportunidade> ObtenerPorValuacion_Ver2(Sesion sesion, int idCte, int idVal)
        {
            CD_CrmValuacionOportunidades cdCrmValuacionOportunidades = new CD_CrmValuacionOportunidades();
            return cdCrmValuacionOportunidades.ConsultarPorValuacion_Ver2(sesion.Id_Emp, sesion.Id_Cd, idCte, sesion.Id_Rik, idVal, sesion.Emp_Cnx_EF);
        }

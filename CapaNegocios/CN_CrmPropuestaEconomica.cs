...
namespace CapaNegocios
{
    public class CN_CrmPropuestaEconomica
    {
        ...
        // 
        public List<CapaEntidad.ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, Sesion sesion)
        {
            ...
            Lst = cdCrmPE.CRM_ObtenerPropuestaEconomica(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Id_Op, Id_Val, sesion.Emp_Cnx);
            return Lst;
        }

        // JUN12-2020 RFH 
        public List<CapaEntidad.ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica_Ver2(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, int Id_Ptp, Sesion sesion)
        {
            CD_CrmPropuestaEconomica cdCrmPE = new CD_CrmPropuestaEconomica();
            return cdCrmPE.CRM_ObtenerPropuestaEconomica_Ver2(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Id_Op, Id_Val, Id_Ptp, sesion.Emp_Cnx);
        }

        // AGO14-2020 RFH 
        public List<CapaEntidad.ePropuestaTecnoEconomicaDetalle> CRM_ObtenerPropuestaEconomica_Ver3(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, int Id_Ptp, Sesion sesion)
        {
            CD_CrmPropuestaEconomica cdCrmPE = new CD_CrmPropuestaEconomica();
            return cdCrmPE.CRM_ObtenerPropuestaEconomica_Ver3(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Id_Op, Id_Val, Id_Ptp, sesion.Emp_Cnx);
        }

        // 
        // lo miso que la de arriba solo que nombre no se ven en el DS del reporte. 
        //
        public List<CapaEntidad.ePropuestaTecnoEconomicaDetalle> CRM_PE(
            int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, int Id_Ptp, Sesion sesion)
        {
            CD_CrmPropuestaEconomica cdCrmPE = new CD_CrmPropuestaEconomica();
            return cdCrmPE.CRM_ObtenerPropuestaEconomica_Ver2(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Id_Op, Id_Val, Id_Ptp, sesion.Emp_Cnx);
        ...
        // 1 Sep 2018 RFH
        public CapaEntidad.eCapValProyecto spCRMCapValProyecto(int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, int Id_Op, int Id_Val, Sesion sesion)
        {
            CapaEntidad.eCapValProyecto Obj = new CapaEntidad.eCapValProyecto();
            CD_CrmPropuestaEconomica cdCrmPE = new CD_CrmPropuestaEconomica();
            Obj = cdCrmPE.spCRMCapValProyecto(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Id_Op, Id_Val, sesion.Emp_Cnx);
            return Obj;
        }

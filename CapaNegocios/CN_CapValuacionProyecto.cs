...
namespace CapaNegocios
{
    public class CN_CapValuacionProyecto
    {
        ...
        public void ConsultarValuacionProyecto2(ref ValuacionProyecto valuacionProyecto, string Conexion)
        {
            try
            {
                new CD_CapValuacionProyecto().ConsultarValuacionProyecto2(ref valuacionProyecto, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ValuacionProyecto InsertarValuacionProyecto_Ver2(
            ...
            ValuacionProyecto VPro, ValuacionParametros VPara, ValuacionParametrosActual VPActual, string Conexion)
        {
            CD_CapValuacionProyecto CD = new CD_CapValuacionProyecto();
            return CD.InsertarValuacionProyecto_ver2(
                Id_Emp, Id_Cd, Id_Op, Id_Cte, Folio, TipoValuacion,
                VPro, VPara, VPActual, Conexion);
        }
        ...
        //
        // Actualiza 6 Mar 2019 RFH
        // Se corrigue problema en la asingacion de folio de Id_Vap
        //
        public CapaModelo.CapValProyecto InsertarValuacionProyecto(
            ValuacionProyecto valuacionProyecto,
            ValuacionParametros vp,
            ValuacionParametrosActual p2,
            Sesion sesion, int[] idOps, IBusinessTransaction ibt)
        {

            // 6 Mar 2019 RFH
            // Pasamos de P2 > valuacionProyecto , Id_Vap 
            valuacionProyecto.Id_Vap = p2.Id_Vap;
            ...
            /*
            CN_CapValProyectoParams CN_ProyectoP = new CN_CapValProyectoParams();
            eCapValProyectoParams parametros1 = new eCapValProyectoParams();
            parametros1.Id_Emp = sesion.Id_Emp;
            parametros1.Id_Cd = sesion.Id_Cd;
            parametros1.Id_Vap = capValProyecto.Id_Vap;
            parametros1.Vap_Vigencia = vp.Vap_Vigencia;
            ...
            parametros1.Vap_Gastos_Admin = vp.Vap_Gastos_Admin;
            parametros1.Vap_Inversion_Activos = vp.Vap_Inversion_Activos;
            CN_ProyectoP.CapValProyectoParams_InsertUpdate(sesion.Id_Emp, sesion.Id_Cd, parametros1, sesion.Emp_Cnx);  
            */
        ...
        public void ModificarValuacionProyecto(ref ValuacionProyecto valuacionProyecto, ValuacionParametros vp, Sesion sesion, ref int verificador, int[] idOps, IBusinessTransaction ibt)
        {
            try
            {
                ...
                new CD_CapValuacionProyecto().CRM2_ModificarValuacionProyecto(ref valuacionProyecto, vp, sesion.Emp_Cnx, ref verificador, idOps, sesion.Emp_Cnx_EF, sesion.Id_Rik, ibt.DataContext);
                ...
                foreach (var idOp in idOps)
                {
                    ...
                    var proyecto = cnCrmOportunidad.ObtenerPorId_Context(sesion.Id_Emp, sesion.Id_Cd, idOp, ibt.DataContext);
        ...
        //
        // 18 Sep 2018 RFH
        // Actualiza Parametros de Valuacion 
        //
        public eCapValProyectoParametros InsertUpdate_CapValProyectoParametros(eCapValProyectoParametros eCVPP, string Conexion)
        {
            eCapValProyectoParametros eCPP = new eCapValProyectoParametros();

            CD_CapValProyecto_Parametros P = new CD_CapValProyecto_Parametros();
            eCPP = P.InsertUpdate_CapValProyectoParametros(eCVPP, Conexion);

    ...
    public class CN_PrecioEspecial
    {
        public void ConsultaVentanaPrecioEspecial_ComboCliente(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion, ref string Cte_NomComercial, bool vTerritorio)
        {
            try
            {
                ...
                claseCapaDatos.ConsultaVentanaPrecioEspecial_ComboCliente(Id_Emp, Id_Cd, Id_Cte, Conexion, ref Cte_NomComercial, vTerritorio);
        ...
        public void PrecioEspecialProductoCliente_Consulta(ref VentanaPrecioEspecialPro precioEspecialPro, IBusinessTransaction ibt, int id_Emp, int id_Cd, int id_Cli, long id_Prd)
        {
            try
            {
                CD_ProPrecioEspecial claseCapaDatos = new CD_ProPrecioEspecial();

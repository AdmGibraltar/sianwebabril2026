...
namespace CapaNegocios
{
    public class CN_CapOrdenCompra
    {
        ...
        public void InsertarOrdenCompra(ref OrdenCompra ordenCompra, string Conexion, string ValidaParametrosOC, ref int verificador)
        {
            ...
            {
                CD_CapOrdenCompra claseCapaDatos = new CD_CapOrdenCompra();
                claseCapaDatos.InsertarOrdenCompra(ref ordenCompra, Conexion, ValidaParametrosOC, ref verificador);
        ...
        public void ValidarOrdenCompraExtraordinaria(ref OrdenCompra ordCompra, string Conexion, ref int verificador, Sesion sesssion, string sUrl)
        {
            try
            {
                CD_CapOrdenCompra claseCapaDatos = new CD_CapOrdenCompra();
                claseCapaDatos.ValidarOrdenCompraExtraordinaria(ref ordCompra, Conexion, ref verificador, sesssion, sUrl);

...
namespace CapaNegocios
{
    public class CN_CrmPromocion
    {
        ...
        {
            CD_CrmPromocion CD = new CD_CrmPromocion();
            return CD.ConsultaCatPromocion_Ver2(Id_Emp, Id_Cd, Id_Cte, Id_Op, Id_Rik, Conexion, vTerritorio);
        }
        ...
        //
        // 14 Sep 2018 RFH 
        // Se modifica para aplicar filtro sobre oportunidades ya cerradas
        // 

        public void ProyectosDisponiblesParaValuacion_2(Sesion sesion, CrmPromociones promocion, ref List<CrmPromociones> list, IBusinessTransaction ibt)
        {
            try
            {
                CD_CrmPromocion claseCRM = new CD_CrmPromocion();

...
namespace CapaNegocios
{
    ...
    public class CN_CapValuacionGlobalCliente
    {
        ...
        public CapValuacionGlobalCliente CrearParaCliente(Sesion s, int idCte, IBusinessTransaction ibt)
        {
            ...
            //
            // Ya no guardara AQUI May08-2019 FRh
            // se guarda abajo 
            //
            ...
            CD_CapValProyecto_Parametros cdCapValProyecto_Parametros = new CD_CapValProyecto_Parametros();
            cdCapValProyecto_Parametros.spCapValProyecto_Insertar(capValProyecto_Parametros, s.Emp_Cnx);
        ...
        public double PartidasCalcularPrecioAAA(int Id_Emp, int Id_Cd, int Id_Cte, long Id_Prd, int idVap, IBusinessTransaction ibt)
        {

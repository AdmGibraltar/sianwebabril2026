...
namespace CapaNegocios
{
    public class CN_CatClienteDet
    {
        ...
        // 5 Nov 2018  RFH Creacion 

        public List<eTerritoriosCte> ObtenerTerritoriosPorCte(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion)
        {
            CD_CatClienteDet cdCatClienteDet = new CD_CatClienteDet(Conexion);
            return cdCatClienteDet.ObtenerTerritoriosPorCte(Id_Emp, Id_Cd, Id_Cte, Conexion);
        }

        // 16 Ene 2019  RFH Creacion 

        public List<eTerritoriosCte> ObtenerTerritoriosPorCteYRik(int Id_Emp, int Id_Cd, int Id_Cte, int Id_Rik, string Conexion)
        {
            CD_CatClienteDet cdCatClienteDet = new CD_CatClienteDet(Conexion);
            return cdCatClienteDet.ObtenerTerritoriosPorCte_UnionRik(Id_Emp, Id_Cd, Id_Cte, Id_Rik, Conexion);
        }
    }

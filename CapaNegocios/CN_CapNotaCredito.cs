...
namespace CapaNegocios
{
    public class CN_CapNotaCredito
    {
        ...
        public void ConsultarNotaCredito(ref NotaCredito notaCredito, string Conexion, ref List<NotaCreditoDet> listaNotaCreditoDet)
        {
            try
            {
                new CD_CapNotaCredito().ConsultarNotaCredito(ref notaCredito, Conexion, ref listaNotaCreditoDet);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaNotaCreditoNacional(ref NotaCredito notaCredito, string Conexion)
        {
            try
            {
                ...
                claseCapaDatos.ConsultaNotaCreditoNacional(ref notaCredito, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultarNotaCreditoOptenerNcrSerie(ref NotaCredito notaCredito, string Conexion)
        {
            try
            {
                new CD_CapNotaCredito().ConsultarNotaCreditoOptenerNcrSerie(ref notaCredito, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultarNotaCreditoSAT(ref NotaCredito notaCredito, string Conexion, ref object resultado, ref object resultadoCN)
        {
            try
            {
                new CD_CapNotaCredito().ConsultarNotaCreditoSAT(ref notaCredito, Conexion, ref resultado, ref resultadoCN);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertarNotaCredito(ref NotaCredito notaCredito, ref Factura facturaNacional, string Conexion, ref int verificador, List<AdendaDet> listAdendaCabecera, System.Data.DataTable ListaProductosNotaCredito)
        {
            try
            {
                new CD_CapNotaCredito().InsertarNotaCredito(ref notaCredito, ref facturaNacional, Conexion, ref verificador, listAdendaCabecera, ListaProductosNotaCredito);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ModificarNotaCredito(ref NotaCredito notaCredito, ref Factura facturaNacional, string Conexion, ref int verificador, List<AdendaDet> listAdendaCabecera, System.Data.DataTable ListaProductosNotaCredito)
        {
            try
            {
                new CD_CapNotaCredito().ModificarNotaCredito(ref notaCredito, ref facturaNacional, Conexion, ref verificador, listAdendaCabecera, ListaProductosNotaCredito);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertarNotaCreditoNacional(ref Factura facturaNacional, string Conexion, ref int verificador)
        {
            try
            {
                new CD_CapNotaCredito().InsertarNotaCreditoNacional(ref facturaNacional, Conexion, ref verificador);
            }
            catch (Exception ex)
            {
                throw ex;

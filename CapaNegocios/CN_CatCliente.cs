...
namespace CapaNegocios
{
    public class CN_CatCliente
    {
        ...
        public void ConsultarSolicitudesPdtesClienteTerr(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion, ref int Existe)
        {
            try
            {
                new CD_CatCliente().ConsultarSolicitudesPdtesClienteTerr(Id_Emp, Id_Cd, Id_Cte, Conexion, ref Existe);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertarClientes(Clientes clientes, string Conexion, ref int verificador, bool vTerritorio)
        {
            try
            {
                ...
                claseCapaDatos.InsertarClientes(clientes, Conexion, ref verificador, vTerritorio);
        ...
        public void ModificarClientes(Clientes clientes, string Conexion, ref int verificador, bool vTerritorio)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ModificarClientes(clientes, Conexion, ref verificador, vTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClientes(ref Clientes cte, string Conexion)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                Sesion sesion = (Sesion)HttpContext.Current.Session["Sesion" + HttpContext.Current.Session.SessionID];
                claseCapaDatos.ConsultarCliente(cte, Conexion, sesion.VersionTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClientesBasico(ref Clientes cte, string Conexion, bool VersionTerritorio)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarCliente(cte, Conexion, VersionTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool ConsultaClienteDirecto(Clientes cte, string conexion)
        {
            try
            {
                return new CD_CatCliente().ConsultaClienteDirecto(cte, conexion);
            }
            catch { return false; }
        }

        public void ConsultarClienteCaptacion(ref Clientes cte, string Conexion)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarClienteCaptacion(cte, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClienteDet(ClienteDet clientedet, string Conexion, ref DataTable dt, bool vTerritorio)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarClienteDet(clientedet, Conexion, ref dt, vTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClienteDirEntrega(ClienteDirEntrega clienteDirEntrega, string Conexion, ref DataTable dt, bool vTerritorio)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarClienteDirEntrega(clienteDirEntrega, Conexion, ref dt, vTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertarClientesDirEntrega(Clientes clientes, DataTable dt, string Conexion, bool vTerritorio)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.InsertarClienteDirEntrega(clientes, dt, Conexion, vTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void InsertarClientesDet(Clientes clientes, DataTable dt, string Conexion, bool vTerritorio)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.InsertarClienteDet(clientes, dt, Conexion, vTerritorio);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClienteValidoFacturaSinPedido(int id_cliente, Sesion sesion, ref String SiValida)
        {
            try
            {
                new CD_CatCliente().ConsultaClienteValidoFacturaSinPedido(id_cliente, sesion, ref SiValida);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClientesDirectosSP(ref Clientes cte, ref int EsClienteDirectoSP, string Conexion)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultaClientesDirectosSP(ref cte, ref EsClienteDirectoSP, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<CapaEntidad.CatFormaPago> CatClienteFPago_Consultar(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion)
        {
            ...
            return CD.CatClienteFPago_Consultar(Id_Emp, Id_Cd, Id_Cte, Conexion);
        }
        ...
        public void ConsultarClienteMetodoFormaPago(ref Clientes cte, string Conexion)
        {
            ...
            {
                CD_CatCliente cd_catcliente = new CD_CatCliente();
                cd_catcliente.ConsultarClienteMetodoFormaPago(ref cte, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
            ...
            string TextoBuscar, string Conexion)
        {
            ...
            lst = CC.ListarBusqueda_PorRik(Id_Emp, Id_Cd, Id_Uen, Id_Seg, Id_Terr, Id_Rik, TextoBuscar, Conexion);
            return lst;
        }
        ...
        {
            CD_CatCliente CC = new CD_CatCliente();
            return CC.spGC_CatCiente_Listar(PageNumber, PageSize, Anio, Mes, Id_Emp, Id_Cd, Id_U, Id_Rik, TextoBuscar, Conexion);
        }
        ...
        {
            CD_CatCliente CC = new CD_CatCliente();
            return CC.spRepCumplimientoVI_Dinamico(Pms);
        }
        ...
        {
            CD_CatCliente CC = new CD_CatCliente();
            return CC.spRepCumplimientoVI_ver3(Pms);
        }
        ...
        {
            CD_CatCliente CC = new CD_CatCliente();
            return CC.spCrmInt_Clientes(Id_Emp, Id_Cd, Id_Rik, Conexion);
        }
        ...
        public eCliente Consultar_PorId_Cte(int Id_Emp, int Id_Cd, int Id_Cte, string Conexion)
        {
            ...
            CD_CatCliente CC = new CD_CatCliente();
            return CC.Consultar_PorId_Cte(Id_Emp, Id_Cd, Id_Cte, Conexion);
            //return Cte;
        }
        //
        //RBM
        ...
        public void ValidaSucursal(Sesion sesion, string conexion, ref int respuesta)
        {
            ...
            {
                CD_CatCliente cd_cte = new CD_CatCliente();
                cd_cte.ValidaSucursal(sesion, conexion, ref respuesta);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void CargarEstados(Sesion sesion, int Id_Pais, ref DataSet datos)
        {
            ...
            {
                CD_CatCliente CD = new CD_CatCliente();
                CD.CargarEstados(sesion, Id_Pais, ref datos);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultaClientesDetRecibe(ref ClienteDetRecibe entClienteDetRecibe, string Conexion)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultaClientesDetRecibe(ref entClienteDetRecibe, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultarCatalogoDinamico(int IdEmp, int IdCd, string Conexion, ref List<Comun> lstCatalogo, ref List<Comun> lstCatalogoDetalle, ref List<Comun> lstCampos)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarCatalogoDinamico(IdEmp, IdCd, Conexion, ref lstCatalogo, ref lstCatalogoDetalle, ref lstCampos);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void GuardarSeleccionCatalogoAdicional(string Conexion, int IdCd, int[] lstParametro, int intIdCampo, string strValor)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.GuardarSeleccionCatalogoAdicional(Conexion, IdCd, lstParametro, intIdCampo, strValor);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        //ConsultarSeleccionCatalogoAdicional(session.Emp_Cnx, session.Id_Cd, intIdCte, lstCatalogoSeleccion);
        ...
        public void ConsultarSeleccionCatalogoAdicional(string Conexion, int IdCd, int intIdCte, ref List<Comun> lstCatalogoSeleccion)
        {
            ...
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ConsultarSeleccionCatalogoAdicional(Conexion, IdCd, intIdCte, ref lstCatalogoSeleccion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ModificarTerritorioAcys(string Conexion, int IdU, ClienteDet entCliente, int intIdCteDetPadreAnterior, int intIdCteDetPadreNuevo)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ModificarTerritorioAcys(Conexion, IdU, entCliente, intIdCteDetPadreAnterior, intIdCteDetPadreNuevo);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ActualizaTerritorioActivo(string emp_Cnx, ClienteDet clienteDet, int intIdTerActivo, int intIdU)
        {
            try
            {
                CD_CatCliente claseCapaDatos = new CD_CatCliente();
                claseCapaDatos.ActualizaTerritorioActivo(emp_Cnx, clienteDet, intIdTerActivo, intIdU);
            }
            catch (Exception ex)
            {
                throw ex;

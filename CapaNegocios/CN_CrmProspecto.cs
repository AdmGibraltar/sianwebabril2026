...
namespace CapaNegocios
{
    ...
    {
        // May23-2019 RFH            
        public List<eProspectos> ObtenerProspecto_Page(int Id_Emp, int Id_Cd, string TextoBuscar, int PageSize, int PageIndex, string Conexion)
        {
            CD_CrmProspecto CD = new CD_CrmProspecto();
            return CD.spCRM_ObtenerProspecto_Page(
                Id_Emp, Id_Cd, TextoBuscar, PageSize, PageIndex, Conexion
            );
        }
        ...
        //1 Oct 2018 RFH
        //
        public List<CrmProspecto> spObtenerProspectos(int idEmp, int idCd, int idRik, string Conexion, bool vTerritorio)
        {
            CD_CrmProspecto cdCrmProspecto = new CD_CrmProspecto();
            return cdCrmProspecto.spObtenerProspectos(idEmp, idCd, idRik, Conexion, vTerritorio);
        }
        //
        //16 Ene 2018 RFH
        //
        ...
        {
            CD_CrmProspecto cdCrmProspecto = new CD_CrmProspecto();
            return cdCrmProspecto.spObtenerProspecto(Id_Emp, Id_Cd, Id_CrmProspecto, Conexion);
        }
        ...
        public CrmProspecto CrearProspecto(CrmProspecto prospecto, Sesion sesion)
        {
            ...
            try
            {
                ...
                {
                    int verificador = 0;
                    cdCatCliente.InsertarClientes(clientes, sesion.Emp_Cnx, ref verificador, sesion.VersionTerritorio);
                    if (verificador == 0)
                    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (AgregarCliente)
                    {
                        ...
                        cdCatCliente.InsertarClientes(clientes, sesion.Emp_Cnx, ref verificador, ibt.DataContext, sesion.VersionTerritorio);
                    }
                    else
                    {
        ...
        public List<eProspectos> VerificarNombre(Sesion sesion, string query)
        {
            var c = new CD_CrmProspecto().VerificarNombreProspecto(sesion.Emp_Cnx_EF, sesion.Id_Emp, sesion.Id_Cd, sesion.Id_Rik, query);
            return c;
        }
        ...
        /// <returns></returns>
        public CrmProspecto ObtenerProspecto_Ver2(int idEmp, int idCd, int idRik, int idCrmProspecto, Sesion sesion)
        {
            CD_CrmProspecto cdCrmProspecto = new CD_CrmProspecto();
            return cdCrmProspecto.ObtenerProspecto_Ver2(
                idEmp,
                idCd,
                idRik,
                idCrmProspecto,
        ...
        */
        ...
        {
            public ClienteProspectoInvalidoException()
                : base("Cliente inválido para el prospecto")
            {
        ...
        {
            public NuevoProspectoRFCExistenteException()
                : base("El RFC ya se encuentra registrado por otro cliente.")
            {
            }
        }
        ...
        {
            public ErrorAsociarClienteTerritorioException()
                : base("Ocurrió una complicación al asociar Territorios al prospecto")
            {
            }
        ...
        {
            public RFCRequeridoException()
                : base("El campo RFC es requerido")
            {
            }
        }

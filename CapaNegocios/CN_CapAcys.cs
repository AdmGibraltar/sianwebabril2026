...
namespace CapaNegocios
{
    public class CN_CapAcys
    {
        ...
        public void ConsultarCaptarAcys(ref Acys acys, string Conexion)
        {
            ...
            {
                CD_CapAcys claseCapaDatos = new CD_CapAcys();
                claseCapaDatos.ConsultarCaptarAcys(ref acys, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            CD_CapAcys claseCapaDatos = new CD_CapAcys();
            return claseCapaDatos.ConsultarDet2(Id_Emp, Id_Cd, Id_Acs, Id_AcsVersion, Conexion, TipoCuenta, ref ErrorMensaje);
        }
        ...
        public void ConsultarReemplazos(Acys acys, long Id_Prd, ref DataTable list2, string Conexion)
        {
            try
            {
                CD_CapAcys claseCapaDatos = new CD_CapAcys();
        ...
        public bool ExisteProductoEnGarantia(int idEmp, int idCd, long idPrd, int idTer, int idCte, int idRik, Sesion sesion)
        {
        ...
        public bool ExisteProductoEnGarantia(int idEmp, int idCd, long idPrd, int idTer, int idCte, int idRik, Sesion sesion, int idTg)
        {
        ...
        public CapaModelo.CapAcysDet ObtenerDetallePorProducto(int idEmp, int idCd, long idPrd, int idTer, int idCte, int idRik, Sesion sesion)
        {
            CD_CapAcysDet cdCad = new CD_CapAcysDet(sesion.Emp_Cnx_EF);
        ...
        //
        public int ClieneTieneACYS_ByCteTer(Sesion s, int Id_Emp, int Id_Cd, int Id_Cte, int Id_Ter,
            ref int Acys_Id_Acs, ref int Acys_Id_AcsVersion)
        {
            CD_CapAcys cdCapAcys = new CD_CapAcys();
            return cdCapAcys.CRM_ClienteTieneACYS_ByCteTer(s.Emp_Cnx, Id_Emp, Id_Cd, Id_Cte, Id_Ter,
        ...
        public bool ExisteProductoEnGarantia(int idEmp, int idCd, long idPrd, int idTer, int idCte, int idRik, string sesion)
        {
            CD_CapAcysDet cdCad = new CD_CapAcysDet(sesion);
            var cad = cdCad.Consultar_PorProducto(idEmp, idCd, idPrd, idTer, idCte, idRik);
            if (cad != null)
            {
                return cad.Id_TG != null;
        ...
        public void ConsultarEstatus(ref Acys acys, string Conexion)
        {
            ...
            {
                CD_CapAcys claseCapaDatos = new CD_CapAcys();
                claseCapaDatos.ConsultarEstatus(ref acys, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void ConsultarvalidaracysFrecuencia(Acys acys, ref int verificador, string Conexion)
        {
            ...
            {
                CD_CapAcys claseCapaDatos = new CD_CapAcys();
                claseCapaDatos.ConsultarvalidaracysFrecuencia(acys, ref verificador, Conexion);
            }
            catch (Exception ex)
            {
                throw ex;

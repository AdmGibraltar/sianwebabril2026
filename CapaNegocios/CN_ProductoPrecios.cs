...
namespace CapaNegocios
{
    public class CN_ProductoPrecios
    {
        ...
        public void ConsultaListaProductoPreciosCL(ProductoPrecios productoPrecio, string Conexion, ref List<ProductoPrecios> List)
        {
            try
            {
                CD_ProductoPrecios claseCapaDatos = new CD_ProductoPrecios();
                claseCapaDatos.ConsultaListaProductoPreciosCL(productoPrecio, Conexion, ref List);
        ...
        public List<ProductoPrecios> CL_ConsultaListaProductoPrecios(ProductoPrecios productoPrecio, string Conexion)
        {
            CD_ProductoPrecios CD = new CD_ProductoPrecios();
            return CD.CL_ConsultaListaProductoPrecios(productoPrecio, Conexion);
        }
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, Sesion sesion, long Id_Prd, ref int Id_Pre, IBusinessTransaction ibt)
        {
            try
            {
                CD_ProductoPrecios claseCapaDatos = new CD_ProductoPrecios();
        ...
        public void ConsultaListaProductoPrecioAAA(ref float precio, int Id_Emp, int Id_Cd, long Id_Prd, IBusinessTransaction ibt)
        {
            try
            {
                CD_ProductoPrecios claseCapaDatos = new CD_ProductoPrecios();
        ...
        // 30JUL-2020
        // Debe regresar precioLista en lugar de precioAAA
        // Este valor se despliega default en la columna Precio Venta
        public double ConsultarPrecioAAA(Sesion sesion, long Id_Prd)
        {
        ...
        public double ConsultarPrecioAAA(Sesion sesion, long Id_Prd, IBusinessTransaction ibt)
        {
            double precioLista = 0.0D;
            double precioAAA = 0.0D;
            try
        ...
        public double ConsultarPrecioLista(Sesion sesion, long Id_Prd)
        {
            double precioLista = 0.0D;
            double precioAAA = 0.0D;
            try
        ...
        /// <returns>double</returns>
        public double ConsultarPrecioLista(Sesion sesion, long Id_Prd, IBusinessTransaction ibt)
        {
            double precioLista = 0.0D;
            double precioAAA = 0.0D;
            try
        ...
        //RBM
        //MAR 2024
        public List<PreciosComprasLocales> spCL_ProductoConsultaPreciosCL(PreciosComprasLocales productoPrecio, string Conexion)
        {
            CD_ProductoPrecios CD = new CD_ProductoPrecios();
            return CD.spCL_ProductoConsultaPreciosCL(productoPrecio, Conexion);
        }
    }
}
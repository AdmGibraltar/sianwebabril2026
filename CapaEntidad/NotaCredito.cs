...
namespace CapaEntidad
{
    public class NotaCredito
    {
        ...
        private string _Ncr_UsoCFDI;
        public string Ncr_UsoCFDI
        {
            get { return _Ncr_UsoCFDI; }
            set { _Ncr_UsoCFDI = value; }
        }

        private string _Ncr_MetodoPago;
        public string Ncr_MetodoPago
        {
            get { return _Ncr_MetodoPago; }
            set { _Ncr_MetodoPago = value; }
        }

        private string _Ncr_FormaPago;
        public string Ncr_FormaPago
        {
            get { return _Ncr_FormaPago; }
            set { _Ncr_FormaPago = value; }
        }

        private string _Ncr_TipoRelacion;
        public string Ncr_TipoRelacion
        {
            get { return _Ncr_TipoRelacion; }
            set { _Ncr_TipoRelacion = value; }
        }
        ...
        public string Fac_CteCalle { get; set; }
        public string Fac_CteNumero { get; set; }
        public string Fac_CteColonia { get; set; }
        public string Fac_CteMunicipio { get; set; }
        public string Fac_CteEstado { get; set; }
        public string Fac_CteRfc { get; set; }
        public string Fac_CteCp { get; set; }
        public string Fac_CteAdeNombre { get; set; }

        public string Ncr_SelloCN { get; set; }
        public string Ncr_FolioCN { get; set; }
        public object Ncr_XmlCN { get; set; }
        public string Ncr_FolioFiscalCN { get; set; }
        public byte[] Ncr_PdfCN { get; set; }

...
namespace CapaEntidad
{
    public class RemisionDet
    {
        ...
        //Carta porte
        //Se agrega para controlar si el material es peligroso
        public object EsPeligroso { get; set; }

        private double _Prd_Peso;
        public double Prd_Peso
        {
            get { return _Prd_Peso; }
            set { _Prd_Peso = value; }
        }
    }
}
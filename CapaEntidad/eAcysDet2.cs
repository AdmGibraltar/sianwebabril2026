...
namespace CapaEntidad
{
    ...
    /*
       29MAR-2021 Actalización RFH
    
       MAR2-2020 RFH 
       .- Se agrga el campo para el nobre de la frecuencia que va en el reporte.             
    */
    ...
    public class eAcysDet2
    {
        ...
        public int Id_Acs
        { get { return _Id_Acs; } set { _Id_Acs = value; } }

        private int _Id_AcsVersion;
        public int Id_AcsVersion
        { get { return _Id_AcsVersion; } set { _Id_AcsVersion = value; } }
        private int _Id_AcsDet;
        public int Id_AcsDet
        { get { return _Id_AcsDet; } set { _Id_AcsDet = value; } }
        ...
        private int _Acs_FrecuenciaTipo;
        public int Acs_FrecuenciaTipo
        {
            get { return _Acs_FrecuenciaTipo; }
            set { _Acs_FrecuenciaTipo = value; }
        }

        private string _Acs_FrecuenciaTipo_Nombre;
        public string Acs_FrecuenciaTipo_Nombre
        {
            get { return _Acs_FrecuenciaTipo_Nombre; }
            set { _Acs_FrecuenciaTipo_Nombre = value; }
        }
        ...
        private Int32 _Id_Reg;
        public Int32 Id_Reg
        { get { return _Id_Reg; } set { _Id_Reg = value; } }

        private Int32 _Id_Ter;
        public Int32 Id_Ter
        { get { return _Id_Ter; } set { _Id_Ter = value; } }

        private string _Acs_Modalidad;
        public string Acs_Modalidad
        { get { return _Acs_Modalidad; } set { _Acs_Modalidad = value; } }

        private decimal _Acs_canTTotal;
        public decimal Acs_canTTotal
        { get { return _Acs_canTTotal; } set { _Acs_canTTotal = value; } }

        //JUN18-2020 RFH

        private int _RequiereOC;
        public int RequiereOC
        {
            get { return _Id_Reg; }
            set { _Id_Reg = value; }
        }
        ...
        { get { return _NombreNodo; } set { _NombreNodo = value; } }

        private int _Id_Matriz;
        public int Id_Matriz
        { get { return _Id_Matriz; } set { _Id_Matriz = value; } }
        ...
        public int Acs_FrecMesIni { get; set; }
        public int Acs_FrecAnioIni { get; set; }
    }
    //
}
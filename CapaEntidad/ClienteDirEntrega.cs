...
namespace CapaEntidad
{
    public class ClienteDirEntrega
    {
        ...
        private string _Ruta_Entrega;
        private int _Ruta_EntregaId_Rut;
        ...
        public string Ruta_Entrega
        {
            get { return _Ruta_Entrega; }
            set { _Ruta_Entrega = value; }
        }

        public int Ruta_EntregaId_Rut
        {
            get { return _Ruta_EntregaId_Rut; }
            set { _Ruta_EntregaId_Rut = value; }
        }

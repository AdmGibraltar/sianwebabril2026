...
namespace CapaEntidad
{
    ...
    public class Pago
    {
        ...
        private string _Filtro_ClienteIni;
        private string _Filtro_ClienteFin;
        private string _NumOperacion;

        public string Filtro_ClienteIni
        {
            get { return _Filtro_ClienteIni; }
            set { _Filtro_ClienteIni = value; }
        }
        public string Filtro_ClienteFin
        {
            get { return _Filtro_ClienteFin; }
            set { _Filtro_ClienteFin = value; }
        }
        ...
        public string Id_PagExt { get; set; }

...
namespace CapaEntidad
{
    public class ConfiguracionGlobal
    {
        ...
        //RBM
        private string mail_AdministradorQuejas;
        public string Mail_AdministradorQuejas
        {
            get { return mail_AdministradorQuejas; }
            set { mail_AdministradorQuejas = value; }
        }
        ...
        // Usuarios ACyS
        //
        private string _mail_AutorizacionAcys_Gerente;
        public string mail_AutorizacionAcys_Gerente
        {
            get { return _mail_AutorizacionAcys_Gerente; }
            set { _mail_AutorizacionAcys_Gerente = value; }
        }

        private string _mail_AutorizacionAcys_JefeOperaciones;
        public string mail_AutorizacionAcys_JefeOperaciones
        {
            get { return _mail_AutorizacionAcys_JefeOperaciones; }
            set { _mail_AutorizacionAcys_JefeOperaciones = value; }
        }
        ...
        public string Mail_Portal { get; set; }
        public string Mail_PassPortal { get; set; }
        public string Mail_PuertoPopPortal { get; set; }
        public string Mail_PuertoSMTP { get; set; }
    }
}
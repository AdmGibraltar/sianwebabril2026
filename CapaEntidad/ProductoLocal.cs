...
namespace CapaEntidad
{
    public class ProductoLocal
    {
        ...
        private double _Costo_Old;
        private double _AAA_Old;
        private double _Publico_Old;
        ...
        public double Costo_Old
        {
            get { return _Costo_Old; }
            set { _Costo_Old = value; }
        }
        public double AAA_Old
        {
            get { return _AAA_Old; }
            set { _AAA_Old = value; }
        }
        public double Publico_Old
        {
            get { return _Publico_Old; }
            set { _Publico_Old = value; }
        }
    }
}

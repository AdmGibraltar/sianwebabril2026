...
namespace CapaEntidad
{
    public class Territorios
    {
        ...
        private int _Aut_IdRepresentante;
        public int Aut_IdRepresentante
        {
            get { return _Aut_IdRepresentante; }
            set { _Aut_IdRepresentante = value; }
        }

        private string _Aut_ClaveTerritorio;
        public string Aut_ClaveTerritorio
        {
            get { return _Aut_ClaveTerritorio; }
            set { _Aut_ClaveTerritorio = value; }
        }

        private string _Aut_Territorio;
        public string Aut_Territorio
        {
            get { return _Aut_Territorio; }
            set { _Aut_Territorio = value; }
        }

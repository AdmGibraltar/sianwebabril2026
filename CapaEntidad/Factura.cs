...
namespace CapaEntidad
{
    public class Factura
    {
        ...
        {
            get { return _Fac_CteNumeroInterior; }
            set { _Fac_CteNumeroInterior = value; }
        }
        ...
        private int? _Fac_EstatusCanc;
        public int? Fac_EstatusCanc
        {
            get { return _Fac_EstatusCanc; }
            set { _Fac_EstatusCanc = value; }
        }

        private String _Fac_EstatusSAT;
        public String Fac_EstatusSAT
        {
            get { return _Fac_EstatusSAT; }
            set { _Fac_EstatusSAT = value; }
        }

        private String _Fac_AcuseCanc;
        public String Fac_AcuseCanc
        {
            get { return _Fac_AcuseCanc; }
            set { _Fac_AcuseCanc = value; }
        }



        private DateTime? _Fac_FecCanSAT;
        public DateTime? Fac_FecCanSAT
        {
            get { return _Fac_FecCanSAT; }
            set { _Fac_FecCanSAT = value; }
        }


        public int id_pedMag { get; set; }
        public string pdf { get; set; }
        public string xml { get; set; }

        private String _Fac_FolioFiscSust;
        public String Fac_FolioFiscSust
        {
            get { return _Fac_FolioFiscSust; }
            set { _Fac_FolioFiscSust = value; }
        }

        public int Id_Ncr { get; set; }
        public string UsoCFDI { get; set; }
        public int Id_MotivoBaja { get; set; }
        public string DescripcionMotivoBaja { get; set; }
        public int Id_Fac_Reemplaza { get; set; }
    }
}
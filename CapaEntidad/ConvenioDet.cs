   ...
   public class ConvenioDet
    {
       ...
       public string Prd_Descripcion { get; set; }
        public string PCD_Referencia { get; set; }
       ...
       public DateTime? PCD_FechaFinVer { get; set; }
        //jfcv convenio
       public double? PCD_PrecioPAAAEspProv { get; set; }
       public double? PCD_PrecioVentaConvenio { get; set; }
       public double? PCD_Margen { get; set; }
       public int Id_ConvDet { get; set; }

...
namespace CapaEntidad
{
    public class DevParcial_Detalle
    {
        ...
        int id_u;
        string ncr_UsoCFDI;
        string ncr_MetodoPago;
        string ncr_FormaPago;
        ...
        {
            get { return ncr_UsoCFDI; }
            set { ncr_UsoCFDI = value; }
        }

        public string Ncr_MetodoPago
        {
            get { return ncr_MetodoPago; }
            set { ncr_MetodoPago = value; }
        }

        public string Ncr_FormaPago
        {
            get { return ncr_FormaPago; }
            set { ncr_FormaPago = value; }
        }
    }
}
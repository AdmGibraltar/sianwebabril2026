   ...
   public class SolConvenio
    {
       ...
       public int? FiltroId_CD { get; set; }
        ...
        public string Filtro_Id_Cat { get; set; }
       ...
       public string Sol_Unique { get; set; }
        public int Id_UAtendio { get; set; }
        public string Sol_NombreAtendio { get; set; }
        public DateTime Sol_FechaAtendio { get; set; }
        public int OrigenSolicitud { get; set; }

...
{
    public class ConvenioHis
    {
        public int Id_PCH { get; set; }
        ...
        //JFCV Convenio 
        public int PC_NoConvenioKey { get; set; }
        public DateTime PC_FechaInicio { get; set; }
        public int PC_DesplegarMatrizCN { get; set; }
        public string PC_NombreArchivoPDF { get; set; }
        public string PC_ArchivoPDF { get; set; }
        public string PC_NoConvenioFuturo { get; set; }
        public string PC_Nombreusuario { get; set; }

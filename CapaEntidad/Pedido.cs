...
namespace CapaEntidad
{
    public class Pedido
    {
        ...
        public DateTime Ped_FechFactAcys { get; set; }

        public string Pedidos { get; set; }

        public bool ped_reqdocfolio { get; set; }
        public bool ped_reqdocreposicion { get; set; }
        public string ped_reqotrodesc { get; set; }
        ...
        public string acs_telefono6 { get; set; }
        ...
        private DateTime? _Filtro_FecEntregaIni;

        public DateTime? Filtro_FecEntregaIni
        {
            get { return _Filtro_FecEntregaIni; }
            set { _Filtro_FecEntregaIni = value; }
        }
        private DateTime? _Filtro_FecEntregaFin;

        public DateTime? Filtro_FecEntregaFin
        {
            get { return _Filtro_FecEntregaFin; }
            set { _Filtro_FecEntregaFin = value; }
        }
        ...
        public string TraePicking
        {
            get { return _TraePicking; }
            set { _TraePicking = value; }
        }
        ...
        private int _filtro_Credito;

        public int Filtro_Credito
        {
        ...
        public int Acs_ReqOrdenrep { get; set; }
        ...
        public bool Acs_ReqOrden { get; set; }
        ...
        public int PedidoExterno { get; set; }

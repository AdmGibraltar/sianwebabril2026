...
namespace CapaEntidad
{
    public class AgendaRsc
    {
        ...
        public string fechaModificacionFinal { get; set; }
        ...
        public double PorcTiempo { get; set; }
        public string lugar { get; set; }
        public int actividaCheck { get; set; }
        public bool actividaChecked { get; set; }

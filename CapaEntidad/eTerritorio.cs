...
namespace CapaEntidad
{
    public class eTerritorio
    {
        ...
        // 22AGO-2019 RFh
        private string _Uen_Descripcion { get; set; }
        ...
        private string _Seg_Unidades { get; set; }
        ...
        private double _Seg_ValUniDim { get; set; }
        ...
        // 22AGO-2019 RFh
        private string _Seg_Descripcion { get; set; }

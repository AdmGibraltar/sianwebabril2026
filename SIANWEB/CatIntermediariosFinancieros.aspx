<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master" AutoEventWireup="true" CodeBehind="CatIntermediariosFinancieros.aspx.cs" Inherits="SIANWEB.CatIntermediariosFinancieros" %>
                ...
                <td>
                    <table style="font-family: verdana; font-size: 8pt">
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:radnumerictextbox id="txtClave" runat="server" enabled="false" width="70px" minvalue="1">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:radtextbox onpaste="return false" id="txtBanco" runat="server" width="300px"
                                    maxlength="100">
                                    <ClientEvents OnKeyPress="SoloAlfabetico" />
                                </telerik:radtextbox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBanco"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td colspan="2">
                                <telerik:radtextbox id="txtRfc" runat="server" width="300px" maxlength="30">
                         ...
                         <tr>
                            ...
                            <td colspan="2">
                                <telerik:radtextbox id="txtRazonSocial" runat="server" width="300px" maxlength="100">
                                    
                                    <ClientEvents OnKeyPress="RazonSocial" />
                                </telerik:radtextbox>
                           ...
                           <tr>
                            ...
                            <td colspan="2">
                                <telerik:radtextbox id="txtCorreo" runat="server" width="300px" maxlength="100">
                                    
                                    <ClientEvents OnKeyPress="Email" />
                                </telerik:radtextbox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCorreo"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <telerik:radgrid id="rgBancos" runat="server" autogeneratecolumns="False" gridlines="None"
                        ...
                        <MasterTableView>
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="Clave" UniqueName="Id_If" DataField="Id_If">
                                <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </telerik:GridBoundColumn>                                
                                <telerik:GridBoundColumn DataField="Banco" HeaderText="Banco" UniqueName="Banco">
                                ...
                                <telerik:GridBoundColumn DataField="RazonSocial" HeaderText="Razon Social" UniqueName="RazonSocial">
                                  <HeaderStyle HorizontalAlign="Center" Width="300px" />
                                    <ItemStyle HorizontalAlign="left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Correo" HeaderText="Correo Electronico" UniqueName="Correo">
    ...
    <telerik:radcodeblock id="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function LimpiarControles() {
                ...
                LimpiarTextBox($find('<%= txtBanco.ClientID %>'));
                LimpiarTextBox($find('<%= txtRazonSocial.ClientID %>'));
                LimpiarTextBox($find('<%= txtCorreo.ClientID %>'));                
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        parametros = "Catalogo=CatIntermediarioFinanciero";
                        parametros = parametros + "&sp=spCatLocal_Maximo";
                        parametros = parametros + "&columna=Id_IF";

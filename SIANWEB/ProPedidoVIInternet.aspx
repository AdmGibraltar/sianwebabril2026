<%@ Page Title="Captación de pedidos" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.master"
    AutoEventWireup="true" CodeBehind="ProPedidoVIInternet.aspx.cs" Inherits="SIANWEB.ProVentInst_PedidoCapInt" %>
                                    ...
                                    <table>
                                               ...
                                               <tr>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <tr>
                                                        <td>
                                                            <asp:Label ID="Label22" runat="server" Text="Uso CFDI"></asp:Label>
                                                        </td>
                                                        <td>
                                                       
                                                              <telerik:RadComboBox ID="ddUsoCfdi" runat="server" EmptyMessage="Seleccionar cliente"
                                                                 Width="300px"
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <td>
                                                      <telerik:RadTextBox onpaste="return false" ID="txtRHoraam1" runat="server" Width="100px"
                                                                Enabled="False">                                                                
                                                            </telerik:RadTextBox>
                                                ...
                                                <td>
                                                      <telerik:RadTextBox onpaste="return false" ID="txtRHoraam2" runat="server" Width="100px"
                                                                Enabled="False">                                                                
                                                            </telerik:RadTextBox>
                                                ...
                                                <td>
                                                      <telerik:RadTextBox onpaste="return false" ID="txtRHorapm1" runat="server" Width="100px"
                                                                Enabled="False">                                                                
                                                            </telerik:RadTextBox>
                                                ...
                                                <td>
                                                      <telerik:RadTextBox onpaste="return false" ID="txtRHorapm2" runat="server" Width="100px"
                                                                Enabled="False">                                                                
                                                            </telerik:RadTextBox>
                                        ...
                                        <MasterTableView NoMasterRecordsText="No se encontraron registros." CommandItemDisplay="Top"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." UniqueName="Id_Prod">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtProd" runat="server" MaxLength="16"
                                                            MinValue="1" MaxValue="999999999999999" Text='<%# Bind("Id_Prd") %>'

<%@ Page Title="Embarque de documentos" Language="C#" MasterPageFile="~/MasterPage/MasterPage03.master"
    AutoEventWireup="true" CodeBehind="ProEmbarques.aspx.cs" Inherits="SIANWEB.ProEmbarques" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <telerik:RadComboBox runat="Server"  ID="CmbTipo">
                                                            <Items>
                                                            <telerik:RadComboBoxItem runat ="Server" Text = "Logística" Value ="1" Selected="true" ></telerik:RadComboBoxItem>
                                                            <telerik:RadComboBoxItem runat ="Server" Text = "Cobranza" Value ="2"   ></telerik:RadComboBoxItem>
                            ...
                            <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="270px" ResizeMode="AdjacentPane"
                                ...
                                <telerik:RadPane ID="RadPane1" runat="server" Height="250px" OnClientResized="onResize"
                                    ...
                                    <telerik:RadGrid ID="rgDetalles" runat="server" GridLines="None" AllowPaging="False"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top" DataKeyNames="Emb_Tipo, Id_Doc" NoMasterRecordsText="No se encontraron registros."
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn UniqueName="Emb_Tipo" HeaderText="Tipo doc.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEmb_TipoStr" runat="server"  Text='<%# Eval("Emb_TipoStr") %>'></asp:Label>
                                                        <asp:Label ID="lblEmbTipo" runat="server"  Text='<%# Eval("Emb_Tipo") %>' Visible="false"></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <telerik:RadComboBox ID="CmbTipo" runat="server" Width="80px" >
                                                        <Items>
                                                       <telerik:RadComboBoxItem runat ="Server" Text = "Factura" Value ="1" Selected="true" ></telerik:RadComboBoxItem>
                                                       <telerik:RadComboBoxItem runat ="Server" Text = "Remisión" Value ="2" Selected="true" ></telerik:RadComboBoxItem>
                                                        </Items>
                                                        </telerik:RadComboBox>
                                                    </EditItemTemplate>
                                                    <HeaderStyle Width="115px" />
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn DataField="Id_Doc" HeaderText="Documento" UniqueName="Id_Doc">
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtFact" runat="server" MaxLength="9" MinValue="1"
                                                            Text='<%# Eval("Id_Doc") %>' Width="55px" OnTextChanged="txtFac_TextChanged"
                                                            AutoPostBack="true">
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                            <ClientEvents OnKeyPress="handleClickEvent" />
                                                        </telerik:RadNumericTextBox>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="FacLabel" runat="server" Text='<%# Eval("Id_Doc") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Cte_NomComercial" HeaderText="Cliente" UniqueName="Cte_NomComercial">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadTextBox ID="txtCte" runat="server" ReadOnly="true" Text='<%# DataBinder.Eval(Container.DataItem, "Cte_NomComercial") %>'
                                                            Width="250px">
                                                        </telerik:RadTextBox>
                                                         <asp:Label ID="LblId_Cte" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Id_Cte") %>' Visible="false"></asp:Label>
                                                    </EditItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn DataField="Fac_Importe" HeaderText="Importe" UniqueName="Fac_Importe">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtImporte" runat="server" MaxLength="9" MinValue="0"
                                                            ReadOnly="true" Width="70px" Text='<%# DataBinder.Eval(Container.DataItem, "Doc_Importe") %>'>
                                                        </telerik:RadNumericTextBox>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblImporte" runat="server" Text='<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "Doc_Importe")).ToString("N") %>'>
                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                ...
                                                <telerik:GridButtonColumn ConfirmText="¿Desea quitar el documento de la lista?" ConfirmDialogType="RadWindow"

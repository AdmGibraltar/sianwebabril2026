<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ReporteCom.Master" EnableEventValidation="false"  AutoEventWireup="true" CodeBehind="dshIndicadoresACySv3.aspx.cs" Inherits="SIANWEB.Dashboard.dshIndicadoresACySv3" %>
...
<asp:Content ID="Content1ACyS" ContentPlaceHolderID="head" runat="server">
    ...
    <script asyn src="https://charts.livegap.com/js/webfont.js" type="text/javascript"></script>
    <script src="https://charts.livegap.com/js/Chart.min.js" type="text/javascript"></script>
...
<asp:Content ID="Content2ACys" ContentPlaceHolderID="CPH" runat="server">
                            ...
                            <table class="table-condensed">
                                <tr>
                                    <td style="vertical-align: top; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #3d3d5c;" class="h3">&nbsp;
                                        <img src="../Images/imgAplicarFiltro.png" width="25" height="25" onclick="Actualiza();" style="cursor: pointer" alt="Filtros" />&nbsp;Filtros&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table style="width: 100%; border-spacing: 2px">
                                            <tr>
                                                <td>
                                                    <p class="h4 small" id="p1" runat="server">Año</p>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="drpAnio" runat="server" CssClass="h5 small"
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="h4 small" id="p2" runat="server">Mes</p>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="drpMes" runat="server" CssClass="h5 small" Width="150px" AutoPostBack="true" OnSelectedIndexChanged="drpMes_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p class="h4 small" id="parrCDI" runat="server">CDI</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr style="height: 5px">
                                                <td>
                                                    <p class="h4 small">Estatus</p>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="drpEstatus" runat="server" CssClass="h4 small"
                                                        AutoPostBack="true" OnSelectedIndexChanged="drpEstatus_SelectedIndexChanged" Width="150px">
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="h4 small">Representante:</p>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="drpGridRiks2" runat="server" CssClass="h5 small"
                                                        Width="275px" AutoPostBack="true" OnSelectedIndexChanged="drpGridRiks2_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                            ...
                            <table class="table-condensed" style="width: 100%; column-width: 10px; height: 100%;">
                                <tr>
                                    <td class="h3" style="align-content: start; align-self: start; align-items: start; text-align: start; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #3d3d5c;">&nbsp;
                                        <img src="../Images/imgBajarExcel.png" width="25" height="25" alt="Descargar Información" />&nbsp;Descargar Información&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <table style="border-spacing: 10px; height: 80%; vertical-align: top;">
                                                        <tr>
                                                            ...
                                                            <td style="align-content: start; align-self: start; align-items: start; text-align: start; vertical-align: top; cursor: pointer;"
                                                                class="h4 text-nowrap" onclick="ClickAvance();">&nbsp;Reporte de Avance Detallado&nbsp;
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                            <td class="h4 small">
                                                                <asp:CheckBox name="chkLista8020" ID="chkLista8020" runat="server"
                                                                    Text="" Checked="true" />&nbsp;Listado de Clientes de Venta Instalada
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="h4 small">
                                                                <asp:CheckBox name="chkDetalleXRIK" ID="chkDetalleXRIK" runat="server"
                                                                    Text="" Checked="false" AutoPostBack="true" OnCheckedChanged="chkDetalleXRIK_CheckedChanged" />&nbsp;Desglosar por RIK
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                ...
                                                <td style="width: 40%; vertical-align: top;">
                                                    <table style="border-spacing: 10px; height: 80%; vertical-align: top;">
                                                        <tr>
                                                            ...
                                                            <td style="align-content: start; align-self: start; align-items: start; text-align: start; vertical-align: top; cursor: pointer;"
                                                                class="h4 text-nowrap" onclick="ClickCumplimiento();">&nbsp;Cumplimiento en Captura&nbsp;
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;</td>
                        ...
                        <td style="width: 32%; vertical-align: top; align-content: start; text-align: start; align-items: start; align-self: start;">
                            <table class="table-condensed" style="border-spacing: 1px; align-content: start; text-align: start; align-items: start; align-self: start;">
                                ...
                                <tr>
                                    ...
                                    <td style="align-content: start; align-self: start; align-items: start; text-align: start; vertical-align: top; cursor: pointer;"
                                        class="h4 text-nowrap" onclick="ClickGraficar();">
                                        <asp:ImageButton runat="server" ID="ImgBtnGraficar" ImageUrl="../Images/imgAvance01.png" AlternateText="Resumen: indicadores y graficas."
                                            OnClick="ImgBtnGraficar_Click" Width="30" Height="30" Style="vertical-align: top;" />

                                        &nbsp;Resumen: indicadores y graficas.&nbsp;
                                    </td>
                                    <td>&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td class="h5 text-nowrap" style="align-content: end; text-align: end;">Total ACyS Vigentes:</td>
                                    <td class="h4" style="align-content: center; align-self: center; align-items: center; text-align: center; vertical-align: top;">&nbsp;<strong><%=lblTotalGeneral %> </strong></td>
                                </tr>
                                <tr>
                                    <td class="h5 text-nowrap" style="align-content: end; text-align: end;">Total ACyS Autorizados:</td>
                                    <td class="h4" style="align-content: center; align-self: center; align-items: center; text-align: center; vertical-align: top;">&nbsp;<strong><%=lblCapturavsAutorizado %></strong></td>
                                </tr>
                                <tr>
                                    <td class="h5 text-nowrap" style="align-content: end; text-align: end;">Cumplimiento Autorizados:</td>
                                    <td class="h4" style="align-content: center; align-self: center; align-items: center; text-align: center; vertical-align: top;">&nbsp;<strong><%=lblCumplimientoACySAutorizados %></strong></td>
                                </tr>
                                <tr>
                                    <td class="h5 text-nowrap" style="align-content: end; text-align: end;">Total Clientes de Venta Instalada:</td>
                                    <td class="h4" style="align-content: center; align-self: center; align-items: center; text-align: center; vertical-align: top;">&nbsp;<strong><%=lbltotalVentaInstalada %></strong></td>
                                </tr>
                                <tr>
                                    <td class="h5 text-nowrap" style="align-content: end; text-align: end;">Cumplimiento ACyS Clientes de Venta Instalada:</td>
                                    <td class="h4" style="align-content: center; align-self: center; align-items: center; text-align: center; vertical-align: top;">&nbsp;<strong><%=lblCumplimientoACySVenta %></strong></td>
                                </tr>
                            </table>
                        </td>
                        <td style="width: 10px;">&nbsp;</td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: center; align-content: center; align-items: center;"
                                                    class="h4">
                                                    <br />
                                                    <small><%=lblNumCapturado %></small><br />
                                                    <b style="color: #9C27B0"><%=NumCapturado %>%</b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: center; align-content: center; align-items: center;"
                                                    class="h4">
                                                    <br />
                                                    <small><%=lblNumSolicitadoG %></small><br />
                                                    <b style="color: #9C27B0"><%=NumSolicitadoG %>%</b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: center; align-content: center; align-items: center;"
                                                    class="h4">
                                                    <br />
                                                    <small><%=lblNumSolicitadoJ %></small><br />
                                                    <b style="color: #9C27B0"><%=NumSolicitadoJ %>%</b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: center; align-content: center; align-items: center;"
                                                    class="h4">
                                                    <br />
                                                    <small><%=lblNumAutorizado %></small><br />
                                                    <b style="color: #9C27B0"><%=NumAutorizado %>%</b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: center; align-content: center; align-items: center;"
                                                    class="h4">
                                                    <br />
                                                    <small><%=lblNumOtro %></small><br />
                                                    <b style="color: #9C27B0"><%=NumOtro %>%</b>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="vertical-align: top; align-content: center; text-align: center; align-items: center; align-self: center;">
                            <canvas id="chart-01" width="1000" height="550"
                                style="border-radius: 0px; width: 950px; height: 550px; padding-left: 50px; padding-right: -50px; padding-top: 50px; padding-bottom: -50px"></canvas>
                        </td>
    ...
    <script type="text/javascript">
        ...
        function ClickGraficar() {
            var e = document.getElementById("<%=ImgBtnGraficar.ClientID%>");
            e.click();
        }
        ...
        var ChartData = {
            labels: [ <%=strRIKS%>
                //labels: ["CARMEN DANIELA LIZARRAGA CAÑEDO", "BARBARA PATRICIA PEREZ RODRIGUEZ", "MARIA MAGDALENA ACUÑA GONZALEZ", "MARIO CESAR PEREZ ROMERO", "LYHBETT ALEJANDRA HERNANDEZ HERNANDEZ"
            ],
            datasets: [{

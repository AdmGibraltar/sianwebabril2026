<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master" 
    AutoEventWireup="true" CodeBehind="dshIndicadoresACyS.aspx.cs" Inherits="SIANWEB.Dashboard.dshIndicadoresACyS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <link  id='GoogleFontsLink' href='https://fonts.googleapis.com/css?family=Open Sans' rel='stylesheet' type='text/css'>
        ...
        <table style=" width: 100%; border-spacing:20px; column-width:5px">
                                ...
                                <tr>
                                    <td>
                                        <table style=" width: 100%; border-spacing:2px">
                                            <tr>
                                                <td><p class="text-secondary"  id="parrCDI" runat="server" >CDI</p></td>
                                                <td>
                                                ...
                                                <!--
                                                <td rowspan="3" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top; ">
                                                        
                                                        <img src="../Images/imgAplicarFiltro.png" width="35" height="35"/>
                                                        
                                                </td> -->
                                            </tr>
                                            <tr>
                                                <td><p class="text-secondary">Representante:</p></td>
                                                <td><p class="text-secondary">
                                                        <asp:checkbox name="chkTodosRIKs" id="chkTodosRIKs" runat="server"
                                                                onclick="ChkaTodos();" checked="true" />&nbsp;<small>Todos los RIKS</small>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <asp:DropDownList ID="drpRIKs" runat="server" CssClass="text-secondary"
                                                    ...
                                                    <asp:CheckBoxList ID="lstchkRIKS" runat="server" onclick="UnChkaElTodos();"
                                                            CellPadding="5" Width="280px" Height="100px" TextAlign="Right" />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr style="height:5px">
                                                <td><p class="text-secondary">Estatus</p></td>
                                                <td>
                ...
                <table style=" width: 100%; border-spacing:5px; column-width:5px" >
                    <tr>
                        <td style="width:32%; vertical-align:top;  align-content:start; text-align:start; align-items:start; align-self:start;">
                            <table class="table subcompact" style=" align-content:start; text-align:start; align-items:start; align-self:start;">
                                <tr><td colspan="2"><h5>&nbsp;&nbsp;</h5></td></tr>
                                <tr>
                                    <td><p class="text-secondary" style="align-content:end; text-align:end;">Total General De Acuerdos Capturados/Actualizados:</p></td>
                                    <td><p class="text-secondary" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top;">
                                        &nbsp;<strong><%=lblTotalGeneral %> </strong></p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-secondary" style="align-content:end; text-align:end;">Total De Clientes Del 80/20:</p></td>
                                    <td><p class="text-secondary" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top;">
                                        &nbsp;<strong><%=lblTotalClientes %></strong></p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-secondary" style="align-content:end; text-align:end;">Total De Captura De ACyS Del 80/20:</p></td>
                                    <td><p class="text-secondary" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top;">
                                        &nbsp;<strong><%=lblTotalCaptura %></strong></p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-secondary" style="align-content:end; text-align:end;">Avances En Captura Del 80/20:</p></td>
                                    <td><p class="text-leader2" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top;">
                                        &nbsp;<strong><%=lblAvanceCaptura %></strong></p></td>
                                </tr>
                                <tr>
                                    <td><p class="text-secondary" style="align-content:end; text-align:end;">Total Capturado vs. Total Autorizaddo:</p></td>
                                    <td><p class="text-leader2" style="align-content:end; align-self:end; align-items:end; text-align:end; vertical-align:top;">
                                        &nbsp;<strong><%=lblCapturavsAutorizado %></strong></p></td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; align-content:center; align-items:center;">
                                                    <h6> <small><%=lblNumCapturado %></small><br /><p style=" color:#9C27B0"><%=NumCapturado %>%</p></h6>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td >
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; align-content:center; align-items:center;">
                                                    <h6> <small><%=lblNumSolicitadoG %></small><br /><p style=" color:#9C27B0"><%=NumSolicitadoG %>%</p></h6>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td >
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; align-content:center; align-items:center;">
                                                    <h6> <small><%=lblNumSolicitadoJ %></small><br /><p style=" color:#9C27B0"><%=NumSolicitadoJ %>%</p></h6>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr> -->
                                    <td >
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; align-content:center; align-items:center;">
                                                    <h6> <small><%=lblNumAutorizado %></small><br /><p style=" color:#9C27B0"><%=NumAutorizado %>%</p></h6>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td >
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; align-content:center; align-items:center;">
                                                    <h6> <small><%=lblNumOtro %></small><br /><p style=" color:#9C27B0"><%=NumOtro %>%</p></h6>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

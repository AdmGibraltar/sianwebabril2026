                                                                ...
                                                                <Columns>
                                                                    <telerik:GridTemplateColumn HeaderText="Clave" UniqueName="Id_Prd" EditFormColumnIndex="0">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            ...
                                                                            <telerik:RadTextBox ID="txtClave" runat="server" Text='<%# Bind("Id_Prd") %>' 
                                                                                AutoPostBack="true" MaxLength="15" Width="140px" OnTextChanged="cmbProductoDet_TextChanged">
                                                                                <ClientEvents OnKeyPress="keyPress" OnLoad="OnIdPrdLoad"/>
                                                                            </telerik:RadTextBox>

                                                                        <%--    <telerik:RadNumericTextBox ID="txtClave" runat="server" Text='<%# Bind("Id_Prd") %>'
                                                                                AutoPostBack="true" MaxLength="15" Width="140px" MinValue="1" OnTextChanged="cmbProductoDet_TextChanged">
                                                                                <NumberFormat DecimalDigits="0" GroupSeparator="" />

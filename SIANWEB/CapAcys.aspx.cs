    ...
    public partial class CapAcys : System.Web.UI.Page
    {
        ...
        protected void cmbProductoDet_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    cnProducto.ConsultaProducto(ref prd, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, sesion.Id_Cd_Ver, Convert.ToInt64(cmbProd.Value.HasValue ? cmbProd.Value.Value : -1), 0);
                }
                catch (Exception ex)
                {
        ...
        {
            GridDataItem item = (GridDataItem)e.Item;
            long Id_Prd = Convert.ToInt32((item.FindControl("txtCodigoEdit") as RadNumericTextBox).Value);
        ...
        public List<AcysPrd> LLenarDatosGrid(DataTable dt, int Id_TG)
        {
            ...
            {
                prd = new AcysPrd();
                prd.Id_Prd = Convert.ToInt64(dt.Rows[x]["Id_Prd"]);
        ...
        private void Delete(GridCommandEventArgs e)
        {
            ...
            GridItem gi = e.Item;
            long Id_Prd = Convert.ToInt64(((Label)gi.FindControl("lblIdPrd")).Text);
        ...
        private void PerformInsert(GridCommandEventArgs e)
        {
            try
            {
                ...
                Id_Prd = Convert.ToInt64(((RadNumericTextBox)gi.FindControl("RadNumericTextBox2")).Value.HasValue ? ((RadNumericTextBox)gi.FindControl("RadNumericTextBox2")).Value.Value : -1);
        ...
        private void PintarCalendario(RadGrid rg)
        {
            ...
            foreach (GridDataItem item in rg.Items)
            {
                ...
                Int64 prod = Convert.ToInt64(((Label)(item["Id_Prd"].Controls[1])).Text);

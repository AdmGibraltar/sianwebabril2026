<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" 
    AutoEventWireup="true" CodeBehind="CapAcys2_OrdenIndex.aspx.cs" Inherits="SIANWEB.CapAcys2Orden_Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/Librerias/bootstrap-datepicker-1.6.4-dist/js/bootstrap-datepicker.min.js") %>"></script>
    <link href="<%=Page.ResolveUrl("~/Librerias/bootstrap-datepicker-1.6.4-dist/css/bootstrap-datepicker.css")%>" rel="stylesheet"-->
...
<!--div class="row">
    <div class="col-md-12">
        <table>
            <tr>                
                <td><label>Opciones del filtro: &nbsp; </label></td>
                <td></td>
            </tr>
        </table>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <table>
            <tr>
                <td></td>
                <td style="vertical-align:middle;">Por rango de fechas&nbsp;</td>
                <td style="vertical-align:middle;">
                    <input type="checkbox" id="chbPorFechas" />&nbsp;
                </td>
                <td style="vertical-align:middle;">Por rango de folios&nbsp;</td>
                <td style="vertical-align:middle;">
                ...
                <td style="display:none;" style="vertical-align:middle;">Estatus</td>
                ...
                <td style="display:none;"  style="vertical-align:middle;">Vencido</td>
                <td style="display:none;" >
                ...
                <td style="display:none;"  style="vertical-align:middle;">Tipo de Modalidad</td>
                <td style="display:none;" style="width:150px;">
                    <select id="ddlModalidad" class="form-control">
                        <option value="0">-- Todos --</option>
    ...
    <div class="col-md-4">        
        <table>
            <tr>
                ...
                <td><input type="text" id="tbFechaInicio" class="form-control datepicker wfecha" /></td>
                <td style="vertical-align:middle;">&nbsp;a&nbsp;</td>
                <td><input type="text" id="tbFechaFin" class="form-control datepicker wfecha" /></td>
            </tr>
        </table>
    </div>    
</div>
    ...
    <div class="col-md-4">        
        <table>
            <tr>
                ...
                <td><input type="text" id="tbNumeroCliente" class="form-control"/></td>                                
            </tr>
        </table>
    </div>    
</div>

<div class="row mt5" style="margin-top:5px;">
    <div class="col-md-12">

       <table>
        <tr>
            <td>
                <button type="button" class="btn btn-primary btn-sm" id="btnCargarListado">
                    <i class="fa fa-filter" aria-hidden="true"></i>&nbsp;Cargar
                </button>
            </td>
            <td>
                <button 
                    type="button" class="btn btn-primary btn-sm" 
                    onclick="AcysOrdenes_BajarReporteExcel();" 
                    id="btnOrden_BajarReporteExcel"  >
                    <i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;Bajar reporte
                </button>
            </td>
            <td>
                <img id="spinner_Orden_BajarReporteExcel" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
            </td>
            <td>                
                <img id="btnCargandoIndice" style="display: none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>">
            </td>
        </tr>
       </table>
...
<div class="row mt5">
    <div class="col-md-12 text-center">
        ...
        <table class="table table-hover table-bordered" id="tblAcysIndex" >
            <thead>
                <tr>
                    <th>Folio</th>
                    <th>Versión</th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <tr>
                    ...
                    <td>                        
                        <img id="MensajeCargando" style="display: none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>">
                    </td>
                </tr>
                </table>
            ...
            <div class="modal-body" id="dvCuerpoVentanaDimension">
                ...
                <input type="hidden" id="hfId_Emp" value="" />
                <input type="hidden" id="hfId_Cd" value="" />
                <input type="hidden" id="hfId_Acs" value="" />
                <input type="hidden" id="hfId_AcsVersion" value="" />
                
                <ul class="nav nav-tabs role="tablist" id="tabPage">
                    ...
                    <li><a href="#tabServicioValor" data-toggle="tab">Servicio de valor</a></li>            
                </ul>
                    <div class="tab-content">
                        ...
                        <div class="col-md-12">
                                   ...
                                   <div class="panel-heading titulo_blod">Información de Cliente</div>
                                      <div class="panel-body">
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-primary btn-xs" id="btnConsultarAcys" >Consultar ACyS</button></td>
                            ...
                            <div class="panel-body">
                                ...
                                <tr>
                                    ...
                                    <td>                                                                                
                                        <select id="chbEspAd_CuentaCorporativa">
                        ...
                        <div class="tab-pane" id="tabRecepcionPedidos">                    
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:33%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="selAcs_ParcialidadesSi">
                                                        <option value="0">No</option>
                                                        <option value="1">Si</option>
                                                    </select>
                                               </td>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading titulo_blod">Forma de envío de pedido</div>
                                <div class="panel-body">
                                    <div class="col-md-12"> 
                                        <table style="width:100%;">
                                            <tr>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table style="width:100%;">
                                        <tr>
                                            <td style="width:150px;" rowspan="2">Días de recepción</td>                                            
                                        </tr>
                                        <tr>
                                    ...
                                    <div id="divAcs_EspecsAdic1" style="display:none;">
                                        ...
                                        <tr>
                                            <td td data-nota="ESTE ARCHIVO NO">Remisión</td>
                                         ...
                                         <tr>                                            
                                            <td data-nota="ESTE ARCHIVO NO">Certificado</td>
                                            <td align="center">
                                                <input id="chkAcs_RecDocCertificadoEnt" type="checkbox" class="chb" />
                                            </td>
                                            <td>
                                                <input id="tbAcs_RecDocCertiicadoEntCop" type="text" class="form-control" />
                                            </td>
                                            <td align="center">
                        ...
                        <div class="tab-pane" id="tabCondicionesPago">                    
                            ...
                            <div class="panel-body">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td><input type="text" id="txtLimite" class="form-control" value="" /></td>
                                        <td>
                                            <select id="cmbCPBancoDeposita" class="form-control" >
                                                <option value="0">-- Seleccione --</option>                                                
                                            </select>
                                        </td>
                                        <td><input type="text" id="txtCPNumCuenta" class="form-control" value="" /></td>
                                        <td><input type="text" id="txtCPRefTecleada" class="form-control" value="" /></td>
                                    </tr>
                                </table>
                                <!-- 
                                    ESTA PARTE NO 
                            ...
                            <table style="width:100%;">
                                ...
                                <td style="vertical-align: text-bottom;">
                                    ...
                                    <table style="width:500px;" data-rnd="465467878">                                        
                                    <tr>
                                        <td>Dirección</td>
                                        <td><input type="text" id="txtCPDiasPagoDireccion" class="form-control" value="" disabled/></td>
                                    </tr>
                                    <tr>                                        
                                        <td>Colonia</td>
                                        <td><input type="text" id="txtCPColonia" class="form-control" value="" disabled/></td>                                        
                                    </tr>
                                    <tr>
                                        <td>Municipio</td>
                                        <td><input type="text" id="txtCPMunicipio" class="form-control" value="" disabled/></td>
                                    </tr>
                                    <tr>
                                        <td>Estado</td>                                        
                                        <td>
                                            <table>
                                                <tr>
                                                    <td style="width:150px;">
                                                        <input type="text" id="txtCPEstado" class="form-control" value="" />
                                                    </td>                                        
                                                    <td>CP</td>
                                                    <td>
                                                    <input type="text" id="txtCPCP" class="form-control" value="" style="width:70px;" />
                                                    </td>
                                                </tr>
                                            </table>                                            
                                        </td>
                                    ...
                                    <tr>                                                                            
                                        <td>Ciudad</td>
                                        <td><input type="text" id="txtCPCiudad" class="form-control" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td>Teléfonos</td>
                                        <td><input type="text" id="txtCPTelefonos" class="form-control" value="" /></td>
                                    </tr>
                                   </table>
                                </td>
                            ...
                            <div class="panel-body">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">                                                                                             
                                            ...
                                            <table style="width:100%;">
                                                <tr>                                        
                                                    <td>
                                                        <input type="checkbox" id="chkRevFolio"  class="form-control chb" value="" disabled />
                                                    </td>
                                                    <td>Folio</td>
                                                    <td>
                                                        <input type="checkbox" id="chkRevRntrada"  class="form-control chb" value="" disabled />
                                                    </td>
                                                    <td>Entrada de almacén</td>
                                                    <td>
                                                        <input type="checkbox" id="chkRevOrden"  class="form-control chb" value="" disabled />
                                                    </td>
                                                    <td>Orden de compra</td>
                                                </tr><tr>                                                                                
                                                    <td>
                                                        <input type="checkbox" id="chkRevReporte"  class="form-control chb" value="" disabled />
                                                    </td>
                                                    <td>Reporte de consumo</td>                                    
                                                    <td>
                                                        <input type="checkbox" id="chkRevCopia"  class="form-control chb" value="" disabled />
                                                    </td>
                                    ...
                                    <tr>
                                        <td>Otro</td>
                                        <td colspan="5">
                                            <input type="text" id="tbRevFac_Otro"  class="form-control" value="" disabled />
                                        </td>                                                                                
                                    </tr>
                            ...
                            <div class="panel-body">
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td style="width:150px;">Días de pago</td>                                            
                                        <td>
                                            <table style="width:100%">
                                                <tr>
                                                    <td>L</td>
                                ...
                                <div id="divDER_EspecsAdic2" style="display:none;">
                                    ...
                                    <tr>        
                                        <td>Factura KEY</td>
                                        <td align="center">                                                                                                    
                                            <input id="chbACS_chk62DocFactKeyEnt" type="checkbox" class="chb" />
                                        </td>                                        
                                        <td>
                                            <input id="tbACS_txt62DocFactKeyEntCop" type="text" class="form-control" />
                                        </td>
                                        <td align="center">
                                            <input id="chbACS_chk62DocFactKeyRec" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocFactKeyRecCop" type="text" class="form-control" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Orden de compra/release</td>
                                        <td align="center">                                                   
                                            <input id="chbACS_chk62DocOrdCompraEnt" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocOrdCompraEntCop" type="text" class="form-control" />
                                        </td>
                                        <td align="center">
                                            <input id="chbACS_chk62DocOrdCompraRec" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocOrdCompraRecCop" type="text" class="form-control" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Orden de reposición</td>
                                        <td align="center">                                                   
                                            <input id="chbACS_chk62DocOrdReposEnt" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocOrdReposEntCop" type="text" class="form-control" />
                                        </td>
                                        <td align="center">
                                            <input id="chbACS_chk62DocOrdReposRec" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocOrdReposRecCop" type="text" class="form-control" />
                                         </td>
                                    </tr>
                                    <tr>
                                        <td>Copia de pedido</td>
                                        <td align="center">
                                            <input id="chbACS_chk62DocCopPedidoEnt" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocCopPedidoEntCop" type="text" class="form-control" />
                                        </td>
                                        <td align="center">
                                            <input id="chbACS_chk62DocCopPedidoRec" type="checkbox" class="chb" />
                                        </td>
                                        <td>
                                            <input id="tbACS_txt62DocCopPedidoRecCop" type="text" class="form-control" />
                                        </td>                                        
                                    </tr>
                                    <tr>
                                        <td>Remisión</td>
                        ...
                        <div class="tab-pane" id="tabServicioValor">                    
                            ...
                            <div class="panel-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!--input type="text" class="form-control" id="tbVis_Frecuencia" /-->
                                    ...
                                    <tr id="trReqServTec" style="display:none;">
                                        <td>                                            
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <table class="mt5">
                                                <tr>
                                                    <td><input type="checkbox" id="chb_ST_Relleno" class="form-control chb" value=""/></td>
                                                    <td>Servicio de Relleno</td>                                                    
                                                    <td><input type="checkbox" id="Chb_ST_Mantenimiento" class="form-control chb" value=""/></td>                                                    
                    ...
                    <div class="col-md-12 pull-right">
                        ...
                        <tr>
                            <td>
                                ...
                                <button id="btnOrdenCancelar" class="btn btn-default">
                                Cancelar
                                </button>
                            </td>
                            <td>
                                <button id="btnOrdenGuardar" class="btn btn-primary">
                                Guardar
                                </button>
                            </td>
                            <td>
...
<div class="modal fade" id="dvDialogoInicioSesion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <script type="text/javascript">
        document.title = 'Control de Ordenes';
        var _ApplicationUrl = '<%=ApplicationUrl %>';
    </script>

    <script src="<%=Page.ResolveUrl("~/js/Login.js")%>"></script>    
    <script src="<%=Page.ResolveUrl("~/js/Cliente_ajax.js")%>"></script>    
    <script src="<%=Page.ResolveUrl("~/js/Paginacion.js")%>"></script>    
    <!--script src="<%=Page.ResolveUrl("~/js/Acys/Acys2Cliente.js")%>"></script-->

    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_config.js")%>"></script>        
    <script src="<%=Page.ResolveUrl("~/js/Acys/tools.js")%>"></script>    
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_excel.js")%>"></script>        
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_Orden_Ajax.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_OrdenFunc.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_OrdenMain.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_Orden_Load.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_Orden_Save.js")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/Acys/Acys2_Ordenindex.js")%>"></script>

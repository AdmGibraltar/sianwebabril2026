    ...
    public partial class Ventana_Equivalencias : System.Web.UI.Page
    {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        for (int x = 0; x < RadGrid1.Items.Count; x++)
                        {
                            ...
                            cn_catproducto.ConsultaProducto(ref pr, Sesion.Emp_Cnx, Sesion.Id_Emp, Sesion.Id_Cd_Ver, id_Prd,1);
        ...
        protected void txtId_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    cnProducto.ConsultaProducto(ref prd, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, id_prd,1);
                }
                catch (Exception ex)
                {
        ...
        protected void rtb1_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            try
            {
                ...
                long Id_Prd_Original = Convert.ToInt32(Request.QueryString["Id_Prd"]);
                long Id_Prd = 0;
                int Cantidad = 0;
                double precio = 0;
                string Acs_Doc = "";

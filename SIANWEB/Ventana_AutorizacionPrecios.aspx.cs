...
namespace SIANWEB
{
    public partial class Ventana_AutorizacionPrecios : System.Web.UI.Page
    {
        ...
        {
            get { return (List<AlertaAutorizacion>)Session["lAurizacionPrecios" + Session.SessionID + uniqueKey]; }
            set { Session["lAurizacionPrecios" + Session.SessionID + uniqueKey] = value; }
        }
        ...
        {
            set { Session["Id_ConvDet_AREM" + Session.SessionID + uniqueKey] = value; }
            get { int? st = (int?)Session["Id_ConvDet_AREM" + Session.SessionID + uniqueKey]; return st == null ? -1 : (int)st; }
        }
                ...
                switch (tipoAutorizacion.Value)
                   {
                    ...
                    case "4":
                        ...
                        Session["Respuesta" + Session.SessionID + uniqueKey] = true;
                        string funcion;
        ...
        private void Inicializar()
        {
            try
            {
                ...
                ListDet = (List<AlertaAutorizacion>)Session["lAurizacionPrecios" + Session.SessionID + uniqueKey];
                ...
                if (ListDet != null)
                {
                        ...
                        if (ListDet[0].TipoAutorizacion.ToString() == "1")
                    {
                        ...
                        EstadisticaRentabilidad er = (EstadisticaRentabilidad)Session["CalculoUafir" + Session.SessionID + uniqueKey];
        ...
        public List<AlertaAutorizacion> getList()
        {
            try
            {
                ...
                List<AlertaAutorizacion> lAurizacionPrecios = (List<AlertaAutorizacion>)Session["lAurizacionPrecios" + Session.SessionID + uniqueKey];
        ...
        private void Guardar(Int64 id_prd)
        {
            ...
            Session["lAurizacionPrecios" + Session.SessionID + uniqueKey] = ListDet;
        ...
        protected void rgBitacora_UpdateCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                Session["Id_prd" + Session.SessionID + uniqueKey] = Id_Prd2;
                Session["Justificacion" + Session.SessionID + uniqueKey] = comentarios;
        ...
        protected void rgDetalles_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.CommandName == "enviar")
                {
                    ...
                    {
                        estrentabilidad = (EstadisticaRentabilidad)Session["CalculoUafir" + Session.SessionID + uniqueKey];

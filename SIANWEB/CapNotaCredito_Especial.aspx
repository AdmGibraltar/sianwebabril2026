<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage02.Master" AutoEventWireup="true"
    CodeBehind="CapNotaCredito_Especial.aspx.cs" Inherits="SIANWEB.CapNotaCredito_Especial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            var lblNcr_CantidadClientId = '';
            var txtNcr_CantidadClientId = '';
            ...
            var lblVal_txtNcr_PrecioClientId = '';
            var txtNcr_PrecioClientId = '';
            ...
            function ValidaFormEdit(accion) {
                ...
                var lblNcr_Cantidad = document.getElementById(lblNcr_CantidadClientId);
                var txtNcr_Cantidad = $find(txtNcr_CantidadClientId);
                ...
                var lblVal_txtNcr_Precio = document.getElementById(lblVal_txtNcr_PrecioClientId);
                var txtNcr_Precio = $find(txtNcr_PrecioClientId);

                //Limpiar contenedores de mensaje de validación
                lblNcr_Cantidad.innerHTML = '';
                ...
                lblVal_txtNcr_Precio.innerHTML = '';
                ...
                switch (button.get_value()) {
                    case 'save':
                        ...
                        if (montoTotalFacturaEspecial != montoTotalFacturaOriginal) {
                            var alertMontoDif = radalert('El importe de la nota de crédito especial no cuadra con el importe de la nota de crédito original', 330, 150, tituloMensajes);
                            continuarAccion = false;
                        }
                        break;
                }
            ...
            //--------------------------------------------------------------------------------------------------
            function rgNotaCreditoEspecialDet_ClientRowDblClick(sender, eventArgs) {
    ...
    <div runat="server" id="divPrincipal">
        ...
        <div id="formularioTotales" runat="server" class="formulario">
                ...
                <tr>
                    <td>
                        ...
                        <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="320px" ResizeMode="AdjacentPane"
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Height="320px" BorderStyle="None" OnClientResized="onResize">
                                <%-- Height="320px" --%>
                                <telerik:RadGrid ID="rgNotaCreditoEspecialDet" runat="server" GridLines="None" AllowPaging="false"
                                    AutoGenerateColumns="False" OnNeedDataSource="rgNotaCreditoEspecialDet_NeedDataSource"
                                    OnInsertCommand="rgNotaCreditoEspecialDet_InsertCommand" OnUpdateCommand="rgNotaCreditoEspecialDet_UpdateCommand"
                                    OnDeleteCommand="rgNotaCreditoEspecialDet_DeleteCommand" OnItemDataBound="rgNotaCreditoEspecialDet_ItemDataBound"
                                    OnItemCommand="rgNotaCreditoEspecialDet_ItemCommand" OnPageIndexChanged="rgNotaCreditoEspecialDet_PageIndexChanged">
                                    <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Ncr,Id_NcrDet,Id_Prd"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Descripción" DataField="Prd_DescripcionEspecial"
                                                UniqueName="Prd_DescripcionEspecial">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Cantid. ord." DataField="Ncr_Cant" UniqueName="Ncr_Cant"
                                                Display="false">
                                                <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOrd_Cantidad" runat="server" Text='<%# Eval("Ncr_Cant") %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox ID="txtNcr_Cantidad" runat="server" Width="50px" MaxLength="9"
                                                        Text='<%# Eval("Ncr_Cant") %>'>
                                                        <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                    </telerik:RadNumericTextBox>
                                                    <asp:Label ID="lblVal_txtNcr_Cantidad" runat="server" ForeColor="#FF0000"></asp:Label>
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <telerik:GridTemplateColumn DataField="Ncr_Precio" HeaderText="Precio" UniqueName="Ncr_Precio"
                                                Display="false">
                                                <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNcr_Precio" runat="server" Text='<%# Eval("Ncr_Precio") %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox ID="txtNcr_Precio" runat="server" Width="50px" MaxLength="9"
                                                        MinValue="0" Text='<%# Eval("Ncr_Precio") %>'>
                                                        <NumberFormat DecimalDigits="2" GroupSeparator="" />
                                                    </telerik:RadNumericTextBox>
                                                    <asp:Label ID="lblVal_txtNcr_Precio" runat="server" ForeColor="#FF0000"></asp:Label>
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <telerik:GridTemplateColumn DataField="Ncr_Importe" HeaderText="Importe" UniqueName="Ncr_Importe">
                                                ...
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNcr_Importe" runat="server" Text='<%# Bind("Ncr_Importe", "{0:N2}") %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblNcr_ImporteEdit" runat="server" Text='<%# Bind("Ncr_Importe", "{0:N2}") %>'
                                                        Visible="false" />

    ...
    public partial class CapPedido : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (rdBox.Value.HasValue)
                {
                    ...
                    else
                    {
                        ...
                        prd.Id_Prd = Convert.ToInt64(rdBox.Value);
                        ...
                        try
                        {
                            ...
                            catproducto.ConsultaProducto(ref prd, Sesion.Emp_Cnx, Sesion.Id_Emp, Sesion.Id_Cd_Ver, prd.Id_Prd, 2);
                        }
                        catch (Exception ex)
                        {
        ...
        private void CargarTerritorios()
        {
            try
            {
                ...
                if (cmbTerritorio.Items.Count > 1)
                {
                    ...
                    cmbTerritorio.SelectedValue = cmbTerritorio.Items[1].Value;
                ...
                else
                {
                    if (Request.QueryString["id"] != "-1")
                    {
                        ...
                        if (cmbTerritorio.Items.Count > 1)
                        {
                            ...
                            txtTerritorio.Text = cmbTerritorio.Items[0].Value;
                            CargarRik();
                        }
                    }
                    else
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int x = 0; x < dt.Rows.Count; x++)
                    {
                        ...
                        conv.Id_Cte = Convert.ToInt32(txtNumCliente.Value.HasValue ? txtNumCliente.Value.Value : -1);
                    ...
                    if (Productos.Count > 0 && lconveniosdet.Count > 0)
                    {
                        ...
                        Session["Id_FacPrec" + Session.SessionID] = txtPedidodel.Text;
        ...
        private void cargarPedido()
        {
            try
            {
                ...
                {
                    long Id_Prd = Int64.Parse(dt2.Rows[x]["Id_Prd"].ToString());
        ...
        private void PerformInsert(GridCommandEventArgs e)
        {
            try
            {
                ...
                Id_prd = Convert.ToInt64(((RadNumericTextBox)gi.FindControl("txtProd")).Value);

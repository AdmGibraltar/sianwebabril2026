...
namespace SIANWEB
{
    public partial class ProAdminCapPedido_VentInst : System.Web.UI.Page
    {
        ...
        public bool _PermisoGuardar = true;
        public bool _PermisoModificar = true;
        public bool _PermisoEliminar = true;
        public bool _PermisoImprimir = true;
        ...
        protected void CargarDatosOC()
        {
            ...
            Int32.TryParse(txtCteIni.Text, out cteIni);
            Int32.TryParse(txtCteFin.Text, out cteFin);
            Int32.TryParse(txtTerIni.Text, out terIni);
            Int32.TryParse(txtTerFin.Text, out terFin);
            Int32.TryParse(TxtAnioIni.Text, out anioIni);
            Int32.TryParse(TxtAnioFin.Text, out anioFin);
            List<catcnac_PedidosOc> lista = new List<catcnac_PedidosOc>();
            CN_CatCNac_OrdenCompra cn_oc = new CN_CatCNac_OrdenCompra();
            cn_oc.ConsultarPedidosOC(cteIni, cteFin, terIni, terFin, anioIni, anioFin, txtNombre.Text, this.CmbEstatus.SelectedValue, ref lista, session.Emp_Cnx);
        ...
        //AbrirVentana_ProPedido_OC

        protected void rgDatosOC_ItemCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                try
                {
                    ...
                    if (e.Item == null) return;
                    item = e.Item.ItemIndex;
                    string Estatus = this.rgDatosOC.Items[item]["Estatus"].Text;
        ...
        private void CaptarInternet(ref GridCommandEventArgs e, GridItem gi)
        {
            try
            {
                ...
                else
                {
                    ...
                    //" + rg1.Items[item]["Acs_Anio"].Text + ", '" + rg1.Items[item]["Acs_Semana"].Text + "')");
                    RAM1.ResponseScripts.Add("return AbrirVentana_ProPedido_Internet('" + this.rgInternet.Items[item]["Num_Pedido"].Text + "', '" + _PermisoGuardar + "', '" + _PermisoModificar + "', '" + _PermisoEliminar + "', '" + _PermisoImprimir + "',2020, '1')");
                }
        ...
        private void CaptarOC(ref GridCommandEventArgs e, GridItem gi)
        {
            try
            {
                Int32 item = default(Int32);
                ...
                ////Edsg 09042015
                RAM1.ResponseScripts.Add("return AbrirVentana_ProPedido_OC('" + this.rgDatosOC.Items[item]["Num_Pedido"].Text + "', '" + _PermisoGuardar + "', '" + _PermisoModificar + "', '" + _PermisoEliminar + "', '" + _PermisoImprimir + "'," + "2000" + ", '" + "1" + "')");
        ...
        private void VerRem(ref GridCommandEventArgs e, GridItem gi)
        {
            try
            {
                Int32 item = default(Int32);
                ...
                ////Edsg 09042015
                RAM1.ResponseScripts.Add("return AbrirVentana_VerRemisiones_OC(" + this.rgDatosOC.Items[item]["Num_Pedido"].Text + ")");

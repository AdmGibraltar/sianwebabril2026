...
AutoEventWireup="true" CodeBehind="Rep_InvAnalisisInventario.aspx.cs" Inherits="SIANWEB.Rep_InvAnalisisInventario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RblTipo">
                <UpdatedControls>
       ...
       <telerik:AjaxSetting AjaxControlID="cmbDias">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal" LoadingPanelID="RadAjaxLoadingPanel1"
                        UpdatePanelHeight="" />
                </UpdatedControls>
            ...
            <telerik:AjaxSetting AjaxControlID="RblOrdenado">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal" 
                        LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td width="310">
                                <asp:RadioButtonList runat= "Server" ID="RblTipoRep" RepeatDirection="Vertical" OnSelectedIndexChanged="RblTipoRep_SelectedIndexChanged" AutoPostBack="True">
                         ...
                         <tr>
                            <td>
                                <asp:Label ID="lbldias" Text="A partir (Días)" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                             <td>
                                &nbsp;
                            ...
                            <td width="310">
                                <telerik:RadComboBox ID="cmbDias" runat="server" Width="250px">
                                    <Items>
                                        <telerik:RadComboBoxItem runat="server" Text="-- Seleccionar --" Value="-1"   />
                                        <telerik:RadComboBoxItem runat="server" Text="Todos" Value="0"   />
                                        <telerik:RadComboBoxItem runat="server" Text=" 0 – 29 días (desabasto)" Value="1"   />
                                        <telerik:RadComboBoxItem runat="server" Text="30 – 59 días (inventario ideal)" Value="2"   />
                                        <telerik:RadComboBoxItem runat="server" Text="60 días en adelante (sobre inventario)" Value="3"   />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                    ...
                    <tr>
                            <td>
                               <asp:Label ID="Label1" Text="Tipo reporte" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                             <td>
                                &nbsp;
                            ...
                            <td width="310">
                                <asp:RadioButtonList runat= "Server" ID="RblTipo" RepeatDirection="Vertical" OnSelectedIndexChanged="RblTipo_SelectedIndexChanged" AutoPostBack="True">
                         ...
                         <tr>
                            <td>
                               <asp:Label ID="Label2" Text="Ordenado por" runat="server">
                                </asp:Label>&nbsp;
                            </td>
                             <td>
                                &nbsp;
                            ...
                            <td width="310">
                                <asp:RadioButtonList runat= "Server" ID="RblOrdenado" RepeatDirection="Vertical" OnSelectedIndexChanged="RblOrdenado_SelectedIndexChanged" AutoPostBack="True">
                                <asp:ListItem runat="Server" Value ="1" Text ="Código de producto"  ></asp:ListItem>
                                <asp:ListItem runat="Server" Value ="2" Text ="Monto" Selected="True" ></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>

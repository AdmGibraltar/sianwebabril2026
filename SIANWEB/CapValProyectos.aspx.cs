...
namespace SIANWEB
{
    public partial class CapValProyectos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                { //obtener valores desde la URL
                    ...
                    lblCetes.Visible = false;
                    txtCetes.Visible = false;
                    txtFecha.Focus();
            ...
            try
            {
                ...
                switch (btn.CommandName)
                {
                    ...
                    case "excel":
                        ...
                        System.IO.StreamWriter sw = new System.IO.StreamWriter(Server.MapPath("Reportes") + "\\Vp.xls");
                        ...
                        sw.Close();
                        Response.Redirect("Reportes/Vp.xls");
                        break;
                }
            }
            catch (Exception ex)
        ...
        protected void txtGastosServirCliente_TextChanged(object sender, EventArgs e)
        {
            if (txtGastosServirCliente.Value != 10 && txtGastosServirCliente.Value != 20)
            {
                Alerta("Solo se permiten Valores 10 Gerencial o 20 RIK/RCK");
                txtGastosServirCliente.Value = 20;
            }
        }
        ...
        private void LlenarParametros(int? Id_Vap)
        {
            try
            {
                ...
                txtInversionactivosfijos.ReadOnly = true;

                txtFinanciamientoproveedores.ReadOnly = true;
                txtCostodecapital.ReadOnly = true;
                ...
                if (sesion.Id_TU == 3 || sesion.Id_TU == 2)
                { txtFleteLocales.ReadOnly = true; }
                else { txtFleteLocales.ReadOnly = false; }
                ...
                txtCetes.ReadOnly = true;
                txtInventarioConsignacion.ReadOnly = true;
                ...
                if (Id_Vap == null)
                {
                    ...
                    txtInventarioConsignacion.DbValue = 0;
                    ...
                    lblInventarioConsignacion.DbValue = 0;
                    txtInventarioConsignacion.DbValue = 0;

                    lblGastosVarAplTerr.DbValue = 0;
                    txtGastosVarAplTerr.DbValue = 0;

                    lblFletesPagadosalCliente.DbValue = 0;
                    txtFletesPagadosalCliente.DbValue = 0;
                }
                else
                {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtFletesPagadosalCliente != 0)
                        {
                            txtFletesPagadosalCliente.DbValue = vpactuales.txtFletesPagadosalCliente;
                        }
                        if (vpactuales.txtGastosVarAplTerr != 0)
                        {
                            txtGastosVarAplTerr.DbValue = vpactuales.txtGastosVarAplTerr;
                        }
                    }

                    if (verificador != 0)
                    {
                        if (vpactuales.txtInventario != 0)
                        {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtGastosServirCliente != 0)
                        {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtFleteLocales != 0)
                        {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtFinanciamientoproveedores != 0)
                        {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtInversionactivosfijos != 0)
                        {
                    ...
                    if (verificador != 0)
                    {
                        if (vpactuales.txtCostodecapital != 0)
                        {
        ...
        private string GeneraReporteVP_PorSP()
        {
            ...
            double.TryParse(txtInventarioConsignacion.Text, out InversionActivosFijos_);
            ...
            Resultado = cnCRMVO.ObtenerPorValuacion_Detallado(1, 100, ref Verificador, Sesion,
            ...
            {
                CadenaHtml += "<tr>";
                CadenaHtml += "<td colspan=\"4\" align=\"center\" style=\"font-family: Verdana; font-size: 12pt;background-color: #A9BCF5\"><b>" + e.Titulo + "</b></td>";
                CadenaHtml += "<td colspan=\"5\" align=\"center\" style=\"font-family: Verdana; font-size: 12pt;background-color: #A9BCF5\"><b>" + e.Monto + "</b></td>";
                CadenaHtml += "</tr>";
            }
            CadenaHtml += "</table>";
        ...
        private string GeneraReporteVP()
        {
            ...
            double Cte_GasVarT = Convert.ToDouble(txtGastosVarAplTerr.Text);
            double Cte_FletePaga = Convert.ToDouble(txtFletesPagadosalCliente.Text);
            ...
            CadenaHtml = CadenaHtml + "                <td align=\"right\" style=\"font-family: Verdana; font-size: 10pt;\">$" + String.Format("{0:N}", Cte_GasVarT) + "</td>";
            CadenaHtml = CadenaHtml + "                <td align=\"right\" style=\"font-family: Verdana; font-size: 10pt;\">&nbsp;</td>";
            CadenaHtml = CadenaHtml + "                <td>&nbsp;</td>";
            CadenaHtml = CadenaHtml + "            </tr>";
            CadenaHtml = CadenaHtml + "";
        ...
        private void Guardar()
        {
            try
            {
                ...
                vpactual.txtGastosVarAplTerr = Convert.ToDouble(txtGastosVarAplTerr.Text);
                vpactual.txtFletesPagadosalCliente = Convert.ToDouble(txtFletesPagadosalCliente.Text);
                ...
                vp.txtGastosVarAplTerr = txtGastosVarAplTerr.Value.Value;
                vp.txtFletesPagadosalCliente = txtFletesPagadosalCliente.Value.Value;
                ...
                #region validar alertas de precios 
                //JFCV marzo 2021 
                //validar si se capturaron algunos productos que reuieran autorización de precios 
                ...
                #endregion validar alertas de precios 
                int verificador = 0;
                ...
                if (GLOBAL_CRM_ValidaPrecioMinimoRik == 1)
                {
                    ...
                    if (valuacionProyecto.ListaProductosValuacionProyecto.Count > 0)
                    {
                        ...
                        foreach (ValuacionProyectoDetalle ValuacionProyectoDetalle in valuacionProyecto.ListaProductosValuacionProyecto)
                        {
                            ...
                            //for (int x = 0; x < valuacionProyecto.ListaProductosValuacionProyectoCapacity.Count; x++)
                            //{
                            ...
                            //conv.Id_Cte = Convert.ToInt32(txtCliente.Text.Trim() != "" ? txtCliente.Text.Trim() : "-1");
                            //conv.Id_Prd = Convert.ToInt64(ValuacionProyectoDetalle.Id_Prd);
                            ...
                            if (Convert.ToInt64(ValuacionProyectoDetalle.Id_Prd) <= 999999999999)
                            {
                                ...
                                alertaaut.Id_Cte = Convert.ToInt32(txtCliente.Text.Trim() != "" ? txtCliente.Text.Trim() : "-1");
                                alertaaut.Id_Prd = Convert.ToInt64(ValuacionProyectoDetalle.Id_Prd);
                                alertaaut.IdRepresentante = sesion.Id_Rik;
                                alertaaut.Id_Ter = 30302011; //JFCV  ver como obtener el territorio o si no entonces validarlo
                                alertaaut.Cte_NomComercial = txtClienteNombre.Text;
                                double Preciodefactura = Convert.ToDouble(ValuacionProyectoDetalle.Vap_Precio);
                                ...
                                if (alertaautdet != null && alertaautdet.Precio_MinimoRik > 0)
                                {
                                    ...
                                    if (Math.Round(Preciodefactura, 3) < alertaautdet.PrecioObjetivo)
                                    {
                                        ...
                                        pasoalertaautdet.Id_Cte = Convert.ToInt32(txtCliente.Text.Trim() != "" ? txtCliente.Text.Trim() : "-1");
                                        pasoalertaautdet.IdRepresentante = sesion.Id_Rik;
                                        pasoalertaautdet.Id_Ter = 30302011; //JFCV todo validar poner -1 en territorio  Convert.ToInt32(ddlTerritorioNom.Value);
                                        ...
                                        pasoalertaautdet.PrecioLista = alertaautdet.PrecioLista;
                                        pasoalertaautdet.Cantidad = Convert.ToInt32(ValuacionProyectoDetalle.Vap_Cantidad);
                                        ...
                                        pasoalertaautdet.Prd_Descripcion = ValuacionProyectoDetalle.Producto.Prd_Descripcion;
                                        pasoalertaautdet.Cte_NomComercial = txtClienteNombre.Text;
                                        pasoalertaautdet.TipoAutorizacion = 1; // Valuación
                        ...
                        //JFCV 26 enero 2021 FIn Validar si tiene precios inferiores a los precios minimos
                    }
        ...
        private void EnviaEmail(int solicitud)
        {
            try
            {
                string sSianWeb_ServerIp = ConfigurationManager.AppSettings["SianWeb_ServerIp"].ToString();
                ...
                cuerpo_correo.Append("<a href='" + sSianWeb_ServerIp + "/CapValProyectos_Autorizacion.aspx?Id1=" + solicitud.ToString() + "&id2=" + session.Id_Emp + "&id3=" + session.Id_Cd_Ver + "'>Solicitud de autorización de valuación de proyectos</a></font></center>");

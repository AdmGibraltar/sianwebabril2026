                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td><asp:Label ID="Label10" runat="server" Text="Picking"></asp:Label>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="cmbpicking" runat="server">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                                        ...
                                        <MasterTableView ClientDataKeyNames="Id_Ped, Cte_Nom">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Id_Ped" HeaderText="Folio" UniqueName="Id_Ped">
                                                 ...
                                                 <telerik:GridBoundColumn DataField="Ped_FechaEntrega" HeaderText="Fecha Compromiso de Entrega" UniqueName="Ped_FechaEntrega"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Facturar" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgFacturar" runat="server" ImageUrl="~/Imagenes/blank.png"
                                                            CssClass="aceptar" ToolTip="Facturar" CommandName="Facturar" Visible='<%# DataBinder.Eval(Container.DataItem, "Ped_Asign").ToString() != "N" && DataBinder.Eval(Container.DataItem, "ValidaPicking").ToString() == "S"? true : false  %>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Width="70px"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn HeaderText="Remisionar" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgRemisionar" runat="server" ImageUrl="~/Imagenes/blank.png"
                                                            CssClass="aceptar" ToolTip="Remisionar" CommandName="Remisionar" Visible='<%# DataBinder.Eval(Container.DataItem, "Ped_Asign").ToString() != "N" && DataBinder.Eval(Container.DataItem, "ValidaPicking").ToString() == "S" ? true : false  %>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Width="70px"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                </telerik:GridTemplateColumn>
       ...
       // Broad cast that your're opening a page.
        ...
        var onLocalStorageEvent = function(e){
            ...
            if(e.key == "page_available"){
                alert("No se puede tener abierta más de una sesion de Facturación de Venta Instalada o tener abierta la opcion de Devolución de Remisiones o Facturas");
        ...
        window.addEventListener('storage', onLocalStorageEvent, false);
            ...
            function ConfirmaRem() {
                radconfirm("¿Desea imprimir la Remisión?", confirmCallBackFnVIRem, 400, 160)
                return false;
            }
            ...
            function AbrirVentana_Remision(Id_Rem, PermisoGuardar, strpicking) {
                //debugger;
                var oWnd = radopen("CapRemisiones.aspx?tdm=3&PedRem=" + Id_Rem + "&PermisoGuardar=" + PermisoGuardar
                    + "&strpicking=" + strpicking
                    , "AbrirVentana_Remision");
                oWnd.center();
                oWnd.Maximize();
            }
            ...
            function AbrirVentana_Factura(Id_Emp, Id_Cd, Id_Fac, permisoGuardar, permisoModificar, permisoEliminar, permisoImprimir, strpicking) {
                //debugger;

    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function LimpiarControlesTipoMoneda() {
                ...
                var txtCodigo = $find('<%= txtCodigo.ClientID %>');
                    ...
                    <table>
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td colspan="4">
                                <telerik:RadTextBox onpaste="return false" ID="txtCodigo" runat="server" Width="100px"
                                    MaxLength="3">
                                    <ClientEvents OnKeyPress="SoloAlfanumerico" />
                                </telerik:RadTextBox>
                        ...
                        <MasterTableView DataKeyNames="Id_Mon" DataMember="listTipoMoneda">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Tipo cambio" UniqueName="Mon_TipCambio" DataField="Mon_TipCambio"
                                 ...
                                 <telerik:GridBoundColumn HeaderText="Código" UniqueName="Mon_Codigo" DataField="Mon_Codigo"
                                    Visible="true">
                                </telerik:GridBoundColumn>

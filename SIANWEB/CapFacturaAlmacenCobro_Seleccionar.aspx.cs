...
{ 
    ...
    {
        private string  strIdPag; 
        private List<FacturaAlmacenCobroDet> ListaFacturaRevisionCobro
        {
            get { return (List<FacturaAlmacenCobroDet>)Session[Session.SessionID + "ListaFacturaAlmacenCobroDet"+ strIdPag]; }
            set { Session[Session.SessionID + "ListaFacturaAlmacenCobroDet"+ strIdPag] = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //CapFacturaAlmacenCobro capFacturaAlmacenCobro = new CapFacturaAlmacenCobro();
                //List<FacturaAlmacenCobroDet> ListaFacturaRevisionCobro = capFacturaAlmacenCobro.ListaFacturaAlmacenCobro;
                ...
                else
                {
                    ...
                    strIdPag = Request.Params["IdPag"].ToString();
                    if (doc != -1)
                    {

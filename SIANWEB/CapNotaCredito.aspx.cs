    ...
    public partial class CapNotaCredito : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if ((e.Item is GridEditableItem) && (e.Item.IsInEditMode))
                {
                    ...
                    if (updatebtn != null)
                    {
                        ...
                        {
                            if (Convert.ToInt64(ncd["Id_Prd"]) == Id_Prd)
                            {
        ...
        protected void rgNotaCreditoDet_InsertCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                notaCreditoDet.Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value.Value);
        ...
        protected void cmbProductoDet_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    cnProducto.ConsultaProducto(ref prd, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, Convert.ToInt64((sender as RadNumericTextBox).Value.HasValue ? (sender as RadNumericTextBox).Value : -1), 0);
                }
                catch (Exception ex)
                {
        ...
        protected void txtReferencia_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                txtCliente.Focus();
                if (txtCliente.Text != "" && txtMov.Value.ToString() != "2")
                {
                    cargarDatosCuentaNacional(txtCliente.Text);
                }
            }
            catch (Exception ex)
            {
        ...
        public void cargarDatosCuentaNacional(string idCliente)
        {
            bool FacturarCuentaNacional = false;
            Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
            ...
            RadTabStrip1.Tabs[3].Visible = FacturarCuentaNacional;
        }
        ...
        protected void chkDesgloceIva_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkDesgloceIva.Checked)
                {
                    ...
                    //CentroDistribucion cd = new CentroDistribucion();
                    //new CN_CatCentroDistribucion().ConsultarCentroDistribucion(ref cd, sesion.Id_Cd_Ver, sesion.Id_Emp, sesion.Emp_Cnx);
                    HD_IVAfacturacion.Value = IVAComprobante;
                }
                else
                {
                ...
                case "1": //factura
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                double saldoVAl = factura.Fac_Saldo ?? 0;
                                ...
                                else
                                {
                                    ...
                                    txtFolioFiscal.Text = factura.Fac_FolioFiscal;
                                    IVAComprobante = (factura.Fac_ImporteIva / factura.Fac_SubTotal * 100).Value.ToString("0.00");
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    txtFolioFiscal.Text = notaCargo.Nca_FolioFiscal;
                                    //consulta datos del ciente y sus territorios
        ...
        private void ConsultarDatosCliente2(string idCliente, bool modificar, int id_territorio, int? id_terr = 1)
        {
            ...
            {//Consultar clientes
                ...
                try
                {
                    ...
                    //cte.Id_Cte = Convert.ToInt32(txtCliente.Text.ToString());
                    //CN_CatCliente clsCatClientes = new CN_CatCliente();
                    //clsCatClientes.ConsultaClientes(ref cte, sesion.Emp_Cnx);


                    cmbNCUsoCFDI.SelectedIndex = cmbNCUsoCFDI.FindItemIndexByValue(cliente.Cte_NCUsoCFDI.ToString());
                    cmbNCUsoCFDI.Text = cmbNCUsoCFDI.FindItemByValue(cliente.Cte_NCUsoCFDI.ToString()).Text;
                    //cmbNCFormaPago.SelectedIndex = cmbNCFormaPago.FindItemIndexByValue(cliente.Cte_NCMetodoPago.ToString());
                    //cmbNCFormaPago.Text = cmbNCFormaPago.FindItemByValue(cliente.Cte_NCMetodoPago.ToString()).Text;

                    cmbNCFormaPago.SelectedIndex = cmbNCFormaPago.FindItemIndexByValue(cliente.Cte_NCFormaPago.ToString());
                    cmbNCFormaPago.Text = cmbNCFormaPago.FindItemByValue(cliente.Cte_NCFormaPago.ToString()).Text;

                    //cmbNCMetodoPago.SelectedIndex = cmbNCMetodoPago.FindItemIndexByValue(cliente.Cte_NCFormaPago.ToString());
                    //cmbNCMetodoPago.Text = cmbNCMetodoPago.FindItemByValue(cliente.Cte_NCFormaPago.ToString()).Text;

                    cmbNCMetodoPago.SelectedIndex = cmbNCMetodoPago.FindItemIndexByValue(cliente.Cte_NCMetodoPago.ToString());
                    cmbNCMetodoPago.Text = cmbNCMetodoPago.FindItemByValue(cliente.Cte_NCMetodoPago.ToString()).Text;

                    RadTipoRel.SelectedIndex = RadTipoRel.FindItemIndexByValue("01");
                    RadTipoRel.Text = RadTipoRel.FindItemByValue("01").Text;
                }
                catch
                {
                    ...
                    cmbNCMetodoPago.SelectedIndex = cmbNCMetodoPago.FindItemIndexByValue("-1");
                    cmbNCMetodoPago.Text = cmbNCMetodoPago.FindItemByValue("-1").Text;
                }
        ...
        private void LLenarFormNotaCredito(int Id_Emp, int Id_Cd, int Id_Ncr, string Id_NcrSerie)
        {
            ...
            new CN_CapNotaCredito().ConsultarNotaCredito(ref notaCredito, sesion.Emp_Cnx, ref listaNotaCreditoDet);
            new CN_CapNotaCredito().ConsultaNotaCreditoNacional(ref NotaCreditoNacional, sesion.Emp_Cnx);
            //Agregar Adendas
            List<AdendaDet> listCabT = new List<AdendaDet>();
            List<AdendaDet> listDetT = new List<AdendaDet>();
            ...
            cmbNCUsoCFDI.SelectedIndex = cmbNCUsoCFDI.FindItemIndexByValue(notaCredito.Ncr_UsoCFDI.ToString());
            cmbNCUsoCFDI.Text = cmbNCUsoCFDI.FindItemByValue(notaCredito.Ncr_UsoCFDI.ToString()).Text;
            cmbNCFormaPago.SelectedIndex = cmbNCFormaPago.FindItemIndexByValue(notaCredito.Ncr_FormaPago.ToString());
            cmbNCFormaPago.Text = cmbNCFormaPago.FindItemByValue(notaCredito.Ncr_FormaPago.ToString()).Text;
            cmbNCMetodoPago.SelectedIndex = cmbNCMetodoPago.FindItemIndexByValue(notaCredito.Ncr_MetodoPago.ToString());
            cmbNCMetodoPago.Text = cmbNCMetodoPago.FindItemByValue(notaCredito.Ncr_MetodoPago.ToString()).Text;
            RadTipoRel.SelectedIndex = RadTipoRel.FindItemIndexByValue(notaCredito.Ncr_TipoRelacion.ToString());
            RadTipoRel.Text = RadTipoRel.FindItemByValue(notaCredito.Ncr_TipoRelacion.ToString()).Text;
            ...
            if (int.Parse(cmbMovimientoTipo.SelectedValue) == 1)
            {
                bool encontrado = false;
                Factura factura = new Factura();
                factura.Id_Emp = sesion.Id_Emp;
                factura.Id_Cd = sesion.Id_Cd_Ver;
                factura.Id_Fac = Convert.ToInt32(this.txtReferencia.Text);
                factura.Id_FacSerie = this.cmbSerie.Text + this.txtReferencia.Text.ToString();
                new CN_CapFactura().ConsultaFacturaEncabezado(ref factura, sesion.Emp_Cnx, ref encontrado);
                txtFolioFiscal.Text = factura.Fac_FolioFiscal;
            }
            else
            {
                ...
                notacargo.Id_Emp = sesion.Id_Emp;
                notacargo.Id_Cd = sesion.Id_Cd_Ver;
                notacargo.Id_Nca = Convert.ToInt32(this.txtReferencia.Text);
                notacargo.Serie = cmbSerie.Text;
            ...
            if (NotaCreditoNacional != null)
            {
                ...
                txtClienteNacionalNombre.Text = NotaCreditoNacional.Cte_NomComercial;
                txtClienteNacional.Text = NotaCreditoNacional.Id_Cte.ToString();
                TxtClienteNacionalCalle.Text = NotaCreditoNacional.Fac_CteCalle;
                TxtClienteNacionalNoExterior.Text = NotaCreditoNacional.Fac_CteNumero;
                TxtClienteNacionalColonia.Text = NotaCreditoNacional.Fac_CteColonia;
                TxtClienteNacionalMunicipio.Text = NotaCreditoNacional.Fac_CteMunicipio;
                TxtClienteNacionalEstado.Text = NotaCreditoNacional.Fac_CteEstado;
                TxtClienteNacionalCp.Text = NotaCreditoNacional.Fac_CteCp;
                TxtClienteNacionalRfc.Text = NotaCreditoNacional.Fac_CteRfc;
                TxtClienteNacionalAdenda.Text = NotaCreditoNacional.Fac_CteAdeNombre;
        ...
        private NotaCredito LlenarObjetoNotaCredito()
        {
            ...
            notaCredito.Ncr_ReferenciaSerie = cmbSerie.Text;
            notaCredito.Ncr_UsoCFDI = cmbNCUsoCFDI.SelectedValue;
            notaCredito.Ncr_MetodoPago = cmbNCMetodoPago.SelectedValue;
            notaCredito.Ncr_FormaPago = cmbNCFormaPago.SelectedValue;
            notaCredito.Ncr_TipoRelacion = RadTipoRel.SelectedValue;
            return notaCredito;
        }
        private void Guardar()
        {
            try
            {
                ...
                { //ADENDA
                    ...
                    {
                        if (RadTabStrip1.Tabs[3].Visible)
                        {
                            ...
                            new CN_CapNotaCredito().InsertarNotaCredito(ref notaCredito, ref facturaNacional, sesion.Emp_Cnx, ref verificador, listAdendaCabecera, ListaProductosNotaCredito);
                        ...
                        else
                        {
                            ...
                            mensaje = "La Nota de credito se guardo correctamente en estatus IMPRESO";
                        }
                    }
                    else
                    {
                        if (RadTabStrip1.Tabs[4].Visible)
                        {
                            ...
                            new CN_CapNotaCredito().ModificarNotaCredito(ref notaCredito, ref facturaNacional, sesion.Emp_Cnx, ref verificador, listAdendaCabecera, ListaProductosNotaCredito);
        ...
        private void CargarTipoRelacion()
        {
            try
            {
                RadTipoRel.Items.Clear();
                DataTable Dt = new DataTable();
                Dt.Columns.Add("Descripcion");
                Dt.Columns.Add("Id");
                Dt.Rows.Add(new object[] { "-- Seleccionar --", "-1" });
                Dt.Rows.Add(new object[] { "Nota de crédito de los documentos relacionados", "01" });
                Dt.Rows.Add(new object[] { "Devolución de mercancía sobre facturas o traslados previos", "03" });
                RadTipoRel.DataSource = Dt;
                RadTipoRel.DataValueField = "Id";
                RadTipoRel.DataTextField = "Descripcion";
                RadTipoRel.DataBind();
            }
            catch (Exception ex)
            {
        ...
        //protected void ListaProductosNotaCredito_EliminarProducto(long id_Prd)
        //{
        //    List<NotaCreditoDet> lista = this.ListaProductosNotaCredito;

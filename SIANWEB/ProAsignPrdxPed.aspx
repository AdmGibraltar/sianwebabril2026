                        ...
                        <MasterTableView>
                            <Columns>
                             <telerik:GridBoundColumn DataField="Id_PedDet" HeaderText="Id_PedDet" UniqueName="Id_PedDet" Display="false">
                                        ...
                                        <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
                                            <script type="text/javascript">
                                                ...
                                                function Asig_OnBlur(sender, args) {
                                                    ...
                                                    var Picking = row.get_cell('Ped_Picking').innerText;
                                                    ...
                                                    if (sender.get_value() > DispOrd) {
                                                        ...
                                                        if ((Asignado < Picking) && (Picking > 0)) {
                                                                sender.set_value(Old);
                                                                Asignado = Old;
                                                                radalert('El Asignado no puede ser menor al Picking', 330, 150);
                                                            HF.value = 'false';
                                                        }
                                                        else {
                                                            HF.value = 'true';
                                ...
                                <telerik:GridBoundColumn DataField="Prd_Faltante" HeaderText="Falt" UniqueName="Prd_Faltante">
                                    <HeaderStyle Width="40px" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="Prd_Disponible" HeaderText="Disp" UniqueName="Prd_Disponible">
                                    <HeaderStyle Width="40px" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Ped_Picking" HeaderText="Pick" UniqueName="Ped_Picking">
                                    <HeaderStyle Width="40px" />
                                    <ItemStyle HorizontalAlign="Right" />
                                </telerik:GridBoundColumn>
                            </Columns>

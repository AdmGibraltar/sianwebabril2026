<%@ Page Title="Relación de facturas enviadas de Almacén a Cobranza" Language="C#"
    MasterPageFile="~/MasterPage/MasterPage02.master" AutoEventWireup="true" CodeBehind="CapFacturaAlmacenCobro.aspx.cs"
    Inherits="SIANWEB.CapFacturaAlmacenCobro" %> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            var cmbTipoClientID = '';
            //var lblVal_txtFac_DocClientID = '';
            var txtFac_DocClientID = '';
            var lblVal_cmbFac_EnviarAClientID = '';
            var cmbFac_EnviarAClientID = '';
            ...
            function ValidaFormEdit(accion) {
                ...
                //var lblVal_txtFac_Doc = document.getElementById(lblVal_txtFac_DocClientID);
                var txtFac_Doc = $find(txtFac_DocClientID);
                var lblVal_cmbFac_EnviarA = document.getElementById(lblVal_cmbFac_EnviarAClientID);
                var cmbFac_EnviarA = $find(cmbFac_EnviarAClientID);

                //Limpiar contenedores de mensaje de validación
                lblVal_cmbTipo.innerHTML = '';
                //lblVal_txtFac_Doc.innerHTML = '';
                lblVal_cmbFac_EnviarA.innerHTML = '';
                ...
                if (txtFac_Doc != null)
                    if (txtFac_Doc.get_textBoxValue() == '') {
                        //lblVal_txtFac_Doc.innerHTML = '*Requerido';
                        continuarAccion = false
                    }

                if (cmbFac_EnviarA != null)
                    if (cmbFac_EnviarA.get_value() == '-1') {
                        //lblVal_cmbFac_EnviarA.innerHTML = '*Requerido';
                        continuarAccion = false
                    }
            ...
            function CheckAllIncluir(sender) {
                //debugger;
                var grid = $find('<%=rgFacturaAlmacenCobroDet.ClientID %>');
            ...
            function actualizar_tabla(doc, sel) {
                ...
                const idPag = urlParams.get('IdPag');
                console.log(queryString);

                var urlArchivo = 'CapFacturaAlmacenCobro_Seleccionar.aspx';
                parametros = "doc=" + doc;
                parametros = parametros + "&sel=" + sel + "&idPag=" + idPag;
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RadToolBar1">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgFacturaAlmacenCobroDet" LoadingPanelID="RadAjaxLoadingPanel1" />
            ...
            <telerik:AjaxSetting AjaxControlID="rgFacturaAlmacenCobroDet">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgFacturaAlmacenCobroDet" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <td valign="top">
                <div id="formulario" runat="server">
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:Label ID="lblFecha" runat="server" Text="Documentos del el día"></asp:Label>
                            </td>
                            <td>
                            ...
                            <td style="width:382px; text-align:right">
                        ...
                        <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="300px" ResizeMode="AdjacentPane"
                            ...
                            <telerik:RadPane ID="RadPane1" runat="server" Height="300px" OnClientResized="onResize"
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <telerik:RadGrid ID="rgFacturaAlmacenCobroDet" runat="server" GridLines="None" AutoGenerateColumns="False"
                                                OnNeedDataSource="rgFacturaAlmacenCobroDet_NeedDataSource" OnInsertCommand="rgFacturaAlmacenCobroDet_InsertCommand"
                                                OnUpdateCommand="rgFacturaAlmacenCobroDet_UpdateCommand" OnDeleteCommand="rgFacturaAlmacenCobroDet_DeleteCommand"
                                                OnItemDataBound="rgFacturaAlmacenCobroDet_ItemDataBound" OnItemCommand="rgFacturaAlmacenCobroDet_ItemCommand"
                                                OnPageIndexChanged="rgFacturaAlmacenCobroDet_PageIndexChanged" PageSize="10"
                                                AllowPaging="True" DataMember="listaOrdCompraDet">
                                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="Id_Fac,Id_FacDet,Fac_Doc,Fac_Tipo, Fac_Confirmado, Fac_Seleccionado,Fac_EnviarA"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Doc." DataField="Fac_Doc" UniqueName="Fac_Doc">
                                                            <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFac_Doc" runat="server" Text='<%# Eval("Fac_Doc").ToString() %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <telerik:RadNumericTextBox ID="txtFac_Doc" runat="server" Width="65px" MaxLength="9"
                                                                    MinValue="1" AutoPostBack="true" OnTextChanged="txtFac_Doc_TextChanged" Text='<%# Eval("Fac_Doc") %>'>
                                                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                                    <ClientEvents OnKeyPress="handleClickEvent" />
                                                                </telerik:RadNumericTextBox>
                                                                <asp:Label ID="lblVal_txtFac_Doc" runat="server" ForeColor="#FF0000" Text='<%# Eval("Fac_Doc").ToString() %>'
                                                                    Visible="false"></asp:Label>
                                                            </EditItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                                        <telerik:GridTemplateColumn DataField="Fac_Fecha" HeaderText="Fecha" UniqueName="Fac_Fecha">
                                                            <HeaderStyle Width="80px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFac_Fecha" runat="server" Text='<%# Convert.ToDateTime(Eval("Fac_Fecha")).ToShortDateString() %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <telerik:RadDatePicker ID="txtFac_Fecha" runat="server" DbSelectedDate='<%# Eval("Fac_Fecha") %>'
                                                        ...
                                                        <telerik:GridTemplateColumn DataField="Fac_Importe" HeaderText="Saldo" UniqueName="Fac_Importe">
                                                            <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                            <ItemTemplate>
                                                                <telerik:RadNumericTextBox ID="txtFac_Importe" runat="server" Width="65px" MaxLength="9"
                                                                    MinValue="0" ReadOnly="true" BackColor="Transparent" BorderWidth="0" Text='<%# Eval("Fac_Importe") %>'>
                                                                    <NumberFormat DecimalDigits="2" GroupSeparator="" />
                                                                </telerik:RadNumericTextBox>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <telerik:RadNumericTextBox ID="txtFac_ImporteEdit" runat="server" Width="65px" MaxLength="9"
                                                                    MinValue="0" ReadOnly="true" BackColor="Transparent" BorderWidth="0" Text='<%# Eval("Fac_Importe") %>'>
                                                                    <NumberFormat DecimalDigits="2" GroupSeparator="" />
                                                                </telerik:RadNumericTextBox>
                                                            </EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Revisión" DataField="Cte_DiasRevision " UniqueName="Fva_DiaRev">
                                                            <HeaderStyle Width="80px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFva_DiaRev" runat="server" Text='<%# Eval("Cte_DiasRevision ") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:Label ID="lblVal_Fva_DiaRev" runat="server" Text='<%# Eval("Cte_DiasRevision ") %>' />
                                                            </EditItemTemplate>
                                                        </telerik:GridTemplateColumn>

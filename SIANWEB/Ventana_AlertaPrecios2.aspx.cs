...
namespace SIANWEB
{
    public partial class Ventana_AlertaPrecios2 : System.Web.UI.Page
    {
        #region Variables 
        ...
        protected void btnDescargarPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string WebURLtempPDFGastos = string.Concat(ConfigurationManager.AppSettings["WebURLCarpetaConvenios"].ToString(), "PoliticasGenerales.pdf");
        ...
        private void Inicializar()
        {
            try
            {
                ...
                //List<string> lConvPrecios = (List<string>)Session["lConvPrecios" + Session.SessionID];
                List<ConvenioDet> lConvPrecios = new List<ConvenioDet>();
                lConvPrecios = (List<ConvenioDet>)Session["lConvPrecios" + Session.SessionID];
        ...
        private void EnviarCorreo()
        {
            try
            {
                ...
                List<string> Productos = (List<string>)Session["ProdsConv" + Session.SessionID];
                List<string> lConvenios = (List<string>)Session["lConvPrecios" + Session.SessionID];
        ...
        public List<ConvenioDet> getList()
        {
            try
            {


                List<ConvenioDet> lConvPrecios = (List<ConvenioDet>)Session["lConvPrecios" + Session.SessionID];

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.Master"
    AutoEventWireup="true" CodeBehind="CapFacturaPedido.aspx.cs" Inherits="SIANWEB.CapFacturaPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function CloseWindow_FacturaPedido(mensaje) {
                //debugger;
                GetRadWindow_FacturaPedido().BrowserWindow.ActivarBanderaRebind_FacturaPedido();
               //debugger;
            ...
            function RefreshParentPage_FacturaPedido() {
                GetRadWindow_FacturaPedido().BrowserWindow.location.reload();
            }
        </script>

...
<asp:TextBox runat="server" ID="PanelId" CssClass="PanelId" Text="7"></asp:TextBox>
 ...
 <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1"
    ...
    <Tabs>
        ...
        <telerik:RadTab runat="server" Text="OC Centralizado" PageViewID="RadPageViewOrdenCompra" AccessKey="I">
        </telerik:RadTab>
...
<div id="Menu2" style="height:600px; overflow:scroll">
 <table>
    ...
    <telerik:RadPageView ID="RadPageViewOrdenCompra" runat="server">
     <div id="Menu3" style="height:600px; overflow:scroll">
        <table>
                        <tr>
                            <td>
                                <telerik:RadGrid ID="rgDatosOC" runat="server" AutoGenerateColumns="False" GridLines="None" 
                                     PageSize="100" AllowMultiRowSelection="true" OnItemCommand="rgDatosOC_ItemCommand">
                                    <MasterTableView NoMasterRecordsText="No se encontraron registros.">
                                        <Columns>

                                           <telerik:GridBoundColumn DataField="Id_OC" HeaderText="Núm OC Centralizada" UniqueName="Num_OC">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="Estatus" HeaderText="Estatus" UniqueName="Estatus" Display="false">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="Id" HeaderText="Núm Pedido" UniqueName="Num_Pedido" Display="false">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="FechaAlta" HeaderText="Fecha" UniqueName="FechaAlta">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>
                                          ...
                                          <telerik:GridBoundColumn DataField="Id_Cte" HeaderText="Num. Cliente" UniqueName="Id_Cte">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>


                                          <telerik:GridBoundColumn DataField="Cte_NomComercial" HeaderText="Nombre Cliente" UniqueName="Cte_Descripcion">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="200px" />
                                            </telerik:GridBoundColumn>

                                           <telerik:GridBoundColumn DataField="Id_Ter" HeaderText="Territorio" UniqueName="Id_Ter">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="VentaInstalada" HeaderText="Total" UniqueName="Total">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>
                                           ...
                                           <telerik:GridBoundColumn DataField="Nombre" HeaderText="Estatus" UniqueName="Nombre">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>


                                            <telerik:GridTemplateColumn HeaderText="Remisiones" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center" AllowFiltering="false" UniqueName="VerRem" >
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="VerRemisiones" runat="server" ImageUrl="~/Imagenes/view.png"
                                                         ToolTip="Ver Remisiones" CommandName="VerRem" />
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" Width="80px"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" ></ItemStyle>
                                            </telerik:GridTemplateColumn>
                        ...
                        <tr>
                            <td style="text-align: right">
                                ...
                                <asp:Label ID="Label12" runat="server" Width="120px" Font-Bold="True">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_ProPedido_Internet(Id, guardar, modificar, eliminar, imprimir, Anio, semana) {
                //debugger;
                var oWnd = radopen("ProPedidoVIInternet.aspx?IdPeInt=" + Id + "&PermisoGuardar=" + guardar + "&PermisoModificar=" + modificar + "&PermisoEliminar=" + eliminar + "&PermisoImprimir=" + imprimir + "&Anio=" + Anio + "&Semana=" + semana, "AbrirVentana_PedidoVI");
                oWnd.center();
                oWnd.Maximize();
            }
            function AbrirVentana_ProPedido_OC(Id, guardar, modificar, eliminar, imprimir, Anio, semana) {
                //debugger;
                var oWnd = radopen("ProPedidoVI.aspx?IdOC=" + Id + "&PermisoGuardar=" + guardar + "&PermisoModificar=" + modificar + "&PermisoEliminar=" + eliminar + "&PermisoImprimir=" + imprimir + "&Anio=" + Anio + "&Semana=" + semana, "AbrirVentana_PedidoVI");
                oWnd.center();
                oWnd.Maximize();
            }
            function AbrirVentana_VerRemisiones_OC(Id) {
                //debugger;
                var oWnd = radopen("VentanaRemisionesOC.aspx?IdOC=" + Id);

    ...
    public partial class CatRutaEntrega : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (e.CommandName.ToString() == "Modificar")
                {
                    ...
                    if (item >= 0)
                    {
                        ...
                        cmbAuxiliar.SelectedIndex = cmbAuxiliar.FindItemIndexByValue(rg1.Items[item]["Id_Aux"].Text);
                        if (rg1.Items[item]["Aux_Nombre"].Text!="&nbsp;")
                        {
                            cmbAuxiliar.Text = rg1.Items[item]["Aux_Nombre"].Text;
                        } else
                        {
                            cmbAuxiliar.Text = "";
                        }
        ...
        private void Guardar()
        {
            try
            {
                ...
                ruta.Id_Aux = Convert.ToInt32(cmbAuxiliar.SelectedValue);
                CN_CatRutaEntrega clsCatRutaEntrega = new CN_CatRutaEntrega();
                int verificador = -1;

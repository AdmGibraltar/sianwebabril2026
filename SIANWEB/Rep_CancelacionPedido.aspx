<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" AutoEventWireup="true" CodeBehind="Rep_CancelacionPedido.aspx.cs" Inherits="SIANWEB.Rep_CancelacionPedido" %>
    ...
    <div class="container-fluid">
        ...
        <asp:UpdatePanel runat="server" ID="UpdRepresentante">
            <ContentTemplate>
                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="col-md-10">
                                <h3 class="panel-title">Reporte de Cancelación de Pedidos</h3>
                            </div>
                ...
                <div class="col-md-12">
                    <dx:BootstrapGridView ID="GrdCancPedido" ClientInstanceName="grid" runat="server"
                        KeyFieldName="Id_Ped" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <dx:BootstrapGridViewTextColumn FieldName="Id_Ped" Caption="# Pedido">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="U_Nombre" Caption="Nombre Usuario">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="UsuarioDescripcion" Caption="Perfil">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewDateColumn FieldName="FechaBaja" Caption="Fecha Baja">
                            </dx:BootstrapGridViewDateColumn>
                            <dx:BootstrapGridViewDateColumn FieldName="Modulo" Caption="Modulo">
                            </dx:BootstrapGridViewDateColumn>
                        </Columns>

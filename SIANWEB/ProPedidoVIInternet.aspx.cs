...
namespace SIANWEB
{
    public partial class ProVentInst_PedidoCapInt : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void RAM1_AjaxRequest(object sender, AjaxRequestEventArgs e)
        {
            switch (e.Argument)
            {
                ...
                case "direccion":
                    ...
                    //JFCV 28 feb 2020 estaba marcando error al cargar contactos , no funcionaba 
                    cliente.Cte_HoraAm1 = cliente.Cte_HoraAm1.Replace(" a.m.", "");
                    cliente.Cte_HoraAm1 = cliente.Cte_HoraAm1.Replace(" p.m.", "");
                    cliente.Cte_HoraAm2 = cliente.Cte_HoraAm1.Replace(" a.m.", "");
                    cliente.Cte_HoraAm2 = cliente.Cte_HoraAm1.Replace(" p.m.", "");
                    cliente.Cte_HoraPm1 = cliente.Cte_HoraAm1.Replace(" a.m.", "");
                    cliente.Cte_HoraPm1 = cliente.Cte_HoraAm1.Replace(" p.m.", "");
                    cliente.Cte_HoraPm2 = cliente.Cte_HoraAm1.Replace(" a.m.", "");
                    cliente.Cte_HoraPm2 = cliente.Cte_HoraAm1.Replace(" p.m.", "");
                     ...
                     * */
                    txtRHoraam1.Text = cliente.Cte_HoraAm1;
                    txtRHoraam2.Text = cliente.Cte_HoraAm2;
                    txtRHorapm1.Text = cliente.Cte_HoraPm1;
                    txtRHorapm2.Text = cliente.Cte_HoraPm2;
                ...
                switch (e.CommandName)
                {
                    case "Agregar":
                        ...
                        foreach (GridItem item in rg1_Resto.SelectedItems)
                        {
                            ...
                            long Id_Prd = Convert.ToInt64(((Label)item.FindControl("lblProd_resto")).Text);
        ...
        private void Guardar()
        {
            try
            {
                ...
                pedido.UsoCFDI = ddUsoCfdi.SelectedValue;
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int x = 0; x < dt.Rows.Count; x++)
                    {
                        ...
                        conv.Id_Cte = Convert.ToInt32(txtIdCte.Value.HasValue ? txtIdCte.Value.Value : -1);
                        conv.Id_Prd = Convert.ToInt64(dt.Rows[x]["Id_Prd"]);
                        double PrecioIngresado = Convert.ToDouble(dt.Rows[x]["Prd_Precio"]);
                        //double impore =  dt.Rows[x]["Prd_Precio"].ToString()!= DBNull.Value  ? (double)(dt.Rows[x]["Prd_Precio"]) : 0;
                    ...
                    if (Productos.Count > 0 && lconveniosdet.Count > 0)
                    {
                        ...
                        Session["Id_FacPrec" + Session.SessionID] = TxtPed_PedAcys.Text;
                ...
                if (HF_ID.Value == "")
                {
                    ...
                    {
                        _prd = Convert.ToInt64((rg1.Items[x]["Id_Prod"].FindControl("lblProd") as Label).Text);
            ...
            {//IdVI
                ...
                else
                {
                    ...
                    if (Request.QueryString["IdOC"] != null)
                    {
                        ...
                        txtIdCte.Text = res.Id_Cte.ToString();
        ...
        private void CargarPedidoInternet(int num_pedido)
        {
            try
            {
                ...
                cn_capPedidoInternet.ConsultarPedido_Datos(session.Emp_Cnx, ref pedido, ref dirEntrega, num_pedido, 0);
                ...
                */
                txtRHoraam1.Text = dirEntrega.Cte_HoraAm1;
                txtRHoraam2.Text = dirEntrega.Cte_HoraAm2;
                txtRHorapm1.Text = dirEntrega.Cte_HoraPm1;
                txtRHorapm2.Text = dirEntrega.Cte_HoraPm2;

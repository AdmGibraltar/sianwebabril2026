<%@ Page Title="Imprimir embarque" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.Master" 
    AutoEventWireup="true" CodeBehind="ProEmbarques_Imprimir.aspx.cs" Inherits="SIANWEB.ProEmbarques_Imprimir" %>
        ...
        <telerik:RadToolBar ID="rtb1" runat="server" Width="100%" dir="rtl" OnButtonClick="rtb1_ButtonClick">
            <Items>
                ...
                <telerik:RadToolBarButton CommandName="print" Value="print" CssClass="print" ToolTip="Imprimir"
                   ...
                   <%-- <telerik:RadToolBarButton CommandName="expruta" Value="expruta" ToolTip="Exportar rutas"
                        ...
                        <tr>
                            <td colspan="7">                            
                                <asp:RadioButtonList ID="optOpciones" runat="server" RepeatDirection="Vertical">
                                    ...
                                    <asp:ListItem Text="Documentos por producto" Value="rdFacturaFacPro"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td>
                            </td>

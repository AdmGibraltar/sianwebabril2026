<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master"
    AutoEventWireup="true" CodeBehind="CatAuxiliar.aspx.cs" Inherits="SIANWEB.CatAuxiliar" %>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtId_Aux" runat="server" Width="70px" MaxLength="9">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                </telerik:RadNumericTextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtId_Aux"
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <telerik:RadTextBox onpaste="return false" ID="txtAux_Nombre" runat="server" Width="235px"
                                    MaxLength="40">
                                    <ClientEvents OnKeyPress="SoloAlfanumerico" />
                                </telerik:RadTextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAux_Nombre"
                                    Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                                ...
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn UniqueName="Id_Aux" HeaderText="Clave" DataField="Id_Aux">
                                                <ItemStyle HorizontalAlign="Center" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Aux_Nombre" HeaderText="Nombre" DataField="Aux_Nombre">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function LimpiarControles() {
                LimpiarTextBox($find('<%= txtId_Aux.ClientID %>'));
                LimpiarTextBox($find('<%= txtAux_Nombre.ClientID %>'));
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                switch (button.get_value()) {
                    case 'new':
                        ...
                        var txtId = $find('<%= txtId_Aux.ClientID %>');
                        var urlArchivo = 'ObtenerMaximo.aspx';
                        parametros = "Catalogo=CatAuxiliares";
                        parametros = parametros + "&sp=spCatLocal_Maximo";
                        parametros = parametros + "&columna=Id_Aux";

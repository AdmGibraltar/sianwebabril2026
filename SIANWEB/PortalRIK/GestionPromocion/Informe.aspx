          ...
          <div class="row ROWPAD MARGIN_BT5">
            ...
            <div class="row ROWPAD MARGIN_BT5">
                <div class="col-sm-12 col-md-12 ROWPAD">
                    ...
                    <table style="width: 500px; border-spacing: 5px; border-collapse: separate;">
                        <tr>
                            <td style="width: 150px;">Tipo de reporte</td>
                            <td>
                                <select id="rbTipo" class="form-control" style="width: 280px;">
                                    ...
                                    <option value="8">Reporte a nivel aplicación</option>                                
                                </select>
                            </td>
                        </tr>
                        <tr id="tr_1">
                            ...
                            <td colspan="3" id="tbUnidadNegocio" style="display:none;">

                             <div class="panel panel-default" style="width: 450px; margin-top:10px;">                                      
                                <div class="panel-heading titulo_blod">
                                    <table style="border-collapse:separate; border-spacing:5px;" >                                        
                                        <tr>
                                            <td>
                                                Seleccione configuraci&oacute;n
                                            </td>
                                            <td>
                                                &nbsp;<img id="Spinner_MapaAplicaciones" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" style="display:none; margin-top:-16px;" />    
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="panel-body" style="padding:10px!important;" >
                                    ...
                                    <tr>
                                        <!--td>
                                            <input id="chbUen" type="checkbox" class="form-control" checked disabled/>
                                        </td-->
                                        <td style="width: 100px;">UEN</td>
                                        <td>
                                            <select id="ddlUEN" class="form-control" disabled>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!--td>
                                            <input id="chbSegmento" type="checkbox"  class="form-check-input" checked>
                                        </td-->
                                        <td>Segmento</td>
                                        <td>
                                            <select id="ddlSegmento" class="form-control" disabled>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>                            
                                        <!--td>
                                            <input id="chbArea" type="checkbox" class="form-control" checked>
                                        </td-->
                                        <td>&Aacute;rea</td>
                                        <td>
                                            <select id="ddlArea" class="form-control" disabled>                            
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>                            
                                        <!--td>
                                            <input id="chbSolucion" type="checkbox" class="form-control" checked>
                                        </td-->
                                        <td>Soluci&oacute;n</td>
                                        <td>
                                            <select id="ddlSolucion" class="form-control" disabled>                            
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>     
                                        <!--td>
                                            <input id="chbAplicacion" type="checkbox" class="form-control" checked>
                                        </td-->                       
                                        <td>Aplicaci&oacute;n</td>
                                        <td>
                                            <select id="ddlAplicacion" class="form-control" disabled>                            
                                            </select>
                                        </td>
                                    </tr>
                                    </table>                                
                        ...
                        <tr>
                            <td>Representante</td>
                            <td>
                                <select id="ddlRepresentantesComercial" class="form-control" style="width: 280px;">                            
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>Periodo</td>
                            <td>
                                <select id="ddPeriodo" class="form-control" style="width: 280px;">                            
                                </select>                        
                            </td>
                        </tr>
                        <tr>
                            <td>Proyectos Nuevos</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="border-spacing: 5px; border-collapse: separate;" >
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control" style="width:100px;"  id="txtDe" value="0" /></td>
                                        <td><input type="text" class="form-control" style="width:100px;" id="txtA" value="9999999" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td>                                
                                <table style="border-spacing: 5px; border-collapse: separate;">
                                    <tr>                                        
                                        ...
                                        <td>
                                            <img id="Spinner_Cargando" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" style="display:none;" />    
                                        </td>
                                    </tr>
                                </table>
                            </td>

...
<body>
    ...
    <script src="<%=Page.ResolveUrl("~/js/crm2/Proyectos_tablaAgrupada_PropuestaTE.js?version=20201016_1720")%>"></script>                                                 
                    ...
                    <ul class="nav navbar-nav">
                        <li id="navCmdImpresionEncabezado" style="display: block;">
                            <a id="btnPrevisualizar" onclick="PrevisualizarPropuesta('1');" title="Impresión de Encabezado.">
                                <i class="fa fa-print fa-2x" aria-hidden="true"></i>&nbsp;Encabezado1
                            </a>
                        </li>

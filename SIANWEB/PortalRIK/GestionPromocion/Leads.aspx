<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/PortalRIK.Master" AutoEventWireup="true" CodeBehind="Leads.aspx.cs" Inherits="SIANWEB.PortalRIK.GestionPromocion.Leads" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/Librerias/aSimpleTour-master/jquery.aSimpleTour.js") %>"></script>
      ...
      <!-- Cancelar proyecto Leads  9 mzo 2021-->  
<script  type="text/javascript">
    ...
    <style>
     ...
     <style type="text/css">
         td.details-control {
            background: url('../../img/plus-green.png') no-repeat top center;
            cursor: pointer;
             width: 30px;
        }
   
        tr.shown td.details-control {
            background: url('../../img/quitar1.png') no-repeat top center;
            width: 30px;
        }
        /*param ellipse circulo defs los leads FONT BLANCO #ffffff PERO PARA ESTE EJEMPLO LE PUSE DEL MISMO COLOR*/
        span.red {
                  background: red;
                   border-radius: 0.8em;
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row ROWPAD MARGIN_BT5">
                ...
                <table style="width:100%;">
                    <tr>
                        <td>
                            <h3 style="display: inline-block;"><strong>Leads</strong></h3> 
                        </td>
                                             ...
                                             <table id="tblLeads" class="datatable table table-striped table-bordered table-hover display">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Asignar Representante</th>
                                                        <th>Cambiar de sucursal</th>
                                                        <th>Detalle</th>
                                                        <th>Aceptar</th>
                                                        <th>Cancelar</th>
                                                    </tr>
                            ...
                            <div id="dvMenu_General" class="tab-pane active" role="tabpanel">
                                ...
                                <div class="tab-content" id="tabDireccion">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <input type="text" id="txtIdLead" name="txtIdLead" class="form-control" placeholder="idlead" />
                                                </div>
                                            </div>
                                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/CRM_Prospectos_Tour.js")%>"></script>
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Leads.js")%>"></script>

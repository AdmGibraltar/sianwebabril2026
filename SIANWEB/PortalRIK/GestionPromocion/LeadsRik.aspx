...
CodeBehind="LeadsRik.aspx.cs" Inherits="SIANWEB.PortalRIK.GestionPromocion.LeadsRik" %>
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row ROWPAD MARGIN_BT5">
                ...
                <table style="width:100%;">
                    <tr>
                        <td>
                            <h3 style="display: inline-block;"><strong>Leads Representante</strong></h3> 
                        </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/LeadsRik.js")%>"></script>

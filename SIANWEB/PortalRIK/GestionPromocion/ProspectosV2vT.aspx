...
AutoEventWireup="true" CodeBehind="ProspectosV2vT.aspx.cs" 
Inherits="SIANWEB.PortalRIK.GestionPromocion.ProspectosV2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<!-- LEADS -->
    <script type="text/javascript" src="<%=Page.ResolveUrl("https://code.jquery.com/jquery-3.5.1.js") %>"></script>
    <script  type="text/javascript"src="<%=Page.ResolveUrl("https://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js") %>"></script>
        
    <link href="<%=Page.ResolveUrl("~/css/key_soluciones.css")%>" rel="stylesheet">

    <!-- TOUR -->
    <script src="<%=Page.ResolveUrl("~/Librerias/jquery.scrollTo-2.1.2/jquery.scrollTo.js") %>"></script>
    <script src="<%=Page.ResolveUrl("~/Librerias/aSimpleTour-master/jquery.aSimpleTour.js") %>"></script>

  <!-- Cancelar proyecto Leads -->  
<script  type="text/javascript">

    function cancelarProyectoLead(d) {
        alert('cancelar  proyecto');
        alert(d);
    };
    function cargarDatosLeads(d) {
        alert('cargar datos Leads  proyecto');
        alert(d);
    };
    function tipoCancelaLeadschange() {
        tipodecancelacion = $('#dvModalCancelarLeads #tipoCancelaLeads').val();
        if (tipodecancelacion != 3) {
            $('#dvModalCancelarLeads #txtMotivo').text('');
            $("#dvModalCancelarLeads #lblmotivocancelacion").hide();
            $("#dvModalCancelarLeads #txtMotivo").hide();
        } else {
            $("#dvModalCancelarLeads #lblmotivocancelacion").show();
            $("#dvModalCancelarLeads #txtMotivo").show();
            $("#dvModalCancelarLeads #lblMotivo").show();
            $("#dvModalCancelarLeads #lblMotivo").css("display", "block");
            $("#dvModalCancelarLeads #lblmotivocancelacion").css("display", "block");
        }
    };
    ...
    <style>
     ...
     <style type="text/css">
         td.details-control {
            background: url('../../img/plus-green.png') no-repeat center center;
            cursor: pointer;
             width: 30px;
        }
        tr.shown td.details-control {
            background: url('../../img/quitar1.png') no-repeat center center;
            width: 30px;
        }
 </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyContent" runat="server">
    ...
    <div class="row" style="display: block;">
        ...
        <input type="hidden" id="hfFlag1" value="0" />
          <%-- Leads--%>
        <input type="hidden" id="HF_IdLeads" value="" />   
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row ROWPAD MARGIN_BT5">
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style="width:100px; padding: 0px 5px 0px 0px;">                            
                        ...
                        <!--td style="width:100px;" >                            
                            <button id="btnAyudaToru" type="button" class="btn btn-default pull-right" data-action="1" style="width:100%;" title="Iniciar el Tour de la Aplicacíon">
            ...
            <div class="row ROWPAD" id="lstProspectos">
                <div class="col-sm-12 col-md-12 ROWPAD">                
                    ...
                    <table id="tblProspectos" class="datatable table table-striped table-bordered table-hover display">
                        <thead>
                            <tr>
                                <%--<th>#</th>--%>                                
                                <th>Nombre</th>
                                <th style="width:150px;">No. Cte.</th>
                                <th style="width:100px;">Editar<!--Columna de comando de edición--></th>
                                <th style="width:100px;">Nuevo Proyecto</th>
                                <th style="width:100px;">Eliminar<!--Columna de comando de eliminación-->
                                </th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="row ROWPAD">
                <div class="col-sm-12 col-md-12 ROWPAD">
                    ...
                    <table>
                        <tr>
                        <td><h3 id="ProspectoNombre"><strong>Seguimiento</strong></h3></td>
                        <td><img id="Spinner_Seguimiento" style="position:absolute; display:none; margin-left:5px; margin-top:-5px;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" /></td>
                        </tr>
                    </table>                   
            ...
            <div class="row ROWPAD">
                ...
                <div class="col-sm-12 col-md-12 ROWPAD">
                    ...
                    <ul class="nav nav-tabs" id="tabSeguimiento">
                        ...
                        <li>                            
                            <a href="#dvSeccionTerritorios" data-toggle="tab">Territorio</a>                            
                        </li>
                        <li>
                            <a href="#dvNotas" data-toggle="tab">Notas</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" style="margin-bottom:3rem;" class="tab-pane active" id="dvGeneral">
                            <div class="row" style="margin-top:10px">                                       
                                ...
                                <div class="col-md-12 col-sd-12 col-xd-10" >                                       
                                    <dl class="dl-horizontal">
                                        <dt style="text-align:left">Nombre Comercial</dt>
                                        <dd id="ddDatosGeneralesNombreComercial"></dd>
                                        <dt style="text-align:left">Calle</dt>
                                        <dd id="ddDatosGeneralesCalle"></dd>
                                        <dt style="text-align:left">Contacto</dt>
                                        <dd id="ddDatosGeneralesContacto"></dd>
                                        <dt style="text-align:left">Correo electrónico</dt>
                                        <dd id="ddDatosGeneralesCorreoElectronico"></dd>
                                        <dt style="text-align:left">Teléfono</dt>
                            ...
                            <div class="row" style="margin-top:1rem; margin-bottom:1rem;">
                                <div class="col-md-6">
                                    <em>Importante considerar que la UEN, Segmento y Tipo de cliente que se especifiquen deber&aacute;n ser atributos acorde al giro de negocio del cliente, NO basados en la oferta de producto que se busca desarrollar.</em>
                                    <b>Una vez agregado los siguientes campos no podr&aacute;n ser modificados</b>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-xs-6">
                                    <div class="form-group">
                                        <label>UEN</label>
                                        <select onchange="dg_uenOnChange(this)" id="dg_uen" class="form-control"></select>
                                        <small style="display:none" id="dg_uenError" class="form-text text-muted">* campo requerido</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select id="dg_segmento" class="form-control"></select>
                                        <small style="display:none" id="dg_segError" class="form-text text-muted">* campo requerido</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select onchange="dg_tipoClientesOnChange(this)" id="dg_tipoClientes" class="form-control"></select>
                                        <small style="display:none" id="dg_tipoClienteError" class="form-text text-muted">* campo requerido</small>
                                    </div>
                                </div>
                                <!--<div class="col-md-4 col-xs-6">
                                    <div class="form-group">
                                        <label>Cuenta corporativa</label>
                                        <select id="dg_cuentasCorporativas" class="form-control"></select>
                                    </div>
                                </div>-->
                            </div>
                            <div id="dg_mostrarBotonGuardar" class="row">
                                <div class="col-md-4">
                                    <button onclick="dg_guardar()" class="btn btn-primary">Guardar</button>
                                    <label id="dg_loader" style="float:right; display:none;">Guardando informaci&oacute;n...</label>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table_ter" style="border-spacing:5px; border-collapse:separate;" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">
                                                    <input Readonly="True" type="text" id="txtDetallesAsociarTerritorio_PotencialMeta" class="form-control" data-inputmask="'alias' : 'currency', 'autoUnmask' : 'true'" />
                                                </td>                                                
                                            </tr><tr>

                                                <td colspan="2" style="text-align:right;">
                                                    <small id="errorTerritorioAsociado" class="form-text text-muted" style="margin-right:1rem;display:none;">* acci&oacute;n requerida</small>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">VPO Meta</th>
                    ...
                    <form id="frmDvModalNuevoProspecto">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="tabProspectoNuevoTerritorio">
                            ...
                            <li role="presentation">
                                <a href="#dvMenu_Leads" aria-controls="dvMenu_Leads" role="tab" data-toggle="tab">
                                    Leads
                                </a>
                            </li>
                        ...
                        <div class="tab-content" id="tabMenu">
                                ...
                                <div class="form-group" style="margin-top:10px;">
                                    ...
                                    <!--div class="row">
                                        <div class="col-md-12"-->
                                            ...
                                            <table id="tbRFC" style="border-collapse: separate; display:block; width:100%;">
                                            <tbody>
                                                <tr>
                                                    <td>
                                ...
                                <div class="tab-content" id="tabDireccion">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="row" Visible = "false">
                                                <div class="col-md-5">
                                                    <input type="text" id="txtIdLead" name="txtIdLead" class="form-control"  visible="False" style="visibility:hidden" />
                                </div>
                            </div>
                                        </div>
                            ...
                            <%--JFCV LEADS--%>
                           <div role="tabpanel" class="tab-pane" id="dvMenu_Leads">

                         <%--  inicio de inserción jfcv leads  --%>
                         
                          <div class="row ROWPAD" id="lstLeads">
                                    <div class="col-sm-12 col-md-12 ROWPAD">                

                                        <div id="dvLoadingLeads"></div>

                                        <%-- <table id="tblLeads" class="datatable table table-striped table-bordered table-hover display">
                                             <thead>
                                                <tr>
                                                    
                                                    <th style="width:150px;">Fecha</th>    
                                                    <th style="width:120px;">Medio de comunicación</th>    
                                                    <th style="width:200px;">Giro de la empresa</th>                         
                                                    <th style="width:150px;">Nombre de la empresa</th>
                                                    <th style="width:150px;">Producto de Interes</th>
                                                   
                                                    <th style="width:60px;">Seleccionar</th>
                                                    <th style="width:150px;" visible="false">Nombre Contacto</th>
                                                    <th style="width:100px;" visible="false">Correo</th>
                                                    <th style="width:100px;" visible="false">Telefono</th> 
                                             ...
                                             <table id="tblLeads" class="datatable table table-striped table-bordered table-hover display">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Fecha de Alta</th>
                                                        <th>Medio de comunicación</th> <%--Acs_Contacto3--%>
...
--%>
                        ...
                        <tr>    
                            <td>
                                ...
                                <tr>
                                    ...
                                    <td id="spinnerBuscar" style="padding: 0px 5px 0px 0px; display:none;">
                                        <img src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                    </td>
                                    <td id="trBuscarCliente_TextoError" style="padding: 0px 5px 0px 0px; display:none;">
    ...
    <div class="modal fade" id="dvModalNuevoProyecto" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="form-group">
                            ...
                            <!--table style="width:100%" >
                                <tr>
                                    ...
                                    <td>
                                        <select id="tipoVenta" class="selectpicker form-control" style="width:200px;" >
                                            <option value="0">-Seleccione-</option>
                                            <option value="1">Instalada</option>                                            
                                            <option value="2">Espor&aacute;dica</option>
                                        </select>
                                    </td>
                                </tr>
                            </table-->                            
                            ...
                            <div class="radio">
                                <label class="radio-inline">Instalada
                                    <input type="radio" id="rbVtaInstalada" name="tipoVenta" class="form-control" value="1"/>
                                </label>
                            </div>&nbsp;
                            <div class="radio">
        ...
        <!--modal alerta UEN y Segmento-->
    <div class="modal fade" id="modalAlerta" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog">
    ...
    <!--Modal /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ -->
    <div class="modal fade" id="dvModalCancelarLeads" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">

                 <input type="hidden" id="HF_IdLeadscanc" name="HF_IdLeads" />

                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="H12">
                        Cancelar Lead
                    </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                           <select id="tipoCancelaLeads" class="selectpicker form-control" style="width:200px;" onchange="tipoCancelaLeadschange()" >
                                            <option value="1">No es cliente de interés</option>                                            
                    ...
                    <div class="row" id="lblmotivocancelacion" style="display:none;"> 
                        <div class="col-md-12" > 
                            <label for="lblmotivoc" >
                                Motivo de Cancelación
                            </label>
                            
                        </div>
                    </div>
                    <div class="row" id="lblMotivo" style="display:none;"> 
                        <div class="col-md-12"  >
                            <input type="text" id="txtMotivo" name="txtMotivo" class="form-control" placeholder="Motivo Cancelación"  />
                        </div>
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="$('#dvModalCancelarLeads').modal('hide');" >
                        Cerrar</button>

                        <button type="button" class="btn btn-primary"
                            id="btnModCancelarlead" onclick="cancelarLead(jQuery)">
                            Confirmar
                        </button>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/CRM_Prospectos_Tour.js?v=20220201")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Config.js?v=20220201")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/mapa.js?v=20220201")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/contacto.js?v=20220201")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/nota.js?v=20220201")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/territoriovT.js?v=20241210")%>"></script>    
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Prospectos2vT.js?v=20241210")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Prospectos2_ajax.js?v=20220201")%>"></script>        
    ...
    <div class="panel panel-default" data-id="id">
        ...
        <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="selDetallesAsociarTerritorio_Id_Ter">Territorio</label>
                    <select class="selectpicker form-control" id="selDetallesAsociarTerritorio_Id_Ter">                                                                
                    </select>
                </div>
                <div class="form-group">
...
////                      <th style="text-align: center;">Editar</th>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="h5">Contactos</h4>
                        </div>
                        <div class="modal-body" id="dvContenidoModalContactos">                    
                        </div>
                        <div class="modal-footer">
    ...
    <script type="text/javascript">
        function AfterCargarAreas() {
            var id_area = getParameterByName("Id_Area");
            if (id_area != null)
                $("#selArea").val(id_area).change();
        };
        function AfterCargarSolucion() {
            var id_Sol = getParameterByName("Id_Sol");
            if (id_Sol != null)
                $("#selSolucion").val(id_Sol).change();
        };
        function setValor() {
            //   $("#selArea option[value = 8]").attr('selected','selected');
            //alert($("#selArea option[value = 15]").val());
            //  $("#selArea option[value = 8]").text("Prueba");
            // document.getElementById('selArea').value = "8";
        }
        ...
        $(document).ready(function () {            
            var Flag1 = $('#hfFlag1').val();
            Flag1 = parseInt(Flag1);
            if (isNaN(Flag1)) {
                Flag1= 0;
            }
            var id_op = getParameterByName("Id_Op");
            var Id_Cte = getParameterByName("Id_Cte");
            Id_Cte = parseInt(Id_Cte);
            if (isNaN(Id_Cte)) {
                Id_Cte = 0;
            }
            var FIntegralidad = getParameterByName("FlagIntegralidad");
            FIntegralidad = parseInt(FIntegralidad);
            if (isNaN(FIntegralidad)) {
                FIntegralidad = 0;
            }
            // 30 Ago 2022 - RFH 
            if (FIntegralidad == 1 && Flag1 == 0) {
                
                if (Id_Cte > 0) {
                    _tablaProspectos.columns(1).search(Id_Cte);
                }
                //   _tablaProspectos.draw();
                _tablaProspectos.on('draw', function () {
                    ...
                    //if (Flag1 == 0) {                        
                        if (contador == 2) {
                            ...
                            contador = contador + 1;
                            if (Id_Cte != null) {
                                var link = $('a:contains("' + Id_Cte + '")');
                                var row = link.attr('row');
                               // if (row != null) {
                                    NuevoProyecto2(row);
                                //} else {
                                //    alert("Solo el RIK que dio de alta el proyecto puede agregar nuevas oportunidades");
                                //}
                            }
                        }
                        $('#hfFlag1').val(1);

...
namespace SIANWEB.PortalRIK.GestionPromocion
{
    ...
    public partial class ProspectosV2vT : BaseServerPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               if (Parametro_IdTU == 3)
                ...
                if (Request.QueryString["Id_Op"] != null)
                {
                    //Page.ClientScript.RegisterStartupScript(this.GetType(), "Llamada_Func", "alert('Entra');", true);
                }

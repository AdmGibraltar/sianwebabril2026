<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDinamo.aspx.cs" Inherits="SIANWEB.PortalRIK.GestionPromocion.ReporteDinamo" %>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <h3><strong>Reporte DINAMO</strong></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-1 col-md-1 col-xs-12 PARAM" style=" min-width:140px;">
                    ...
                    <tr>
                        <td>
                            <label for="<%=rbCDI.ClientID %>">CDI</label>
                        ...
                        <td>
                            <label for="<%=rbCDC.ClientID %>">CDC</label>
                ...
                <div class="col-sm-4 col-md-4 col-xs-12 PARAM">
                    <table>
                        ...
                        <tr>
                            <td>
                                <label for="<%=rbAntiguedadRIKTodos.ClientID %>">Todos</label>
                            ...
                            <td>
                                <label for="<%=rbAntiguedadMenor8Meses.ClientID %>">Menor a 8 meses</label>
                            ...
                            <td>
                                <label for="<%=rbAntiguedadRIKMayorIgual8Meses.ClientID %>">Mayor o igual a 8 meses</label>
                ...
                <div class="col-sm-3 col-md-3 col-xs-12 PARAM">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <label for="<%=chkPromedioTresMeses.ClientID %>">Promedio 3 meses</label>
                                    <asp:CheckBox runat="server" ID="chkPromedioTresMeses" />
                                    <%--<input type="checkbox" name="promedioTresMeses" id="promedioTresMeses" />--%>
                                </td>
                                <td>
                                    <label for="<%=chkListadoRIKS.ClientID %>">Listado RIK's</label>
            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-md-12 col-xs-12" style=" min-width:140px;">
                    ...
                    <div runat="server" id="dvContenedorDeReporte" style="overflow:hidden; width: 99%;" visible="false">
                        <table style="width: 100%;" id="tblContenido">
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="text-align: center;">
                                                <div style="font-size:1.2em;"><strong>Key Química, S.A. de C.V.</strong></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: center;">
                                                <div style="font-size:1.2em;"><strong>SIANWEB Central</strong></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: center;">
                                                <div style="font-size:1.2em;"><strong>INDICADORES DINAMO | <%=ViewModel.NombreRepresentanteElegido %> <%=ViewModel.MesElegido %> <%=ViewModel.AnyoElegido %></strong></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div runat="server" id="tblReportePorCd" style="width: 100%;"  visible="false">
                                    ...
                                    -->
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th rowspan="2" style="text-align: center;">CDI</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Proyectos Ingresados en el mes</th>
                                                    <th colspan="3" scope="colgroup" style="text-align: center;">Proyectos Promoción</th>
                                                    <th colspan="3" scope="colgroup" style="text-align: center;">Cierre</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Cancelados</th>
                                                    <th colspan="1" scope="colgroup" style="text-align: center;">Entradas</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" style="text-align: center;">Núm. proy.</th>
                                                    <th scope="col" style="text-align: center;">Importe proy.</th>
                                                    <th scope="col" style="text-align: center;">Monto proy.</th>
                                                    <th scope="col" style="text-align: center;">Cumplimiento</th>
                                                    <th scope="col" style="text-align: center;">Plantilla</th>
                                                    <th scope="col" style="text-align: center;">Monto Cierre</th>
                                                    <th scope="col" style="text-align: center;">Cumplimiento</th>
                                                    <th scope="col" style="text-align: center;">Plantilla</th>
                                                    <th scope="col" style="text-align: center;">Núm. proy.</th>
                                                    <th scope="col" style="text-align: center;">Importe proy.</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td style='<%# Eval("StyleProyectosIngresadosNumProy") %>'>
                                                                <%#Eval("ProyectosIngresados_Num")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "$0,0.00"' style='<%# Eval("StyleProyectosIngresadosImporteProy") %>'>
                                                                <%#Eval("ProyectosIngresados_Importe")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "$0,0.00"' style='<%# Eval("StyleProyectosPromocionMontoProy") %>'>
                                                                <%#Eval("ProyectosPromocion_Monto")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "0.00%"' style='<%# Eval("StyleProyectosPromocionCumplimientoProy") %>'>
                                                                <%#Eval("ProyectosPromocion_Cumplimiento")%>
                                                            </td>
                                                            <td style='<%# Eval("StyleProyectosPromocionPlantilla") %>'>
                                                                <%#Eval("ProyectosPromocion_Plantilla")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "$0,0.00"' style='<%# Eval("StyleCierreMontoCierre") %>'>
                                                                <%#Eval("ProyectosCierre_Monto")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "0.00%"' style='<%# Eval("StyleCierreCumplimiento") %>'>
                                                                <%#Eval("ProyectosCierre_Cumplimiento")%>
                                                            </td>
                                                            <td style='<%# Eval("StyleCierrePlantilla") %>'>
                                                                <%#Eval("ProyectosCierre_Plantilla")%>
                                                            </td>
                                                            <td style='<%# Eval("StyleCanceladosNumProy") %>'>
                                                                <%#Eval("ProyectosCancelados_Num")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "$0,0.00"' style='<%# Eval("StyleCanceladosImporteProy") %>'>
                                                                <%#Eval("ProyectosCancelados_Importe")%>
                                                            </td>
                                                            <td data-numeraljs='"format" : "0.00"' style='<%# Eval("StyleEntradasFrecuencia") %>'>
                            ...
                            <tr>
                                <td>
                                    <div runat="server" id="tblReportePorRik" style="width: 100%;" visible="false">
                                    ...
                                    -->
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th rowspan="2" style="text-align: center;">CDI</th>
                                                    <th rowspan="2" style="text-align: center;">Representante</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Proy. Ingresados en el mes</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Proyectos promoción</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Cierre</th>
                                                    <th colspan="2" scope="colgroup" style="text-align: center;">Cancelados</th>
                                                    <th colspan="1" scope="colgroup" style="text-align: center;">Entradas</th>
                                                </tr>
                                                <tr>
                                                ...
                                                <asp:Repeater runat="server" ID="rptReportePorRIK">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td data-numeraljs='"format" : "$0,0.00"' style='<%# Eval("StyleProyectosPromocionMontoProy") %>'>
                                                                <%#Eval("ProyectosPromocion_Importe")%>
                                                            </td>
                            ...
                            <tr>
                                <td>
                                    <div runat="server" id="tblReportePorProyecto" style="width: 100%;" visible="false">
                                    
                                    <!--
                                        TABLA: tblReportePorProyecto - tblReportePorProyecto - tblReportePorProyecto - tblReportePorProyecto 
                                    -->
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center;">VTeórico</th>
                                                        ...
                                                        <th style="text-align: center; white-space:nowrap;">Monto Proyecto</th>
                                                        <th style="text-align: center;">Fecha Mod.</th>
                                                ...
                                                <tbody>
                                                    <asp:Repeater runat="server" ID="rptReporteProyecto">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td><%# Eval("IdProyecto")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("NombreCliente")%></td>
                                                                <td><%# Eval("Area")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Solucion")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Aplicacion")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Productos")%></td>
                                                                <td data-numeraljs='"format" : "$0,0.00"' style="text-align: right;"><%# Eval("VTeorico")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Analisis")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Presentacion")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Negociacion")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Cierre")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("Cancelacion")%></td>
                                                                <td style="white-space:nowrap; text-align: right;" data-numeraljs='"format" : "$0,0.00"' ><%# Eval("MontoProyecto")%></td>
                                                                <td style="white-space:nowrap;"><%# Eval("FechaModificacion")%></td>
                                                                <td><%# Eval("Estatus")%></td>
                                                                <td><%# Eval("Causa")%></td>
            ...
            <div class="col-sm-3 col-md-2 col-sm-pull-9 col-md-pull-10 sidebar-pf sidebar-pf-left">
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <% CapaEntidad.Sesion sesion = (CapaEntidad.Sesion)Session["Sesion" + Session.SessionID]; %>
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li <%=(int)Session["activeMenu"]==2?"class=\"active\"":"" %>><a href="../GestionPromocion/FullDashboard.aspx">
                                        <i class="fa fa-tachometer"></i>Inicio</a>
                                    </li>

                                    <li <%=(int)Session["activeMenu"]==1?"class=\"active\"":"" %>><a href="../GestionPromocion/ProspectosV2.aspx">
                                        <i class="fa fa-street-view"></i>Prospectos</a>
                                    </li>

                                    <li <%=(int)Session["activeMenu"]==4?"class=\"active\"":"" %>><a href="<%=sesion.VersionTerritorio ? Page.ResolveUrl("~/PortalRIK/GestionPromocion/ProspectosV2vT.aspx") : Page.ResolveUrl("~/PortalRIK/GestionPromocion/ProspectosV2.aspx") %>">
                                        <i class="fa fa-cog"></i>Proyectos</a>
                                    </li>
                                    <!--li <%=(int)Session["activeMenu"]==5?"class=\"active\"":"" %>><a href="../../Valuaciones/ListadoValuaciones.aspx">
                                        <i class="fa fa-flask"></i>Valuaciones</a></li>
                                    <li>
                                    <a href="#"><i class="fa fa-paper-plane"></i>Propuestas</a>
                                    </li-->

                                   <%-- 
                                   <li <%=(int)Session["activeMenu"]==7?"class=\"active\"":"" %>><a href="../GestionPromocion/Reportes/DINAMO/ReporteDINAMOFull.aspx">
                                        <i class="fa fa-book"></i>Reporte DINAMO</a>
                                    </li>--%>

                                    <li <%=(int)Session["activeMenu"]==9?"class=\"active\"":"" %>>
                                        <a href="../GestionPromocion/Informe.aspx">
                                        <i class="fa fa-book"></i>Informes</a>
                                    </li>

                                    <!--li <%=(int)Session["activeMenu"]==8?"class=\"active\"":"" %>><a href="../VentaDeProyectos/ReporteDeVentaDeProyecto.aspx">
                ...
                <div>
                    <asp:Label id="lbVersion" runat = "server">Ver ?</asp:Label>
                </div>

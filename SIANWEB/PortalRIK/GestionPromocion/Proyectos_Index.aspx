<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/PortalRIK.Master"                                 
AutoEventWireup="true" CodeBehind="Proyectos_Index.aspx.cs" 
Inherits="SIANWEB.PortalRIK.Proyectos_Index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 01OCT-2020 RFH Actualizdado, Control de Version
 --%>

    <link rel="stylesheet" href="<%=Page.ResolveUrl("~/css/crm.css")%>">
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBodyContent" runat="server">
    <div class="row" style="display: block;">
        <div class="col-sm-12 col-md-12">        
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="width:100px;">                            
                                <button id="btnNuevoProyecto" class="btn btn-primary pull-right" data-toggle="modal" data-target="#dvModalEditarProyecto" data-action="1" style="width:100%; display:none;">
            ...
            <div class="row ROWPAD">
                ...
                <input type="hidden" id="hfId_Cte" value="" /> 

                <table id="tblProyectosIndex" class="datatable table table-bordered display" cellspacing="0">
                    <thead>
                        <tr>
                            <th style="width:70px;">Proyectos</th>
                            <th style="width:200px;">No. Cliente</th>
                            <th >Cliente</th>
                            <!--th>Valuación</th-->
                        </tr>
                    </thead>
            ...
            <div class="alert alert-danger" id="errorProyectoMalEspecificado" style="margin-bottom:1rem; margin-top: 1rem; display:none;">
                *AVISO TEMPORAL: Si observas este mensaje es porque se requiere actualizar tu mapa de aplicaciones, consulta <a href="mailto:estefany.ruiz@key.com.mx">estefany.ruiz@key.com.mx</a> para apoyo
            </div>
            ...
            <div class="row ROWPAD">
                <div class="col-sm-12 col-md-12 ROWPAD">
                    <table>
                        <tr>
                            <td>
                                <h3 id="lbDetalleDeProyecto"><strong>Detalles del proyecto</strong></h3>
                            </td>
                            <td>&nbsp;
                                <img id="imgCargandoProductos" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                            </td>
                        </tr>
                    </table>                
                </div>
            ...
            <input type="hidden" id="hfVap_Estatus" value="" />
            <input type="hidden" id="hfVap_Estatus2" value="" />
            ...
            <div class="row ROWPAD">
                <div class="col-md-12 ROWPAD">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#dvProductos" data-toggle="tab">Productos</a>                             
                        </li>
                    ...
                    <!-- Tab panes -->
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="dvGeneral">
                                    ...
                                    <input type="hidden" id="hf_Id_EmpGen" value="0" />
                                    <input type="hidden" id="hf_Id_CdGen" value="0" />
                                    <input type="hidden" id="hf_Id_CteGen" value="0" />
                                    <input type="hidden" id="hf_Id_CteDetGen" value="0" />
                                    <input type="hidden" id="hf_Id_TerGen" value="0" />
                                    <input type="hidden" id="hf_Id_SegGen" value="0" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <dl class="dl-horizontal">
                                                ...
                                                <dd>$5,000.00</dd>--%>
                                                <dt style="text-align: left; white-space: normal">Venta promedio mensual esperada &nbsp;(VPO)&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-pencil gi-4x" id="imgEdicionPME" onclick="GuardaNuevoPME(this);" style="cursor:pointer;"></i></dt>
                                                <dd id="ddVPME"></dd> <input type="text" 
                                                                                        id="txtVPME" 
                                                                                        name="txtVPME" 
                                                                                        class="form-control" 
                                                                                        style="width:120px;"  
                                                                                        title="Ajustar el Valor potencial teorico" data-toggle="tooltip" />
                                                <dt style="text-align: left; white-space: normal">Venta promedio mensual al cierre &nbsp; (VPO Cierre)</dt>
                                                <dd id="ddVPMEAC"></dd>
                                            </dl>
                                        ...
                                        <div class="col-md-12">                                            
                                            ...
                                            <table style="border-collapse:separate; border-spacing:5px;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger" type="button" onclick="EliminarProyecto(this)" id="btnEliminarProyecto" style="visibility:hidden;">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body" id="contendorProductos" style="padding:0px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <form id="frmAgregarProductoPDA">
                                                                                         
                                                                <input type="hidden" id="hdnAgregarProductoPDA_Id_Op" name="Id_Op" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_Id_Cte" name="Id_Cte" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_COP_EsQuimico" name="COP_EsQuimico" value="true" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_COP_DilucionAntecedente" name="COP_DilucionAntecedente" value="1" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_COP_DilucionConsecuente" name="COP_DilucionConsecuente" value="1" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_COP_ConsumoMensual" name="COP_ConsumoMensual" value="0" />
                                                                <input type="hidden" id="hdnAgregarProductoPDA_COP_CostoEnUso" name="COP_CostoEnUso" value="0" />
                                                                                                                                
                                                                <input type="hidden" id="ProductoAplicacion_LowResImage" value="" />
                                                                <input type="hidden" id="ProductoAplicacion_HighResImage" value="" />
                                                                
                                                                <div class="row ui-front" id="dvBusquedaProducto">
                                                                        <div class="col-md-12 tooltip-demo">
                                                                            <table class="table MARGIN_BOTTOM5">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th></th>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="text-align: center; width: 5%;">
                                                                                        ...
                                                                                        <img id="spinner_ConsultarProductoAplicacion" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                                                    </td>
                                                                                    <td style="text-align: center; width: 12%;">                                                                                            
                                                                                        <input type="text" 
                                                                                        id="txtProductoBusqueda" 
                                                                                        onblur="Consultar_Producto_DeAplicacion(this);"
                                                                                        name="txtProductoBusqueda" 
                                                                                        class="form-control" 
                                                                                        style="width:100%;"  
                                                                                        placeholder="Clave" 
                                                                                        title="Ingrese parte de la descripción o del código para buscar el producto" data-toggle="tooltip" />
                                                                                    </td>
                                                                                    <td style="text-align: center;" id="tdProductoDescripcionPDA">
                                                                                        <input type="text" id="txtProductoDescripcionPDA" class="form-control" style="width:100%;" readonly="readonly" 
                                                                                        disabled placeholder="Descripción" />
                                                                                        <span class="help-block" id="spanProductoDescripcionPDAHlp" style="display: none;">Producto no encontrado</span>
                                                                                    </td>
                                                                                    <td style="text-align: center; width: 12%;">
                                                                                        <input type="text" id="txtProductoCantidadPDA" name="PDA_Cantidad" class="form-control" style="width:100%;"  
                                                                                        placeholder="Cantidad" title="Ingrese la cantidad del producto" />
                                                                                    </td>
                                                                                    <td style="text-align: center; width: 12%;">
                                                                                        <button 
                                                                                            id="btnProductosAplicacion_Agregar" 
                                                                                            type="button" 
                                                                                            data-tipo="1"
                                                                                            onclick="Crm_AgregarProducto_Ver2(this)"
                                                                                            <%--onclick="$agregarProductoAplicacion($('#contendorProductos'),this)"--%>
                                                                    ...
                                                                    <input type="hidden" id="hdnProductoBusquedaPDA" name="Id_Prd" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_Uen" name="Id_Uen" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_Seg" name="Id_Seg" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_Area" name="Id_Area" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_Sol" name="Id_Sol" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_Apl" name="Id_Apl" />
                                                                    <input type="hidden" id="hdnAgregarProductoPDA_Id_SubFam" name="Id_SubFam" />
                                            ...
                                            <div>
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body" style="padding:0px;">
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                <form id="frmAgregarProductoOP">
                                                                    <input type="hidden" id="hdnAgregarProductoOP_Id_Op" name="Id_Op" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_Id_Cte" name="Id_Cte" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_COP_EsQuimico" name="COP_EsQuimico" value="true" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_COP_DilucionAntecedente" name="COP_DilucionAntecedente" value="1" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_COP_DilucionConsecuente" name="COP_DilucionConsecuente" value="1" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_COP_ConsumoMensual" name="COP_ConsumoMensual" value="0" />
                                                                    <input type="hidden" id="hdnAgregarProductoOP_COP_CostoEnUso" name="COP_CostoEnUso" value="0" />

                                                                    <input type="hidden" id="ProductoOtro_LowResImagen" value="" />
                                                                    <input type="hidden" id="ProductoOtro_HighResImagen" value="" />
                                                                    ...
                                                                    <div class="row ui-front" id="dvBusquedaProducto">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="text-align: center; width: 5%;">
                                                                                                <img id="imgBuscandoProducto" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                                                                <img id="imgAgregandoProducto" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                                                                <img id="spinner_ConsultarProductoOtros" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                                                            </td>
                                                                                            <td style="text-align: center; width: 12%;">
                                                                                                <input 
                                                                                                type="text" 
                                                                                                id="txtProductoBusquedaOtros" 
                                                                                                onblur="Consultar_Producto_Otros(this);"
                                                                                                class="form-control" placeholder="Clave" 
                                                                                                title="Ingrese parte de la descripción o del código para buscar el producto" 
                                                                                                data-toggle="tooltip" />
                                                                                            </td>
                                                                                            <td style="text-align: center;" id="tdProductoDescripcionOP">
                                                                                                <input type="text" id="txtProductoDescripcionOP" class="form-control" readonly="readonly" disabled placeholder="Descripción" />
                                                                                                <span class="help-block" id="spanProductoDescripcionHlp" style="display: none;">Producto no encontrado</span>
                                                                                            </td>
                                                                                            <td style="text-align: center; width: 12%;">
                                                                                                <input type="text" id="txtProductoCantidadOP" name="OP_Cantidad" class="form-control" placeholder="Cantidad" title="Ingrese la cantidad del producto" />
                                                                                            </td>
                                                                                            <td style="text-align: center; width: 12%;">
                                                                                                <button 
                                                                                                    id="btnProductosOtros_Agregar" 
                                                                                                    type="button" 
                                                                                                    class="btn btn-default"
                                                                                                    <%--onclick="AgregarProductoAplicacion_Ver2($('#contendorProductos'),this)"--%>
                                                                                                    data-tipo="2"
                                                                                                    onclick="Crm_AgregarProducto_Ver2(this)"
                                                                                                    <%--onclick="$agregarProductoOtro($('#contenedorOtrosProductos'),this)"--%>
                                                                                                    >Agregar
                                                                                                </button>
                                                                                            </td>
                                                                                        </tr>
                                                                        ...
                                                                        <input type="hidden" id="hdnProductoBusquedaOP" name="Id_Prd" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_Uen" name="Id_Uen" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_Seg" name="Id_Seg" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_Area" name="Id_Area" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_Sol" name="Id_Sol" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_Apl" name="Id_Apl" />
                                                                        <input type="hidden" id="hdnAgregarProductoOP_Id_SubFam" name="Id_SubFam" />
    ...
    <%--MODAL /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ --%>
    <div class="modal" id="modalCamposDelReporte" tabindex="-1"  role="dialog" aria-labelledby="hTituloVentanaValuacion">
        <div class="modal-dialog vertical-center" role="document">
            <div class="modal-content" style="width:800px;" >
                            ...
                            <tr>
                                <td>
                                    <h4 class="modal-title" id="h3">
                                        Información Adicional para Propuesta de Valor
                                    </h4>
                                </td style="width:60px;">
                                <td>
                                    <img id="spinner_CamposDeReporte" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                </td>
                            </tr>
                        </table>                   
                ...
                <div class="modal-body" id="Div3">
                    ...
                    <!-- 
                    INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - 
                    INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - 
                    INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - INFORMACION CLIENTE - 
                    ...
                    <div class="panel panel-default">                                      
                    <div class="panel-heading titulo_blod text-center"><b>Sección del Cliente</b></div>
                        <div class="panel-body">
                        
                            <table style="width:100%; border-collapse:separate; border-spacing:5px;" >
                               
                                 <tr>
                                    <td colspan="2">Atención a</td>                                    
                                </tr>    
                                  <tr>
                                  <td colspan="2">
                                        <input id="tbCte_AtencionA" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                    </td> 
                                </tr>    

                                <tr>
                                    <td colspan="2">Nombe de la empresa</td>                                    
                                </tr>                        
                                <tr>                                    
                                    <td colspan="2">
                                        <input id="tbCte_Nombre" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                    </td>
                                </tr>   
                                    <td colspan="2">                     

                                      <ul class="nav nav-tabs" role="tablist">
                                         <li class="active"><a href="#Div1" data-toggle="tab">Dirección física</a></li>
                                      </ul>
                                      <div class="tab-content">
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>Calle</td>
                                                                <td>
                                                                    <input id="tbCte_Calle" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>Numero</td>
                                                                <td>
                                                                    <input id="tbCte_No" type="text" class="Form-Control" style="width:100px;"  value="" placeholder="" maxlength="10"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>C.P.</td>
                                                                <td>
                                                                    <input id="tbCte_CP" type="text" class="Form-Control" style="width:100px;"  value="" placeholder="" maxlength="10" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>Colonia</td>
                                                                <td>
                                                                    <input id="tbCte_Colonia" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>Municipio</td>
                                                                <td>
                                                                    <input id="tbCte_Municipio" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        <table style="width:100%;">
                                                            <tr>
                                                                <td>Estado</td>
                                                                <td>
                                                                    <input id="tbCte_Estado" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                    ...
                    <!-- 
                    INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY 
                    INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY 
                    INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY - INFORMACION KEY 
                    ...
                    <div class="panel panel-default">                                      
                    <div class="panel-heading titulo_blod text-center"><b>Sección del Remitente (Datos KEY)</b></div>
                        <div class="panel-body">
                            ...
                            <tr>                                
                                <td colspan="2">
                                    <input id="tbKey_NombreRik" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>                                
                                <td colspan="2">
                                    <input id="tbKey_RazonSocial" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120"/>
                                </td>
                            </tr>                             
                            <tr>
                                <td colspan="2">
                                        ...
                                        <td colspan="2">
                                            <table style="width:100%;">
                                                <tr>
                                                     <td>Calle</td>
                                                    <td>
                                                        <input id="tbKey_Calle" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <tr>
                                                <td>Numero</td>
                                                <td>
                                                    <input id="tbKey_No" type="text" class="Form-Control" style="width:100px;"  value="" placeholder="" maxlength="10" />
                                                </td>
                                            </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td colspan="2">
                                             <table style="width:100%;">
                                                <tr>
                                                    <td>C.P.</td>
                                                    <td>
                                                        <input id="tbKey_CP" type="text" class="Form-Control" style="width:100px;"  value="" placeholder="" maxlength="10" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                     ...
                                     <td colspan="2">
                                             <table style="width:100%;">
                                                <tr>
                                                     <td>Colonia</td>
                                                    <td>
                                                        <input id="tbKey_Colonia" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                     ...
                                     <td colspan="2">
                                             <table style="width:100%;">
                                                <tr>
                                                    <td>Municipio</td>
                                                    <td>
                                                        <input id="tbKey_Municipio" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                     ...
                                     <td colspan="2">
                                             <table style="width:100%;">
                                                <tr>
                                                   <td>Estado</td>
                                                    <td>
                                                        <input id="tbKey_Estado" type="text" class="Form-Control" style="width:100%;"  value="" placeholder="" maxlength="120" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                     ...
                                     <td colspan="2">
                                             <table style="width:100%;">
                                                <tr>
                                                     <td>Nomenclatura</td>
                                                    <td>
                                                        <input id="tbKey_Nomenclatura" type="text" class="Form-Control" style="width:150px;"  value="" placeholder="" maxlength="30" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                ...
                <div class="modal-footer">
                    <button id="btnCamposDelRep_Cerrar" type="button" class="btn btn-default" data-dismiss="modal">
                        Cerrar
                    </button>  
                    <button id="btnCamposDelRep_Guardar" type="button" class="btn btn-primary btn-sm">
                        <i class="fa fa-check fa-2x"></i>&nbsp;Guardar
                    </button>                   
                </div>
            </div>
        </div>
    ...
    <%--MODAL /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ --%>
    <div id="dvModalPropuestaTE_ver2" data-backdrop="static" data-keyboard="false" 
    role="dialog" class="modal fade" tabindex="-1">
                    ...
                    <input type="hidden" id="hf_Vap_Estatus2" value="0">
                        ...
                        <div class="row form-inline" id="rowAceptarPropuesta" style="display:none;">                                                
                            ...
                            <div class="panel-body">
                                ...
                                <h4>Est&aacute; a punto de aceptar esta propuesta y generar el ACYS correspondiente. ¿Desea continuar?</h4>
                        ...
                        <div class="row form-inline" id="rowLoagin" style="display:none;"> 
                            <table>
                                <tr>
                                    <td><label>Cargando...</label></td>
                                    <td><!--div id="loading_ModalPropuestaTE" class="Loading"></div--></td>
                                </tr>
                            </table>                                               
                        </div>
                                    ...
                                    <td style="width:100px;">
                                       ...
                                       <div class="dropdown inline"  >
                                          <button 
                                            ...
                                            aria-haspopup="true" 
                                            aria-expanded="true">
                                            Ver para imprimir <span class="caret"></span>
                                          </button>
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">                                
                                            <%--<li><a onclick="PrevisualizarPropuesta('1');" >Rep 1</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('2');" >Rep 2</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('3');" >Rep 3</a></li>
                                            <li><hr></li>  --%>                                          
                                            <li><a onclick="PrevisualizarPropuesta('10');" >1) Encabezado</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('11');" >2) Presentación</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('12');" >3) Propuesta de Valor </a></li>
                                            <li><a onclick="PrevisualizarPropuesta('13');" >4) Propuesta Técnica</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('14');" >5) Propuesta Económica</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('16');" >&nbsp;Propuesta Económica / Costo en Uso</a></li>
                                            <li><a onclick="PrevisualizarPropuesta('15');" >6) Términos y Condiciones</a></li>
                                          </ul>
                                        </div>

                                    </td>
                                    <td style="width:150px;">
                                        <button type="button" class="btn btn-default btn-sm" id="btnPropuestaCamposDelReporte">
                                            <i class="fa fa-bars fa-2x"></i>&nbsp;Información Adicional para Propuesta de Valor
                                        </button>
                                    </td>

                                    <td style="width:100px;">
                                        <button type="button" class="btn btn-primary btn-sm" id="btnPropuestaEditar">
                                            <i class="fa fa-pencil-square-o fa-2x"></i>&nbsp;Editar
                                        </button>
                                    </td>

                                    <td>
                                        <img id="spinner_loading" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                    </td>

                                    <td style="width:100px;">
                                        <button type="button" class="btn btn-warning btn-sm" id="btnPropuestaAceptar">
                                        <i class="fa fa-check-square fa-2x">
                                        </i>&nbsp;Aceptar Propuesta 
                                        </button>                    
                                    </td>
                                    <td style="width:90px;">
                                        <button type="button" class="btn btn-default btn-sm pull-right" id="btnPropuestaCerrar">
                        ...
                        <div class="row mt5" id="divPropuestaDetalle">
                                <ul class="nav nav-tabs role="tablist">
                                    ...
                                    <li><a href="#CostoEnUsu" data-toggle="tab">Propuesta Econ&oacute;mica/Costo en Uso</a></li>
                                    <li><a href="#PropTecnica" data-toggle="tab">Propuesta T&eacute;cnica</a></li>                                                
                                </ul>                                                           
                                <div class="tab-content">
                                    <div class="tab-pane active" id="PropEconomica">                    
                                        <%-- 1) QUIMICO --%>
                                        <div id="divListadoProducto_1" style="display:block;" >
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>&nbsp;Químico&nbsp;</h4></td>
                                                    <td>
                                                        <img id="spinner_tbl1" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                            <table id="tbl1_PropuestaEconomica" class="table table-hover table-bordered" style="width: 100%;">
                                                <thead>
                                                    <tr style="height:50px;">
                                                        <td class="Col_Codigo" valign="bottom">C&oacute;digo</td>
                                                        <td class="Col_Producto">Producto</td>
                                                        <td class="Col_Presentacion">Presentaci&oacute;n</td>
                                                        <td class="Col_Unidad">Unidad</td>
                                                        <td class="Col_Cantidad">Cantidad</td>
                                                        <td class="Col_ConsumoM">Consumo Mensual<br></br>(Unidad)</td>                                                        
                                                        <td class="Col_Precio" style="display:none;" >Precio Lista</td>
                                                        <td class="Col_Precio">Precio</td>
                                                        <td class="Col_SubTotal">Subtotal</td> 
                                                        <td style="text-align:center; vertical-align: bottom; display:none;">Diluci&oacute;n</td>
                                                        <td style="text-align:center; vertical-align: bottom; display:none;">Consumo Mensual<br></br>(L Diluidos)</td>
                                                        <td style="text-align:center; vertical-align: bottom; display:none;">Costo en uso</td>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>  
                                        ...
                                        <%-- 2) APAPEL --%>
                                        <div id="divListadoProducto_2" style="display:block;">
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>&nbsp;Papel&nbsp;</h4></td>
                                                    <td>
                                                        <img id="spinner_tbl2" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                            <table id="tbl2_PropuestaEconomica" class="table table-hover table-bordered" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <td class="Col_Precio" valign="bottom" >C&oacute;digo</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Producto</td>
                                                        <td class="Col_Presentacion">Presentaci&oacute;n</td>
                                                        <td class="Col_Unidad">Unidad</td>
                                                        <%--<td style="text-align:center; vertical-align: bottom;">Unidad</td>--%>
                                                        <td class="Col_Cantidad">Cantidad</td>
                                                        <td class="Col_ConsumoM">Consumo Mensual (Unidad)</td>
                                                        <td class="Col_Precio" style="display:none;">Precio Lista</td>
                                                        <td class="Col_Precio">Precio</td>
                                                        <td class="Col_SubTotal">Subtotal</td>
                                        ...
                                        <%-- 3) SUPLEMENTEOS --%>
                                        <div id="divListadoProducto_3" style="display:block;">
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>Suplementos</h4></td>
                                                    <td>
                                                        <img id="spinner_tbl3" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                             <table id="tbl3_PropuestaEconomica" class="table table-hover table-bordered" style="width:100%"">
                                                <thead>
                                                    <tr>
                                                        <td class="Col_Precio" valign="bottom">C&oacute;digo</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Producto</td>
                                         ...
                                         <%-- 4) DOSIFICADORES Y SUPLEMENTOS  --%>
                                        <div id="divListadoProducto_4" style="display:block;">
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>Dosificadores/despachadores</h4></td>
                                                    <td>
                                                        <img id="spinner_tbl4" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                             <table id="tbl4_PropuestaEconomica" class="table table-hover table-bordered" style="width:100%"">
                                                <thead>
                                                    <tr>
                                                        <td class="Col_Precio" valign="bottom">C&oacute;digo</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Producto</td>
                                        ...
                                        <%-- 4) DOSIFICADORES Y SUPLEMENTOS  --%>
                                        <div id="divListadoProducto_5" style="display:block;">
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>Otros</h4></td>
                                                    <td>
                                                        <img id="spinner_tbl5" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                             <table id="tbl5_PropuestaEconomica" class="table table-hover table-bordered" style="width:100%"">
                                                <thead>
                                                    <tr>
                                                        <td class="Col_Precio" valign="bottom">C&oacute;digo</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Producto</td>
                                    ...
                                    <div class="tab-pane" id="CostoEnUsu"> 
                                       <div id="divListadoProducto_10" style="display:block;" >
                                            ...
                                            <table style="border-spacing:5px; border-collapse:separate;"> 
                                                <tr>
                                                    ...
                                                    <td><h4>&nbsp;Químico&nbsp;</h4></td>
                                                    <td>
                                                        <img id="Img4" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                                                    </td>
                                                </tr>
                                            </table>

                                            <table id="tbl10_PropuestaEconomica" class="table table-hover table-bordered" style="width: 100%;">
                                                <thead>
                                                    <tr style="height:50px;">
                                                        <td class="Col_Precio" valign="bottom">C&oacute;digo</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Producto</td>
                                                        ...
                                                        <td class="Col_Cantidad">Cantidad</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Consumo Mensual<br></br>(Unidad)</td>                                                        
                                                        <!--td style="text-align:center; vertical-align: bottom;">Gasto Mensual</td-->
                                                        <td style="text-align:center; vertical-align: bottom; display:none;">Precio Lista</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Precio</td>
                                                        <td style="text-align:center; vertical-align: bottom;">Subtotal</td>                                                        
                                                        <td class="Col_ConsumoM">Diluci&oacute;n</td>
                                                        <td class="Col_Precio">Consumo Mensual<br></br>(L Diluidos)</td>
                                                        <td class="Col_SubTotal">Costo en uso</td>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                            </table>  
    ...
    <script type="text/html" id="tplValuacionGlobal">
        ...
        <td>
            ...
            type="button" class="btn btn-primary" data-toggle="modal" data-idrnd="67434443" data-target="#dvModalValuacionGlobal" id="btnEditarValuacion" data-modo="1">
                                            ...
                                            <div class="row" style="height:180px;">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <br>                                                        
                                                        ...
                                                        <label type="label" id="lbmodalRecursoNombreArchivo"></label>
                                                            <br></br>
    ...
    <%--MODAL /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ --%>
    <div class="modal fade" id="ModalDepurarValuacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img id="img5" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="H4">
                        Depurar Valuaciones</h4>
                </div>
                <div class="modal-body">
                ...
                <table class="table">
                    <tr>
                        <td>No de Cliente</td>
                        <td>
                            <input type="text" class="from-control" id="tbDep_NoCliente" />
                        </td>
                    </tr>
                </table>
                ...
                <table class="table">
                    <tr>
                        <td>No Proyecto (1)</td>
                        <td>
                            <input type="text" class="from-control" id="tDep_NoProyecto1" />
                        </td>
                        <td>
                            CrmValuacionOportunidad
                            <table id="tbCrmValuacionOportunidad1">
                            </table>
                        </td>
                        <td>
                            CrmValuacionOportunidad
                ...
                <table class="table">
                    <tr>
                        <td>No Proyecto (1)</td>
                        <td>
                            <input type="text" class="from-control" id="Text1" />
                        </td>
                    </tr>
                </table>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="Button3">Aceptar</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="Button4">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <%--MODAL /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ --%>
    <div class="modal fade" id="Modal_ImageDeProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <img id="img6" style="display:none;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="H5">Imagen de producto</h4>
                </div>
                <div class="modal-body">
                ...
                <table class="table">
                    <tr>
                        <td>
                        <label id="ImagenPrd_Nombre"></label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">

                            <img id="ImagenPrd_Img" src="" alt="" class="" style="width:204px;">
                ...
                <div class="modal-footer">                    
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="Button5">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/js/crm2/Proyectos_tablaAgrupada_PropuestaTE.js?version=20210516_1")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/crm2/Proyectos_tablaAgrupada_PropuestaTE_ajax.js?version=20210516_1")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/crm2/Proyectos_tablaAgrupada.js?version=20210516_1")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/crm-namespaces/crm.js?version=20210516_1")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/crm-namespaces/crm.ui-ns.js?version=20210516_1")%>"></script>
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Gerente.js?version=20210516_1")%>"></script>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/valuacion.js?version=20210516_1")%>"></script>
   
    <%--  JUN02-2020 RFH --%>
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Crm_Productos.js?version=20210516_1")%>"></script>
    ...
    <script type="text/javascript">
        ...
        var contador = 0;
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
        function DespelgarDetalleProyecto(obj) {
            console.log('DespelgarDetalleProyecto');
        }
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
        function ClickDetalle(obj) {
            Estatus = $(obj).data('estatus');
            Id_Op = $(obj).data('id_op');
            Id_Cte = $(obj).data('id_cte');
            VAP_ESTATUS = $(obj).data('vap_estatus');
            VAP_ESTATUS2 = $(obj).data('vap_estatus2');
            // Funcion para desplegar el detalle del proyecto 
            //var renglonActual=TblTablaHija.data('_renglonActual');
            $('#lbDetalleDeProyecto').html('<strong>Detalles del proyecto <span class="badge badge-secondary bad_det_prod">' + Id_Op + '</span></strong>');
            ...
            */
            ...
            //TblTablaHija.data('_renglonActual', renglonActual);
            //_$campoDescripcionActual=$tdDescripcion;
            cargarProductosDeProyecto(Id_Op, Id_Cte,
                {
                    'Seg_Descripcion': '',
                    'Area_Descripcion': '',
                    'Sol_Descripcion': '',
                    'ValorPotencialTeorico': '',
                    'VentaPromedioMensualEsperada': '',
                    'Estatus': Estatus
                }
            );
            ...
            switch (_Parametro_ControlesSoloLectura) {
                case 0:
                    ...
                    $('#btnProductosAplicacion_Agregar').prop('disabled', false);
                    $('#btnProductosOtros_Agregar').prop('disabled', false);
                    $('#imgEdicionPME').prop('disabled', false);
                    break;
                case 1:
                    // Solo lectura                                     
                    ...
                    $('#btnProductosAplicacion_Agregar').prop('disabled', false);
                    $('#btnProductosOtros_Agregar').prop('disabled', false);
                    $('#imgEdicionPME').prop('disabled', true);
                    break;
                default:
                    // 11 Sep 2018 RFH       
                    $('#btnCancelarProyecto').prop('disabled', true);
                    ...
                    $('#btnProductosAplicacion_Agregar').prop('disabled', true);
                    $('#btnProductosOtros_Agregar').prop('disabled', true);
                    $('#imgEdicionPME').prop('disabled', true);
                    break;
            }

            //console.log('ESTATUS:'+ESTATUS+',VAP_ESTATUS:'+VAP_ESTATUS+', VAP_ESTATUS2:'+VAP_ESTATUS2);
            var bBloquedoInterface = false;
            if (VAP_ESTATUS == "A" && VAP_ESTATUS2 == 4) {
                bBloquedoInterface = true;
            }
            ...
            // Se Genero el ACyS
            if (bBloquedoInterface) {
                // No se puede cancelar el proyecto
                $('#btnCancelarProyecto').prop('disabled', true);
                $("#btnCancelarProyecto").css("pointer-events", "none");
        ...
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
        // TABLA HIJA 
        // 24 Ene 2019 Actualizado RFH
        // 
        function CrearTablaHija(Id_Cte, Id_Ter, Modo) {
            //console.log(datos);  
            $('#hfId_Cte').val(Id_Cte);
            var Icono_Global = '<i class="fa fa-globe"></i>';

            if (Modo == 0) {
                var DivContenedor = $('<div id="Slider_' + Id_Cte + '" class="slider">');
            }

            if (Modo == 1) {
                var DivContenedor = $('#Slider_' + Id_Cte);
            }
            var TblTablaHija = $('<table data-name="TablaHija" class="table table-bordered table-hover">' +
                '<thead>' +
                '<tr>' +
                '<th></th>' +
                '<th>Clave</th>' +
                ...
                // VALUACION GLOBAL 
                //
                '<tr id="RowValuacionGlobalCte_' + Id_Cte + '" style="background-color:#FFBF00;" >' +
                '<th></th>' +
                '<th style="text-align: left; vertical-align: middle;" id="rowNoProyecto_' + Id_Cte + '">' +
                //'<div id="DivNoProyecto_'+Id_Cte+'">'+'</div>'+                                
                '</th>' +
                '<th style="text-align: left; vertical-align: middle;">' +
                '<b id="lbValuacionGlobalCte_' + Id_Cte + '" style="display:none;">Valuación Global</b>' +
                '<button ' +
                'style="display:block;" ' +
                'id="btnValuacionGlobalCte_' + Id_Cte + '" ' +
                'data-tipo="1" ' + // Valuacion Global
                'data-id_op="0" ' + // NO LO REQUIRE
                'data-id_ter="0" ' +  // NO LO REQUIRE
                'data-valuacion="0" ' +
                'data-id_cte="' + Id_Cte + '" ' +
                'data-modo="0" ' +
                'data-modo="' + Id_Ter + '" ' +
                'onclick="Generar_Valuacion(this);" ' +
                '>' + Icono_Global + '&nbsp;Generar valuación global' +
                '</button>' +
                '</th>' +
                //'<th>EditarX</th>'+ RFH TODO: Verificar funcionamiento de Edit.
                '<th></th>' +
                '<th id="row_lbVG_UtilidadRemanente_' + Id_Cte + '" style="text-align: center; vertical-align: middle;">' +
                '<label id="lbVG_UtilidadRemanente_' + Id_Cte + '" style="display:none;"></label>' +
                '</th>' +
                '<th id="row_lbVG_ValorPresenteNeto_' + Id_Cte + '"  style="text-align: center; vertical-align: middle;">' +
                '<label id="lbVG_ValorPresenteNeto_' + Id_Cte + '"  style="display:none;"></label>' +
                '</th>' +
                '<th style="text-align: center; vertical-align: middle;">' +
                '<label id="lbVG_EstadoValuacion_' + Id_Cte + '"  style="display:block;"></label>' +
                '</th>' +
                //'<th style="text-align: center;">Estado de Valuación</th>'+
                //'<th>Editar Valuación</th>'+
                '<th style="text-align: center;" id="trbtnVerValuacion_' + Id_Cte + '"></th>' +
                //'<th style="text-align: center;">Propuestas</th>'+
                '<th style="text-align: center;" id="trbtnVerPropuestaTE_' + Id_Cte + '"></th>' +
                '</tr>' +
                '</thead><tbody>');

            DivContenedor.append(TblTablaHija);

            Cargar_SubTabla(_CRM_Usuario_Rik, Id_Cte, function (lst) {
                //var Icono_Editar = '<i class="fa fa-pencil-square-o"></i>';
                var Icono_Editar = '<i class="fa fa-usd"></i>';
                var Icono_VerPropuesta = '<i class="fa fa-map-o"></i>';
                // ********
                $.each(lst, function (index, element) {
                    /// console.log('Proyecto:'+ element.Id_Op +' Valuacion: '+element.Valuacion);
                    var ESTATUS = element.Estatus;
                    var VAP_ESTATUS = element.Vap_Estatus;
                    var VAP_ESTATUS2 = element.Vap_Estatus2;

                    /*
                    if (element.CrmValuacionOportunidades!=null) {
                    if (element.CrmValuacionOportunidades!=null) {
                        var ESTATUS =  element.Estatus;
                        var VAP_ESTATUS =  element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus;
                        var VAP_ESTATUS2 =  element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2;                
                    } else {    
                        var ESTATUS = 0;
                        var VAP_ESTATUS =  "";
                        var VAP_ESTATUS2 =  0;                
                    ...
                    */
                    ...
                    //var tr=$('<tr id="ProyectoRow_' + element.Id + '" >');

                    var chk_Estado = '';
                    if (element.Valuacion > 0)
                    {
                        chk_Estado = 'checked';
                    }
                    //
                    var tr = null
                    const disabledTr = element.Uen_Descripcion == "" || element.Seg_Descripcion == "" || element.Sol_Descripcion == "" || element.Id_CteDet == -1;
                    if (disabledTr)
                        tr = $('<tr disabled id="ProyectoRow_' + element.Id_Op + '" style="background-color:lightgrey;">');
                    else tr = $('<tr id="ProyectoRow_' + element.Id_Op + '" >');

                    //27 Sep 2018 RFH
                    var $tdForCheck = $('<td>').append(
                        '<input type="hidden" id="ESTATUS_' + element.Id_Op + '" value="' + ESTATUS + '">' +
                        '<input type="hidden" id="VAP_ESTATUS_' + element.Id_Op + '" value="' + VAP_ESTATUS + '">' +
                        '<input type="hidden" id="VAP_ESTATUS2_' + element.Id_Op + '" value="' + VAP_ESTATUS2 + '">'
                    );
                    $tdForCheck.append(
                        '<div class="inactiveLink">' +
                        '<input type="checkbox" id="chk_' + element.Id_Op + '" name="chk_' + element.Id_Op + '" ' + chk_Estado + '/>' +
                        '</div>'
                    );
                    //validarEstadoDeCheck($tdForCheck.find('input'), element, datos.ProyectosEnValuacion);
                    //validarEstadoDeCheck($tdForCheck.find('input'), element, datos.Valuacion);
                    //validarEstadoDeCheck($tdForCheck.find('input'), element, element.Valuacion);
                    ...
                    // DESCRIPCION - AREA DE APLICACION 
                    //var $tdDescripcion=$('<td>' + element.Descripcion + '</td>'); // Columna Area de Aplicacion
                    var $tdDescripcion = $('<td>' + element.AreaDeAplicacion + '</td>'); // Columna Area de Aplicacion
                    //if(element.Cancelado==true){
                    if (element.Estatus == 5) {
                        $tdDescripcion.css('text-decoration', 'line-through');
                    }
                    var a = $('<a data-idrnd="45775787" ' +
                        'data-estatus="' + element.Estatus + '" ' +
                        'data-proyecto_id="' + element.Id_Op + '" ' +
                        'data-vap_estatus="' + VAP_ESTATUS + '" ' +
                        'data-vap-estatus2="' + VAP_ESTATUS2 + '">');
                    $(a).attr('href', '#dvDetalles');
                    //
                    // EVENTO CLICK EN Numero de PROYECTO 
                    // Desplegar Detalle Proyecto
                    //
                    $(a).click(function () {
                        console.log('$(a).click');
                        console.log(element);
                        const error = element.Uen_Descripcion == "" || element.Seg_Descripcion == "" || element.Sol_Descripcion == "" || element.Id_CteDet == -1;
                        if (error) {
                            $('#errorProyectoMalEspecificado').show()
                            $('#DetalleProyecto').css('display', 'none');
                            return
                        }

                        $('#errorProyectoMalEspecificado').hide()
                        $('#DetalleProyecto').css('display', 'block');
                        var ESTATUS = element.Estatus;
                        var VAP_ESTATUS = $('#VAP_ESTATUS_' + element.Id_Op).val();
                        var VAP_ESTATUS2 = $('#VAP_ESTATUS2_' + element.Id_Op).val();
                        // Funcion para desplegar el detalle del proyecto 
                        var renglonActual = TblTablaHija.data('_renglonActual');
                        //$('#lbDetalleDeProyecto').html('<strong>Detalles del proyecto : '+element.Id_Op);
                        $('#lbDetalleDeProyecto').html('<strong>Detalles del proyecto <span class="badge badge-secondary bad_det_prod">' + element.Id_Op + '</span></strong>');
                        ...
                        TblTablaHija.data('_renglonActual', renglonActual);
                        _$campoDescripcionActual = $tdDescripcion;
                        // CARGA PRODUCTOS DE PROYECTO 
                        /// console.log('--> <--');
                        cargarProductosDeProyecto(element.Id_Op, element.Id_Cte, element);
                        //
                        //Si el proyecto está cancelado, se desactiva el comando de cancelación
                        //if(element.Cancelado==true){
                        //
                    ...
                    // <-------- EVENTO CLICK EN PROYECTO - END

                    //
                    // Aqui se despliegan las COLUMNAS de EDITAR VALUACION Y PROPUSTA 
                    //
                    $(a).text(element.Id_Op); // Columna : HRef par el ID de proyecto
                    ...
                    */
                    ...
                    if (element.Crm_TipoVenta == 0) {
                        $(tr).append($('<td></td>'));
                    }
                    if (element.Crm_TipoVenta == 1) {
                        $(tr).append($('<td>VI</td>'));
                    }
                    if (element.Crm_TipoVenta == 2) {
                        $(tr).append($('<td>VE</td>'));
                    }
                    ...
                    {
                        // SI TIENE VALUACION 
                        $('#hf_Vap_Estatus').val(element.Vap_Estatus);
                        $('#hf_Vap_Estatus2').val(element.Vap_Estatus2);
                        var alMenosUnoNegativo = false;
                        //
                        //  UTILIDAD REMANENTE
                        //

                        //if(element.Vap_UtilidadRemanente > 0 && element.Estatus != 5)
                        if (element.Estatus != 5)
                        {
                            //.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente!=null){
                            var $nodoUR = $('<td>');
                            //establecerFormatoResultadosValuacion($nodoUR, element.Vap_UtilidadRemanente);
                            //CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente);

                            if (element.Vap_UtilidadRemanente < 0) {
                                $nodoUR.css('background-color', 'red');
                            } else {
                                $nodoUR.css('background-color', 'green');
                            }
                            $nodoUR.css('color', 'white');
                            $nodoUR.css('font-weight', 'bold');
                            $nodoUR.css('text-align', 'center');

                            var bhColor = 1;
                            if (element.Vap_UtilidadRemanente < 0)
                            {   //.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente<0){
                                alMenosUnoNegativo = true;
                                bhColor = 2;
                            }
                            // Utilidad Remanente
                            var utilidadRemanenteConFormato = numeral(element.Vap_UtilidadRemanente).format('$0,0.00');//.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente).format('$0,0.00');

                            $(tr).append($nodoUR.text(utilidadRemanenteConFormato));
                            /*
                            switch(bhColor) {
                                case 1:
                                    $(tr).append('<span class="label label-success" style="margin-top:5px;">'+ utilidadRemanenteConFormato +'</span>');
                                break;
                                case 2:
                                    $(tr).append('<span class="label label-danger" style="margin-top:5px;">'+ utilidadRemanenteConFormato +'</span>');
                                break;
                            }*/
                        }
                        else
                        ...
                        //
                        //  UTILIDAD PRESENTE NETO 
                        //
                        //if(element.Vap_ValorPresenteNeto>0 && element.Estatus != 5)
                        if (element.Estatus != 5)
                        {
                            //.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto!=null){
                            var $nodoVPN = $('<td>');
                            if (element.Vap_ValorPresenteNeto < 0)
                            {//.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto<0){
                                alMenosUnoNegativo = true;
                            }
                            // Valor Presente Neto 
                            //establecerFormatoResultadosValuacion($nodoVPN, element.Vap_ValorPresenteNeto);//.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto);
                            if ($nodoVPN.Vap_ValorPresenteNeto < 0) {
                                $nodoVPN.css('background-color', 'red');
                            } else {
                                $nodoVPN.css('background-color', 'green');
                            }
                            $nodoVPN.css('color', 'white');
                            $nodoVPN.css('font-weight', 'bold');
                            $nodoVPN.css('text-align', 'center');
                            var valorPresenteNetoConFormato = numeral(element.Vap_ValorPresenteNeto).format('$0,0.00');//.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto).format('$0,0.00');
                        ...
                        // 2 Oct 2018 RFH
                        // Deinfe / Autorizando y Autorizado 
                        var AutorizandoAutroizado;
                        AutorizandoAutroizado = 0;
                        /*
                        //En proceso de autorización Vap_Estatus = C && Vap_Estatus2 or Vap_Estatus2==3 AND Vap_Estatus2==3 OR 
                        if( (element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus=='C' && (element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2==2 || 
                        element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2==3)) || 
                        ...
                        {
                            $(tr).append($('<td data-idrnd="74654654">Autorizando</td>'));
                        }
                        else if( (element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus=='A' && (element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2==3 || element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2==4)))
                        {
                            $(tr).append($('<td>Autorizado</td>'));
                        }
                        else if(element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente!=null && element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto!=null )
                        {
                            /*Cascada para manejar el caso cuando la valuación es positiva, pero no ha sido autorizada: solo para casos antiguos*
                            if(element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente>0 && element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto>0)
                            {
                                $(tr).append($('<td>Autorizado</td>'));
                            }
                            else
                        ...
                        */
                        if (element.Vap_Estatus == 'C' && element.Vap_Estatus2 == 2)
                        {
                            AutorizandoAutroizado = 1;
                        } else {
                            AutorizandoAutroizado = 0;
                        }

                        /// debugger;
                        switch (AutorizandoAutroizado) {
                            //JFCV control cambios valuacion 
                            case 0:
                                if (element.Vap_Estatus == 'A' && element.Vap_Estatus2 == 0) {
                                    $(tr).append($('<td data-idrnd="87646548" style="text-align:center; background-color:red; color: rgb(255,255,255); font-weight: bold;"  >Val. Precios</td>'));

                                }
                                else {
                                    $(tr).append($('<td data-idrnd="22345667" style="text-align:center">Autorizado</td>'));
                                }
                                //    $(tr).append($('<td data-idrnd="22345667" style="text-align:center">Autorizado</td>'));
                                break;
                            case 1:
                                $(tr).append($('<td data-idrnd="87646546" style="text-align:center">Autorizando</td>'));
                                break;
                        }
                        ...
                        if (element.Valuacion > 0)
                        {
                            ...
                            $(tr).append($('<td style="text-align: center;">' +
                                ...
                                'onclick="Generar_Valuacion(this)" ' +
                                'data-idrnd="4564687" ' +
                                'data-id="btnVerValuacion_' + element.Id_Op + '" ' +
                                'data-tipo="0" ' + // Valuacion Individual
                                'data-Id_op="' + element.Id_Op + '" ' +
                                'data-valuacion="' + element.Valuacion + '" ' +
                                'data-id_cte="' + element.Id_Cte + '" ' +
                                'data-modo="0" ' +
                                'data-id_ter="' + element.Id_Ter + '" ' +
                                'data-idval="' + element.Valuacion + '" ' +
                                //'data-idval="' + element.CrmValuacionOportunidades.CapValProyectoSerializable.Id_Vap + '" data-modo="1" '+                                            
                                '>' +
                                Icono_Editar + '&nbsp;Ver Valuación' +
                                '</button>' +
                                '</td>')
                            );
                            /*} 
                    ...
                    {
                        // SI NO TIENE VALUACION 
                        /*
                        $(tr).append($('<td style="text-align:center;">').text('-'));
                        $(tr).append($('<td style="text-align:center;">').text('-'));
                        $(tr).append($('<td style="text-align:center;">').text('Sin Valuación'));
                        $(tr).append($('<td>').text(''));
                        */
                        //
                        // SOLO UN BOTON 
                        //
                        var btnValuacion = $('<td colspan="5" style="text-align:center;" >' +
                            '<button type="button" class="btn btn-default" ' +
                            'id="btnCrearValuacion" ' +
                            'onclick="Generar_Valuacion(this)"' +
                            (disabledTr ? 'disabled ' : '') +
                            'data-tipo="0" ' +   //Valuacion Individual
                            'data-id_op="' + element.Id_Op + '" ' +
                    ...
                    //if(element.CrmValuacionOportunidades!=null)
                    {
                        // si hay CrmValuacionOportunidades
                        //if(element.CrmValuacionOportunidades.CapValProyectoSerializable!=null)
                        if (element.Valuacion > 0)
                        {
                            /*
                            ...
                            else if(element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2==4 && element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus=='A')
                            {
                                // 14 Sep 2018 RFH
                                // Si esta aprovada o si se crreo el acys.
                                $(tr).append($('<td>'+
                                '<button type="button" class="btn btn-primary" '+
                                    'id="btnVisualizarPropuestaTE" '+
                                    'onclick="Valuacion_Cargar(this)"' +
                            ...
                            else if(element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente!=null && element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto!=null)
                            {
                                ...
                                {
                                    $(tr).append($('<td>').text(''));
                                    //$(tr).append($('<td>XXX1</td>'));
                                }
                            }
                            */
                            var bVisualizaBtn_VerPropuesta = false;
                            var Estatus = element.Estatus;
                            var Vap_Estatus2 = element.Vap_Estatus2;
                            var Vap_Estatus = element.Vap_Estatus;
                            var Vap_UtilidadRemanente = element.Vap_UtilidadRemanente;
                            var Vap_ValorPresenteNeto = element.Vap_ValorPresenteNeto;
                            if (Vap_Estatus == 'A' && Vap_Estatus2 == 3)
                            {
                                bVisualizaBtn_VerPropuesta = true;
                            }
                            else if (Vap_Estatus == 'A' && Vap_Estatus2 == 4)
                            {
                                bVisualizaBtn_VerPropuesta = true;
                            }
                            else if (Vap_Estatus == 'C' && Vap_Estatus2 == 1)
                            {
                                bVisualizaBtn_VerPropuesta = true;
                            }
                            else if (Vap_Estatus == 'C' && Vap_Estatus2 == 3)
                            {
                                bVisualizaBtn_VerPropuesta = true;
                            }
                            else if (Vap_Estatus == 'C' && Vap_Estatus2 == 4)
                            {
                                bVisualizaBtn_VerPropuesta = true;
                            }
                            else if (Vap_UtilidadRemanente != null && Vap_ValorPresenteNeto != null)
                            {
                                /*Cascada para manejar el caso cuando la valuación es positiva, pero no ha sido autorizada: solo para casos antiguos*/
                                /* if(element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente>0 && element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto>0)
                                 {                                    
                            ...
                            // Si esta cancelada no despliega
                            if (Estatus == 5) {
                                bVisualizaBtn_VerPropuesta = false;
                            }
                            if (bVisualizaBtn_VerPropuesta) {
                                $(tr).append($('<td style="text-align:center;">' +
                                    '<button type="button" class="btn btn-default" ' +
                                    //'id="btnVisualizarPropuestaTE_'+element.CrmValuacionOportunidades.CapValProyectoSerializable.Id_Vap+'" '+                                    
                                    'id="btnVisualizarPropuestaTE_' + element.Valuacion + '" ' +
                                    (disabledTr ? 'disabled ' : '') +
                                    'onclick="PTE.Valuacion_Cargar(this)"' +
                                    //'data-toggle="modal" '+
                                    //'data-target="#dvModalPropuestaTE_ver2" '+                                
                                    //'data-target="#dvModalPropuestaTE" '+                                
                                    'name="btnVisualizarPropuestaTE" ' +
                                    //'data-idop="' + element.Id + '" '+
                                    'data-rnd="2308" ' +
                                    'data-idop="' + element.Id_Op + '" ' +
                                    'data-idbtn="0" ' +
                                    'data-idcte="' + element.Id_Cte + '" ' +
                                    //'data-idval="' + element.CrmValuacionOportunidades.CapValProyectoSerializable.Id_Vap + '" >'+                                
                                    'data-idval="' + element.Valuacion + '" >' +
                                    Icono_VerPropuesta + '&nbsp;Ver Propuesta' +
                                    '</button>' +
                                    '</td>'));
                            } else {
                                // Imprime la celda
                        ...
                        {
                            $(tr).append($('<td>').text(''));
                            //$(tr).append($('<td>XXX2</td>'));
                        }
                    } else {

                        //$(tr).append($('<td>').text(''));
                        //$(tr).append($('<td>XXX3</td>'));
                    }

                    $(TblTablaHija).find('tbody').append(tr);
                });

                // 
                // SI EXISTE VALUACION GLOBAL - DESPLEGAR            
                //

                //Valuacion_Global(Id_Cte, function () {
                Cargar_ValuacionGlobales(_CRM_Usuario_Rik, Id_Cte, function (lst) {

                    var Desplegar_BtnVerPropuesta = 0;
                    if (lst && lst.length > 0) {
                        var aVG = $('<p data-idrnd="45775787" ' +
                            'style="cursor: pointer;" ' +
                            'onclick="ClickDetalle(this);" ' +
                            'data-estatus="' + lst[0].Estatus + '" ' +
                            'data-id_op="' + lst[0].Id_Op + '" ' +
                            'data-id_cte="' + Id_Cte + '" ' +
                            'data-vap_estatus="' + lst[0].Vap_Estatus + '" ' +
                            'data-vap-estatus2="' + lst[0].Vap_Estatus2 + '">' + lst[0].Id_Op + '</p>');
                        //$(aVG).attr('href', '');
                        $('#rowNoProyecto_' + Id_Cte).append(aVG);

                        var VG_AutorizandoEstatus = '';
                        if (lst[0].Vap_Estatus == 'C' && lst[0].Vap_Estatus2 == 2)
                        {
                            VG_AutorizandoEstatus = 1;
                        } else {
                            VG_AutorizandoEstatus = 0;
                        }

                        VG_AutorizandoEstatus_HTML = '';
                        switch (VG_AutorizandoEstatus) {
                            case 0:
                                VG_AutorizandoEstatus_HTML = 'Autorizado';
                                break;
                            case 1:
                                VG_AutorizandoEstatus_HTML = 'Autorizando';
                                break;
                        }

                        $('#lbVG_EstadoValuacion_' + Id_Cte).text(VG_AutorizandoEstatus_HTML);

                        $('#btnValuacionGlobalCte_' + Id_Cte).css('display', 'none');
                        $('#lbValuacionGlobalCte_' + Id_Cte).css('display', 'block');
                        $('#lbVG_UtilidadRemanente_' + Id_Cte).css('display', 'block');
                        $('#lbVG_ValorPresenteNeto_' + Id_Cte).css('display', 'block');
                        $('#lbVG_Id_Op_' + Id_Cte).css('display', 'block');

                        var fVG_UR = lst[0].Vap_UtilidadRemanente;
                        var format_VGUR = numeral(fVG_UR).format('$0,0.00');
                        $('#lbVG_UtilidadRemanente_' + Id_Cte).text(format_VGUR);
                        var fVG_VPN = lst[0].Vap_ValorPresenteNeto;
                        var format_VGVPN = numeral(fVG_VPN).format('$0,0.00');
                        $('#lbVG_ValorPresenteNeto_' + Id_Cte).text(format_VGVPN);

                        if (fVG_UR <= 0) {
                            $('#row_lbVG_UtilidadRemanente_' + Id_Cte).css('background-color', 'red');
                            $('#row_lbVG_UtilidadRemanente_' + Id_Cte).css('color', 'white');
                        } else {
                            $('#row_lbVG_UtilidadRemanente_' + Id_Cte).css('background-color', 'green');
                            $('#row_lbVG_UtilidadRemanente_' + Id_Cte).css('color', 'white');
                        }
                        if (fVG_VPN <= 0) {
                            $('#row_lbVG_ValorPresenteNeto_' + Id_Cte).css('background-color', 'red');
                            $('#row_lbVG_ValorPresenteNeto_' + Id_Cte).css('color', 'white');
                        } else {
                            $('#row_lbVG_ValorPresenteNeto_' + Id_Cte).css('background-color', 'green');
                            $('#row_lbVG_ValorPresenteNeto_' + Id_Cte).css('color', 'white');
                        }

                        $('#lbVG_Id_Op_' + Id_Cte).text(lst[0].Id_Op);

                        var btnVV = '<button type="button" ' +
                            'class="btn btn-default" ' +
                            'id="btnEditarValuacion" ' +
                            'onclick="Generar_Valuacion(this)" ' +
                            'data-idrnd="43465468" ' +
                            'data-id="btnVerValuacion_' + lst[0].Id_Op + '" ' +
                            'data-tipo="1" ' + // Valuacion Individual
                            'data-id_op="' + lst[0].Id_Op + '" ' +
                            'data-valuacion="' + lst[0].Valuacion + '" ' +
                            'data-id_cte="' + Id_Cte + '" ' +
                            'data-modo="0" ' +
                            'data-id_ter="' + 0 + '" ' +
                            'data-idval="' + lst[0].Valuacion + '" ' +
                            //'data-idval="' + element.CrmValuacionOportunidades.CapValProyectoSerializable.Id_Vap + '" data-modo="1" '+                                            
                            '>' +
                            Icono_Editar + '&nbsp;Ver Valuación' +
                            '</button>';
                        var btnVP = '<button type="button" ' +
                            'class="btn btn-default" ' +
                            'id="btnEditarValuacion" ' +
                            //21SEP-2020
                            'onclick="PTE.Valuacion_Cargar(this)" ' +
                            'data-idrnd="464687687" ' +
                            'data-id="btnVerValuacion_' + lst[0].Id_Op + '" ' +
                            'data-tipo="1" ' + // Valuacion Individual
                            'data-idop="' + lst[0].Id_Op + '" ' +
                            'data-valuacion="' + lst[0].Valuacion + '" ' +
                            'data-idcte="' + Id_Cte + '" ' +
                            'data-modo="0" ' +
                            'data-id_ter="' + 0 + '" ' +
                        ...
                        $('#trbtnVerValuacion_' + Id_Cte).append(btnVV);
                        switch (VG_AutorizandoEstatus) {
                            case 0:
                                $('#trbtnVerPropuestaTE_' + Id_Cte).append(btnVP);
                                break;
                            case 1:
                                $('#trbtnVerPropuestaTE_' + Id_Cte).append();
                                break;
                        }


                    } else {
                        $('#btnValuacionGlobalCte_' + Id_Cte).css('display', 'block');
                        $('#lbValuacionGlobalCte_' + Id_Cte).css('display', 'none');
                        $('#lbVG_UtilidadRemanente_' + Id_Cte).css('display', 'none');
                        $('#lbVG_ValorPresenteNeto_' + Id_Cte).css('display', 'none');
                        $('#lbVG_Id_Op_' + Id_Cte).css('display', 'none');
                    }
                });
            }, function () {
                console.log('Error: CrearTablaHija().');
            });
...
//                      },
            ...
            'url': '<%=ApplicationUrl %>' + '/a'url': '<%=ApplicationUrl %>' + ' / api / ObtenerProyectosPorRik / spCRM_SelProyectos ? Id_Rik = 0 & Id_Cte=0', pi/ObtenerProyectosPorRik/spCRM_SelProyectos?Id_Rik=0&Id_Cte=0',
                'dataSrc': ''
        },* /
        /*buttons: [
            {
    ...
    */
        ...
        // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
        $('#tblProyectosIndex tbody').on('click', 'td.details-control', function () {
            ...
            if (row.child.isShown()) {
                ...
                row.child(CrearTablaHija(row.data().Id_Cte, row.data().Id_Ter, 0), 'no-padding').show();
                tr.addClass('shown');
        ...
        $('#ddFiltroClaveOrdenarAsc').click(function () {
            $('#tblProyectosIndex').DataTable().order([0, 'asc']);
            $('#tblProyectosIndex').DataTable().draw(false);
        });
        $('#ddFiltroClaveOrdenarDesc').click(function () {
            $('#tblProyectosIndex').DataTable().order([0, 'desc']);
            $('#tblProyectosIndex').DataTable().draw(false);
        });
        ...
        */
        ...
        function txtCantidad$onchange(sender) {
            ...
            var lstAplicacion = $('#lstAplicacion [item]');
            $.each(lstAplicacion, function (index, item) {
        ...
        */
        ...
        function precargarProyectoSeleccionado(idCte, idOp) {
            ...
            console.log('function precargarProyectoSeleccionado');
            console.log(_proyectoSeleccionado);

            //_proyectoSeleccionado=
            $('#tblProyectosIndex').DataTable().rows().every(function (rowIdx, tableLoop, rowLoop) {
                var data = this.data();
        ...
        */
        ...
        function crearElementoDeListadoDeProductos(E) {
            ...
            var n = $('<div class="list-group-item list-view-pf-stacked list-view-pf-top-align" id="lstElem_' + E.Id_Prd + '" elementoDeLista>' +
                '<div class="list-view-pf-checkbox"><input type="checkbox" style="magin-bottom:5px;"></div>' +
        ...
        function confirmarCancelarProyecto(sender) {
            ...
            servicioCancelarProyecto_Ver2(
                _proyectoSeleccionado.Id_Cte,
                _proyectoSeleccionado.Id_Op,
                idCausa,

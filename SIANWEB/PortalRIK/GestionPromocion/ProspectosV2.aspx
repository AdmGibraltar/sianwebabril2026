...
AutoEventWireup="true" CodeBehind="ProspectosV2.aspx.cs" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphScripts" runat="server">
    ...
    <script src="<%=Page.ResolveUrl("~/js/CRM2/territorio.js?v=20220201")%>"></script>    
    <script src="<%=Page.ResolveUrl("~/js/CRM2/Prospectos2.js?v=20220201")%>"></script>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDINAMOFull.aspx.cs" Inherits="SIANWEB.PortalRIK.GestionPromocion.Reportes.DINAMO.ReporteDINAMOFull" %>
        ...
        <div class="row">
            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-md-12 col-xs-12" style=" min-width:140px;">
                    ...
                    <div runat="server" id="dvContenedorDeReporte" style="overflow:scroll; width: 99%;" visible="false">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li <%=(int)Session["activeMenu"]==1?"class=\"active\"":"" %>><a href="<%=sesion.VersionTerritorio ? Page.ResolveUrl("~/PortalRIK/GestionPromocion/ProspectosV2vT.aspx") : Page.ResolveUrl("~/PortalRIK/GestionPromocion/ProspectosV2.aspx") %>">
                                    ...
                                    <li <%=(int)Session["activeMenu"]==7?"class=\"active\"":"" %>><a href="ReporteDINAMOFull.aspx">

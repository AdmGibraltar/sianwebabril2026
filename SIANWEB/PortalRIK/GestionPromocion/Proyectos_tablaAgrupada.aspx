...
AutoEventWireup="true" CodeBehind="Proyectos_tablaAgrupada.aspx.cs" 
Inherits="SIANWEB.PortalRIK.GestionPromocion.Proyectos_tablaAgrupada" %>
                                        ...
                                        <div class="col-md-12">                                            
                                            ...
                                            <table style="border-collapse:separate; border-spacing:5px;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger" type="button" onclick="EliminarProyecto(this)" id="btnEliminarProyecto">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: center; width: 12%;">                                                                                            
                                                                                        <input type="text" id="txtProductoBusqueda" name="txtProductoBusqueda" class="form-control" style="width:100%;"  placeholder="Clave" 
                                                                                    ...
                                                                                    <td style="text-align: center;" id="tdProductoDescripcion">
                                                                                        <input type="text" id="txtProductoDescripcion" class="form-control" style="width:100%;" readonly="readonly" 
                                                                                    ...
                                                                                    <td style="text-align: center; width: 12%;">
                                                                                        <input type="text" id="txtProductoCantidad" name="COP_Cantidad" class="form-control" style="width:100%;"  
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="text-align: center; width: 12%;">
                                                                                                ...
                                                                                                <input type="text" id="txtProductoBusquedaOtros" class="form-control" placeholder="Clave" 
        ...
        <div class="modal-dialog vertical-center" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="Div3">
                    <h5>Nombre del campo:</h5>
                    <table style="width:100%; border-collapse:separate; border-spacing:0 5px;" >
                        <tr>
                            <td style="width:100px;">Nombre RIK</td>
                            <td>
                                <input id="tbNombreRik" type="text" class="Form-Control" style="width:100%;"  value="" palceholder="Atención" />
                            </td>
                        </tr>                        
                        <tr>
                            <td>Atención (Cliente)</td>
                            <td>
                                <input id="tbNombreAtencion" type="text" class="Form-Control" style="width:100%;"  value="" palceholder="Atención" />
                            </td>
                        </tr>                                                
                        <tr>
                            <td>Representante (Cliente)</td>
                            <td>
                                <input id="tbRepresentanteClienteNombre" type="text" class="Form-Control" style="width:100%;"  value="" palceholder="Atención" />
                            </td>
                        </tr>                                                
                        <tr>
                            <td>Dirección Key</td>
                            <td>
                                <input id="tbDireccion1" type="text" class="Form-Control" style="width:100%;"  value="" palceholder="" />
                            </td>
                        </tr>  
                        <tr>
                            <td></td>
                            <td>
                                <input id="tbDireccion2" type="text" class="Form-Control" style="width:100%;"  value="" palceholder="" />
                            </td>
                        </tr>  
                    </table>                    
                </div>
                    ...
                    <input type="hidden" id="hf_Vap_Estatus2" value="0">
                        ...
                        <div class="row form-inline" id="rowPropuestaAcciones" style="display:none;">                                                
                            ...
                            <button type="button" class="btn btn-default btn-sm" id="btnPropuestaCamposDelReporte">
                                <i class="fa fa-bars fa-2x"></i>&nbsp;Campos adicionales de reportes
                            </button>&nbsp;&nbsp;
...
//                      },
            ...
            function crearTablaHija(datos){                                
                ...
                var elemento=$('<table data-name="TablaHija" class="table table-bordered">'+
                    '<thead>'+
                        '<tr>'+
                            '<th></th>'+
                            '<th>Clave</th>'+
                ...
                $.each(datos.Proyectos, function(index, element){
                    ...
                    var $tdForCheck=$('<td>').append(
                        '<input type="hidden" id="ESTATUS_'+element.Id+'" value="'+ ESTATUS +'">'+
                        '<input type="hidden" id="VAP_ESTATUS_'+element.Id+'" value="'+ VAP_ESTATUS +'">'+
                        '<input type="hidden" id="VAP_ESTATUS2_'+element.Id+'" value="'+ VAP_ESTATUS2 +'">'
                    );
                    $tdForCheck.append(
                    ...
                    var a=$('<a data-idrnd="45775787" data-proyecto_id="'+ element.Id +'" data-vap_estatus="'+ VAP_ESTATUS +'" data-vap-estatus2="'+ VAP_ESTATUS2 + '" >');
                    ...
                    $(a).click(function(){
                        var ESTATUS = element.Estatus;
                        var VAP_ESTATUS = $('#VAP_ESTATUS_'+element.Id).val();
                        var VAP_ESTATUS2 =  $('#VAP_ESTATUS2_'+element.Id).val();
                        // Funcion para desplegar el detalle del proyecto 
                        var renglonActual=elemento.data('_renglonActual');
                        $('#lbDetalleDeProyecto').html('<strong>Detalles del proyecto : '+element.Id);
                    ...
                    //
                    // Aqui se despliegan las columnas de Editar Valuacion y Propuesta.
                   ...
                   /* if(element.Cancelado==true){
                    ...
                    if(element.CrmValuacionOportunidades!=null)
                    {
                        ...
                        if(element.UtilidadRemanente!=null)
                        {
                            ...
                            var bhColor = 1;
                            if(element.UtilidadRemanente<0) 
                        ...
                        if(element.ValorPresenteNeto!=null)
                        {
                       ...
                       // case 0:
                       //     $(tr).append($('<td data-idrnd="22345667">Autorizado</td>'));
                       // break;
                       // case 1:
                        //    $(tr).append($('<td data-idrnd="87646546">Autorizando</td>'));
                        //break;
                        //}
                        switch(AutorizandoAutroizado) {
                            //JFCV control cambios valuacion 
                        case 0:
                            if (element.Vap_Estatus == 'A' && element.Vap_Estatus2 == 0) {
                                $(tr).append($('<td data-idrnd="87646548" style="text-align:center;color: rgb(255,255,255); font-weight: bold;"  >Val. Precios</td>'));
                                }
                                else {
                    ...
                    if(element.CrmValuacionOportunidades!=null)
                    {
                        ...
                        if(element.CrmValuacionOportunidades.CapValProyectoSerializable!=null)
                        {
                            ...
                            */
                            ...
                            var Vap_Estatus2 = element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus2;
                            var Vap_Estatus = element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_Estatus;
                            var Vap_UtilidadRemanente = element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_UtilidadRemanente;
                            var Vap_ValorPresenteNeto = element.CrmValuacionOportunidades.CapValProyectoSerializable.Vap_ValorPresenteNeto;

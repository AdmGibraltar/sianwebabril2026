...
<div class="table-responsive" style="display: inline !important;">
    <% if (ConteoValuacionesAAutorizar > 0)
       {%>
    <table id="tblValuacionesAutorizacion_<%=this.ClientID %>" style="margin-bottom: 0px" class="table table-hover">
        <thead>
            <tr>
...
<script type="text/javascript">
    ...
    function AutorizarPregunta(idVal) {
        alertify.confirm("Atenci&oacute;n', 'Est&aacute; a punto de autorizar la valuaci&oacute;n:" + idVal + " ¿Est&aacute; seguro de que desea continuar?", function (ev) {
            ev.preventDefault();

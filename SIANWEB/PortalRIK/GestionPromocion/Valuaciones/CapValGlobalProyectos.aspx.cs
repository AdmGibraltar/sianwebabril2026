...
namespace SIANWEB.PortalRIK.GestionPromocion.Valuaciones
{
        ...
        : BaseServerPage
    {
        ...
        private double PartidasCalcularPrecioLista(int Id_Emp, int Id_Cd, int Id_Cte, Int64 Id_Prd, string Conexion)
        {
        ...
        private double PartidasCalcularPrecioAAA(int Id_Emp, int Id_Cd, int Id_Cte, Int64 Id_Prd, string Conexion)
        {
            double precioProductoAceptado = 0;
            //obtener precio especial del producto 
            //para el cliente actual de la factura

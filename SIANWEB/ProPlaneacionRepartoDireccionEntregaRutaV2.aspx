<%@ Page Language="C#"
    ...
    CodeBehind="ProPlaneacionRepartoDireccionEntregaRutaV2.aspx.cs"
    Inherits="SIANWEB.ProPlaneacionRepartoDireccionEntregaRutaV2" %>
    ...
    <script>
        function agregarDirEntrega() {
            ...
            jQuery.ajax({
                ...
                url: 'ProPlaneacionRepartoDireccionEntregaRutaV2.aspx/AgregarDirEntrega',

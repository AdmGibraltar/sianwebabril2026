    ...
    public partial class Rep_SerBaseInstalada : System.Web.UI.Page
    {
        ...
        private void Abrir_Reporte(bool a_pantalla)
        {
            try
            {
                ...
                ALValorParametrosInternos.Add(txtNumeroCliente.Text == "" ? (object)null : txtNumeroCliente.Text);//new CN__Comun().DesgloceRangoProductos(txtCliente.Text.Trim()));//Cliente
                ...
                ALValorParametrosInternos.Add((txtRepresentante.Text == "" || txtRepresentante.Text == "0") ? (object)null : txtRepresentante.Text);// new CN__Comun().DesgloceRangoProductos(txtRepresentante.Text.Trim()));
                ALValorParametrosInternos.Add(cmbAño.SelectedValue);

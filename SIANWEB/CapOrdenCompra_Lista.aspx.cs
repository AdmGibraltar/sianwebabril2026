            ...
            try
            {
                ...
                if (listaOrdCompraDet.Count() > 0)
                {
                    foreach (OrdenCompraDet ocd in listaOrdCompraDet)
                    {
                        ...
                        if (ApiSAPDetalle != ""){
                            ApiSAPDetalle = ApiSAPDetalle + ",";
                        }

                        ApiSAPDetalle = ApiSAPDetalle + "{";
                        ApiSAPDetalle = ApiSAPDetalle + "'oczonnumsian': " + ocd.Id_Cd + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocnumsian': " + ocd.Id_Ord + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocpronumsian': " + ocd.Id_Prd + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocprodescsian': '" + ocd.Producto.Prd_Descripcion.ToString().Replace("\"", "").Replace("'", "").Replace("&", "") + "',";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocpropresensian': " + ocd.Producto.Prd_Presentacion + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocprounidadsian': '" + ocd.Producto.Prd_UniNe + "',";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocprocostosian': " + ocd.ProductoPrecio.Prd_Pesos + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'occantidadsian': " + ocd.Ord_Cantidad + ",";
                        ApiSAPDetalle = ApiSAPDetalle + "'ocimportesian': " + importe + "}";

                    }
                }


                String ApiSAPEncabezado = "";
                ...
                ApiSAPEncabezado = "{'oczonnumsian': " + ordCompra.Id_Cd.ToString() + ",";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczondescsian': '" + Cd.Cd_Descripcion.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocnumsian': " + ordCompra.Id_Ord.ToString() + ",";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocusunumsian': " + ordCompra.Id_Pvd.ToString() + ",";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocusunomsian': '" + Cd.Cd_Descripcion.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocfechasian': '" + string.Format("{0:s}", ordCompra.Ord_Fecha) + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocfechamacola': '" + string.Format("{0:s}", ordCompra.Ord_Fecha) + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocusunummacola': 0,";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocusunommacola': '100',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczoncallesian': '" + Cd.Cd_Calle.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczoncolsian': '" + Cd.Cd_Colonia.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczoncd': '" + Cd.Cd_Descripcion.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczonedo': '" + Cd.Cd_Descripcion + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczonlnum': '" + Cd.Cd_Numero.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'oczoncpsian': '" + Cd.Cd_CP.ToString() + "',";
                ApiSAPEncabezado = ApiSAPEncabezado + "'octotalsian': 0,";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocinvsian': " + ordCompra.Id_Ord.ToString() + ",";
                String ValorTran = Cd.Cd_NumMacola != null ? Cd.Cd_NumMacola.ToString() : Cd.Id_Cd.ToString();

                ApiSAPEncabezado = ApiSAPEncabezado + "'octransian': " + ValorTran + ",";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocestatus': true,";
                ApiSAPEncabezado = ApiSAPEncabezado + "'ocnumlocmacola': '100',";


                String ApiSAP = "";

                ApiSAP = ApiSAPEncabezado + "\"ocs\":[" + ApiSAPDetalle + "]}";
                ...
                //EnvioOrdencompra = 1 Macola, = 2 Macola y SAP, =3 SAP

                //Revisa configuracion

                object sianEnvioOrdendeCompraResult = null;

                if (EnvioOrdencompra == 1 || EnvioOrdencompra == 2)
                {
                    OrdendeCompra.Service1 sianEnvioOrdendeCompra = new OrdendeCompra.Service1();
                    sianEnvioOrdendeCompraResult = sianEnvioOrdendeCompra.OrdenCompra(xmlString);
                }
                // xmlOrdenCompra.LoadXml(sianEnvioOrdendeCompraResult.ToString());
                if (EnvioOrdencompra == 2 || EnvioOrdencompra == 3)
                {
                    System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
                    string URL = "http://keyquimica.vertrou.mx:82/api_ocsian/api/oc";
                    HttpClient client = new HttpClient();
                    client.BaseAddress = new Uri(URL);

                    string json = ApiSAP.Replace("'", "\"");
                    string jsonString = "";
                    string estatus = "";
                    string message = "";
                    ...
                    while (jsonString == null || jsonString == "")
                    {
                        try
                        {
                            ...
                            var response = client.PostAsync(URL, data).Result;    //try
                            ...
                            estatus = blogObject.status.ToString();
                    ...
                    if (estatus == "True")
                    {
                        sianEnvioOrdendeCompraResult = 1;
                    } else
                    {
                        // if (message.Substring(message.Length - 18, 18) == "ya está descargada")
                        if ((message.Contains("ya está descargada")) || (message.Contains("actualmente existe")))
                        {
                            sianEnvioOrdendeCompraResult = 2;
                        } else {
                            sianEnvioOrdendeCompraResult = 3;
                        }
                    }

<%@ Page Title="Reporte comisiones" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master" AutoEventWireup="true" CodeBehind="RepComisiones.aspx.cs" Inherits="SIANWEB.RepComisiones" %>
                            ...
                            <td colspan= "2">
                                <telerik:RadComboBox ID="cmbTipoReporte" runat="server" Width="150px" >
                                   <Items>   
                                       ...
                                       <telerik:RadComboBoxItem runat="server" Text="Comisiones (diferenciadas)" Value = "comisiondiferenciada" />   

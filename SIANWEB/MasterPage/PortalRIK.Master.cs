...
namespace SIANWEB.MasterPage
{
    ...
    {
        public int countNotiProyCentral;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CargaNotiProyecCentral();
        }

        public void CargaNotiProyecCentral()
        {
            CN_VinculacionNotificacion oCN_VinculacionNotificacion = new CN_VinculacionNotificacion();
            countNotiProyCentral = oCN_VinculacionNotificacion.Consultar_CountNoti(Sesion.Id_Cd, Sesion.Id_Rik, Sesion.Emp_Cnx);
        }

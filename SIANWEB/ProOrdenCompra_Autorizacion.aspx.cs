    ...
    public partial class ProOrdenCompra_Autorizacion : System.Web.UI.Page
    {
        ...
        protected void rgOrdenCompra_DeleteCommand(object sender, GridCommandEventArgs e) 
        {
            try {
                ...
                long Id_PrdFac = Convert.ToInt32(itemAde.OwnerTableView.DataKeyValues[itemAde.ItemIndex]["Id_Prd"]);
                string eliminar = "SI";
        ...
        protected void listaPartidas_EliminarProducto(long Id_Prd, int Id_Ord)
        {
            try
            {
                DataRow[] Ar_dr;
        ...
        protected void rgOrdenCompra_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                long Id_Prd = Convert.ToInt32(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["Id_Prd"]);

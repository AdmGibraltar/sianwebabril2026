...
function ExportExcel_Ordenes_BajarReporteExcel(Data) {
    ...
    var headers=["Folio","Ver","Estatus","Núm","Cliente","Terr.","Rik",
    ...
    for (var i=0; i<Data.length; i++) {             
        ...
        excel.set(0,0,line,Data[i].Id_Acs, formatCell_C);                    
        excel.set(0,1,line,Data[i].Id_AcsVersion, formatCell);                    
        excel.set(0,2,line,Data[i].Acs_EstatusTexto, formatCell);                    
        excel.set(0,3,line,Data[i].Id_Cte, formatCell);                    
        excel.set(0,4,line,Data[i].Cte_NomComercial, formatCell);                    
        excel.set(0,5,line,Data[i].Id_Ter, formatCell);                    
        excel.set(0,6,line,Data[i].Id_Rik, formatCell);                    
        excel.set(0,7,line,Data[i].Acs_Fecha, formatCell);                    
        excel.set(0,8,line,Data[i].Acs_FechaInicio, formatCell);                    
        excel.set(0,9,line,Data[i].Acs_FechaFin, formatCell);                    
        excel.set(0,10,line,Data[i].Acs_Vencido, formatCell);                    
        excel.set(0,11,line,Data[i].Acs_Modalidad, formatCell);                    
        line = line+1;
    }
...
function Terr_BajarReporteExcel(Data) {
    //var Periodo = $('#ddPeriodo option:selected').text();
    ...
    var Fecha = new Date();
    Fecha = Fecha.format("dd/mm/yyyy");
    excel.set(0,0,line,"Modulo - ", formatTitulo);             
    excel.set(0,0,line+1,"", formatTitulo);             
    excel.set(0,0,line+1,"", formatTitulo);             
    excel.set(0,0,line+2,"Fecha: "+Fecha, formatTitulo);             
    //excel.set(0,0,line+3,"Periodo: "+Periodo, formatTitulo);             
    ...
    // Titulos de Celda
    var headers=["Territorio","Descripción","UEN","Representante","Segmento","Tipo cliente","TR","Estatus"];                            
    ...
    for (var i=0; i<Data.length; i++) {             
        // Imprime registro Normal
        excel.set(0,0,line,Data[i].Id_Ter, formatCell_C);                    
        excel.set(0,1,line,Data[i].Descripcion, formatCell);                    
        excel.set(0,2,line,Data[i].Uen_Descripcion, formatCell);                    
        excel.set(0,3,line,Data[i].Rik_Nombre, formatCell);                    
        excel.set(0,4,line,Data[i].Seg_Nombre, formatCell);                    
        excel.set(0,5,line,Data[i].TipoCliente_Nombre, formatCell);                    
        excel.set(0,6,line,Data[i].TipoRepresentante_Nombre, formatCell);                    

        if (Data[i].Estatus == true) {
            excel.set(0,7,line,'Activo', formatCell);                           
        } else {
            excel.set(0,7,line,'Inactivo', formatCell);                           
        }          
        line = line+1;
    }
    ...
    */    
    ...
    //Periodo=Periodo.replace(/-/g,'');
    excel.generate("Reporte_Territorios_"+ "1" +".xlsx");
}      

// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
/*
function Terr_BajasReporte() {

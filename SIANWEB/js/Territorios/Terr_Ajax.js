...
// RBM
function Cargar_TiposTerritorios(Movimiento,  CALLBACK_Exito) {
    ajax_CL_Cargar_TiposTerritorios(Movimiento, function (lst) {
        $('#ddlTipoTerritorio').empty();
        //$('#ddlTipoTerritorio').append('<option value="" >-- Seleccione -- </option>');
        for (i = 0; i < lst.length; i++) {
            $('#ddlTipoTerritorio').append('<option value="' + lst[i].Id_Tipo + '" >' + lst[i].Descripcion + '</option>');
        }
        if (CALLBACK_Exito) {
            CALLBACK_Exito();
        }
...
function ajax_CL_Cargar_TiposTerritorios(Movimiento, CallBack_Exito) {
    var ajax_urls = _ApplicationUrl + '/api/Territorio/Get_ListadoTipoTerritorio?Movimiento=' + Movimiento;
    ...
    $.ajax({
        ...
        if (Estado == 1) {
            ...
            alertify.error('Error en ajax_CL_Cargar_TiposTerritorios');

...
function Terr_BajarReporteExcel(Data) {
    ...
    // Titulos de Celda
    var headers = ["Territorio", "Descripción", "Representante", "Tipo cliente", "TR", "Estatus"];
    ...
    for (var i = 0; i < Data.length; i++) {
        ...
        excel.set(0, 2, line, Data[i].Rik_Nombre, formatCell);
        //excel.set(0,4,line,Data[i].Seg_Nombre, formatCell);                    
        excel.set(0, 3, line, Data[i].TipoCliente_Nombre, formatCell);
        excel.set(0, 4, line, Data[i].TipoRepresentante_Nombre, formatCell);

        if (Data[i].Estatus == true) {
            excel.set(0, 5, line, 'Activo', formatCell);
        } else {
            excel.set(0, 5, line, 'Inactivo', formatCell);
        }
        line = line + 1;
    }

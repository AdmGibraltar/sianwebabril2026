...
Gerente.js
14 Jun 2018 RFH
13 Dic 2018 .- Columna de No de Cliente en listado de prospectos. 
OCT18-2019 RFH Se corrige problma para Gerentes, el listado de prospectos es incorrecto.
*/
...
function Incializa_Gerente(GModulo) {
    ...
    if (_Parametro_IdTU == 3) {
        ...
        //JFCV Si es gerente la opción de Leads Riks no se activa 
        $('#collapseOne li:nth-child(5) a').text('');
        $('#collapseOne li:nth-child(5) a').css('display', 'block');
        ...
        //JFCV Si es rik no se activa la opción de Leads 
        $('#collapseOne li:nth-child(3) a').text('');
        $('#collapseOne li:nth-child(3) a').css('display', 'block');

...
(function () {
    ...
    function generateCell(cell, column, row) {
        ...
        // better numeric test: treat actual numbers or numeric strings as numbers
        var isNumeric = (typeof value === 'number') || (!isNaN(value) && value !== '');
        if (!isNumeric) {
            // value is non-numeric string (could be a formula)

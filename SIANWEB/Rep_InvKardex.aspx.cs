...
namespace SIANWEB
{
    public partial class Rep_InvKardex : System.Web.UI.Page
    {
        #region Variables
        ...
        private void Imprimir(bool a_pantalla)
        {
            try
            {
                ...
                if (error == 0)
                {
                    ...
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_InvKardex);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_InvKardex);
                    }
                    if (a_pantalla)
                    {
        ...
        private void CargarAnoMes()
        {
            try
            {
                ...
                this.cmbanio.SelectedValue = sesion.AnioActual.ToString();
                this.cmbmes.SelectedValue = sesion.MesActual.ToString();
            }
            catch (Exception ex)
            {
        ...
        private void CargarFechas()
        {
            try
            {
                ...
                if (sesion.AnioActual >= int.Parse(cmbanio.SelectedValue))
                {

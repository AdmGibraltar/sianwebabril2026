<%@ Page Title="Reporte GAP Gerente"   Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master"
    CodeBehind="ReporteGAPGerente.aspx.cs" Inherits="SIANWEB.ReporteGAPGerente" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH" runat="server">
    ...
    <link href="<%=Page.ResolveUrl("~/js/jquery-ui-1.11.4.custom/jquery-ui.min.css")%>" rel="stylesheet">
     ...
     function onCustomButtonClick(s, e) {
               var año = CPH_CmbAnio.GetValue().toString();
                var mes = CPH_CmbMes.GetValue().toString();
         if (e.buttonID == 'PorCliente') {
             rowVisibleIndex = e.visibleIndex;
             window.open("ReporteGAPRik.aspx?Id=" + s.GetRowKey(e.visibleIndex) + "&Año=" + año + "&Mes=" + mes, "_self");
             /* s.GetRowValues(e.visibleIndex, 'ID', ShowPopup);*/
         }
         else {
             window.open("ReporteGAPRikProducto.aspx?Id=" + s.GetRowKey(e.visibleIndex) + "&Año=" + año + "&Mes=" + mes, "_self");
         }

         //ya no habre en forma modal porque no aparecen 
         //la paginación y el scrooll 
         //AbrirVentana_ReporteRik(s.GetRowKey(e.visibleIndex), año, mes);
     ...
     //var oWnd = radopen("CapLeads.aspx?Id=" + Id_PC + "&PC_NoConvenio=" + PC_NoConvenio + "&PC_Nombre=" + PC_Nombre + "&Id_CatStr=" + Id_CatStr, "Ventana_VincularSucursal");
            ...
            function AbrirVentana_ReporteRik(idrik, año, mes) {
            $('#modalAutorizarSol').modal('hide');
                document.getElementById('<%=FrameInventario.ClientID%>').src = "ReporteGAPRik.aspx?Id=" + idrik + "&Año=" + año + "&Mes=" + mes;
              ...
              <asp:UpdatePanel runat="server" ID="updpanel2">
                        <ContentTemplate>
                            ...
                            <PropertiesTextEdit DisplayFormatString="p2" />
                                        ...
                                        <dx:bootstrapgridviewtextcolumn width="50px" fieldname="MgRedPO_Porc" caption="Margen CDI Objetivo %" visible="true">
                                            <propertiestextedit displayformatstring="p2" />
                                        </dx:bootstrapgridviewtextcolumn>
                            ...
                            ,  ,   ,  ,  MgRedPO_Porc   ,    ,    ,IdUsuario  , FechaAlta  , FechaUltMod  , Mes  , Año  ,FechaInicial  , FechaFinal  ,    
                                        ...
                                        <dx:bootstrapgridviewtextcolumn fieldname="NomEstatus" caption="Seleccionar" width="100px" visible="false" />
                                        <dx:bootstrapgridviewcommandcolumn caption="Consultar" width="150px">
                                            <custombuttons>
                                                <dx:bootstrapgridviewcommandcolumncustombutton iconcssclass="fa fa-user" id="PorCliente" />
                                                <dx:bootstrapgridviewcommandcolumncustombutton iconcssclass="fa fa-edit" id="PorProducto" />
    ...
    <div class="modal fade" id="modalAutorizarSol" style="height: 1000px !important" class="modal"
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="col-md-10">
                    <h4 style="color: #45709b;" id="h1">Reporte de GAP por Rik 
                    </h4>
                </div>
            </div>
            <div>

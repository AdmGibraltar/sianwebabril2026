...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <style>
        #RAD_SPLITTER_PANE_CONTENT_ctl00_CPH_RadPane2 {
    ...
    <telerik:RadAjaxManager ID="RAM1" runat="server" EnablePageHeadUpdate="False" OnAjaxRequest="RAM1_AjaxRequest1">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RadPageViewCargaArchivo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                                    ...
                                    <div runat="server" id="Generales">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadDatePicker ID="rdFechaPago" runat="server" Width="100px" Culture="es-MX" OnSelectedDateChanged="rdFechaPago_SelectedDateChanged" AutoPostBack="true">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cmbMovimiento" runat="server" Width="350px" Filter="Contains"
                                                        ...
                                                        LoadingMessage="Cargando..." OnClientSelectedIndexChanged="cmb_ClientSelectedIndexChanged" AutoPostBack="true"
                                                        OnClientFocus="_PreValidarFechaEnPeriodo" OnSelectedIndexChanged="cmbMovimiento_SelectedIndexChanged" >
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                    ...
                                                    <telerik:RadSplitter ID="RadSplitter4" runat="server" Height="270px" ResizeMode="AdjacentPane"
                                                        ...
                                                        <telerik:RadPane ID="RadPane4" runat="server" Height="270px" BorderStyle="None" OnClientResized="onResize">
                                                            <telerik:RadGrid ID="RgGral" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                                ...
                                                                OnUpdateCommand="RgGral_UpdateCommand"
                                                                OnItemDataBound="RgGral_ItemDataBound"
                                                                >
                                                                <MasterTableView NoMasterRecordsText="No se encontraron registros." CommandItemDisplay="Top"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridTemplateColumn DataField="Pag_Fecha" HeaderText="Fecha Pag." UniqueName="Pag_Fecha">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <telerik:GridTemplateColumn HeaderText="Num Operación" DataField="Pag_NumOperacion" UniqueName="Pag_NumOperacion">
                                                                            <HeaderStyle Width="120px" HorizontalAlign="Center" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="LblNumOperacion" runat="server" Text='<%# Eval("Pag_NumOperacion").ToString() %>' />
                                                                            </ItemTemplate>
                                                                            <EditItemTemplate>
                                                                                <telerik:RadTextBox Width="100px" ID="txtNumOperacion" runat="server" ReadOnly="false"
                                                                                    Text='<%# Eval("Pag_NumOperacion").ToString() %>'>
                                                                                </telerik:RadTextBox>
                                                                            </EditItemTemplate>
                                                                        </telerik:GridTemplateColumn>
                                                            ...
                                                            <telerik:GridTemplateColumn DataField="Pag_RefBancaria" HeaderText="Referencia Bancaria" UniqueName="Pag_RefBancaria">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPag_RefBancaria" runat="server" Text='<%# Bind("Pag_RefBancaria") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadTextBox ID="txtPag_RefBancaria" runat="server" Text='<%# Bind("Pag_RefBancaria") %>' OnTextChanged="txtPag_RefBancaria_TextChanged"
                                                                        Width="50px" MaxLength="11" AutoPostBack="true">
                                                                        <ClientEvents OnKeyPress="handleClickEvent" />
                                                                    </telerik:RadTextBox>
                                                                </EditItemTemplate>
                                                                <ItemStyle HorizontalAlign="Right" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn DataField="Pag_Fecha" HeaderText="Fecha" UniqueName="Pag_Fecha">
                                                                ...
                                                                <EditItemTemplate>
                                                                    <telerik:RadDatePicker ID="rdFecha" runat="server" DbSelectedDate='<%# Bind("Doc_Fecha") %>'
                                                                        Width="90px" MinDate="01/01/0001" MaxDate="<%# DateTime.Today %>" Enabled="false">
                                                                        <Calendar ID="Calendar1" runat="server">
                                                                            <FastNavigationSettings CancelButtonCaption="Cancelar" OkButtonCaption="Aceptar"
                                                                                TodayButtonCaption="Hoy">
                                                                            </FastNavigationSettings>
                                                            ...
                                                            <telerik:GridTemplateColumn DataField="Pag_Importe" HeaderText="Importe" UniqueName="Pag_Importe">
                                                                ...
                                                                <EditItemTemplate>
                                                                    ...
                                                                    <telerik:RadNumericTextBox ID="RadNumericTextBox1" Visible="false" runat="server" Text='<%# Bind("Pag_ImporteReal") %>'
                                                                        Width="50px" MinValue="0" MaxLength="9">
                                                                        <NumberFormat DecimalDigits="2" AllowRounding="true" />
                                                                        <ClientEvents OnKeyPress="handleClickEvent" />
                                                                        <EnabledStyle HorizontalAlign="Right" />
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_PagoDif(idPag) {
                var oWnd = radopen("CapPago_Dif.aspx?idPagina=" + idPag, "AbrirVentana_DifPago");
                oWnd.center();
                //return true;
            ...
            function ValidarFichas(sender, args) {
                ...
                /*
                david bustamante
                quite esta validacion para cargar los pagos a traves del excel
                */

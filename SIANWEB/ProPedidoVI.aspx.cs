    ...
    public partial class ProVentInst_PedidoCap : System.Web.UI.Page
    {
        ...
        private void Guardar()
        {
            try
            {
                ...
                bool _PermisoGuardar = bool.Parse(Request.QueryString["PermisoGuardar"].ToString());
                bool _PermisoModificar = bool.Parse(Request.QueryString["PermisoModificar"].ToString());
                rtb1.Enabled = false;
                if (dt.Rows.Count == 0)
                {
        ...
        private void CargarTerritorios()
        {
            try
            {
                ...
                if (txtTerritorioNom.Items.Count > 0)
                {
                    txtTerritorioNom.SelectedIndex = 0;
                ...
                else
                {
                    if (Request.QueryString["id"] != "-1")
                    {
                        ...
                        {
                            txtTerritorioNom.SelectedIndex = 0;
                            txtTerritorioNom.Text = txtTerritorioNom.Items[0].Text;
                            txtIdTer.Text = txtTerritorioNom.Items[0].Value;
                        }
                    }
                    else
                    {

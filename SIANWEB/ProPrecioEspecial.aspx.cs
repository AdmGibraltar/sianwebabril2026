    ...
    public partial class Ventana_PrecioEspecial : System.Web.UI.Page
    {
        ...
        protected void cmbProductoDet_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    cnProducto.ConsultaProducto(ref prd, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, Convert.ToInt32((sender as RadNumericTextBox).Value.HasValue ? (sender as RadNumericTextBox).Value : -1),1);
                }
                catch (Exception ex)
                {
        ...
        private void PerformInsert_rgCliente(GridCommandEventArgs e)
        {
            ...
            CN_PrecioEspecial CN_PrecioEspecial = new CN_PrecioEspecial();
            CN_PrecioEspecial.ConsultaVentanaPrecioEspecial_ComboCliente(Id_Emp, Id_Cd, Id_Cte, session.Emp_Cnx, ref Cte_NomComercial, session.VersionTerritorio);

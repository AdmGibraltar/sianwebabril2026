                ...
                <tr>
                    ...
                    <td>
                        <select id="ddlTipoRepresentante" class="form-control w100">
                            ...
                            <option value="7">Servicio Técnico</option>
                        </select>
                    </td>
                </tr>
            </table>
        ...
        <div class="modal-content" style="width:100%;">
            ...
            <div class="modal-body" id="Div5">
                ...
                <input type="hidden" id="hfIdInsertUpdate" value="0" />
                    ...
                    <div id="div_Uen" class="tbl-Oculto">               
                    <table>
                        <tr>
                    ...
                    <div id="div_Segmento" class="tbl-Oculto">               
                        <table  id="trSegmento">
                            <tr>
                    ...
                    <div id="dev_tipoCliente" class="tbl-Visible">
                        <table>                        
                            <tr>
                ...
                <div class="modal-footer">                                    
                    ...
                    <button class="btn btn-primary" id="btnTerritorio_Guardar">Guardar</button>            
            </div>
        </div>
    </div>
</div>
...
<!--\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ -->
     ...
     <script type="text/javascript">
         ...
         function ValidarNombre(val) {
             ...
             const tbIdLocal = document.getElementById("tbIdLocal"); // Asegúrate de tener este elemento en tu HTML
             ...
             for (let i = 0; i < palabrasProhibidas.length; i++) {
                 if (valor.includes(palabrasProhibidas[i])) {
                     ...
                     return; // Salir de la función si se encuentra una palabra prohibida
                 }
             }

             // Si no hay palabra prohibida, ocultar el mensaje de error
             mensajeError.textContent = "";
             mensajeError.style.display = "none";
         }
     </script>
    ...
    <script src="<%=Page.ResolveUrl("~/js/Territorios/Terr_ExcelvT.js?v=20241210")%>"></script>
    ...
    <script src="<%=Page.ResolveUrl("~/js/Territorios/Terr_PaginacionvT.js?v=20241210")%>"></script>
    ...
    <script src="<%=Page.ResolveUrl("~/js/Territorios/Terr_MainvT.js?v=20260420")%>"></script>

...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    </script><telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Default">
    ...
    <telerik:RadAjaxManager ID="RAM1" runat="server" OnAjaxRequest="RAM1_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="txtProductoID">
              ...
              <telerik:AjaxSetting AjaxControlID="txtDescripcion">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal"  UpdatePanelHeight="" LoadingPanelID="RadAjaxLoadingPanel1"/>
                </UpdatedControls>
            </telerik:AjaxSetting>
     ...
     <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
        <Windows>
              <telerik:RadWindow ID="EnviarComentariosTerritorios" runat="server" Behaviors="Move"
                Opacity="100" VisibleStatusbar="False" Width="700px" Height="350px" Animation="Fade"
                ShowContentDuringLoad="false" KeepInScreenBounds="True" Overlay="True" Title="Motivo de Cambio"
                ...
                <td valign="middle">
                    <telerik:RadTabStrip ID="RadTabStripPrincipal" runat="server" MultiPageID="RadMultiPagePrincipal"
                        ...
                        <Tabs>
                            ...
                            <telerik:RadTab PageViewID="RadPageViewClienteProducto" Text="Cliente <u>P</u>roducto" AccessKey="P" Visible="false">
                            </telerik:RadTab>
                            ...
                            <telerik:RadTab PageViewID="RadPageViewCamposUsuario" Text="Campos de <u>U</u>suario" AccessKey="U"  Visible="false">
                            </telerik:RadTab>
                        </Tabs>
                    </telerik:RadTabStrip>
                    <telerik:RadMultiPage ID="RadMultiPagePrincipal" runat="server" SelectedIndex="0"
                                    ...
                                    <td valign="middle">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td valign="middle">
                                                    <telerik:RadTextBox ID="txtDescripcion" runat="server" OnTextChanged="txtDescripcion_TextChanged"   AutoPostBack="true" MaxLength="250" onpaste="return false"
                                                        Width="255px">
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="middle" width="120">
                                                    <asp:Label ID="Label20" runat="server" Text="Nombre Comercial"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadTextBox ID="txtMarcaComercial" runat="server" MaxLength="50" onpaste="return false" Width="255px">                                                       
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td valign="middle">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtMarcaComercial"
                                                        Display="Dynamic" ErrorMessage="*Requerido" ForeColor="Red" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbPais" runat="server" DataTextField="Descripcion" DataValueField="Id"  Filter="Contains" HighlightTemplatedItems="True" LoadingMessage="Cargando..."  Width="255px" AutoPostBack="True" OnSelectedIndexChanged="cmbPais_SelectedIndexChanged">
                                                        <Items>
                                                            <telerik:RadComboBoxItem runat="server" Text="-- Seleccionar --" Value="-- Seleccionar --" />
                                                        </Items>
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td style="width: 50px; text-align: center" valign="middle">
                                                                        <asp:Label ID="lblId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' Width="50px" />
                                                                    </td>
                                                                    <td style="width: 200px; text-align: left" valign="middle">
                                                                        <asp:Label ID="lblDesc" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                                ...
                                                <td class="style1" valign="middle">
                                                    <telerik:RadComboBox ID="cmbEstado" runat="server" DataTextField="Descripcion" DataValueField="Id"  LoadingMessage="Cargando..." MarkFirstMatch="True" Width="255px" >
                                                        <Items>
                                                            <telerik:RadComboBoxItem runat="server" Text="-- Seleccionar --" Value="-- Seleccionar --" />
                                                        </Items>
                                                        <ItemTemplate>
                                        ...
                                        <table style="width: 833px">
                                            <tr>
                                                ...
                                                <td valign="middle" width="120">
                                                    <asp:Label ID="Label145" runat="server" Text="Regimen Fiscal"></asp:Label>
                                                <td valign="middle">

                                                    <telerik:RadComboBox ID="cmbRegimenFiscal" runat="server" ChangeTextOnKeyBoardNavigation="true" EnableLoadOnDemand="true" Filter="Contains" LoadingMessage="Cargando..." MarkFirstMach="true" OnClientBlur="Combo_ClientBlur" Width="350px">
                                                    </telerik:RadComboBox>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" width="200">
                                                    <asp:HiddenField ID="HF_ID" runat="server" />
                                                     ...
                                                     <asp:HiddenField ID="HF_Nombre" runat="server" />
                                                     <asp:HiddenField ID="HF_PC_Nombre" runat="server" />
                                                     <asp:HiddenField ID="HF_PC_NoConvenio" runat="server" />
                                                     <asp:HiddenField ID="HF_Concesionario" runat="server" />
                                                     <asp:HiddenField ID="HF_Id_PC" runat="server" />
                                                     <%--JFCV ene 2019--%>
                        ...
                        <telerik:RadPageView ID="RadPageViewDireccionesEntrega" runat="server">
                            <table>
                                ...
                                <tr>
                                    <td valign="middle">
                                        <asp:Label ID="lblPaisEntrega" runat="server" Text="País"></asp:Label>
                                    </td>
                                    <td valign="middle">
                                        <telerik:RadComboBox ID="cmbEPais" runat="server" AutoPostBack="True" DataTextField="Descripcion" DataValueField="Id" Filter="Contains" HighlightTemplatedItems="True" LoadingMessage="Cargando..." OnSelectedIndexChanged="cmbEPais_SelectedIndexChanged" Width="255px">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Text="-- Seleccionar --" Value="-- Seleccionar --" />
                                            </Items>
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td style="width: 50px; text-align: center" valign="middle">
                                                            <asp:Label ID="lblId1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' Width="50px" />
                                                        </td>
                                                        <td style="width: 200px; text-align: left" valign="middle">
                                                            <asp:Label ID="lblDesc1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                    ...
                                    <td class="style1" valign="middle">
                                        <telerik:RadComboBox ID="cmbEestado" runat="server" DataTextField="Descripcion" DataValueField="Id" LoadingMessage="Cargando..." MarkFirstMatch="True" Width="255px">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Text="-- Seleccionar --" Value="-- Seleccionar --" />
                                            </Items>
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td style="width: 50px; text-align: center" valign="middle">
                                                            <asp:Label ID="lblId0" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' Width="50px" />
                                                        </td>
                                                        <td style="width: 200px; text-align: left" valign="middle">
                                                            <asp:Label ID="lblDesc0" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <tr>
                                    <td colspan="9">
                                        <table cellpadding="0" cellspacing="0" width="50%">
                                            ...
                                            <tr>
                                                <td colspan="3">Geolocalización:<asp:Image ID="Image1" runat="server" ImageUrl="img\geo.png" OnClick="popup();"/></td>
                                                <td colspan="4"># Cuadrante:<telerik:RadTextBox ID="txtCuadranteG" runat="server" MaxLength="20" onpaste="return false" Width="50px"></telerik:RadTextBox></td>
                                                <td colspan="2">Ruta:
                                            ...
                                            <tr>
                                                <td colspan="9" align="right"><asp:Button ID="BtnAgregarDirEntrega" runat="server" Text="Agregar" OnClick="Click_BtnAgregarDirEntrega" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="9">
                                        <asp:Panel runat="server" ID="pnlGridDireccionesEntrega" Width="944px" ScrollBars="Horizontal">
                                            <telerik:RadGrid ID="rgDireccionesEntrega" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                ...
                                                Height="420px" MasterTableView-CommandItemSettings-ShowAddNewRecordButton ="false" >
                                                <MasterTableView CommandItemDisplay="Top" EditMode="InPlace">
                                                    ...
                                                    <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" Text="Borrar"
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Ruta" UniqueName="ERuta_Entrega">
                                                            <ItemTemplate>
                                                                <%--<asp:Label ID="Label122" runat="server" Text=" - " />--%>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Ruta_Entrega") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:Label ID="lblold2" runat="server" Text='<%# Bind("Ruta_EntregaId_Rut") %>' Visible="true" />
                                                               <%-- <asp:Label ID="LabelSeg_Descripcion" runat="server" Text='<%# Bind("Seg_Descripcion") %>' />--%>
                                                                <telerik:RadComboBox ID="cmbRutaEntrega" runat="server" OnDataBinding="cmbRuta_Entrega_DataBinding"
                                                                   MarkFirstMatch="true" OnItemDataBound="Ruta_Entrega_ItemDataBound" EmptyMessage="Seleccione Ruta"
                                                                    Width="200" OnTextChanged="cmbRuta_Entrega_TextChanged" AutoPostBack="true" 
                                                                   Enable="false" >
                                                                </telerik:RadComboBox>
                                                            </EditItemTemplate>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="Cons." UniqueName="Id_CteDirEntrega" Display="false">
                                                        <ItemTemplate>
                                            ...
                                            <%--País--%>                                                        
                                            <telerik:GridTemplateColumn DataField="entregaPais" HeaderText="País" UniqueName="entregaPais">
                                            <ItemTemplate>  
                                                <asp:Label ID="lblEntPais"  runat="server" Text='<%# Eval("entregaPais") %>'></asp:Label>
                                            </ItemTemplate>

                                                    <EditItemTemplate>
                                                        <asp:Label ID="lblidentregapais" runat="server" Text='<%# Bind("EntregaIdPais") %>' Visible="false" />
                                                        <telerik:RadComboBox ID="cmbPaisEntrega"  runat="server" ChangeTextOnKeyBoardNavigation="true" DataTextField="Descripcion" DataValueField="Id"  
                                                            Width="250px" OnSelectedIndexChanged="cmbPaisEntrega_SelectedIndexChanged" AutoPostBack="true" EnableLoadOnDemand="true" Filter="Contains"
                                                            HighlightTemplatedItems="true" LoadingMessage="Cargando..." MarkFirstMatch="true" OnItemDataBound="Pais_Entrega_ItemDataBound" OnDataBinding="cmbPaisEntrega_DataBinding">
                                                        </telerik:RadComboBox>
                                                    </EditItemTemplate>
                                           ...
                                           <%--Estado--%>
                                           <telerik:GridTemplateColumn DataField="entregaEstado" HeaderText="Estado" UniqueName="entregaEstado">
                                            <ItemTemplate>  
                                                <asp:Label ID="lblEntEstado"  runat="server" Text='<%# Eval("entregaEstado") %>'></asp:Label>
                                            </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:Label ID="lblidentregaestado" runat="server" Text='<%# Bind("EntregaIdEstado") %>' Visible="false" />
                                                        <telerik:RadComboBox ID="cmbEstadoEntrega"  runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                            DataTextField="Descripcion" DataValueField="Id" EnableLoadOnDemand="true" Filter="Contains"
                                                            HighlightTemplatedItems="true" LoadingMessage="Cargando..." MarkFirstMatch="true" OnItemDataBound="Estado_Entrega_ItemDataBound"  OnDataBinding="cmbEstadoEntrega_DataBinding"
                        ...
                        <telerik:RadPageView ID="RadPageViewClienteProducto" runat="server" Visible="false">
                            <table>
                                <tr>
                                    <td>
                                                ...
                                                <MasterTableView CommandItemDisplay="Top" EditMode="InPlace">
                                                    ...
                                                    <Columns>
                                                        <telerik:GridTemplateColumn HeaderText="Cons." UniqueName="Id_CteDet" Display="false">
                                                            ...
                                                            <EditItemTemplate>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("Id_CteDet") %>' />
                                                            </EditItemTemplate>
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </telerik:GridTemplateColumn>
                                                      ...
                                                      <%--  ----------------David Lopez-------------------END--%>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Territorio" UniqueName="Ter_Nombre">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Ter_Nombre") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                <td valign="middle" style="text-align:right; vertical-align:top">
                                                                                    <asp:Label ID="Label5" runat="server" Width="45px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                                </td>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Segmento" UniqueName="Seg_Descripcion">
                                                            <ItemTemplate>
                                                                <%--<asp:Label ID="Label122" runat="server" Text=" - " />--%>
                                                                <asp:Label ID="Label9" runat="server" Text='<%# Bind("Seg_Descripcion") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                       ...
                                                       <%--<telerik:GridTemplateColumn HeaderText="Meta" UniqueName="Meta">
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Unidades de dimensión" UniqueName="Cte_UnidadDim">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label32" runat="server" Text='<%# Bind("Cte_UnidadDim") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Dimensión" UniqueName="Cte_Dimension">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label33" runat="server" Text='<%# Bind("Cte_Dimension") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Pesos" UniqueName="Cte_Pesos">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label34" runat="server" Text='<%# Bind("Cte_Pesos", "{0:N2}") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Potencial" UniqueName="Cte_Potencial">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label35" runat="server" Text='<%# Bind("Cte_Potencial", "{0:N2}") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Mano de obra en proyectos" UniqueName="Cte_ManoObra">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label36" runat="server" Text='<%# Bind("Cte_ManoObra", "{0:N2}") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Gastos territorio" UniqueName="Cte_GastoTerritorio">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label37" runat="server" Text='<%# Bind("Cte_GastoTerritorio", "{0:N2}") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Fletes pagados al cliente" UniqueName="Cte_FletePaga">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label38" runat="server" Text='<%# Bind("Cte_FletePaga", "{0:N2}") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="middle" width="130">
                                                    <asp:Label ID="Label39" runat="server" Text="Tipo de moneda"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbMoneda" runat="server" Width="200px" Filter="Contains"
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 50px; text-align: center">
                                                                        <asp:Label ID="Label40" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                    <td valign="middle" style="width: 200px; text-align: left">
                                                                        <asp:Label ID="Label41" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label42" runat="server" Text="Límite de Crédito"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td colspan="7" valign="middle">
                                                    ...
                                                    <telerik:RadComboBox ID="txtDias1" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        DataTextField="Descripcion" DataValueField="Id" EnableLoadOnDemand="true" Filter="Contains"
                                                        HighlightTemplatedItems="true" MarkFirstMatch="true" OnClientBlur="Combo_ClientBlur"
                                                        Width="50px" LoadingMessage="Cargando...">
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 20px; text-align: center">
                                                                        <asp:Label ID="Label1" runat="server" Width="20px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="middle" width="130">
                                                    <asp:Label ID="Label107" runat="server" Text="Forma de Revisión y Pago"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadTextBox ID="TxtRevPag" runat="server" Width="300">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td valign="middle"></td>
                                            </tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="middle" width="130">
                                                    <asp:Label ID="Label43" runat="server" Text="Horario de revisión"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label45" runat="server" Text="Días de revisión"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                ...
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label46" runat="server" Text="Martes" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label47" runat="server" Text="Miércoles"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle" colspan="2">
                                                    <asp:Label ID="Label48" runat="server" Text="Jueves"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label49" runat="server" Text="Viernes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label50" runat="server" Text="Sábado"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label51" runat="server" Text="Domingo"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label52" runat="server" Text="Revisión martes" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRMartes" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label53" runat="server" Text="Revisión miércoles" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRMiercoles" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle" colspan="2">
                                                    <asp:Label ID="Label55" runat="server" Text="Revisión jueves" Visible="false"></asp:Label>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label56" runat="server" Text="Días de pago"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label57" runat="server" Text="Lunes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label58" runat="server" Text="Martes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label63" runat="server" Text="Miércoles"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle" colspan="2">
                                                    <asp:Label ID="Label65" runat="server" Text="Jueves"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label66" runat="server" Text="Viernes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label67" runat="server" Text="Sábado"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label68" runat="server" Text="Domingo"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label69" runat="server" Text="Semana de recepción"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label70" runat="server" Text="Días de recepción"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label71" runat="server" Text="Lunes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label72" runat="server" Text="Martes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label73" runat="server" Text="Miércoles"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle" colspan="2">
                                                    <asp:Label ID="Label91" runat="server" Text="Jueves"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label92" runat="server" Text="Viernes"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label93" runat="server" Text="Sábado"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label94" runat="server" Text="Domingo"></asp:Label>
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label95" runat="server" Text="Recepción lunes" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecLunes" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label96" runat="server" Text="Recepción martes" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecMartes" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label97" runat="server" Text="Recepción miércoles" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecMiercoles" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle" colspan="2">
                                                    <asp:Label ID="Label102" runat="server" Text="Recepción jueves" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecJueves" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label103" runat="server" Text="Recepción viernes" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecViernes" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label104" runat="server" Text="Recepción sábado" Visible="false"></asp:Label>
                                                    <asp:CheckBox ID="chkRecSabado" runat="server" />
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                </td>
                                                <td style="text-align: center" valign="middle">
                                                    <asp:Label ID="Label105" runat="server" Text="Recepción domingo" Visible="false"></asp:Label>
                                            ...
                                            <tr>
                                                <td valign="middle" valign="top" width="360px">
                                                    <table>
                                                        <tr>
                                                            <td valign="middle">
                                                                <asp:Label ID="Label106" runat="server" Text="Formas de pago" Font-Bold="True"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="middle">
                                                ...
                                                <td valign="middle" valign="top" width="200px">
                                                    <table>
                                                        <tr>
                                                            <td valign="middle">
                                                                <asp:Label ID="Label126" runat="server" Font-Bold="True" Text="Comisiones"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="middle">
                                                ...
                                                <td valign="middle" valign="top" width="200px">
                                                    <table>
                                                        <tr>
                                                            <td valign="middle">
                                                                <asp:Label ID="Label127" runat="server" Font-Bold="True" Text="Documentos"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="middle">
                                                        ...
                                                        <caption>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                     <td>
                                                                     Banco donde nos deposita el cliente:
                                                                        <telerik:RadComboBox ID="cmbPagoBancos" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                                        DataTextField="Descripcion" DataValueField="Id" EnableLoadOnDemand="true" Filter="Contains"
                                                                        HighlightTemplatedItems="true" MarkFirstMatch="true" OnClientBlur="Combo_ClientBlur"
                                                                        Width="200px" LoadingMessage="Cargando...">
                                                                        <ItemTemplate>
                                                                            <table>
                                                                                <tr>
                                                                                    <td style="width: 25px; text-align: center; vertical-align: top">
                                                                                        <asp:Label ID="Label128" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                                    </td>
                                                                                    <td style="text-align: left">
                                                                                        <asp:Label ID="Label129" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </ItemTemplate>
                                                                 ...
                                                                 <tr>                                                                    
                                                                    <td>
                                                                        Número de Cuenta:
                                                                        <telerik:RadTextBox ID="txtPagoNumCta" runat="server"  MaxLength="120" Width="255px">
                                                                            <ClientEvents OnKeyPress="SoloNumerico" />
                                                                        </telerik:RadTextBox></td>
                                                                </tr>
                                                                <tr>                                                                    
                                                                    <td>
                                                                        Correos para el envío de comprobantes de pago: <br />
                                                                        (Puede agregar varias direcciones de correo separandolos con ;)
                                                                        <telerik:RadTextBox ID="txtPagoCorreos" runat="server"  MaxLength="500" Width="400px">
                                                                        </telerik:RadTextBox>
                                                                       </td>
                                                                </tr>
                                                            </table>
                                                         ...
                                                         <tr>
                                                            <td valign="middle">
                                                            <div id="paraNC" style="border-color:#89aee5; border-style:solid; padding-top:10px; border-width: 
1px;">
                                                            <b>Para Notas de Credito</b>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                    Uso CFDI:
                                                                    <telerik:RadComboBox ID="cmbNCUsoCFDI" runat="server" 
...
ChangeTextOnKeyBoardNavigation="true"
                                                                ...
                                                                <tr>
                                                                    <td valign="middle">Forma de Pago:
                                                                        <telerik:RadComboBox ID="cmbNCFormaPago" runat="server" 
...
ChangeTextOnKeyBoardNavigation="true"
                                                                 ...
                                                                 <tr>
                                                                    <td valign="middle">Metodo de Pago:
                                                                        <telerik:RadComboBox ID="cmbNCMetodoPago" runat="server" 
...
ChangeTextOnKeyBoardNavigation="true"
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td valign="middle" style="margin-left: 40px">
                                                    <asp:Label ID="Label146" runat="server" Text="Version CFDI 4.0"></asp:Label>
                                                </td>
                                                
                                                <td valign="middle">                                                    
                                                    <telerik:RadComboBox ID="cmbVersionCFDI" runat="server" ChangeTextOnKeyBoardNavigation="true" 
                                                        EnableLoadOnDemand="true" Filter="Contains" LoadingMessage="Cargado..." MarkFirstMatch="true" 
                                                        OnClientBlur="Combo_ClientBlur" Widht="350px" ShowMoreResultsBox="true" Visible="false">
                                                    </telerik:RadComboBox>                                                    
                                                </td>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label130" runat="server" Text="Serie de consecutivo"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbSerie" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 50px; text-align: center">
                                                                        <asp:Label ID="Label131" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                    <td valign="middle" style="width: 200px; text-align: left">
                                                                        <asp:Label ID="Label132" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label133" runat="server" Text="Serie de nota de crédito"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbNCredito" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 50px; text-align: center">
                                                                        <asp:Label ID="Label134" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                    <td valign="middle" style="width: 200px; text-align: left">
                                                                        <asp:Label ID="Label135" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label136" runat="server" Text="Serie de nota de cargo"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbNCargo" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 50px; text-align: center">
                                                                        <asp:Label ID="Label137" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                    <td valign="middle" style="width: 200px; text-align: left">
                                                                        <asp:Label ID="Label138" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <asp:Label ID="Label139" runat="server" Text="Adenda"></asp:Label>
                                                </td>
                                                <td valign="middle">
                                                    <telerik:RadComboBox ID="cmbAdenda" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td valign="middle" style="width: 50px; text-align: center">
                                                                        <asp:Label ID="Label140" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                    </td>
                                                                    <td valign="middle" style="width: 200px; text-align: left">
                                                                        <asp:Label ID="Label141" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td valign="middle" colspan="2">
                                                                <strong>
                                                                    <asp:Label ID="Label142" runat="server" Text="Correos para el envio de estados de cuenta"></asp:Label>
                                                                </strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <telerik:RadComboBox ID="cmbBancos" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <table>
                                                                            <tr>
                                                                                <td style="width: 25px; text-align: center; vertical-align: top">
                                                                                    <asp:Label ID="Label143" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                                                                </td>
                                                                                <td style="text-align: left">
                                                                                    <asp:Label ID="Label144" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Descripcion") %>' />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
                        ...
                        <telerik:RadPageView ID="RadPageViewCamposUsuario" runat="server">
                            <div id="nuevosCampos" style="width: 45%;display:inline-block;" >
                                <asp:Panel ID= "contenedorNuevosCampos"  runat = "server" Height="500">
                                    <br />
                                    <br /> 
        
                                    <table>
                                        <tr>
                                            <td valign="middle" width="120"  style="text-align:right;">
                                                 <asp:Label ID="lblCampo1" runat="server" Text=""></asp:Label>
                                                <asp:HiddenField ID="hdnIdCampo1" runat="server" Value="" />
                                            </td>
                                            <td>
                                               <asp:TextBox ID="txtCampo1"  Text="" runat="server" style="width:300px;"/>                                                       
                                            </td>
                                        </tr>
                                    </table>
                                <table>
                                    <tr>
                                        <td valign="middle" width="120"  style="text-align:right;">
                                             <asp:Label ID="lblCmb1" runat="server" Text=""></asp:Label>
                                            <asp:HiddenField ID="hdnIdCmb1" runat="server" Value="" />
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="cmbCatalogo1" runat="server" width="300" >
                                            </asp:DropDownList>                                                        
                                        </td>
                                    </tr>
                                </table>
                                <table>
                                    <tr>
                                        <td valign="middle" width="120"  style="text-align:right;">
                                            <asp:Label ID="lblCmb2" runat="server" Text=""></asp:Label>
                                            <asp:HiddenField ID="hdnIdCmb2" runat="server" Value="" />
                                        </td>
                                        <td>
                                             <asp:DropDownList ID="cmbCatalogo2" runat="server"  width="300">
                                             </asp:DropDownList>      
                                 ...
                                 <table>
                                     <tr>
                                         <td valign="middle" width="120"  style="text-align:right;">
                                             <asp:Label ID="lblCmb3" runat="server" Text=""></asp:Label>
                                             <asp:HiddenField ID="hdnIdCmb3" runat="server" Value="" />
                                         </td>
                                         <td>
                                              <asp:DropDownList ID="cmbCatalogo3" runat="server" width="300">
                                              </asp:DropDownList>
                                         </td>
                                     </tr>
                                 </table>
                                 <table>
                                     <tr>
                                         <td valign="middle" width="120"  style="text-align:right;">
                                              <asp:Label ID="lblCmb4" runat="server" Text=""></asp:Label>
                                                <asp:HiddenField ID="hdnIdCmb4" runat="server" Value="" />
                                         </td>
                                         <td>
                                             <asp:DropDownList ID="cmbCatalogo4" runat="server" width="300" >
                                            </asp:DropDownList>
                                         </td>
                                     </tr>
                                 </table>
                                 <table>
                                     <tr>
                                         <td valign="middle" width="120"  style="text-align:right;">
                                              <asp:Label ID="lblCmb5" runat="server" Text=""></asp:Label>
                                                <asp:HiddenField ID="hdnIdCmb5" runat="server" Value="" />
                                         </td>
                                         <td>
                                             <asp:DropDownList ID="cmbCatalogo5" runat="server" width="300" >
                                             </asp:DropDownList>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                var txtFestado = $find('<%= cmbEstado.ClientID %>');
            ...
            function LimpiarControles() {
                ...
                LimpiarTextBox($find('<%= txtMarcaComercial.ClientID %>'));
                ...
                LimpiarTextBox($find('<%= cmbEstado.ClientID %>'));
            ...
            function AbrirVentana_VinculacionCliente(Rfc, id_cd, id_u) {
                var oWnd = radopen("AutorizacionVinculacion.aspx?Rfc=" + Rfc + "&id_cd=" + id_cd + "&id_u=" + id_u, "AbrirVentana_VinculacionCliente");
                oWnd.set_showOnTopWhenMaximized(false);
               
                oWnd.center();
            }
            function AutorizarVinculacionCliente(id_u, id_cd, nombre, tipoAutorizacion) {
                var ajaxManager = $find("<%= RAM1.ClientID %>");
                ajaxManager.ajaxRequest(id_u + "@" + id_cd + "@" + nombre + "@3" + "@" + tipoAutorizacion);
            }
        </script>

<%@ Page Title="Reporte GAP Rik Por producto"   Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master"
    CodeBehind="ReporteGAPRikProducto.aspx.cs" Inherits="SIANWEB.ReporteGAPRikProducto" %>
...
<%--Filtros de busqueda --%>
            <div class="col-md-12" style="margin-top: 5px;">
                   <div class="col-md-4">
                          <div class="form-group">
                            <div class="col-md-4">
                                <asp:Label ID="lblAño" runat="server" Text="Año" name="lblAño" />
                            </div>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                          <div class="form-group">
                            <div class="col-md-4">
                                <asp:Label ID="lblMes" runat="server" Text="Mes" name="lblMes"  />
                            </div>
                            <div class="col-md-8">
            ...
            <div class="col-md-12" style="margin-top: 5px;">  
                 <div class="col-md-4">
                        <div class="form-group">
                            <div class="col-md-4">
                                <asp:Label ID="lblTamaño" runat="server" Text="Tamaño" />
                            </div>
                            <div class="col-md-8">
                 ...
                 <div class="col-md-4">
                        <div class="form-group">
                                <div class="col-md-4">
                                    ...
                                    <asp:Label ID="lblRepresentante" runat="server" Text="Representante" />
                                </div>
                                <div class="col-md-2">
                            
                                     <dx:BootstrapTextBox ID="txtRik" runat="server" ClientInstanceName="txtRik" name="txtRik"   EnableCallbackMode="true" oncustomcallback="cmbRik_CustomCallback" >
                                     </dx:BootstrapTextBox> 
            ...
            <div class="col-md-12" style="margin-top: 5px;">
                <div class="col-md-4">
                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                               <dx:BootstrapTextBox ID="txtCliente" runat="server"  ClientInstanceName="txtCliente" name="txtCliente" ></dx:BootstrapTextBox> 
                            </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             ...
                             <dx:BootstrapTextBox ID="txtProducto" runat="server" ClientInstanceName="txtProducto" name="txtProducto"></dx:BootstrapTextBox> 
                            ...
                            <div id="Div1" class="col-md-12" runat="server" style="margin-top: 5px;">
                                <dx:bootstrapgridview id="grdServicio" clientinstancename="grid" runat="server" width="100%"
                                    ...
                                    <columns>
                                        ...
                                        <dx:bootstrapgridviewtextcolumn fieldname="Unidades" caption="Unidades Vendidas" width="50px" visible="true" />
                                        ...
                                        <%--  <dx:bootstrapgridviewtextcolumn Width="100px" FieldName="POvsPV" Caption="PO vs PV " Visible="true">
                            <propertiestextedit DisplayFormatString="p2" />
                            </dx:bootstrapgridviewtextcolumn>--%>

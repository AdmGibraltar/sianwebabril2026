<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/masterpage02Boostrap.Master" AutoEventWireup="true" CodeBehind="PortalKey_Alta.aspx.cs" Inherits="SIANWEB.PortalKey_Alta" %>
            ...
            <ContentTemplate>
                <div class="col-xs-12">
                    <div class="form-group">
                        <div class="col-xs-2">
                           <asp:label for="txtNombreContacto">Matriz</asp:label>
                        </div>
                        <div class="col-xs-10">
                            <dx:BootstrapTextBox runat="server" ID="TxtMAtriz">
                ...
                <div class="col-xs-12" style="margin-top: 5px;">
                    <div class="form-group">
                        <div class="col-xs-2">
                            <asp:label for="txtNombreContacto">Correo Electronico</asp:label>
                        </div>
                        <div class="col-xs-10">

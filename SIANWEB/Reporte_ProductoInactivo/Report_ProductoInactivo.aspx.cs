...
namespace SIANWEB.Reporte_ProductoInactivo
{
    public partial class Report_ProductoInactivo : BaseServerPage
    {
        #region Variables
            ...
            try
            {
                if (ValidarSesion())
                {
                    if (!IsPostBack)
                    {
                        ...
                        Fecha = session.CalendarioIni.ToString("MM/dd/yyyy");

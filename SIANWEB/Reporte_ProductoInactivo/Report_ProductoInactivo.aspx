<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    Inherits="SIANWEB.Reporte_ProductoInactivo.Report_ProductoInactivo" %>
...
--%>
    ...
    <style>
        ...
        .tabla-container3 {
            ...
            border: 1px solid #ddd; /* Un borde para la tabla */
        }
    </style>
...
<div class="row mt5">
    <div class="col-md-12 tabla-container3" style="vertical-align:middle;" >            
        <table style="width:100%;" class="" > 
            <tr>  
                <td style="width:50px;display:none">Año</td>
                <td style="width:100px;display:none">
                    <input type="text" class="form-control" id="tbAnio" style="width:100px;" /> 
                </td>
                <td style="width:50px;display:none">Mes</td>
                <td style="width:100px;display:none">
               ...
               <td style="width:50px; display:none;" ></td>
                ...
                <td>
                    <h4>Proyectos con productos inactivos</h4>
                </td>
                <td style="width:50px;">
...
<div class="row mt5" style="margin-bottom:20px;">
    <div class="col-md-12 text-center tabla-container3">
        ...
        <table style="width:100%;" class="" > 
            <tr>  
                ...
                <td style="width:150px; display:none;">
                 ...
                 <td>
                    <h4>Acys con productos inactivos</h4>
                </td>
                <td style="width:50px;">
                    <button id="btnCargarListado2" type="button" class="btn btn-primary btn-sm" title="" 
                        onclick="Reporte.btnAplicar2_Click();">
                                <i class="fa fa-search" aria-hidden="true"></i>&nbsp;Buscar
                    </button>
                </td>
                <td>
                    <img id="spinner_GCIndice2" style="display:none; margin-top:5px;" src="<%=Page.ResolveUrl("~/Img/patternfly/spinner-xs.gif") %>" />                    
                </td>
                <td>
                 &nbsp;
                </td>
                <td style="width:100px;" >
                    <button type="button" class="btn btn-default btn-sm " 
                        onclick="Reporte.btnExportaExcel2_Click();">
                                <i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;Bajar reporte
                    </button>
                </td>
...
<div class="row mt5" style="margin-bottom:20px;">
    ...
    <table class="table table-hover table-bordered table-scroll table2" id="tblReporteDinamico2">
        <thead>
            <tr>                
                <th class="text-center" style="width:150px; text-align:center; display:none;">Priorización</th>
                <th class="text-center" style="width: 50px;">
...
<script type="text/javascript">
    ...
    <script src="<%=Page.ResolveUrl("~/js/producto_inactivo/Report_ProductoInactivo.js?v=2")%>"></script>

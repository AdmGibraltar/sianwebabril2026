...
namespace SIANWEB
    {
        public partial class ReporteGAPRikProducto : System.Web.UI.Page
        {
            ...
            public DataTable dt
            {
                get
                {
                    return (DataTable)ViewState["dtReporteConsultaGAPRikProducto"];
                }
                set
                {
                    ViewState["dtReporteConsultaGAPRikProducto"] = value;
            ...
            {
                if (Session["dtReporteConsultaGAPRikProducto"] != null)
                {
                    ...
                    dt = (DataTable)Session["dtReporteConsultaGAPRikProducto"];
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                ...
                if (Session["dtReporteConsultaGAPRikProducto"] != null)
                    {
                        Session["dtReporteConsultaGAPRikProducto"] = null;
                    }
        ...
        private void inicializar()
            ...
            reporteGAP.Id_Cd = sesion.Id_Cd_Ver; // Convert.ToInt32(this.CmbSucursal.SelectedItem.Value);
                ...
                dt = dataTable;
                Session["dtReporteConsultaGAPRikProducto"] = dt;
            ...
            {
                DataTable dtTemp = (DataTable)Session["dtReporteConsultaGAPRikProducto"];
                ...
                Session["dtReporteConsultaGAPRikProducto"] = dtTemp;

<%@ Page Title="Notas de cargo" Language="C#" MasterPageFile="~/MasterPage/MasterPage03.master"
    AutoEventWireup="true" CodeBehind="CapNotaCargo.aspx.cs" Inherits="SIANWEB.CapNotaCargo" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_NotaCargoEspecial() {
                ...
                var Id_NcaSerie = document.getElementById('<%= HdId_NcaSerie.ClientID %>');

                var oWnd = radopen("CapNotaCargo_Especial.aspx?Id_Cte="
                  + txtCliente.get_value()
                  + "&Nca_ImporteTotal=" + txtSubtotal2.get_value()
                  + "&IVA_Nca=" + txtIva2.get_value()
                  + "&Folio=" + Folio.get_value() //clave de la factura
                  + "&Id_NcaSerie=" + Id_NcaSerie.value + Folio.get_value()
                ...
                <td>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" BorderStyle="Solid"
                        ...
                        <telerik:RadPageView ID="RadPageViewDGenerales" runat="server">
                            <telerik:RadSplitter ID="RadSplitter2" runat="server" Height="351px" ResizeMode="AdjacentPane"
                                ResizeWithBrowserWindow="true" BorderSize="0" Width="102%">
                                <telerik:RadPane ID="RadPane2" runat="server" Height="351px" OnClientResized="onResize"
                                    ...
                                    <div id="formulario" runat="server">
                                        ...
                                        <table border="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblCondiciones1" runat="server" Text="Ultimos 4 digitos de la cuenta"></asp:Label>
                                                </td>
                                                <td> 
                                                     <telerik:RadTextBox ID="txtUDigitos" runat="server" MaxLength="4" Width="70px">   
                                                        <ClientEvents OnFocus="_ValidarFechaEnPeriodo" OnKeyPress="handleClickEventCliente" />                                                                                                                                   
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
                        ...
                        <telerik:RadPageView ID="RadPageViewDetalles" runat="server" heigth="350px">
                            <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="351px" ResizeMode="AdjacentPane"
                                ResizeWithBrowserWindow="true" BorderSize="0" Width="102%">
                                <telerik:RadPane ID="RadPane1" runat="server" Height="351px" OnClientResized="onResize"
                                    BorderStyle="None">
                                        ...
                                        <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Nca,Id_NcaDet,Id_Prd,Id_Rik,Id_Ter"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." DataField="Id_Ter" UniqueName="Id_TerN">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtTerritorioPartida" runat="server" Width="40px"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Territorio" DataField="Id_Ter" UniqueName="Id_Ter">
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <telerik:RadComboBox ID="cmbTerritorioPartida" runat="server" Width="200px" Filter="Contains"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." DataField="Id_Rik" UniqueName="Id_RikN">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtRepresentantePartida" runat="server" Width="40px"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Representante" DataField="Id_Rik" UniqueName="Id_Rik">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadTextBox ID="txtRepresentantePartidaStr" runat="server" Width="190px"
                                                            Enabled="false">
                                                        </telerik:RadTextBox>
                                                        <br />
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." DataField="Id_Prd" UniqueName="Id_PrdN">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtId_Prd" runat="server" Width="40px" MaxLength="9"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Producto" DataField="Id_Prd" UniqueName="Id_Prd">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadTextBox ID="txtProductoNombre" runat="server" ReadOnly="true" Width="190px"
                        ...
                        <telerik:RadPageView ID="rpvAdendaNCargo" runat="server" Height="350px">
                            <telerik:RadSplitter ID="RadSplitter3" runat="server" Height="351px" ResizeMode="AdjacentPane"
                                ResizeWithBrowserWindow="true" BorderSize="0" Width="102%">
                                <telerik:RadPane ID="RadPane3" runat="server" Height="351px" OnClientResized="onResize"
                                    BorderStyle="None">
                                    <telerik:RadGrid ID="rgAdendaNotaCargo" runat="server" AutoGenerateColumns="False"
                                        GridLines="None" OnNeedDataSource="rgAdendaNotaCargo_NeedDataSource" Width="100%"

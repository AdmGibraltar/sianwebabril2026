<%@ Page Title="Productividad sistemas propietarios" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master" AutoEventWireup="true" CodeBehind="Rep_SerProductividadSistemas.aspx.cs" Inherits="SIANWEB.Rep_SerProductividadSistemas" %>
                ...
                <tr>
                    ...
                    <td>
                        <table border="0">
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="lblCategoria" runat="server" Text="Categoria" visible = "true"></asp:Label>
                                </td>
                                <td>
                                    
                                <telerik:RadComboBox ID="cmbCategoria" runat="server" Width="250px" AutoPostBack ="True" OnSelectedIndexChanged="cmbCategoria_SelectedIndexChanged"  >
                                </telerik:RadComboBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <telerik:RadComboBox ID="cmbGrupo" runat="server" Width="250px"  onselectedindexchanged="cmbCdi_SelectedIndexChanged" AutoPostBack ="True"  >
                                </telerik:RadComboBox>
                                </td>
                                <td class="auto-style1">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Label ID="Label1" runat="server" Text="Representante" visible = "false"></asp:Label>
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="txtRepresentante" onpaste="return false" runat="server" Width="200px" visible = "false"
                                        MaxLength="1000">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txtCliente" onpaste="return false" runat="server" Width="200px" AutoPostBack="true" OnTextChanged="txtCliente_TextChanged" visible = "true"
                                        MaxLength="1000">
                                        <ClientEvents OnKeyPress="RangoEnterosSeparacionGuionYComas_OnKeyPress" OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                    </telerik:RadTextBox>
                                </td>
                            ...
                            <tr>
                                <td colspan="2"> 
                                    <asp:Label ID="lblTipoCliente" runat="server" Text="Tipo Cliente" visible = "true"></asp:Label>
                                </td>
                                <td>
                                    <asp:RadioButtonList ID="rblTipoCliente" runat="server" AutoPostBack="true">
                                ...
                                <td colspan="3">
                                    <telerik:RadComboBox ID="cmbOrden" runat="server" Width="300px">
                                        <Items>
                                            ...
                                            <telerik:RadComboBoxItem Text="Categorías de sistemas propietarios" Value="1" visible = "true" />
                                            <telerik:RadComboBoxItem Text="Grupos de sistemas propietarios" Value="2" visible = "true" />

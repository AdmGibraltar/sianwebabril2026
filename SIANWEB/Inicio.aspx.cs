                ...
                if (ValidarSesion())
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        if (sesion.Cu_Modif_Pass_Voluntario == false)
                        {
                            ...
                            // JorgeRmzF(15/09/2022): Correción de llamada a función para mostrar la ventana de cambio de contraseña
                            RAM1.ResponseScripts.Add("function f (){ return AbrirContrasenas(); Sys.Application.remove_load(f);}; Sys.Application.add_load(f);");
                            return;
                        }
                        CargarCentros();

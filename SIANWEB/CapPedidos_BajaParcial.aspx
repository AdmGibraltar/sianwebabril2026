                                ...
                                <telerik:RadGrid ID="rgPedido" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView NoMasterRecordsText="No se encontraron registros.">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn HeaderText="Asignado" UniqueName="Prd_Asig" display="false"
                                                DataField="Prd_Asig">
                                                <ItemStyle HorizontalAlign="Right" />
                                                <HeaderStyle Width="100px" />
                                            </telerik:GridBoundColumn>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        <script type="text/javascript">
            ...
            function Asig_OnBlur(sender, args) {
                ...
                var Asignado = row.get_cell('Prd_Asig').innerText;
                var Original = row.get_cell('Cant_original').innerText;
                var SinAsignar = Original - Asignado;

                if (Cancelado > SinAsignar)
                {
                    sender.set_value(SinAsignar);
                    radalert('Solo puede cancelar la cantidad que no se encuentra asignada, favor de desasignar el producto para continuar', 330, 150);
                }
                else if (Cancelado > Pendiente)
                {
                    //if (!alertaenviada) {

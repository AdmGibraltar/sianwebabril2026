                                        ...
                                        <table border="0">
                                            <tr>
                                               ...
                                               <%-- <table>--%>
                                                ...
                                                <div id="paraNC" style="border-color:#89aee5; border-style:solid; padding-top:10px; border-width: 1px;">
                                                <table>
                                                <tr><td>Datos Fiscales</td></tr>
                                                <tr><td>UsoCFDI:
                                                 <telerik:RadComboBox ID="cmbNCUsoCFDI" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                        ...
                                                        MarkFirstMatch="true" Width="273px"
                                                ...
                                                <tr><td>Metodo de pago:<telerik:RadComboBox ID="cmbNCMetodoPago" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                                            EnableLoadOnDemand="true" Filter="Contains" MarkFirstMatch="true" Width="400px"
                                                                            LoadingMessage="Cargando...">
                                                                        </telerik:RadComboBox></td></tr>
                                                    <tr>
                                                       <td>
                                                            Tipo de Relación:<telerik:RadComboBox ID="RadTipoRel" runat="server" ChangeTextOnKeyBoardNavigation="true" 
                                                                                    EnableLoadOnDemand="true" Filter="Contains" 
                                                                MarkFirstMatch="true" Width="338px">
                                                            </telerik:RadComboBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td class="style1">
                                                            Folio Relación:
                                                            <telerik:RadTextBox ID="txtFolioFiscal" runat="server" Width="300px" ReadOnly="True"
                                                            Enabled="False">
                                                            </telerik:RadTextBox>
                                                            </td>                                                                                             
                                                    </tr>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." DataField="Id_Prd" UniqueName="Id_PrdN">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtId_Prd" runat="server" Width="50px" MaxLength="16"
                                                            MinValue="1" MaxValue="999999999999999" Text='<%# Eval("Id_Prd") %>' AutoPostBack="true" OnTextChanged="cmbProductoDet_TextChanged">
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />

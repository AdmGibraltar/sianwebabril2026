...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_CancelarNotaCreditoVencido(Id_Emp, Id_Cd, Id_Ncr, Id_NcrSerie, Num_Cliente, Id_Nca, statusDev, fechaDev, TipoDev, factura_dev, Nca_Subtotal, Nca_Iva, Nca_Total, serieDev) {
                var fechaDev = encodeURIComponent(fechaDev);

                var oWnd = radopen("CapCancelarNCreditoVencido.aspx?Id_Ncr=" + Id_Ncr
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    ...
                    + "&FechaDev=" + fechaDev
                    + "&TipoDev=" + TipoDev
                    + "&Factura_dev=" + factura_dev
                    + "&Nca_Subtotal=" + Nca_Subtotal
                    + "&Nca_Iva=" + Nca_Iva
                    + "&Nca_Total=" + Nca_Total
                    + "&serieDev=" + serieDev
                    , "CapCancelarNCreditoVencido");
                oWnd.setSize(350, 350); // Establece ancho y alto
                oWnd.center();

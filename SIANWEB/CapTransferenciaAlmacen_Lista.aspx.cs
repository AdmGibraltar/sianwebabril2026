...
namespace SIANWEB
{
    public partial class CapTransferenciaAlmacen_Lista : System.Web.UI.Page
    {
        #region Variables
            ...
            try
            {
                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        rgTransferenciaAlmacen.DataSource = this.GetList();
                    ...
                    GridFilterMenu menu = rgTransferenciaAlmacen.FilterMenu;
        ...
        protected void rgTransferenciaAlmacen_ItemCreated(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                GridDataItem item = (GridDataItem)e.Item;
                ImageButton imgButton = (ImageButton)item.FindControl("ImageButton1");
                imgButton.OnClientClick = "return AbrirVentana_TransferenciaAlmacen_Edicion('" + item.ItemIndex + "')";
            }
        }
        protected void rgTransferenciaAlmacen_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (item >= 0)
                {
                    int Id_Emp = Convert.ToInt32(rgTransferenciaAlmacen.Items[item]["Id_Emp"].Text);
                    int Id_Cd = Convert.ToInt32(rgTransferenciaAlmacen.Items[item]["Id_Cd"].Text);
                    int Id_Ord = Convert.ToInt32(rgTransferenciaAlmacen.Items[item]["Id_Ord"].Text);
                    string Ord_EstatusStr = rgTransferenciaAlmacen.Items[item]["Ord_EstatusStr"].Text;
                    string[] datePart = rgTransferenciaAlmacen.Items[item]["Ord_Fecha"].Text.Split(new char[] { '/' });
                    DateTime fechaOrden = new DateTime(Convert.ToInt32(datePart[2]), Convert.ToInt32(datePart[1]), Convert.ToInt32(datePart[0]));
                    string Id_Pvd = ((Label)(rgTransferenciaAlmacen.Items[item]["Id_Pvd"].FindControl("lblId_Pvd"))).Text;

                    switch (e.CommandName.ToString())
                    {
                        case "Eliminar":

                            mensajeError = "CapTransferenciaAlmacen_delete_error";
                            if (_PermisoEliminar)
                            {
                                if (rgTransferenciaAlmacen.Items[item]["Ord_EstatusStr"].Text.ToUpper() == "CAPTURADO" || rgTransferenciaAlmacen.Items[item]["Ord_EstatusStr"].Text.ToUpper() == "IMPRESO")
                                {
                                   // this.CancelarTransferenciaAlmacen(Id_Emp, Id_Cd, Id_Ord, Ord_EstatusStr);
                                    rgTransferenciaAlmacen.Rebind();
                                }
                                else
                                {
                        ...
                        case "Imprimir":
                            mensajeError = "CapTransferenciaAlmacen_print_error";
                            if (_PermisoImprimir)
                            {
                                if (rgTransferenciaAlmacen.Items[item]["Ord_EstatusStr"].Text.ToUpper() != "BAJA")
                                {
                                    HD_GridRebind.Value = "0";
                                   // this.TransferenciaAlmacen_Impresion(Id_Emp, Id_Cd, Id_Ord, fechaOrden, Ord_EstatusStr);
                                    rgTransferenciaAlmacen.Rebind();
                                }
                                else
                                {
                        ...
                        case "Enviar":
                            mensajeError = "CapTransferenciaAlmacen_mail_error";
                            if (Id_Pvd != "100")
                                this.DisplayMensajeAlerta("EnvioInternet_ProveedorNoAlmacen");
                            else
                            {  
                                string  habilitaenviodirecto   = ConfigurationManager.AppSettings["TransferenciaAlmacenEnvioDirecto"].ToString();
                                if (habilitaenviodirecto == "0")
                                {

                                   /* List<string> arregloURL = this.TransferenciaAlmacen_CrearURL_EnvioInternet(Id_Emp, Id_Cd, Id_Ord);
                                    this.TransferenciaAlmacen_EnvioPorInternet(Id_Emp, Id_Cd, Id_Ord, arregloURL, Ord_EstatusStr);*/
                                }
                                else
                                {
                                   // this.TransferenciaAlmacen_CrearEnviaXML(Id_Emp, Id_Cd, Id_Ord, fechaOrden, Ord_EstatusStr);
        ...
        private void TransferenciaAlmacen_EnvioPorInternet(int Id_Emp, int Id_Cd, int Id_Ord, List<string> arregloURL, string Ord_EstatusStr)
        {
            try
            {
                ...
                else
                {
                  ...
                  /*  TransferenciaAlmacen ordCompra = new TransferenciaAlmacen();
                    ordCompra.Id_Emp = Id_Emp;
                    ordCompra.Id_Cd = Id_Cd;
                    ordCompra.Id_Ord = Id_Ord;
                    ordCompra.Ord_Estatus = "I";
                    new CN_CapTransferenciaAlmacen().ModificarTransferenciaAlmacen_Estatus(ordCompra, sesion.Emp_Cnx, ref verificador);*/
                    //this.DisplayMensajeAlerta("CapTransferenciaAlmacen_envioInternet_ok");
      ...
      /*  private List<string> TransferenciaAlmacen_CrearURL_EnvioInternet(int Id_Emp, int Id_Cd, int Id_Ord)
        {
            try
            {
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                ...
                ordCompra.Id_Cd = Id_Cd;
                ordCompra.Id_Ord = Id_Ord;
                new CN_CapTransferenciaAlmacen().ConsultaTransferenciaAlmacen(ref ordCompra, sesion.Emp_Cnx);
                //Consulta detalle de la orden de compra
                List<TransferenciaAlmacenDet> listaOrdCompraDet = new List<TransferenciaAlmacenDet>();
                TransferenciaAlmacenDet TransferenciaAlmacenDet = new TransferenciaAlmacenDet();

                TransferenciaAlmacenDet.Id_Emp = Id_Emp;
                TransferenciaAlmacenDet.Id_Cd = Id_Cd;
                TransferenciaAlmacenDet.Id_Ord = Id_Ord;
                new CN_CapTransferenciaAlmacenDet().ConsultaTransferenciaAlmacenDetalle_Lista(TransferenciaAlmacenDet, sesion.Emp_Cnx, ref listaOrdCompraDet);
                ...
                foreach (TransferenciaAlmacenDet ordComDet in listaOrdCompraDet)
                {
                    URL.Clear();
        ...
        private void TransferenciaAlmacen_CrearEnviaXML(int Id_Emp, int Id_Cd, int Id_Ord, DateTime fechaOrden, string Ord_EstatusStr)
        {
            try
            {
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                ...
                XML_Enviar.Append("<TransferenciaAlmacen");
                ...
                {
                    foreach (TransferenciaAlmacenDet ocd in listaOrdCompraDet)
                    {
                ...
                XmlNode TransferenciaAlmacen = xml.SelectSingleNode("TransferenciaAlmacen");
                TransferenciaAlmacen.Attributes["fecha"].Value = string.Format("{0:s}", ordCompra.Ord_Fecha);
                TransferenciaAlmacen.Attributes["ocnumsian"].Value = ordCompra.Id_Ord.ToString();
                TransferenciaAlmacen.Attributes["oczonnumsian"].Value = ordCompra.Id_Cd.ToString();


                XmlNode Cabecera = TransferenciaAlmacen.SelectSingleNode("Encabezado");
                ...
                XmlDocument xmlTransferenciaAlmacen = new XmlDocument();
              

                OrdendeCompra.Service1 sianEnvioOrdendeCompra = new OrdendeCompra.Service1();


                object sianEnvioOrdendeCompraResult = sianEnvioOrdendeCompra.TransferenciaAlmacen(xmlString);

               // xmlTransferenciaAlmacen.LoadXml(sianEnvioOrdendeCompraResult.ToString());
                ...
                new CN_CapTransferenciaAlmacen().ModificarTransferenciaAlmacen_EstatusEmision(ordCompra, sesion.Emp_Cnx, ref verificador);
        ...
        private void TransferenciaAlmacen_Impresion(int Id_Emp, int Id_Cd, int Id_Ord, DateTime fechaOrden, string Ord_EstatusStr)
        {
            try
            {
                if (Ord_EstatusStr.Contains("Baja"))
                ...
                else
                {
                    ...
                    Type instance = null;
                    instance = typeof(LibreriaReportes.TransferenciaAlmacenImpresion);
      ...
      /*  private void CancelarTransferenciaAlmacen(int Id_Emp, int Id_Cd, int Id_Ord, string Ord_EstatusStr)
        {
            try
            {
                if (Ord_EstatusStr.Contains("Baja"))
                    this.DisplayMensajeAlerta("rgTransferenciaAlmacen_delete_error_cancelacion");
                else
                    ...
                    else
                    {
                        ...
                        ordCompra.Id_Ord = Id_Ord;
                        int verificador = 0;
                        new CN_CapTransferenciaAlmacen().EliminarTransferenciaAlmacen(ordCompra, sesion.Emp_Cnx, ref verificador);
                        this.DisplayMensajeAlerta("CapTransferenciaAlmacen_delete_ok");
                    }
            }
            catch (Exception ex)
            {
        ...
        private List<TransferenciaAlmacen> GetList()
        {
            try
            {
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                List<TransferenciaAlmacen> listTransferenciaAlmacen = new List<TransferenciaAlmacen>();
                List<TransferenciaAlmacen> listTransferenciaAlmacenFinal = new List<TransferenciaAlmacen>();
                TransferenciaAlmacen transferencia = new TransferenciaAlmacen();
                transferencia.Id_Emp = sesion.Id_Emp;
                transferencia.Id_Cd = sesion.Id_Cd_Ver;
                transferencia.Id_U = sesion.Propia ? sesion.Id_U : -1;

                new CN_CapTransferenciaAlmacen().ConsultaTransferenciaAlmacen_Lista(transferencia, sesion.Emp_Cnx, ref listTransferenciaAlmacen
                ...
                return listTransferenciaAlmacen;
            }
            catch (Exception ex)
            {
                throw ex;
                        ...
                        if (mensaje.Contains("PermisoImprimirDenegado"))
                            ...
                            if (mensaje.Contains("EnvioInternet_ProveedorNoAlmacen"))
                                ...
                                if (mensaje.Contains("OrdCompra_estatus_incorrecto"))
                                    ...
                                    if (mensaje.Contains("rgTransferenciaAlmacen_delete_error_cancelacion"))
                                        Alerta("Esta orden de compra ya está cancelada");
                                    else
                                        if (mensaje.Contains("CapTransferenciaAlmacen_envioInternet_ok"))
                                            Alerta("La orden de compra se ha enviado correctamente");
                                        else
                                            if (mensaje.Contains("CapTransferenciaAlmacen_delete_error"))
                                                Alerta("Error al momento de dar de baja la orden de compra");
                                            else
                                                if (mensaje.Contains("CapTransferenciaAlmacen_print_error"))
                                                    Alerta("Error al momento de generar el reporte de impresión de orden de compra");
                                                else
                                                    if (mensaje.Contains("CapTransferenciaAlmacen_mail_error"))
                                                        Alerta("Error al momento de enviar la orden de compra por internet");
                                                    else
                                                        if (mensaje.Contains("CapTransferenciaAlmacen_delete_ok"))
                                                            ...
                                                            if (mensaje.Contains("RAM1_AjaxRequest"))
                                                                ...
                                                                if (mensaje.Contains("rgTransferenciaAlmacen_NeedDataSource"))
                                                                    ...
                                                                    if (mensaje.Contains("rgTransferenciaAlmacen_ItemCommand"))
                                                                        Alerta("Error al ejecutar un evento (rgTransferenciaAlmacen_ItemCommand) al cargar el grid de orden de compra");
                                                                    else

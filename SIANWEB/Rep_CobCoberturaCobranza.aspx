<%@ Page Title="Cobertura de cobranza" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="Rep_CobCoberturaCobranza.aspx.cs" Inherits="SIANWEB.Rep_CobCobertura" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadDatePicker ID="dpFechainicial" runat="server" DateInput-MaxLength="10">
                            ...
                            <td>
                                <telerik:RadDatePicker ID="dpFechafinal" runat="server" DateInput-MaxLength="10">
                                    <Calendar runat="server" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False"
                                        ViewSelectorText="x">
                                        <FastNavigationSettings CancelButtonCaption="Cancelar" OkButtonCaption="Aceptar"
                                            TodayButtonCaption="Hoy">

                                    ...
                                    <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Ord, Id_OrdDet, Id_Prd"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Cantid. ord." DataField="Ord_Cantidad" UniqueName="Ord_Cantidad">
                                             ...
                                             <telerik:GridTemplateColumn HeaderText="Precio AAA" DataField="Prd_precio" UniqueName="Prd_precio" >
                                                <HeaderStyle Width="100px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# ObtenerPrecioAAA(Container.DataItem) %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblPrd_PrecioAAA" runat="server" Text="<%# ObtenerPrecioAAA(Container.DataItem) %>" />
                                                    <asp:HiddenField ID="HD_Prd_PrecioAAA" runat="server" Value="<%# ObtenerPrecioAAA(Container.DataItem) %>" />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            
                                            <telerik:GridTemplateColumn HeaderText="$ Total" DataField="Prd_Total" UniqueName="Prd_Total">
                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPrd_Total" runat="server" Text='<%# ObtenerTotal(Container.DataItem) %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblEditPrd_Total" runat="server" Text='<%# ObtenerTotal(Container.DataItem) %>' />
                                                    <asp:HiddenField ID="HD_PrdTotal" runat="server" />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                            <telerik:GridTemplateColumn HeaderText="Prom Vta Mens" DataField="Prd_PromVtaMens" UniqueName="Prd_PromVtaMens">
                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPrd_PromVtaMens" runat="server" Text='<%# ObtenerPromVtaMens(Container.DataItem) %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblEditPrd_PromVtaMens" runat="server" Text="<%# ObtenerPromVtaMens(Container.DataItem) %>" />
                                                    <asp:HiddenField ID="HD_Prd_PromVtaMens" runat="server" Value="<%# ObtenerPromVtaMens(Container.DataItem) %>" />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                            <telerik:GridTemplateColumn HeaderText="% de Prom Vta M" DataField="Prd_ProcPromVtaMens" UniqueName="Prd_ProcPromVtaMens">
                                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemStyle Width="60px" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPrd_ProcPromVtaMens" runat="server" Text='<%# ObtenerPorcPromVtaMens(Container.DataItem) %>' />
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblEditPrd_ProcPromVtaMens" runat="server" Text="<%# ObtenerPorcPromVtaMens(Container.DataItem) %>" />
                                                    <asp:HiddenField ID="HD_Prd_ProcPromVtaMensUnidades" runat="server" Value="<%# ObtenerPorcPromVtaMensUnidades(Container.DataItem) %>" />
                                                    <asp:HiddenField ID="HD_Prd_ProcPromVtaMens" runat="server" Value="<%# ObtenerPorcPromVtaMens(Container.DataItem) %>" />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            
                                            <telerik:GridTemplateColumn HeaderText="Nota" DataField="Prd_Notas" UniqueName="Prd_Notas">
                                                <HeaderStyle Width="260px" HorizontalAlign="Center" />
                                                <ItemStyle Width="260px" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPrd_Notas" runat="server" Text='<%# ObtenerNotas(Container.DataItem) %>'/>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblEditPrd_Notas" runat="server" Text="<%# ObtenerNotas(Container.DataItem) %>" />
                                                    <asp:HiddenField ID="HD_Prd_Notas" runat="server" Value="<%# ObtenerNotas(Container.DataItem) %>" />
                                                </EditItemTemplate>
                                            </telerik:GridTemplateColumn>

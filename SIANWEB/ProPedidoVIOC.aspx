<%@ Page Title="Captación de pedidos" Language="C#" MasterPageFile="~/MasterPage/masterpage02Boostrap.master"
    AutoEventWireup="true" CodeBehind="ProPedidoVIOC.aspx.cs" Inherits="SIANWEB.ProPedidoVIOC" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    ...
    <style type="text/css">
        ...
        /* NUEVO: modal fullscreen para mostrar completamente el iframe dentro de otro modal */
        .modal-fullscreen {
            padding: 0;
        }
        ...
        .modal-iframe-wrapper {
            position: relative;
            width: 100%;
            /* No forzar altura absoluta: dejamos que el iframe tenga una altura calculada */
            overflow: hidden;
        }

            /* Nuevo: permitimos scroll interno en el iframe y le damos una altura calculada
     para dejar espacio a cabecera/pie del modal. Ajusta 160px si tu header/footer cambian. */
            .modal-iframe-wrapper iframe {
                display: block;
                width: 100%;
                height: calc(100vh - 160px); /* ajuste: deja espacio para header/footer */
                max-height: 100%;
                border: 0;
                overflow: auto; /* para navegadores modernos */
            }

        /* fallback para pantallas pequeñas: limitar la altura */
    ...
    <script type="text/javascript">
        ...
        function bringModalOnTop(modal) {
        ...
        function AbrirVentana_InvIns(fecha, orden, Acys) {
            ...
            $('#modalInventario').on('show.bs.modal', function () {
                bringModalOnTop(this);
            });

        }

        $('#modalInventario').on('hidden.bs.modal', function () {
            // eliminar backdrops que marcamos como apilados
        ...
        function Subtotal() {
            ...
            $.ajax({
                type: "POST",
                url: "ProPedidoVIOC.aspx/CalcularTotalVisible",
                data: dataValue,
        ...
        function onSelectedIndexChanged(cmbId_Prd) {
            ...
            $.ajax({
                type: "POST",
                url: "ProPedidoVIOC.aspx/cmbProductoDetRestos",
                data: dataValue,
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                success: function (response) {
                    ...
                    if (response != null && response.d != null) {
                        ...
                        if (id == 5) {
                            ...
                            data.Presentacion
                            var cmbDesc = grid.GetEditor("Prd_Descripcion");
                            cmbDesc.SetValue(data.Descripcion);
                            var cmbPres = grid.GetEditor("Prd_Presentacion");
                            cmbPres.SetValue(data.Presentacion);
                            var cmbUni = grid.GetEditor("Prd_Unidad");
                            cmbUni.SetValue(data.PrdUni);
                            var cmbCant = grid.GetEditor("Prd_Cantidad");
                            cmbCant.SetValue(data.Cant);
                            var CMBLista = grid.GetEditor("Prd_PrecioLista");
                            CMBLista.SetValue(data.PRecioLista);

                            var valPrd_Activo = grid.GetEditor("Prd_Activo");
                            valPrd_Activo.SetValue(data.Prd_Activo);
        ...
        function onSelectedCantidadIndexChanged(cmbCant) {
            ...
            var IdEmp = $("#" + '<%=HF_IdEmp.ClientID%>').val();
            var EmpCnx = $("#" + '<%=HF_Emp_Cnx.ClientID%>').val();
            var cmbidProd = grid.GetEditor("Id_Prd");
            var idProd = cmbidProd.GetValue();
            var cmbPre = grid.GetEditor("Prd_Precio");
            ...
            $.ajax({
                type: "POST",
                url: "ProPedidoVIOC.aspx/txtCantidad_TextChanged",
                data: dataValue,
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                success: function (response) {
                    ...
                    if (response != null && response.d != null) {
                        ...
                        if (id == 4) {
                            ...
                            var cmbimporte = grid.GetEditor("Prd_Importe");
        ...
        function onSelectedPrecioIndexChanged(cmbPre) {
            ...
            $.ajax({
                type: "POST",
                url: "ProPedidoVIOC.aspx/txtPrecio_TextChanged",
                data: dataValue,
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                <ul class="nav nav-tabs" id="tabPage">
                    <li class="active"><a href="#tabCliente" data-toggle="tab">Datos Generales</a> </li>
                ...
                <div class="tab-content">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2">
                                                <dx:BootstrapTextBox ID="TxtPed_OCAcys" runat="server" MaxLength="50" Visible="false">
                                                </dx:BootstrapTextBox>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="tabDetalle">
                        ...
                        <div class="col-md-12">
                            <dx:BootstrapGridView ID="rg1" ClientInstanceName="grid" runat="server" KeyFieldName="Id_Prd" Width="100%"
                                EnableRowsCache="false" OnRowInserting="rg1_RowInserting" OnInitNewRow="rg1_InitNewRow" OnCustomCallback="rg1_CustomCallback" OnRowUpdating="rg1_RowUpdating"
                                OnRowDeleting="rg1_RowDeleting" EnableCallBacks="true" OnHtmlDataCellPrepared="rg1_HtmlDataCellPrepared">
                 ...
                 Subtotal();  }" />
                                <Columns>
                                    <dx:BootstrapGridViewDataColumn Caption="" VisibleIndex="0">
                                        <DataItemTemplate>
                                            <dx:ASPxHyperLink ID="lnkNew" runat="server" NavigateUrl="javascript:void(0);" CssClass="fa fa-plus" Text=""
                                                OnLoad="lnkNew_Load" />
                                        </DataItemTemplate>
                                        <SettingsEditForm Visible="False" />
                                    </dx:BootstrapGridViewDataColumn>
                                    <dx:BootstrapGridViewCommandColumn ShowNewButton="false" ShowEditButton="false" ShowDeleteButton="true"
                                        Caption=" " Visible="true" />
                                    <dx:BootstrapGridViewTextColumn FieldName="Acs_FechaF" Caption="Acs_FechaF" Visible="false" />
                                    <dx:BootstrapGridViewTextColumn FieldName="Prd_Activo" Caption="Prd_Activo" Visible="true" ReadOnly="true" />
                                    <dx:BootstrapGridViewTextColumn FieldName="Id_PrdOld" CssClasses-HeaderCell="centerText" Caption="Núm. Original" ReadOnly="true" SortIndex="0" SortOrder="Ascending">
                                        <PropertiesTextEdit>
                                    ...
                                    <dx:BootstrapGridViewSpinEditColumn CssClasses-HeaderCell="centerText" FieldName="Prd_Precio" Caption="Precio vta." ReadOnly="true">
                                    ...
                                    <dx:BootstrapGridViewSpinEditColumn CssClasses-HeaderCell="centerText" FieldName="Prd_PrecioLista" ReadOnly="true" Caption="Precio AAA">
                                        <PropertiesSpinEdit DisplayFormatString="c">
                                        </PropertiesSpinEdit>
                                    ...
                                    <dx:BootstrapGridViewComboBoxColumn HorizontalAlign="Center" CssClasses-HeaderCell="centerText" Caption="Doc. de entrega" FieldName="Acs_Doc" ReadOnly="true">
                                    ...
                                    <dx:BootstrapGridViewComboBoxColumn Caption="Requiere Orden de Compra" HorizontalAlign="Center" CssClasses-HeaderCell="centerText" FieldName="ACS_ReqOC" Width="100px" Visible="false" ReadOnly="true">
                                    ...
                                    <dx:BootstrapGridViewTextColumn HorizontalAlign="Center" CssClasses-HeaderCell="centerText" FieldName="Tipo_producto" ReadOnly="true" Caption="tipo_prodcuto" Visible="false">
                                        <PropertiesTextEdit>
                                            <ValidationSettings RequiredField-IsRequired="true">
                                            </ValidationSettings>
                                        </PropertiesTextEdit>
                                    </dx:BootstrapGridViewTextColumn>
                                    <dx:BootstrapGridViewTextColumn HorizontalAlign="Center" CssClasses-HeaderCell="centerText" FieldName="Prd_Cantidadold" ReadOnly="true" Caption="tipo_prodcuto" Visible="false">
                                        <PropertiesTextEdit>
                                            <ValidationSettings RequiredField-IsRequired="true">
                                            </ValidationSettings>
                                        </PropertiesTextEdit>
                                ...
                                <ClientSideEvents EndCallback="function(s, e) { if (s.cpIsdelete) { modalMensaje('No se puede eliminar el producto.'); delete s.cpIsdelete; } }" />

                                <FormatConditions>
                                    <dx:GridViewFormatConditionHighlight FieldName="Tipo_producto" Expression="[Tipo_producto] = 'O'" Format="GreenFillWithDarkGreenText" ApplyToRow="true" />
                                    <dx:GridViewFormatConditionHighlight FieldName="Tipo_producto" Expression="[Tipo_producto] = 'B'" Format="LightRedFillWithDarkRedText" ApplyToRow="true" />
                                    <dx:GridViewFormatConditionHighlight FieldName="Tipo_producto" Expression="[Tipo_producto] = 'P'" Format="YellowFillWithDarkYellowText" ApplyToRow="true" />
    ...
    <div id="mensajeSoliitud" class="modal fade" tabindex="-1" role="dialog" style="height: 500px !important; z-index: 2220!important" class="modal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="Div11">
                    <div class="row">
                        <div class="col-md-1">
                            <i id="modalAcysMensaje_Icon" class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-11">
                            Los siguientes productos no cumplen con el precio AAA
                        </div>
                    </div>
                    <asp:UpdatePanel runat="server" ID="updAAA" UpdateMode="Conditional">
                        <ContentTemplate>
                            <dx:BootstrapGridView ID="grdAAA" runat="server" KeyFieldName="Id_Prd" Width="100%">
                                <Columns>
                                    <dx:BootstrapGridViewTextColumn FieldName="Id_PrdOri" CssClasses-HeaderCell="centerText" Caption="Producto Original" ReadOnly="true" SortIndex="0" SortOrder="Ascending" />
                                    <dx:BootstrapGridViewTextColumn FieldName="Id_Prd" CssClasses-HeaderCell="centerText" Caption="Producto sustituto" />
                                    <dx:BootstrapGridViewSpinEditColumn CssClasses-HeaderCell="centerText" FieldName="Importe" Caption="Precio vta." ReadOnly="true">
                                        <PropertiesSpinEdit DisplayFormatString="c" />
                                    </dx:BootstrapGridViewSpinEditColumn>
                                    <dx:BootstrapGridViewSpinEditColumn CssClasses-HeaderCell="centerText" FieldName="AAA" ReadOnly="true" Caption="Precio AAA">
                                        <PropertiesSpinEdit DisplayFormatString="c" />
                                    </dx:BootstrapGridViewSpinEditColumn>
                                </Columns>
                            </dx:BootstrapGridView>
                            ...
                            <dx:BootstrapGridView ID="RadGrid1" runat="server" KeyFieldName="Id_Prd" Width="100%" EnableRowsCache="false" EnableCallBacks="true">
                                <Columns>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" id="Button2" runat="server" onserverclick="ButtonSolicitud_ServerClick">
                        Guardar y Solicitar Autorización
                    </button>
    ...
    <div class="modal modal-fullscreen" id="modalInventario" data-toggle="modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="col-md-12">
                        <h4 id="print">Inventario
                        </h4>
                    </div>
                </div>
                <div class="modal-body" style="padding: 25px !important;" id="IFrameImprimirPed">
                    <div class="modal-iframe-wrapper">
                       <iframe class="embed-responsive-item" id="FrameInventario" runat="server" scrolling="yes" style="height: calc(100vh - 160px); width:100%; border:0;"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalConfirm2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" runat="server" id="btnImprimir" data-dismiss="modal" onserverclick="btnImprimir_ServerClick">Sí</button>
                </div>
            </div>
        </div>
    </div>

            ...
            <tr>
                ...
                <td>
                    <table style="font-family: Verdana; font-size: 8pt">
                        ...
                        <tr runat="server" id="TrAuxiliar" visible="false">
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="Auxiliar de Ama"></asp:Label>
                            </td>
                            <td colspan="2">
                                <telerik:RadComboBox ID="cmbAuxiliar" runat="server" AutoPostBack="True" ChangeTextOnKeyBoardNavigation="true"
                                    DataTextField="Descripcion" DataValueField="Id" EnableLoadOnDemand="true" Filter="Contains"
                                    HighlightTemplatedItems="true" LoadingMessage="Cargando..." MarkFirstMatch="true"
                                    Width="275px" MaxHeight="250px" TabIndex="6">
                                    <ItemTemplate>

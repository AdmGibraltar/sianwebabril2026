<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master" AutoEventWireup="true"
    CodeBehind="ProEntradaVirtual_Autorizacion.aspx.cs" Inherits="SIANWEB.ProEntradaVirtual_Autorizacion" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_Excel(Id_Emp, Id_Cd) {
                //debugger;
                var oWnd = radopen("ProEntradaVirtual_Autorizacion_GenExcel.aspx?"
                    + "&Id_Emp=" + Id_Emp
                    + "&Id_Cd=" + Id_Cd                  
                    , "AbrirVentana_vExcel");
                oWnd.center();

    ...
    public partial class Rep_CedulaVisita : PaginaBase
    {
        ...
        public void txtCliente_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (new CN_CatCliente().ConsultaClienteDirecto(cte, gSession.Emp_Cnx))
                {
                    Alerta($"El cliente {cte.Id_Cte} pertenece a clientes directos y es administrado desde central");

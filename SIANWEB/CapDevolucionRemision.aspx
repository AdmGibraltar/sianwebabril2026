                                ...
                                <telerik:RadGrid ID="rgDevParcial" runat="server" GridLines="None" PageSize="15"
                                    ...
                                    <MasterTableView>                                        
                                        <Columns>     
                                            ...
                                            <telerik:GridBoundColumn DataField="Id_Rem" HeaderText="# Remisión" UniqueName="Id_Rem" Display="true" >
                                                <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                         ...
                                         <GroupByExpressions> 
                                                 ...
                                                 <SelectFields> 
                                                    <telerik:GridGroupByField FieldName="Id_Rem" HeaderText="Remisión: " HeaderValueSeparator=""></telerik:GridGroupByField>

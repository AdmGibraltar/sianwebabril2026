    ...
    public partial class ProPlaneacionReparto_Admin : System.Web.UI.Page
    {
        ...
        protected void rgAsignacionporproducto_ItemCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "Editar":
                        RAM1.ResponseScripts.Add("return AbrirVentana_ProAsignPedxPrd('" + gi.Cells[3].Text + "','" + gi.Cells[4].Text + "','"+ gi.Cells[2].Text  + "')");
                        break;
                    case "Delete":
...
//            ALValorParametrosInternos.Add(ParametroInt(TxtSectorInicial.Text.Trim()));
        ...
        protected void ImbPickingListPrint_Click(object sender, EventArgs e)
        {
            ...
            ALValorParametrosInternos.Add(ParametroInt(TxtClienteInicial.Text.Trim()));
            ALValorParametrosInternos.Add(ParametroInt(TxtClienteFinal.Text.Trim()));
            ALValorParametrosInternos.Add(ParametroInt("0"));
            ALValorParametrosInternos.Add(ParametroInt("0"));
            ALValorParametrosInternos.Add(ParametroInt("0"));
            ALValorParametrosInternos.Add(ParametroInt("0"));
            ...
            ALValorParametrosInternos.Add(cmbRuta.Text);
        ...
        private List<PedidoDet> GetListPorProdcto()
        {
            try
            {
                ...
                pedido.Filtro_Estatus = CmbEstatusPedido.SelectedValue;
                ...
                pedido.Filtro_Credito = Convert.ToInt32(CmbCredito.SelectedValue);

...
namespace SIANWEB.CuentasCorporativas
{
    public partial class CatClienteMatriz_ACYS : System.Web.UI.Page
    {
        ...
        private List<CatCnac_Producto> listProductos
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductos"];
            }
            set
            {
        ...
        private List<CatCnac_Producto> listProductosKilo
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductosKilo"];
            }
            set
            {
        ...
        private List<CatCnac_Producto> listProductosComensal
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductosComensal"];
            }
            set
            {
        ...
        private List<CatCnac_Producto> listProductosHabitacion
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductosHabitacion"];
            }
            set
            {
        ...
        private List<CatCnac_Producto> listProductosIguala
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductosIguala"];
            }
            set
            {
        ...
        private List<CatCnac_Producto> listProductosServicios
        {
            get
            {
                return (List<CatCnac_Producto>)Session["listProductosServicios"];
            }
            set
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CN_Cn_matriz CN = new CN_Cn_matriz();
                Sesion ObjSesion = new Sesion();
                ObjSesion = (Sesion)Session["Sesion" + Session.SessionID];

                CatCnac_Producto Registros = new CatCnac_Producto();
                List<CatCnac_Producto> lista = new List<CatCnac_Producto>();
                Registros.Id_TG = 0;
                Registros.Id_ACYS = id_ClienteMat;
                CN.ConsultarAcysProductos(Registros, ref lista, ObjSesion.Emp_Cnx);
                listProductos = lista;

                Registros = new CatCnac_Producto();
                lista = new List<CatCnac_Producto>();
                Registros.Id_TG = 1;
                Registros.Id_ACYS = id_ClienteMat;
                CN.ConsultarAcysProductos(Registros, ref lista, ObjSesion.Emp_Cnx);
                listProductosKilo = lista;
        ...
        protected void rtb1_ButtonClick(object sender, Telerik.Web.UI.RadToolBarEventArgs e)
        {
            ...
            if (btn.CommandName == "save")
            {
                ...
                List<CatCnac_Producto> listProdFinal = new List<CatCnac_Producto>();

                var id_ClienteMat = Int32.Parse(Request.QueryString["Id"]);
                ...
                matriz.CatAcys_Productos = (from tlist in listProdFinal
                                            select new CatAcys_Productos
                                            {
                                                Id_Prd = Convert.ToInt32(tlist.Id_Prd),
                                                Id_TG = tlist.Id_TG,
                                                Cantidad = tlist.Cantidad,
                                                Precio = tlist.Precio,
                                                Subtotal = tlist.Subtotal,
                                                Frecuencia = tlist.Frecuencia,
                                                Lun = tlist.Lun,
                                                Mar = tlist.Mar,
                                                Mie = tlist.Mie,
                                                Jue = tlist.Jue,
                                                Vie = tlist.Vie,
                                                Sab = tlist.Sab,
                                                Documento = tlist.Documento,
                                                Id_ACYS = tlist.Id_ACYS,
                                                Descripcion = tlist.Descripcion,
                                                Unidad = tlist.Unidad,

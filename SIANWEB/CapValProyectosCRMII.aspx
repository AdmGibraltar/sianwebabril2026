<%@ Page Title="Valuación de proyectos" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.master"
    AutoEventWireup="true" CodeBehind="CapValProyectosCRMII.aspx.cs" Inherits="SIANWEB.CapValProyectosCRMII" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style type="text/css">
        ...
        .propEc .rtbIcon, .propEc:hover .rtbIcon
        {
	        background: transparent url(Imagenes/Sprite01.png) no-repeat 0px -265px;
	        width: 16px;
	        height: 16px;
        }
        .acepEv .rtbIcon, .acepEv:hover .rtbIcon
        {
	        background: transparent url(Imagenes/Sprite01.png) no-repeat 0px -1152px;
	        width: 16px;
	        height: 16px;
        }
    </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            // 23AGO-2021 RFH
            var GLOBAL_CRMValuacion_PrecioVentaMayor_AAA = '<%=GLOBAL_CRMValuacion_PrecioVentaMayor_AAA %>';
            function page_EndRequest(sender, args) {
                if (args.get_error() != undefined) {
                    if (args.get_error() != null) {
                        if (args.get_error().httpStatusCode == '500') {
                            if (_peticionIniciadaPorComandoGuardar == true) {
                                args.set_errorHandled(true);
                                radalert(args.get_error().message);
                                _peticionIniciadaPorComandoGuardar = false;
                            }
                        }
                    }
                }
            ...
            function pageLoad() {
                ...
                $telerik.$('#txtMotivoCliente').blur(function () {
                    $telerik.$('#<%=txtMotivoAutorizacion.ClientID %>').val($telerik.$(this).val());
                });
            }
            var _externalCustomFn = null;
            function externalCustom() {
                if (_externalCustomFn != null) {
                    var v = document.getElementById('<%=this.hiddenId.ClientID %>').value;
                    _externalCustomFn(v);
                }
            }
            var _peticionIniciadaPorComandoGuardar = false;
            function peticionIniciada() {
            }
            function validarRespuesta(sender, eventArgs) {
                if (_peticionIniciadaPorComandoGuardar == true) {
                    externalCustom();
                    _peticionIniciadaPorComandoGuardar = false;
                }
            ...
            //JFCV 24ene23 si regresa de la valuación que grabe 
            function GrabaAlerta(param) {
                debugger;
                ...
                _peticionIniciadaPorComandoGuardar = true;
                $telerik.$('#<%=txtMotivoAutorizacion.ClientID %>').val($telerik.$('#txtMotivoCliente').val());
                //}
                //else {
            ...
            function ClientTabSelecting(sender, args) {
                ...
                if (continuarAccion) {
                    ...
                    var territorioSeleccionado = $telerik.$('#CPH_ddlTerritorio').val();
                    if (territorioSeleccionado == 0) {
                        //radalert('Por favor elija un territorio', 330, 150, '');
                        //args.set_cancel(true);
                    }
                }
            }
                ...
                if (txtVap_Precio != null) {
                    if (txtVap_Precio.get_textBoxValue() == '') {
                        ...
                        if (parseFloat(txtVap_Precio.get_textBoxValue()) <= 0 && cmbTipo.get_value() == 1) {
                            ...
                            var costoAAA = parseFloat(lblVap_CostoEdit.value);
                            //var costoAAA = parseFloat(lblVap_CostoEdit.get_textBoxValue()) RFH 26 05 2018
                            if (GLOBAL_CRMValuacion_PrecioVentaMayor_AAA == 0) {
                                //Defaul - Ejecta Valicacion de Precio: El Precio NO debe se Menor a AAA
                            ...
                            if (GLOBAL_CRMValuacion_PrecioVentaMayor_AAA == 1) {
                                //Defaul - NO HACE VALIDACION DE PRECIO
                            }                            
                        }
                    }
                }
            ...
            function ToolBar_ClientClick(sender, args) {
                ...
                //// JFCV 24 enero lo comente para que no se cierre la pantalla antes de que envie la consulta
                //// ahorita al llamar esta función hace que se cierre aun y que no haya grabado manda aviso de que ya lo hizo 
                //// voy a poner estas líneas en la parte donde regresa de haber cerrado la pantalla de solicitudes
            ...
            //JFCV Alertas de precios 20 junio abrir ventana envio autorización solicitud de precios 
            //JFCV 22 jun 2022 validar antes de grabar  

            function AbrirVentana_AlertaPrecios() {
                var oWnd = radopen("Ventana_AutorizacionPrecios.aspx", "AbrirVentana_Solicituddeprecios");
                oWnd.setSize(1600, 550);
                oWnd.center();
            }
    ...
    <telerik:RadAjaxManager ID="RAM1" runat="server" OnAjaxRequest="RAM1_AjaxRequest" EnablePageHeadUpdate="False">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rgProyectos">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblMensaje" UpdatePanelHeight="" />
                    <telerik:AjaxUpdatedControl ControlID="rgProyectos" 
                        LoadingPanelID="RadAjaxLoadingPanel1" UpdatePanelHeight="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        <ClientEvents OnRequestStart="peticionIniciada" OnResponseEnd="validarRespuesta" />
    </telerik:RadAjaxManager>
    <div runat="server" id="div1">
        <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" dir="rtl" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="ToolBar_ClientClick" > <%--JFCV 14 enero la active lo comente porque estaba cerrando la pantalla de captura y no dejaba que se viera la pantalla de alerta de precios--%>
            <Items>
                <telerik:RadToolBarButton Width="20px" Enabled="False" CausesValidation="false" />
                <telerik:RadToolBarButton CommandName="save" Value="save" ToolTip="Guardar" CssClass="save"
                    ImageUrl="Imagenes/blank.png" ValidationGroup="guardar" />
                <%--<telerik:RadToolBarButton CommandName="aceptarEvaluacion" Value="aceptarEvaluacion" ToolTip="Aceptar Valuación" CssClass="acepEv"
                    ImageUrl="Imagenes/blank.png" />--%>
            </Items>
        </telerik:RadToolBar>
        <asp:Label ID="lblMensaje" runat="server"></asp:Label>
        
        <asp:HiddenField Value="0" runat="server" ID="hfId_Cte" />
        <asp:HiddenField Value="0" runat="server" ID="hfId_Op" />
        <asp:HiddenField Value="0" runat="server" ID="hfId_Ter" />
        <asp:HiddenField Value="0" runat="server" ID="hfTipoValuacion" />
        ...
        <table style="font-family: Verdana; font-size: 8pt; height: 100%" width="100%">
            <tr>
                ...
                <td>
                    <telerik:RadTabStrip ID="RadTabStrip1" AutoPostBack="True" runat="server" MultiPageID="RadMultiPage1"
                        ...
                        <Tabs>
                            ...
                            <telerik:RadTab runat="server" Text="Proyectos" AccessKey="P"
                                PageViewID="RadPageViewProyectos">
                            </telerik:RadTab>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" BorderStyle="Solid"
                            ...
                            <div runat="server" id="divPrincipal">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <asp:DropDownList runat="server" ID="ddlTerritorio" DataTextField="Nomenclatura" DataValueField="Id_Ter" OnSelectedIndexChanged="ddlTerritorio_OnSelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                         ...
                         <telerik:RadSplitter ID="RadSplitter1" runat="server" Height="480px" ResizeMode="AdjacentPane"
                           ...
                           <%-- <asp:Panel ID="Panel1" runat="server" Width="800px" ScrollBars="Vertical">--%>
                                <telerik:RadGrid ID="rgDetalle" runat="server" GridLines="None" AllowPaging="False"
                                    ...
                                    OnItemDataBound="rgDetalle_ItemDataBound" OnItemCommand="rgDetalle_ItemCommand" OnPreRender="rgDetalle_PreRender" 
                                    ...
                                    <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Vap,Id_VapDet,Vap_TipoStr,Id_Prd"
                                        ...
                                        <CommandItemSettings ExportToPdfText="Export to Pdf" ShowAddNewRecordButton="false" AddNewRecordText="Agregar" RefreshText="Actualizar" />
                                        <Columns>
                                            ...
                                            <%--Precio AAA se oculta y se agrega precio Objetivo--%>
                                            <telerik:GridTemplateColumn HeaderText="Precio AAA" DataField="Vap_Costo" UniqueName="Vap_Costo" Visible="false">
                                                <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>                                                   
                                             ...
                                             <telerik:GridTemplateColumn HeaderText="Precio Objetivo" DataField="Vap_PrecioObjetivo" UniqueName="Vap_PrecioObjetivo">
                                                <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>                                                   
                                                    <asp:Label ID="lblVap_PrecoiObjetivo" runat="server" Text='<%# Convert.IsDBNull(Eval("Vap_PrecioObjetivo")) ? string.Empty : Convert.ToDouble(Eval("Vap_PrecioObjetivo")).ToString("N2") %>' />
                                                    </ItemTemplate>
                                                <EditItemTemplate>
                                              <%--  <telerik:RadNumericTextBox ID="txtVap_PrecioObjetivo" runat="server" Width="50px" MaxLength="9"
                                                        MinValue="0" Text='<%# Eval("Vap_PrecioObjetivo") %>'>
                                                        <ClientEvents />
                                                        <NumberFormat DecimalDigits="2" GroupSeparator="" />
                                                    </telerik:RadNumericTextBox>--%>
                                                    <asp:Label ID="lblVap_PrecioObjetivoEdit" runat="server" Text='<%# Convert.IsDBNull(Eval("Vap_PrecioObjetivo")) ? string.Empty :  Convert.ToDouble(Eval("Vap_PrecioObjetivo")).ToString("N2") %>'
                                                        Width="50px" />
                                                        </EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Territorio" DataField="Id_Ter" UniqueName="txtId_Ter" ReadOnly="true" Display="false">
                                                <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId_Ter" runat="server" Text='<%# Eval("Id_Ter") %>' /></ItemTemplate>
                                                <EditItemTemplate>
                                                <asp:Label ID="lblVal_txtId_Ter" runat="server"
                                                        ForeColor="#FF0000"></asp:Label></EditItemTemplate>
                                            </telerik:GridTemplateColumn>
                        ...
                        <telerik:RadPageView ID="RadPageViewProyectos" runat="server" heigth="480px">
                         <telerik:RadSplitter ID="RadSplitterProyectos" runat="server" Height="480px" ResizeMode="AdjacentPane"
                                ResizeWithBrowserWindow="true" BorderSize="0" Width="101%">
                                <telerik:RadPane ID="RadPaneProyectos" runat="server" Height="480px" OnClientResized="onResize" BorderStyle="None"> 
                                <telerik:RadGrid ID="rgProyectos" runat="server" GridLines="None" AllowPaging="False"
                                    AutoGenerateColumns="False" OnItemCommand="rgProyectos_OnItemCommand" OnItemCreated="rgProyectos_ItemCreated" >
                                    <MasterTableView Name="Master" CommandItemDisplay="Top" HorizontalAlign="NotSet" AutoGenerateColumns="False" NoMasterRecordsText="No se encontraron registros.">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="Id" HeaderText="Proyecto" UniqueName="Id"
                                                ReadOnly="true" Display="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Uen_Descrip" HeaderText="UEN" UniqueName="Uen"
                                                ReadOnly="true" Display="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Seg_Descripcion" HeaderText="Segmento" UniqueName="Segmento"
                                                ReadOnly="true" Display="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Ter_Nombre" HeaderText="Territorio" UniqueName="Territorio"
                                                ReadOnly="true" Display="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Descripcion" HeaderText="Descripcion" UniqueName="Descripcion"
                                                ReadOnly="true" Display="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridCheckBoxColumn UniqueName="chkColSeleccion" HeaderText="¿Incluir?">
                                                
                                            </telerik:GridCheckBoxColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
                                <asp:CheckBox runat="server" ID="chkIncluirVentaTrimestral" Text="Incluir Venta Trimestral" style="display:none;" />
                             </telerik:RadPane>
                         </telerik:RadSplitter>
                        </telerik:RadPageView>
	...
	<tr>
                ...
                <td align="center" style="font-family: Verdana; font-size: 10pt;">
                   <telerik:RadNumericTextBox ID="txtGastosServirCliente" runat="server" MaxLength="9" MinValue="0" Width="80px">
                    <EnabledStyle HorizontalAlign="Right" />
                    </telerik:RadNumericTextBox>
                </td>
	</tr>
	...
	<tr>
                ...
                <td align="left" style="font-family: Verdana; font-size: 10pt;">Cetes</td>
                <td align="center" style="font-family: Verdana; font-size: 10pt;">
	...
	<tr>
                <td align="left" style="font-family: Verdana; font-size: 10pt;">Tasa Incremental al Costo Capital</td>
                <td align="center" style="font-family: Verdana; font-size: 10pt;">
	...
	<tr>
                ...
                <td align="center" style="font-family: Verdana; font-size: 10pt;">&nbsp;</td>
                <td align="center" style="font-family: Verdana; font-size: 10pt;">&nbsp;</td>
	</tr>
	</table>
                            <%--</asp:Panel>--%>
        ...
        <br>
        <div style="width:98%; height:445px; margin-top:20px; margin-bottom:100px; position:absolute; overflow-y:scroll;">
            <div id="divResumen" runat="server"></div>
        </div>
        ...
        <%--</asp:Panel>--%>
                    ...
                    <div style="display: none;">
                        <asp:TextBox runat="server" ID="txtMotivoAutorizacion"></asp:TextBox>
                    </div>
                </td>
            </tr>
            <tr>

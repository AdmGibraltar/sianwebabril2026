...
namespace SIANWEB
{
    public partial class Rep_SerSistemasPropietarios : System.Web.UI.Page
    {
        #region Variables
        ...
        private void CargarTerritorios(int pIdCliente)
        {
            try
            {
                ...
                new CN_CatCliente().ConsultaTodosTerritoriosDelClienteBI(pIdCliente, gSession, ref listaTerritorios);
        ...
        private void Mostrar(bool a_pantalla)
        {
            ...
            {
                amortizacion.Tipo = 1;
                amortizacion.STipo = rbEstadistica.Text;
            }
            if (rbSaldo.Checked == true)
            {
                amortizacion.Tipo = 2;
                amortizacion.STipo = rbSaldo.Text;
            }
            if (!string.IsNullOrEmpty(txtRepresentante.Text) && txtRepresentante.Text != "0")
            {
            ...
            {
                amortizacion.Detalle = 1;
                amortizacion.SDetalle = "Activado";
            }
            else
            {
            ...
            #endregion
            Type instance = null;
            if (!rbEstadistica.Checked)
            {
                if (chkDetalle.Checked)
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_SerAmortizacion2a);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_SerAmortizacion2a);
                    }
                }
                else
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_SerAmortizacion2b);
                    }
                    else
                    {
            ...
            else
            {
                if (chkDetalle.Checked)
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_SerAmortizacion1a);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_SerAmortizacion1a);
                    }
                }
                else
                {
                    if (a_pantalla)
                    {
                        instance = typeof(LibreriaReportes.Rep_SerAmortizacion1b);
                    }
                    else
                    {
                        instance = typeof(LibreriaReportes.ExpRep_SerAmortizacion1b);
                    }
                }
            }

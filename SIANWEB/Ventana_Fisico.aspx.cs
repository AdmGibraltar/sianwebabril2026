...
namespace SIANWEB
{
    public partial class Ventana_Fisico : System.Web.UI.Page
    {
        ...
        public int Id_Pvd;
        public Int64 Prd_Inicial;
        public Int64 Prd_Final;
        ...
        protected void btnImportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                NombreArchivo = Path.GetFileNameWithoutExtension(fn) + DateTime.Now.ToString("ddMMyyyyHHmmss") + ext;

                if (ext != ".xls" && ext != ".xlsx")
                {
                    Alerta("Solo se permiten archivos excel (xls,xlsx).");
                }
                else
                {

...
namespace SIANWEB
{
    ...
    {
        #region Variables
        private bool _PermisoGuardar1 { get { if (Session["Sesion" + Session.SessionID] == null) { return false; } return (bool)Session["PermisoGuardar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]]; } set { Session["PermisoGuardar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]] = value; } }
        private bool _PermisoModificar1 { get { if (Session["Sesion" + Session.SessionID] == null) { return false; } return (bool)Session["PermisoModificar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]]; } set { Session["PermisoModificar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]] = value; } }
        private bool _PermisoEliminar1 { get { if (Session["Sesion" + Session.SessionID] == null) { return false; } return (bool)Session["PermisoEliminar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]]; } set { Session["PermisoEliminar" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]] = value; } }
        private bool _PermisoImprimir1 { get { if (Session["Sesion" + Session.SessionID] == null) { return false; } return (bool)Session["PermisoImprimir" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]]; } set { Session["PermisoImprimir" + Session.SessionID + Page.Request.Url.ToString().Split(new string[] { "." }, StringSplitOptions.RemoveEmptyEntries)[0]] = value; } }
        #endregion
            ...
            try
            {
                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        if (DateTime.Now > dpFecha2.SelectedDate)
                        {
                        ...
                        else
                        {
                            ...
                            dpFecha2.DbSelectedDate = DateTime.Now;
                        }
                        ValidarPermisos();
                        LlenarCombos();
                        CargarCentros();
        ...
        protected void RadToolBar1_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            try
            {
                ...
                switch (btn.CommandName)
                {
                    case "new":
                        //nuevo();
                        RadAjaxManager1.ResponseScripts.Add("return AbrirVentana_Pagos('-1','-1','" + _PermisoGuardar1.ToString().ToLower() + "','" + _PermisoModificar1.ToString().ToLower() + "','"
                                + _PermisoEliminar1.ToString().ToLower() + "','" + _PermisoImprimir1.ToString().ToLower() + "')");
                        break;
                    case "save":
                        //Guardar();
                        break;
        ...
        protected void rgEntSal_ItemCommand(object source, GridCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "Baja":
                        if (_PermisoEliminar1) { 
                            baja(ref e, ref statusPosibles, ref item);
                        } else
                        {
                            Alerta("No tiene permiso para eliminar");
                        }
                        break;

                    case "Imprimir":
                        if (_PermisoImprimir1)
                    ...
                    case "Editar":
                        ...
                        if (_PermisoModificar1)
                        {
                            ...
                            //que no valide la fecha del movimiento
                            ...
                            RadAjaxManager1.ResponseScripts.Add("return AbrirVentana_Pagos('" + ides + "','" + es_naturaleza
                                + "','" + _PermisoGuardar1.ToString().ToLower() + "','" + _PermisoModificar1.ToString().ToLower() + "','"
                                + _PermisoEliminar1.ToString().ToLower() + "','" + _PermisoImprimir1.ToString().ToLower() + "')");
                        } else
                        {
        ...
        private void ValidarPermisos()
        {
            try
            {
                ...
                {
                    _PermisoGuardar1 = Permiso.PGrabar;
                    _PermisoModificar1 = Permiso.PModificar;
                    _PermisoEliminar1 = Permiso.PEliminar;
                    _PermisoImprimir1 = Permiso.PImprimir;

                    if (Permiso.PGrabar)
                        ((RadToolBarItem)RadToolBar1.Items.FindItemByValue("new")).Visible = _PermisoGuardar1;
                }
                else

<%@ Page Title="Autorización"
    Language="C#"
    AutoEventWireup="true"
    MasterPageFile="~/MasterPage/MasterPageModal.Master"
    CodeBehind="Ventana_AutorizacionV2.aspx.cs"
    Inherits="SIANWEB.Ventana_AutorizacionV2" %>
    ...
    <script>
        const logIn = () => {
            ...
            jQuery.ajax({
                ...
                url: 'Ventana_AutorizacionV2.aspx/LogIn',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: (data) => {
                    if (data.d.Status == null) closeThisWindow('autorizar')
                    else {

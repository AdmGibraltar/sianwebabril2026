<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master" AutoEventWireup="true" CodeBehind="CapRemisiones_Lista.aspx.cs" Inherits="SIANWEB.CapRemisiones_Lista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server"  >
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        <script type="text/javascript">
            ...
            //EDSG 02082019
            function AbrirVentana_Soportes(Id_Rem) {
                //debugger;
                var oWnd = radopen("VentanaSoportes.aspx?Id_Rem=" + Id_Rem, "AbrirVentana_Remision");
                oWnd.center();
                oWnd.setSize(500, 300);
            }
            //EDSG 02082019
            function AbrirVentana_FacturaOC(CFD_Serie, CFD_Folio) {
                //debugger;
                var oWnd = radopen("Ventana_FacturasOC.aspx?CFD_Serie=" + CFD_Serie + "&CFD_Folio=" + CFD_Folio);
                oWnd.center();
                oWnd.setSize(500, 300);
            }
            ...
            function AbrirVentana_CFDITraslado(Id_Rem) {
                debugger;
                var oWnd = radopen("CapCFDITraslado.aspx?Id_Rem=" + Id_Rem, "AbrirVentana_CFDITraslado");
                //var oWnd = radopen("FrmCartaPorte.aspx?Id_Rem=" + Id_Rem, "AbrirVentana_CFDITraslado");
                oWnd.center();
                oWnd.Maximize();
            }
            //*******************************************************
            ...
            function AbrirVentana_CFDITimbre(Id_Doc, Id_Cte, Nombre, CodigoPostal, Colonia, TipoDoc, permitirModificar) {
                debugger;
                AbrirVentana_CFDITimbre(Id_Doc, Id_Cte, Nombre, CodigoPostal, Colonia, TipoDoc, permitirModificar);
                return false;
            }
            function AbrirVentana_CFDITimbre(Id_Doc, Id_Cte, Nombre, CodigoPostal, Colonia, TipoDoc, permitirModificar) {
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblSoporte" runat="server" Text="Con Soporte"></asp:Label>
                                </td>
                                <td colspan="2">
                                    <telerik:RadComboBox ID="cmbSoporte" runat="server" Width="150px">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <telerik:RadGrid ID="rgPedido" runat="server" AutoGenerateColumns="False" GridLines="None"
                               ...
                               <CommandItemTemplate> 
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="CDI" HeaderText="CDI" UniqueName="CDI"
                                            Display="false">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridButtonColumn CommandName="ImprimirContrato" HeaderText="Imprimir Contrato"
                                         ...
                                         <telerik:GridButtonColumn CommandName="SubirSoporte" HeaderText="Subir soporte"
                                             UniqueName="SubirSoporte" Visible="True"
                                            ButtonType="ImageButton" ImageUrl="~/Imagenes/iconos/document_edit.png">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle Width="50" />
                                        </telerik:GridButtonColumn>
                                        <telerik:GridTemplateColumn DataField="DocSoporte" HeaderText="Documento Soporte" UniqueName="DocSoporte">
                                            <ItemTemplate>                         
                                                <asp:LinkButton ID="lnkDownload" Text='<%# Eval("PDFSoporteRemision")==""?"":"Descargar" %>' runat="server" OnClientClick='<%# "descargarArchivo(\"" +Eval("PDFSoporteRemision") + "\" );" %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                          
                                         <telerik:GridTemplateColumn DataField="Factura" HeaderText="Ref Fact" UniqueName="Factura">
                                            <ItemTemplate>                         
                                                <asp:LinkButton ID="lnkDownloadFactura" Text='<%# Eval("Serie").ToString()+ Eval("Factura").ToString() %>' runat="server" OnClientClick='<%# "AbrirVentana_FacturaOC(\"" +Eval("Serie") + "\",\"" +Eval("Factura")  +"\" );" %>'></asp:LinkButton> 
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>

    ...
    public partial class CapFactura : System.Web.UI.Page
    {
        ...
        protected void cmbTerritorio_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            try
            {
                ...
                if (Page.Request.QueryString["vieneremision"] != "1")
                {
                    ...
                    if (txtPedido.Text == "" && ConfigurationManager.AppSettings["ValidaPedidos"].ToString() == "S")
                    {
                        ...
                        {
                            new CN_CatCliente().ConsultaClienteValidoFacturaSinPedido(Convert.ToInt32(txtCliente.Value.HasValue ? txtCliente.Value.Value : -1), sesion, ref SiValida);
                        }
                        ...
                        if (SiValida == "S")
                        {
                            ...
                            if (txtTerritorio.Text.Trim().Length >= 8)
                            {

                                if (txtTerritorio.Text.Trim().Substring(1, 2) == "06")
                                {

                                }
                                else
                                {
                                    Alerta("No se permite facturar sin pedido o solo que el territorio sea tipo mostrador");
                                }
                            }
                            else
                            {
                                if (txtTerritorio.Text.Trim().Substring(0, 1) == "6")
                                {
                                }
                                else
                                {
            ...
            try
            {
                ...
                switch (btn.CommandName)
                {
                    case "save":
                        ...
                        //Se agrega validacion antes de guardar para levantar mensajes
                        if (Guardar_FacEspecial == true)
                        {
                            this.Guardar(false);
                        }
                        break;
            ...
            try
            {
                ...
                switch (cmd)
                {
                    ...
                    case "CancelarAlertaPrecios":
                        ...
                        //Eliminar esta alerta JFCV Alerta("Modifique los precios en los productos de acuerdo a los convenios para poder guardar la factura.");
                        break;
                    case "AceptarPrecios":
                        Guardar(true);
                        break;
            ...
            try
            {
                ...
                if (e.Item is GridDataItem)
                {
                    ...
                    if (prdActivo == 2)
                    {
                        ...
                        Alerta("Hay productos inactivos en el detalle de la factura");
                    }
                }
        ...
        protected void rgFacturaDet_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                facturaDet.Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value); //Convert.ToInt32((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
                ...
                //validar campo territorio
                //RBM Sept 2024
                if (facturaDet.Id_Ter == -1 || facturaDet.Id_Ter.ToString() == "" || facturaDet.Id_TerStr == "" || facturaDet.Id_TerStr == "-- Seleccionar --")
                {
                    Alerta("Favor de seleccionar un territorio válido para continuar.");
                    e.Canceled = true;
                    return;
                }
                ...
                facturaDet.Producto.Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value); //Convert.ToInt32((insertedItem.FindControl("cmbProducto") as RadComboBox).SelectedValue);
                ...
                if (ValidaPartidas(Convert.ToInt32((insertedItem["Id_Ter"].FindControl("cmbTerritorioPartida") as RadComboBox).SelectedValue), Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value), Convert.ToInt32((insertedItem["Fac_Cant"].FindControl("txtFac_Cantidad") as RadNumericTextBox).Text)) == false)
                {
                    e.Canceled = true;
                    return;
                }
        ...
        protected void rgFacturaDet_UpdateCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                this.ConsultaInventarioProducto(Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value));
                ...
                facturaDet.Id_Ter = Convert.ToInt32((insertedItem["Id_Ter"].FindControl("cmbTerritorioPartida") as RadComboBox).SelectedValue);
                facturaDet.Id_TerStr = (insertedItem["Id_Ter"].FindControl("cmbTerritorioPartida") as RadComboBox).Text;
                facturaDet.Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value);
                if (((GridTemplateColumn)rgFacturaDet.Columns.FindByUniqueName("Id_CteExt")).Display == true)
                {
                    facturaDet.Id_CteExt = Convert.ToInt32((insertedItem["Id_CteExtN"].FindControl("txtClienteExterno") as RadNumericTextBox).Value);
                    facturaDet.Id_CteExtStr = (insertedItem["Id_CteExt"].FindControl("txtNombreCliente") as RadTextBox).Text;
                ...
                //datos del producto de la orden de compra
                facturaDet.Producto = new Producto();
                facturaDet.Producto.Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_Prd") as RadNumericTextBox).Value);  //Convert.ToInt32((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
                facturaDet.Producto.Id_Emp = sesion.Id_Emp;
                facturaDet.Producto.Id_Cd = sesion.Id_Cd_Ver;
                facturaDet.Producto.Prd_Descripcion = (insertedItem["Prd_Descripcion"].FindControl("txtPrd_Descripcion") as RadTextBox).Text;
                facturaDet.Producto.Prd_Presentacion = (insertedItem["Prd_Presentacion"].FindControl("txtPrd_Presentacion") as RadTextBox).Text;
        ...
        protected void rgFacturaDet_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    long Id_PrdFac = Convert.ToInt64(itemAde.OwnerTableView.DataKeyValues[itemAde.ItemIndex]["Id_Prd"]);
                    string eliminar = "SI";
                    if (rgFacturaDetAde.Items.Count > 1)
                    {
                        foreach (GridDataItem item2 in rgFacturaDetAde.Items)
                        {
                            ...
                            Int64 IdProducto = Convert.ToInt64(item2.OwnerTableView.DataKeyValues[item2.ItemIndex]["Id_Prd"]);
        ...
        protected void rgFacturaDetAde_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                Id_Prd = Convert.ToInt64((insertedItem.FindControl("txtId_PrdAde") as RadNumericTextBox).Value);
        ...
        protected void rgFacturaDetAde_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //long Id_Prd = Convert.ToInt32(item.OwnerTableView.DataKeyValues[item.ItemIndex]["Id_Prd"]);                    
                    //actualizar producto de orden de compra a la lista
        ...
        protected bool ValidaPartidas(int ter, Int64 prd, int cantidad)
        {
            try
            {
                ErrorManager();
                ...
                if (rgFacturaDet.Items.Count > 0)
                {
                    ...
                    foreach (GridDataItem item in rgFacturaDet.Items) // loops through each rows in RadGrid
                    {
                        ...
                        if (Convert.ToInt32(item.OwnerTableView.DataKeyValues[item.ItemIndex]["Id_Ter"]) != ter
                            && Convert.ToInt64(item.OwnerTableView.DataKeyValues[item.ItemIndex]["Id_Prd"]) == prd
                            )
                        {
        ...
        protected void txtPrecio_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                ErrorManager();
                RadNumericTextBox txtFac_Precio = (RadNumericTextBox)sender;
                Telerik.Web.UI.GridTableCell tabla = (Telerik.Web.UI.GridTableCell)txtFac_Precio.Parent;
                RadNumericTextBox prd = (RadNumericTextBox)tabla.FindControl("txtId_Prd");
                ...
                if (txtFac_Precio.Value.HasValue)
                {
                    if (Convert.ToInt64(prd.Text) <= 999999999999)
                    {
                        ...
                        conv.Id_Prd = Convert.ToInt64(prd.Text);
                        cn_conv.Convenio_ConsultaPrecio(conv, ref convdet, ConexionCentral);
                        if (convdet != null && convdet.PCD_PrecioAAAEsp > 0)
                        {
                            /*if (Convert.ToDouble(txtFac_Precio.Text) < convdet.PCD_PrecioAAAEsp)
                            {
                                Alerta("El precio de venta no puede ser menor al Precio AAA del producto.");
                                txtFac_Precio.Text = "0";
                                txtFac_Precio.Focus();
                                return;
                            }
                        ...
                        else
                        {
                            ...
                            int productoNuevo = 0;
                            clsProducto.ConsultaProductos(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, id_Cd_Prod, Convert.ToInt64((prd.Text)), ref productoNuevo, 0);
                            /*
                        if (Convert.ToDouble(txtFac_Precio.Text) < producto.Prd_AAA)
                        {
                            Alerta("El precio de venta no puede ser menor al Precio AAA del producto.");
                            txtFac_Precio.Text = "0";
                            txtFac_Precio.Focus();
        ...
        protected void txtCantidad_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                prd = (Txtcantidad.Parent.Parent.FindControl("txtId_Prd") as RadNumericTextBox).Value.HasValue ? Convert.ToInt64((Txtcantidad.Parent.Parent.FindControl("txtId_Prd") as RadNumericTextBox).Value.Value) : 0;
            ...
            try
            {
                ...
                if (combo.Value.HasValue)
                {
                    ...
                    try
                    {
                        ...
                        clsProducto.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, id_Cd_Prod, sesion.Id_Cd_Ver, Convert.ToInt64(combo.Value), 2);
                    }
                    catch (Exception ex)
                    {
                        combo.Text = "";
                    ...
                    if (producto.Prd_Activo == 2 && producto.Prd_InvFinal <= 0)
                    {
                        this.Alerta("Producto inactivo, reemplazalo con otra alternativa/consulta con el area operativa/CEDIS");
                        return;
                    }

                    //obtener precio de producto
                    float precioPublico = 0;
                    new CN_ProductoPrecios().ConsultaListaProductoPrecioPUBLICO(ref precioPublico, sesion, Convert.ToInt64(combo.Value));
                    ...
                    clienteProd.Id_Prd = Convert.ToInt64(combo.Value);
                    ...
                    if (Convert.ToInt64(combo.Value) <= 999999999999)
                    {
                        CN_Convenio cn_conv = new CN_Convenio();
                        ConvenioDet conv = new ConvenioDet();
                        ConvenioDet convdet = new ConvenioDet();
                        ...
                        conv.Id_Cd = sesion.Id_Cd_Ver;
                        conv.Id_Cte = Convert.ToInt32(txtCliente.Value.HasValue ? txtCliente.Value.Value : -1);
                        conv.Id_Prd = Convert.ToInt64(combo.Value);
                        ...
                        if (convdet != null && convdet.PCD_PrecioAAAEsp > 0)
                        {
                            ...
                            if (Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3) != 0 && Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3) != 0)
                            {
        ...
        private void Consultar_IVA_Cliente()
        {
            ...
            if (txtCliente.Text != string.Empty && txtCliente.Text != "-1")
            {
                ...
                cliente.Cte_RemisionElectronica = RemisionId;
                new CN_CatCliente().ConsultaClientes(ref cliente, sesion.Emp_Cnx);
                ...
                if (bDocumentoValido)
                {
                    ...
                    if (listaProdFacturaEspecialFinal.Count > 0)
                    {
                        foreach (FacturaDet facturaDet in listaProdFacturaEspecialFinal)
                        {
                            ...
                            //RBM 04/2022 Se elimina dato directo y se agrega informacion de la factura especial
                            //Inicio
                            //prd.Attributes["ClaveProdServ"].Value = "01010101";
                            //prd.Attributes["ClaveUnidad"].Value = "H87";
                            prd.Attributes["ClaveProdServ"].Value = facturaDet.Producto.Prd_ClaveProdServ;
                            prd.Attributes["ClaveUnidad"].Value = facturaDet.Producto.Prd_ClaveUnidad;
                            //Fin
        ...
        private void LLenarFormFactura(int Id_Emp, int Id_Cd, int Id_Fac)
        {
            try
            {
                ...
                if (factura.Fac_OrdEntrega == null) txtOrdenCompra.Text = string.Empty; else txtOrdenCompra.Text = factura.Fac_OrdEntrega.ToString();
                ...
                ddUsoCfdi.SelectedValue = factura.UsoCFDI?.ToString().Trim();
        ...
        private void LlenarFactura(DataTable ListaProductosFactura, ref Factura factura)
        {
            try
            {
                ...
                if (txtOrden.Text == string.Empty) factura.Fac_OrdEntrega = txtOrdenCompra.Text; else factura.Fac_OrdEntrega = txtOrden.Text;
            ...
            try
            {
                ...
                if (Page.Request.QueryString["vieneremision"] != "1")
                {
                    if (txtPedido.Text == "" && ConfigurationManager.AppSettings["ValidaPedidos"].ToString() == "S")
                    {
                        ...
                        if (ConfigurationManager.AppSettings["ValidaPedidosClientes"].ToString() == "S")
                        {
                            new CN_CatCliente().ConsultaClienteValidoFacturaSinPedido(Convert.ToInt32(txtCliente.Value.HasValue ? txtCliente.Value.Value : -1), session, ref SiValida);
                        }
                ...
                //JFCV 8 mzo 23 Session["FacEspecialGuardada" + Session.SessionID] = "1";
                if (AceptacionPrecios)
                {
                    if (Session["FacEspecialGuardada" + Session.SessionID] != null)
                    {
                        if (Convert.ToString(Session["FacEspecialGuardada" + Session.SessionID]) == "1")
                        {
                ...
                {
                    Int64 prd = Convert.ToInt64((rgFacturaDet.Items[k].FindControl("lblid_prdnum") as Label).Text);//rgFacturaDet.Items[k]["Id_Prd"].ToString());
                ...
                if (!AceptacionPrecios)
                {
                    ...
                    int GLOBAL_ValidaConvenios = 1;
                    CapaEntidad.eSysConfiguracion SysC = new CapaEntidad.eSysConfiguracion();
                    try
                    {
                        CN_SysConfigruacion CN = new CN_SysConfigruacion();
                        SysC = CN.spSysConfiguracionById(session.Id_Emp, session.Id_Cd, 951, session.Emp_Cnx);
                        int iTmp = 0;
                        int.TryParse(SysC.Conf_Valor, out iTmp);
                        GLOBAL_ValidaConvenios = iTmp;
                    }
                    catch (Exception ex)
                    {
                        GLOBAL_ValidaConvenios = 1;
                    }
                    ...
                    //ciclo para buscar si productos están en convenios
                    foreach (DataRow dr in objdtTabla.Rows)
                    {  //FOR
                        ...
                        conv.Id_Cte = Convert.ToInt32(txtCliente.Value.HasValue ? txtCliente.Value.Value : -1);
                        conv.Id_Prd = Convert.ToInt64(dr["Id_Prd"].ToString());

                        double PrecioIngresado = Convert.ToDouble(dr["Fac_Precio"]);

                        if (Convert.ToInt64(dr["Id_Prd"].ToString()) <= 999999999999)
                        {
                            cn_conv.Convenio_ConsultaPrecio(conv, ref convdet, ConexionCentral);
                            ...
                            if (convdet != null && convdet.PCD_PrecioAAAEsp > 0)
                            {
                                if (Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3) != 0 || Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3) != 0)
                                {
                                    #region si pvtamin # 0 o Pvtamax # 0
                                    // sI  entra aqui es porque uno de los dos o los dos son mayores a cero

                                    if (Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3) != 0 && Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3) == 0)
                                    {
                                        //v- 99 y v+ 0                 precio menor igual a v- 
                                        if (Math.Round(PrecioIngresado, 3) < Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3))
                                        {
                                            agregar = 1;
                                        }
                                    }
                                    else if (Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3) == 0 && Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3) != 0)
                                    {
                                        // vta minima es igual a cero y vta max dif 0 
                                        // si precio es mayor a vta max manda aviso 
                                        if (Math.Round(PrecioIngresado, 3) > Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3))
                                        {
                                            agregar = 1;
                                        }
                                    }
                                    else if (Math.Round(PrecioIngresado, 3) < Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3) || Math.Round(PrecioIngresado, 3) > Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3))
                                    {
                                        agregar = 1;
                                    }
                                    ...
                                    if (agregar == 1)
                                    {
                                        ...
                                        lconvdet.PCD_PrecioVtaMax = Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMax), 3);
                                        lconvdet.PCD_PrecioVtaMin = Math.Round(Convert.ToDouble(convdet.PCD_PrecioVtaMin), 3);
                                        lconvdet.PCD_PrecioVentaConvenio = PrecioIngresado;
                                        lconveniosdet.Add(lconvdet);
                                    }
                                    #endregion
                                } // Si pvtamin == 0 y Pvta Max == 0 No valid ale precio

                            } // convdet dif nulo o precioaaaesp > 0
                        ...
                        if (Productos.Count > 0 && lconveniosdet.Count > 0)
                        {
                            ...
                            //en convenios se debe respetar el precio pactado si no no se puede hacer la factura
                            return;
                        }
                    }  // !AceptacionPrecios
                    ...
                    // configuración 955 Validación para Facturas  
                    // si el valor es 0 no valida y si es 1 si va a validar 
                    int GLOBAL_ValidaPrecioMinimoRik = 0;
                    try
                    {
                        CN_SysConfigruacion CN = new CN_SysConfigruacion();
                        SysC = CN.spSysConfiguracionById(session.Id_Emp, session.Id_Cd, 955, session.Emp_Cnx);
                        int iTmp = 0;
                        int.TryParse(SysC.Conf_Valor, out iTmp);
                    ...
                    //junio 2023 si es refaturación o cta nacional no debe validar alerta precios
                    if (GLOBAL_ValidaPrecioMinimoRik == 1 && EsRefactura == false)
                    {
                        foreach (DataRow dr in objdtTabla.Rows)
                        {
                            ...
                            if (Convert.ToInt64(dr["Id_Prd"]) <= 999999999999)
                            {
                                ...
                                alertaaut.Id_Prd = Convert.ToInt64(dr["Id_Prd"]);
                                alertaaut.IdRepresentante = Convert.ToInt32(txtRepresentante.Text);
                                alertaaut.Id_Ter = Convert.ToInt32(txtTerritorio.Value.HasValue ? txtTerritorio.Value.Value : -1);
                                double Preciodefactura = Convert.ToDouble(dr["Fac_Precio"]);
                                //11 agosto2023 Corrección error al validar precio
                                ...
                                if (alertaautdet != null && alertaautdet.Precio_MinimoRik > 0)
                                {
                                    ...
                                    if (Math.Round(Preciodefactura, 3) < alertaautdet.PrecioObjetivo)
                                    {
                                        ...
                                        pasoalertaautdet.IdRepresentante = Convert.ToInt32(txtRepresentante.Text);
                                        pasoalertaautdet.Id_Ter = Convert.ToInt32(txtTerritorio.Value.HasValue ? txtTerritorio.Value.Value : -1);
                                        ...
                                        pasoalertaautdet.PrecioLista = alertaautdet.PrecioLista;
                                        pasoalertaautdet.Cantidad = Convert.ToInt32(dr["Fac_Cant"]);
                                        ...
                                        pasoalertaautdet.Prd_Descripcion = Convert.ToString(dr["Prd_Descripcion"]);
                                        pasoalertaautdet.Cte_NomComercial = txtClienteNombre.Text;
                                        pasoalertaautdet.TipoAutorizacion = 5; //Factura
                        ...
                        //todo validar si debe ir esta condidión o esta de mas?                     
                        //jfcv Alertas precios 
                        if (Productos.Count > 0 && lconveniosdet.Count > 0)
                        {
                            ...
                            RAM1.ResponseScripts.Add("AbrirVentana_AutorizaciondePrecios(); return false;");
                            //en convenios se debe respetar el precio pactado si no no se puede hacer la factura
                            return;
                        }
                    ...
                    //JFCV 26 Abril del 2022 FIn Validar si tiene precios inferiores a los precios minimos
                ...
                */
                ...
                if (txtMov.Text == "70")
                {
                    ...
                    foreach (DataRow facturaDet in objdtTabla.Rows)
                    {
                        ...
                        {
                            if (Convert.ToInt64(facturaDet["Id_Prd"]) == amor.Id_Prd)
                            {
                        ...
                        entSalDetalle.Id_Prd = Convert.ToInt64(facturaDet["Id_Prd"]);
                ...
                if (listaRem == null)
                {
                    ...
                    else if (Session["ListaDevolucionRemisionesFactura" + Session.SessionID] != null)
                    {
                        ...
                        foreach (DataRow facturaDet in objdtTabla.Rows)
                        {
                            ...
                            Int64 vIdPrd = Convert.ToInt64(facturaDet["Id_Prd"]);
                    ...
                    if (!Convert.IsDBNull(facturaDet["Remisiones"]))
                                                                                    ...
                                                                                    .Where(rem => !string.IsNullOrEmpty(rem)))
                        {
                            ...
                            {//Crear item de lista de entrada-salida mov. 16
                                ...
                                entSalDetalleRem.Id_Prd = Convert.ToInt64(facturaDet["Id_Prd"]); //facturaDet.Id_Prd;
                ...
                if (ListaProductosFacturaEspecial != null)
                {
                    ...
                    double TE1 = (Math.Round(txtImporte.Value.Value, 2) + 1); // Math.Round(totalEspecial, 2) + .90; // se suman 70 centavos al total especial -- modificar si se desea disminuir o aumentar el rango
                    double TE2 = (Math.Round(txtImporte.Value.Value, 2) - 1); // se restan 70 centavos al total especia
                ...
                {// NUEVA FACTURA    
                    ...
                    factura.UsoCFDI = ddUsoCfdi.SelectedValue;
                    if (this.hiddenId.Value == string.Empty)
                    {
                        ...
                        else
                        {
                            ...
                            if (EsRefactura)
                            {
                                Factura facturacanc = new Factura();
                                facturacanc.Id_Cd = Convert.ToInt32(Page.Request.QueryString["Id_Cd"]);
                                facturacanc.Id_Emp = Convert.ToInt32(Page.Request.QueryString["Id_Emp"]);
                                facturacanc.Id_Fac = Convert.ToInt32(Page.Request.QueryString["Id_Fac"]);
                                new CN_CapFactura().ConsultaFactura(ref facturacanc, session.Emp_Cnx);
                                CancelarFacturaNC(ref facturacanc);
                            }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (listaProductosFacturaEspecial.Count > 0 && ((Math.Round((fTotal + 1), 2) < Math.Round(fTotalEsp, 2)) || (Math.Round((fTotal - 1), 2) > Math.Round(fTotalEsp, 2))) && cmbMov.SelectedValue != "91")
                            {
            ...
            try
            {
                ...
                foreach (DataRow dr in listaFacturaDetalle.Rows)
                {
                    if (txtPedido.Text != "")
                    {
                        ...
                        Int64 producto = Convert.ToInt64(dr["Id_Prd"].ToString());
            ...
            try
            {
                if (Session["ListaDevolucionRemisionesFactura" + Session.SessionID] != null)
                {
                    ...
                    if (listaRemisiones.Count > 0)
                    {
                        ...
                        RemisionId = listaRemisiones[0].Id_Rem;
                        //---------------------------------------------------------------------------------------
            ...
            try
            {
                if (Session["PedidoFacturacion" + Session.SessionID] != null)
                {
                    ...
                    if (bTieneAsignado)
                    {
                        ...
                        ddUsoCfdi.SelectedValue = pedido.UsoCFDI?.ToString().Trim();
                        ...
                        dtPedido.Columns.Add("Id_Prd", typeof(Int64));
                        ...
                        pedido.TraePicking = Convert.ToString(Request.QueryString["strpicking"]);
                        ...
                        foreach (DataRow row in colRow)
                        {
                            ...
                            if (row["Id_Prd"] != null)
                                Id_Prd = row["Id_Prd"].ToString() == string.Empty ? -1 : Convert.ToInt64(row["Id_Prd"]);
                            ...
                            // reemplazo del uso de objdtTabla.Rows.Add(new object[] { ... });
                            DataRow drNuevo = objdtTabla.NewRow();
                            drNuevo["Id_Fac"] = DBNull.Value;
                            drNuevo["Id_FacDet"] = z;
                            drNuevo["Id_Rem"] = id_Rem;
                            drNuevo["Id_Tm"] = DBNull.Value;
                            drNuevo["Id_CteExt"] = Id_CteExt == 0 ? (object)DBNull.Value : Id_CteExt;
                            drNuevo["Id_Ter"] = Id_Ter;
                            drNuevo["Id_Prd"] = Id_Prd;
                            drNuevo["Prd_Descripcion"] = Prd_Descripcion;
                            drNuevo["Prd_Presentacion"] = Prd_Presentacion;
                            drNuevo["Prd_UniNe"] = Prd_UniNe;
                            drNuevo["Fac_Cant"] = Fac_Cant;
                            drNuevo["Rem_Cant"] = Rem_Cant;
                            drNuevo["Fac_Precio"] = Fac_Precio;
                            double importe = Fac_Precio * (Fac_Cant + Rem_Cant);
                            drNuevo["Fac_Importe"] = importe;
                            drNuevo["Id_TerStr"] = Id_TerStr;
                            drNuevo["Id_CteExtStr"] = Id_CteExtStr;
                            drNuevo["AmortizacionProducto"] = DBNull.Value;
                            drNuevo["Id_Emp"] = session.Id_Emp;
                            drNuevo["Id_Cd"] = session.Id_Cd_Ver;
                            drNuevo["Fac_Asignar"] = DBNull.Value;
                            drNuevo["Fac_Devolucion"] = DBNull.Value;
                            drNuevo["Prd_UniNs"] = DBNull.Value;
                            drNuevo["Remisiones"] = DBNull.Value;
                            drNuevo["RemisionesXML"] = DBNull.Value;
                            drNuevo["Multiplicador"] = 0d;
                            drNuevo["Precio_Venta"] = 0d;
                            drNuevo["Totales"] = importe;          // inicial igual al importe
                            drNuevo["TotalesAAA"] = 0d;
                            drNuevo["Fac_Precio_Original"] = Fac_Precio;       // guardar precio base
                            drNuevo["Prd_Activo"] = DBNull.Value;     // sin dato en este contexto

                            objdtTabla.Rows.Add(drNuevo);
        ...
        private void InicializarTablaProductos()
        {
            try
            {
                ...
                objdtLista.Columns.Add("Id_Prd", typeof(System.Int64));
                ...
                objdtLista.Columns.Add("Prd_Activo", typeof(System.Int64));
            ...
            try
            {
                ...
                { //Consultar clientes
                    ...
                    if (txtPedido.Text != "")
                    {
                        ...
                        Ped.Id_Ped = Convert.ToInt32(txtPedido.Text);
                    ...
                    {//muestra datos del cliente, los de CONSIGNACION, si no existen, muestra los de FACTURACION
                        ...
                        ddUsoCfdi.SelectedValue = cliente.Cte_UsoCFDI?.ToString().Trim();
                        ...
                        if (cliente.ClienteSIAN != "")
                        {
                            ...
                            cn.ConsultaDireccionesFiscales_SP(idClienteSIAN, sesion.Id_Cd_Ver, ref listadireccion, sesion.Emp_Cnx);
                            var diFisc = listadireccion.FirstOrDefault();
                            if (diFisc != null)
                            {
                                ...
                                this.TxtClienteNacionalNoExterior.Text = diFisc.NumeroDirFis.ToString();
                                this.TxtClienteNacionalColonia.Text = diFisc.ColoniaDirFis;
                                this.TxtClienteNacionalCp.Text = diFisc.CPDirFis.ToString();
                                ...
                                //var cIntra = cn.ConsultaIntranetCuentaNacional(diFisc.id_ClienteMatriz, diFisc.Id);
                                //ListCuentaNacional = cIntra;

                            }
                            else
                            {
                                Alerta("La matriz vinculada al cliente no esta correctamente configurada por lo cual no se generará la doble facturación, favor de ponerse en contacto con el area de Cuentas Nacionales");
                                //this.RadToolBar1.Items[5].Enabled = false;
        ...
        private void ConsultaInventarioProducto(long Id_Prd)
        {
            try
            {
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                ...
                //obtener datos de producto
                CN_CatProducto clsProducto = new CN_CatProducto();
                clsProducto.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, 0, sesion.Id_Cd_Ver, Id_Prd, 2);
        ...
        //    }
        //}
        protected void ListaProductosFactura_EliminarProducto(long Id_Prd, int Id_Ter, int id_Fac)
        {
            try
            {
                DataRow[] Ar_dr;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (e.Value != string.Empty && e.Value != "-1")
                    {
                        //obtener datos de producto
                        CN_CatProducto clsProducto = new CN_CatProducto();
                        clsProducto.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, id_Cd_Prod, sesion.Id_Cd_Ver, Convert.ToInt64(e.Value), 2);
                    }
                    txtRem_Precio.Text = "";
                    txtPrd_Descripcion.Text = producto == null ? string.Empty : producto.Prd_Descripcion;
                    txtPrd_Presentacion.Text = producto == null ? string.Empty : producto.Prd_Presentacion;
        ...
        protected void rgFacturaEspecialDet_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                FacturaDet.Id_Prd = Convert.ToInt64((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
                ...
                //datos del producto de la orden de compra
                FacturaDet.Producto = new Producto();
                FacturaDet.Producto.Id_Prd = Convert.ToInt64((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
                FacturaDet.Producto.Id_Emp = sesion.Id_Emp;
                FacturaDet.Producto.Id_Cd = sesion.Id_Cd_Ver;
        ...
        private void CargarProductosEspeciales(RadComboBox cmb)
        {
            try
            {
                ...
                {
                    prd = new Producto();
                    prd.Id_Prd = Convert.ToInt64(item["Id_Prd"]);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow dr in objdtTabla.Rows)
                        {
                            ...
                            fDet.Id_Prd = Convert.ToInt64(dr["Id_Prd"]);
        ...
        private void LlenarComboUsoCfdi()
        {
            ...
            ddUsoCfdi.DataValueField = "Id";
            ddUsoCfdi.DataTextField = "Descripcion";
            ddUsoCfdi.DataBind();
            ddUsoCfdi.Items.Insert(0, new RadComboBoxItem("Seleccione una opción", ""));
        ...
        private bool Guardar()
        {
            ...
            try
            {
                ...
                //AOG 25-07-2024
                //Validamos si requiere nota de credito automatica que los datos de metodo y forma de pago esten correctos
                Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
                ...
                cte.Id_Emp = sesion.Id_Emp;
                cte.Id_Cd = sesion.Id_Cd_Ver;
                cte.Id_Cte = Convert.ToInt32(txtCliente.Text);
                Cn_cte.ConsultaClientes(ref cte, sesion.Emp_Cnx);
                if (cte.BPorcNotaCredito)
                {
                    if (cte.Cte_NCMetodoPago == "PUE" && cte.Cte_NCFormaPago == "99")
                    {
                        Alerta("Si el método de pago es PUE (Pago en una sola exhibición), la forma de pago no debe ser 99-Por definir. Corrija esta información en el catálogo de clientes.");
                        RadToolBar1.Enabled = true;
                        Guardar_FacEspecial = false;
                    }

                    if (cte.Cte_NCMetodoPago == "PPD" && cte.Cte_NCFormaPago != "99")
                    {
                        Alerta("Si el método de pago es PPD (Pago en parcialidades o diferido), la forma de pago debe ser 99-Por definir. Corrija esta información en el catálogo de clientes.");
                        RadTabStrip1.Tabs[0].Selected = true;
                        RadPageViewDGenerales.Selected = true;
                        //RadToolBar1.Enabled = true;
                        Guardar_FacEspecial = false;
                ...
                {
                    if (cte.Cte_MetodoPago == "PUE" && cte.Id_Fpa == 99)
                    {
                        Alerta("Si el método de pago es PUE (Pago en una sola exhibición), la forma de pago no debe ser 99-Por definir. Corrija esta información en el catálogo de clientes.");
                        RadToolBar1.Enabled = true;
                        Guardar_FacEspecial = false;
                    }
                    if (cte.Cte_MetodoPago == "PPD" && cte.Id_Fpa != 99)
                    {
                        Alerta("Si el método de pago es PPD (Pago en parcialidades o diferido), la forma de pago debe ser 99-Por definir. Corrija esta información en el catálogo de clientes.");
                        RadToolBar1.Enabled = true;
                        Guardar_FacEspecial = false;

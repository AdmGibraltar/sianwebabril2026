    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function popup(id_u, indicador, proveedor, sucursal, dias, tipoProd) {
                ...
                window.open("Rep_InvExceso9.aspx?Id_U=" + id_u
                    + "&Indicador=" + indicador
                    + "&Proveedor=" + proveedor
                    + "&Centro=" + sucursal
                    + "&Dias=" + dias
    ...
    <div runat="server" id="divPrincipal">
        <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" dir="rtl" OnButtonClick="RadToolBar1_ButtonClick">
            <Items>
                ...
                <telerik:RadToolBarButton Width="97%" CommandName="Envio" Value="Envio" CssClass="print" ToolTip="Envio" ImageUrl="Imagenes/blank.png" ValidationGroup="grupo" />
            </Items>
        </telerik:RadToolBar>
        ...
        <table style="font-family: Verdana; font-size: 8pt">
              <tr><td colspan="2">
                    <asp:Label ID="Lblexcesos" runat="server" Text="Excesos Inventarios Excel" />
                </td>
                 <td colspan= "3">
                         <asp:RadioButtonList runat= "Server" ID="RblTipoRep" RepeatDirection="Horizontal">
                    ...
                    <telerik:RadComboBox ID="cmbTipoProducto" runat="server" Width="200px" Filter="Contains"
                        ...
                        <ItemTemplate>
                            <table>
                                <tr>
                                    <td style="width: 25px; text-align: center; vertical-align: top">
                                        <asp:Label ID="Label2" runat="server" Width="30px" Text='<%# DataBinder.Eval(Container.DataItem, "Id").ToString() == "-1" ? "": DataBinder.Eval(Container.DataItem, "Id").ToString() %>' />
                                    </td>
                                    <td style="text-align: left">

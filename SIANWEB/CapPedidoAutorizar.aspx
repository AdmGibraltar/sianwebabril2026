<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" AutoEventWireup="true" CodeBehind="CapPedidoAutorizar.aspx.cs" Inherits="SIANWEB.CapPedidoAutorizar" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-success" style="margin-top: 5px;">
                    <div class="panel-heading" style="height: 40px;">
                        <div class="col-md-10">
                            <h3 class="panel-title">Autorización de Pedidos</h3>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div runat="server" id="div1">
                                    ...
                                    <div class="col-md-4" style="margin-top: 5px;">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <dx:BootstrapComboBox ID="BCBCliente" runat="server">
                                                </dx:BootstrapComboBox>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12 text-center" style="margin-top: 5px;">
                                <dx:BootstrapGridView ID="GrdAutPEdido" ClientInstanceName="grid" runat="server"
                                    ...
                                    <Columns> 
                                        <dx:BootstrapGridViewDateColumn   Caption="Aceptar">
                                            <DataItemTemplate>
                                                <button id="btnAcceptar" type="button" class="btn btn-link" title="Autorizar"
                                        ...
                                        <dx:BootstrapGridViewTextColumn FieldName="Id_Cte" CssClasses-HeaderCell="centerText" HorizontalAlign="right" Caption="Núm. Cliente" />
                                        <dx:BootstrapGridViewTextColumn FieldName="Cte_Nom" CssClasses-HeaderCell="centerText" HorizontalAlign="left" Caption="Cliente" />
                                        <dx:BootstrapGridViewTextColumn FieldName="estatusSTR" CssClasses-HeaderCell="centerText" HorizontalAlign="left" Caption="Estatus" />
                                        <dx:BootstrapGridViewTextColumn FieldName="Id_Ped" CssClasses-HeaderCell="centerText" HorizontalAlign="left" Caption="# Pedido" />
                                        <dx:BootstrapGridViewDateColumn FieldName="Ped_Fecha" CssClasses-HeaderCell="centerText" HorizontalAlign="center" Caption="Fecha" />
                                    </Columns>

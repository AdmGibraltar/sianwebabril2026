<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage03.Master"
    AutoEventWireup="true" CodeBehind="CapEntSal.aspx.cs" Inherits="SIANWEB.CapEntSal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnablePageHeadUpdate="False"
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="cmbiva">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Generales" LoadingPanelID="RadAjaxLoadingPanel1"
                        UpdatePanelHeight="" />
                    <telerik:AjaxUpdatedControl ControlID="rgEntradaSalida" UpdatePanelHeight="" LoadingPanelID="RadAjaxLoadingPanel1" />
                                    ...
                                    <div runat="server" id="Generales">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Aplica a"></asp:Label>
                                                </td>
                                                <td colspan="2">
                                      ...
                                      <tr runat="server" id="trProveedorF" visible="false">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td width="120">
                                                    <asp:Label ID="Label9" runat="server" Text="IVA"></asp:Label>
                                                </td>
                                                <td >
                                                    <telerik:RadComboBox ID="cmbiva" runat="server" Width="150px" AutoPostBack="True"
                                                        Filter="Contains" ChangeTextOnKeyBoardNavigation="true" MarkFirstMatch="true" OnSelectedIndexChanged="cmbiva_SelectedIndexChanged"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top" NoMasterRecordsText="No se encontraron registros."
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Id_Prd" HeaderText="Núm." UniqueName="Id_Prd">
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtId_Prd" runat="server" MaxLength="16" Width="50px"
                                                            MinValue="1" MaxValue="999999999999999" Text='<%# Eval("Id_Prd") %>'>
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                ...
                                                <telerik:GridTemplateColumn DataField="Es_Usado" HeaderText="Num. Usado" UniqueName="Num. Usado">
                                                    <EditItemTemplate>
                                                        <telerik:RadTextBox ID="RadNumericTextNumUsado" Enabled="False" runat="server" MinValue="0"
                                                            Width="70px" Text='<%# Eval("Es_Usado") %>' > 
                                                            <ClientEvents OnLoad="txtEs_Usado_OnLoad" />
                                                        </telerik:RadTextBox></EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label8" runat="server" Text='<%# Eval("Es_Usado") %>' /></ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Es_Cantidad" HeaderText="Cantid." UniqueName="Cantidad">
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="RadNumericTextBoxCantidad" runat="server" MinValue="1"
                                                            MaxLength="9" Width="50px" Text='<%# Eval("Es_Cantidad") %>'>
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                            <ClientEvents OnLoad="txtCantidadPartida_OnLoad" OnBlur="txtCantidad_Onblur" />
                                                        </telerik:RadNumericTextBox></EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="CantidadLabel" runat="server" Text='<%# Eval("Es_Cantidad") %>'></asp:Label></ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Width="70px" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </telerik:GridTemplateColumn>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Es_Costo" HeaderText="Costo" UniqueName="Costo">
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="RadNumericTextBoxCosto" runat="server" MinValue="0"
                                                            MaxLength="9" Width="50px" Text='<%# Eval("Es_Costo") %>'>
                                                            <ClientEvents OnLoad="txtPrecioPartida_OnLoad" OnBlur="txtPrecio_Onblur" />
                                                        </telerik:RadNumericTextBox></EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="CostoLabel" runat="server" Text='<%# Convert.ToDouble(Eval("Es_Costo")).ToString("N") %>' /></ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Width="70px" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </telerik:GridTemplateColumn>
                                                ...
                                                <telerik:GridTemplateColumn DataField="TipoSalida" HeaderText="Tipo de Salida" UniqueName="TipoSalida">
                                            <ItemTemplate>  
                                                ...
                                                <telerik:GridTemplateColumn DataField="ConceptoTipoSalida" HeaderText="Concepto Tipo de Salida" UniqueName="ConceptoTipoSalida">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function txtClienteId_OnBlur(sender, args) {
                ...
                var tipoMov = $find("<%= txtTipoId.ClientID %>")

                if (cte.get_value() == '')
                { return; }

                var nombre = ObtenerCliente(cte.get_value(), tipoMov.get_value());
            ...
            function ObtenerCliente(cte, tipoMov) {
                var urlArchivo = 'ObtenerNombreCliente.aspx';
                parametros = "cte=" + cte + "&tipoMov=" + tipoMov;
            ...
            function txtEs_Usado_OnLoad(sender, args) {
                _Es_Usado = sender;
            }
            ...
            function ObtenerProductoPrecio(_prd, _pre) {
                ...
                var urlArchivo = 'ObtenerProducto_ES.aspx';
            ...
            function txtCantidad_Onblur() {
                ...
                ObtenerProductoCantidad(txtReferencia, txtTipoId, _prd, _ter, txtClienteId, Cve_pagina, txtNaturaleza, _prd_cantidad, txtfolio);
                


                CalcularImporte(_importe, _prd_cantidad, _prd_precio);
            }
            function ObtenerProductoCantidad(_doc, _tip, _prd, _ter, _cte, _clv, _nat, _can, _es) {
...
/*                var var_foliooc = _foliooc == null ? -1 : _foliooc.get_value();
            ...
            function ObtenerProducto(_doc, _tip, _prd, _ter, _clv) {
                ...
                if (Resultado == -2) {
                    ...
                    _Es_Usado.set_value(mySplitResult[4]);

        ...
        <table style="font-family: Verdana; font-size: 8pt">
            <tr>
                ...
                <td>
                    ...
                    <telerik:radgrid id="rgPedido" ScrollBars="Horizontal" runat="server" autogeneratecolumns="False" gridlines="None"
                        ...
                        <MasterTableView>
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Ped_Picking" HeaderText="Picking" UniqueName="Ped_Picking"
                                    Display="true">
                                    <ItemStyle HorizontalAlign="Right" />
                                    <HeaderStyle Width="50px" />
                                </telerik:GridBoundColumn>
                        ...
                        <ClientSettings>
                            <Scrolling AllowScroll="true" ScrollHeight="800" UseStaticHeaders="true" />
                        </ClientSettings>
                    </telerik:radgrid>
                </td>
            </tr>

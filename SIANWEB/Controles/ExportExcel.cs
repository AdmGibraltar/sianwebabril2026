...
namespace SIANWEB.Helper
{
    public class ExportExcel
    {
        ...
        public void CeldaDatoString(string rango, string etiquetea, XLAlignmentHorizontalValues HAlign, bool isBold, bool isItalic, ref IXLWorksheet wsss)
        {
        ...
        public void CeldaDatosDate(string rango, DateTime? DateDato, XLAlignmentHorizontalValues HAlign, bool isBold, bool isItalic, ref IXLWorksheet wsss)
        {

            wsss.Cell(rango).SetValue(DateDato);
            wsss.Cell(rango).Style.Font.Bold = isBold;
            wsss.Cell(rango).Style.Font.Italic = isItalic;
            wsss.Cell(rango).Style.DateFormat.Format = "dd/mm/yyyy";
            wsss.Cell(rango).DataType = XLDataType.DateTime; // Use XLDataType.Number in 2018 and after
            wsss.Cell(rango).Style.Alignment.Horizontal = HAlign;
            wsss.Cell(rango).Style.Border.OutsideBorder = XLBorderStyleValues.Thin;

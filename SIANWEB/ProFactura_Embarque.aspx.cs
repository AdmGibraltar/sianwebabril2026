                ...
                if (_PermisoModificar)
                {
                    ...
                    switch (e.CommandName)
                    {
                        case "Confirmar":
                            ...
                            factura.Id_Cte = Convert.ToInt32(rgFactura.Items[item]["Id_Cte"].Text);
                            ...
                            CN.ValidarPedidoFacturaEcommerce(factura, session2.Emp_Cnx, ref lista);
                            string estatus = "";
                            string mensaje = "";
                            if (lista.Count > 0)
                            {
                                ...
                                APis.EnvioPedido(factura, session2.Emp_Cnx, ref estatus, ref mensaje);

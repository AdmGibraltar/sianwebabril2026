<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" AutoEventWireup="true" CodeBehind="Rep_HistAutPed.aspx.cs" Inherits="SIANWEB.Rep_HistAutPed" %>
    ...
    <div class="container-fluid">
        ...
        <asp:UpdatePanel runat="server" ID="UpdRepresentante">
            <ContentTemplate>
                ...
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="col-md-10">
                                <h3 class="panel-title">Reporte Historial Autorización de Pedidos</h3>
                            </div>
                ...
                <div class="col-md-12">
                    <dx:BootstrapGridView ID="GrdHistAutPed" ClientInstanceName="grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:BootstrapGridViewTextColumn FieldName="ID_sol" Caption="# Solicitud">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="Id_Cte" Caption="# Cliente">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="Cte_Nom" Caption="Nombre del Cliente">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="estatusSTR" Caption="Estatus">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewTextColumn FieldName="U_Nombre" Caption="Nombre Usuario">
                            </dx:BootstrapGridViewTextColumn>
                            <dx:BootstrapGridViewDateColumn FieldName="Ped_Fecha" Caption="Fecha">

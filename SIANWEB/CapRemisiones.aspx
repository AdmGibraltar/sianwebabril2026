...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function popup(KeyElem) {
                var oWnd = radopen("Ventana_Buscar.aspx?Ukey=" + encodeURIComponent(KeyElem), "AbrirVentana_Buscar"); 
                oWnd.center();
                //  } 
            }
            function AbrirBuscarDireccionEntrega(KeyElem) {
                var cte = $find('<%=txtClienteId.ClientID%>');
                var oWnd = radopen("Ventana_Buscar.aspx?DirEnt=true&cte=" + cte.get_value() + "&Ukey=" + encodeURIComponent(KeyElem) , "AbrirVentana_BuscarDireccionEntrega");
            ...
            function AbrirVentana_RemisionEspecial() {
                ...
                var KeyElem = document.getElementById('<%= sessionKey.ClientID %>').value;
                var oWnd = radopen("CapRemisiones_Especial.aspx?Id_Cte="
                  ...
                  + "&Ukey=" + encodeURIComponent(KeyElem)
                , "AbrirVentana_RemisionEspecial");
                oWnd.setSize(600, 400);
                oWnd.center();
                oWnd.Maximize();
            ...
            function abrirBuscar(KeyElem) {
                // debugger;
                if (txtId_Prd != null) {
                    if (txtId_Prd._focused == true) {
                        if (txtId_Prd._enabled) {
                            var cte = $find('<%=txtClienteId.ClientID%>'); 
                            var oWnd = radopen("Ventana_Buscar.aspx?Precio=true&cte=" + cte.get_value() + "&Ukey=" + encodeURIComponent(KeyElem), "AbrirVentana_BuscarPrecio");
                            oWnd.center();
                        }
                    }
                }
            ...
            //JFCV Alertas de precios convenios de precios validar antes de grabar 
            function AbrirVentana_AlertaAutorizacionPrecios() {
                var KeyElem = document.getElementById('<%= sessionKey.ClientID %>').value;
                var oWnd = radopen("Ventana_AutorizacionPrecios.aspx?Ukey=" + encodeURIComponent(KeyElem), "Ventana_AutorizacionPrecios");
                ...
                <td>
                    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1"
                        ...
                        <Tabs>
                            ...
                            <telerik:RadTab runat="server" visible="false" Text="Documentos Adjuntos" AccessKey="D">
                            </telerik:RadTab>
                                                ...
                                                <telerik:GridTemplateColumn DataField="Id_Prd" HeaderText="Núm." UniqueName="Id_Prd">
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server" AutoPostBack="True"
                                                            MaxLength="16" MinValue="0" MaxValue="999999999999999" OnLoad="txtProducto_Load" OnTextChanged="cmbProductoDet_TextChanged"
                                                            Width="50px">
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />
                    ...
                    <telerik:RadPageView ID="RadPageViewAmortizacion" runat="server" heigth="370px">
                      ...
                      <telerik:RadPageView ID="RadPageViewAdjuntos" runat="server">
                            <telerik:RadSplitter ID="RadSplitterAdjuntos" runat="server" Height="380px" ResizeMode="AdjacentPane"
                                ResizeWithBrowserWindow="true" BorderSize="0" Width="100%">
                                <telerik:RadPane ID="RadPaneAdjuntos" runat="server" Height="380px" OnClientResized="onResize"
                                    BorderStyle="None">
            ...
            <div class="uploadPanel">
                <div class="leftPanel">
                    ...
                    <div class="controls">
                        ...
                        <asp:Button ID="ButtonSend" Visible="false" OnClick="ButtonSend_Click" runat="server" Text="Save"
        ...
        <table style="font-family: Verdana; font-size: 8pt">
            <tr>
                <td>
                    ...
                    <asp:HiddenField ID="sessionKey" runat="server" Value="" /> 
                </td>
                <td>
                    &nbsp;
                </td>

<%@ Page Title="Gastos" Language="C#" MasterPageFile="~/MasterPage/MasterPage02.Master"
    AutoEventWireup="true" CodeBehind="CapPagosElectronicosModifica.aspx.cs" Inherits="SIANWEB.CapPagosElectoronicosModifica" %>
    ...
    <telerik:radajaxmanager id="RAM1" runat="server" onajaxrequest="RAM1_AjaxRequest">
        <AjaxSettings>
           ...
           <telerik:AjaxSetting AjaxControlID="CmbAcreedor">
             ...
             <telerik:AjaxSetting AjaxControlID="txtAcreedor">
               <UpdatedControls>
                   <telerik:AjaxUpdatedControl ControlID="divPrincipal" LoadingPanelID="RadAjaxLoadingPanel1" />
               </UpdatedControls>
           </telerik:AjaxSetting>
                        ...
                        <telerik:radgrid id="rgPagoElectronico" runat="server" CommandItemDisplay="Top" gridlines="None" autogeneratecolumns="False"
                            ...
                            onupdatecommand="RadGrid1_UpdateCommand" pagesize="6" allowpaging="True" datamember="listaOrdCompraDet">
                                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="Id_GVComprobante,GVComprobante_ConComprobanteDescripcion,PagElec_Id_PagElecCuenta"
                                                    ...
                                                    <CommandItemSettings ExportToPdfText="Export to Pdf" ShowAddNewRecordButton="false"  RefreshText="Actualizar" />
                                                    <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <%-- <telerik:GridTemplateColumn HeaderText="cuenta" DataField="PagElec_Id_PagElecCuenta" UniqueName="PagElec_Id_PagElecCuenta">
                                                            <HeaderStyle Width="140px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPagElec_Id_PagElecCuenta" runat="server" Text='<%# Eval("PagElec_Id_PagElecCuenta") %>' />
                                                            </ItemTemplate>
...
<%--
                                                            ...
                                                            <EditItemTemplate>
                                                                <telerik:RadComboBox ID="cmbFrc_EnviarA" runat="server" Width="120px" Filter="Contains"
                                                                    ...
                                                                    <Items>
                                                                        ...
                                                                        <telerik:RadComboBoxItem Text="Rev. Elec." Value="3" />
                                                       ...
                                                       <%-- <telerik:GridButtonColumn ConfirmText="¿Está seguro de quitar el documento de la lista?"
                                                          ...
                                                          <%--<telerik:GridTemplateColumn DataField="Frc_MailEnviado" HeaderText="Enviar Correo" UniqueName="Enviacorreo">
                                                            <ItemTemplate>
                                                                   <asp:CheckBox ID="chkEnviarMail" runat="server" Checked="false"  Visible='<%# DataBinder.Eval(Container.DataItem, "Frc_ReqRecibo") != null  ?  Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "Frc_ReqRecibo")) : false %>'  />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                         <asp:CheckBox ID="chkEnviarMailEdit" runat="server" />
                                                            </EditItemTemplate>
                                                            <HeaderTemplate>
                                                                <asp:CheckBox ID="chkEnviarMailCabezera" AutoPostBack="true"  Text="Enviar Correo" HeaderText="Enviar Correo" runat="server" OnCheckedChanged="chkEnviarMailCabezera_CheckedChanged"  />
                                                            </HeaderTemplate>
 
                                                        </telerik:GridTemplateColumn>--%>
                                                         
                                                         <%-- <telerik:GridTemplateColumn HeaderText="ReqRecibo" DataField="Frc_ReqRecibo" UniqueName="Frc_ReqRecibo"
                                                            Display="false">
                                                            <HeaderStyle Width="70px" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFrc_ReqRecibo" runat="server" Text='<%# Eval("Frc_ReqRecibo").ToString() %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:Label ID="lblFrc_ReqReciboEdit" runat="server" Text='<%# Eval("Frc_ReqRecibo").ToString() %>' />
                                                            </EditItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                                         <telerik:GridBoundColumn DataField="Frc_MailEnviado" HeaderText="Frc_MailEnviado" UniqueName="Frc_MailEnviado"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="PDF" HeaderStyle-HorizontalAlign="Center"
                                             ...
                                             <telerik:GridButtonColumn ButtonType="ImageButton" HeaderText="Eliminar" CommandName="Delete" ConfirmDialogType="RadWindow"
            ...
            <table>
                <tr>
                    <td>
                        <telerik:radgrid id="rgPagoElectronico2" runat="server" autogeneratecolumns="False"
                            ...
                            pagesize="6" allowpaging="false" mastertableview-nomasterrecordstext="No se encontraron registros. "
                            height="200px">
                    <MasterTableView>
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="GVComprobante_ConComprobanteDescripcion" HeaderText="Con/Sin" UniqueName="GVComprobante_ConComprobanteDescripcion"><HeaderStyle Width="60" /></telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="GVComprobante_Fecha" HeaderText="Fecha" DataFormatString="{0:dd/MM/yy}" UniqueName="GVComprobante_Fecha" ><HeaderStyle Width="85" /></telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PagElec_CuentaPago" HeaderText="PagElec_CuentaPago" UniqueName="PagElec_CuentaPago" Visible="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PagElec_Cuenta" HeaderText="Número" UniqueName="PagElec_Cuenta" Visible="false"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PagElec_Cc" HeaderText="Cuenta" UniqueName="PagElec_Cc" Visible="true"><HeaderStyle Width="32" /></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PagElec_Numero" HeaderText="Cuenta" UniqueName="PagElec_Numero" Visible="false"><HeaderStyle Width="25" /></telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="PagElec_Serie" HeaderText="Serie" UniqueName="PagElec_Serie" ><HeaderStyle Width="20" /></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="PagElec_Folio" HeaderText="Folio" UniqueName="PagElec_Folio" ><HeaderStyle Width="25" /></telerik:GridBoundColumn>
                            ...
                            <%--JFCV 04-Nov-2016 agregar columna de edición para editar partidas.--%>

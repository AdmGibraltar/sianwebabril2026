<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="ProValidaCierre.aspx.cs" Inherits="SIANWEB.ProValidaCierre" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Fecha inicial del periodo"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="Fecha final del periodo"></asp:Label>
                            </td>
                            <td>
                                <telerik:RadDatePicker ID="dpFecha2" runat="server" Width="100px" Enabled="False">
                                </telerik:RadDatePicker>
                            </td>
                            <td>
                                &nbsp;

...
namespace SIANWEB
{
    public partial class ReporteGAPDetalle : System.Web.UI.Page
    {
        ...
        private void inicializar()
        {
            ...
            //Cargar zonas
            cmbZona.Items.Add("--Todas--", "-1");
            cmbZona.Items.Add("Norte", "1");
            cmbZona.Items.Add("Centro", "2");
            cmbZona.Items.Add("Sur", "3");
            cmbZona.Items.Add("Playas", "4");

            cmbMatriz.Items.Add("--Todas--", "-1");
            cmbMatriz.Items.Add("SORIANA", "1");
            cmbMatriz.Items.Add("HOME DEPOT", "2");
            cmbMatriz.Items.Add("ALCEA", "3");

            cmbZona.Value = "-1";
            cmbMatriz.Value = "-1";

            CmbTipoRepresentante.Items.Add("--Todos--", "-1");
            CmbTipoRepresentante.Items.Add("A", "1");
            CmbTipoRepresentante.Items.Add("B", "2");
            CmbTipoRepresentante.Items.Add("C", "3");
            CmbTipoRepresentante.Items.Add("D", "4");
            CmbTipoRepresentante.Items.Add("E", "5");
            CmbTipoRepresentante.Value = "-1";
        ...
        public void cargarDatos()
        {
            ...
            //else
            //{
            //    reporteGAP.Id_Prd = Convert.ToInt32(this.txtProducto.Text);
            //}
            ...
            CN_ReporteGAP.ConsultaListaReporteGAP_Producto(reporteGAP, ref listreporteGAP, Conexion);

...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
            ...
            <tr>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lbCteInicial" runat="server" Text="Cliente inicial" />
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtCteInicial" runat="server" Width="70px" MinValue="1"
                                    MaxLength="9">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                    <ClientEvents OnKeyPress="handleClickEvent" />
                                </telerik:RadNumericTextBox>
                            ...
                            <td>
                                <asp:Label ID="lbCteFinal" runat="server" Text="Cliente final" />
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtClienteFinal" runat="server" Width="70px" MinValue="1"
                                    MaxLength="9">
                                    <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                    <ClientEvents OnKeyPress="handleClickEvent" />
                                </telerik:RadNumericTextBox>
                    ...
                    <telerik:RadGrid ID="rgPago" runat="server" AutoGenerateColumns="False" GridLines="None"
                        EnableLinqExpressions="False" PageSize="100" AllowPaging="True" MasterTableView-NoMasterRecordsText="No se encontraron registros."
                        ...
                        <MasterTableView ClientDataKeyNames="Id_Pag">
                            ...
                            <Columns>
                                ...
                                <telerik:GridButtonColumn CommandName="Baja" HeaderText="Baja Fiscal y Cobranza" ConfirmDialogType="RadWindow"
                                  ...
                                  <%--Cambio efectuado el dia 16/11/2018. Por: Erik Ramon Guajardo Castellanos--%>
                                 <telerik:GridButtonColumn CommandName="BajaFiscal" HeaderText="Baja Fiscal" ConfirmDialogType="RadWindow"
                                    ConfirmText="¿Está seguro de dar de baja los complementos del pago?</br></br>" ConfirmDialogHeight="150px"
                                    ConfirmDialogWidth="350px" Text="BajaFiscal" UniqueName="BajaFiscal" Visible="True" ButtonType="ImageButton"
                                    ImageUrl="~/Imagenes/blank.png" ButtonCssClass="baja">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" Width="70px"></HeaderStyle>
                                </telerik:GridButtonColumn>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_Pagos_Timbre(Id, notaGuardar, notaModificable, fechaPago, ejecutor) {
                AbrirVentana_Pagos_Timbre(Id, notaModificable, notaModificable, fechaPago, ejecutor);
                return false;
            }
            ...
            function AbrirVentana_Pagos_Timbre(Id, notaGuardar, notaModificable, fechaPago, ejecutor) {
                //debugger;
                var oWnd = radopen("CapPagosTimbres.aspx?Id=" + Id + "&PermisoGuardar=" + notaGuardar + "&PermisoModificar=" + notaModificable + "&PermisoEliminar=<%= _PermisoEliminar %>&PermisoImprimir=<%= _PermisoImprimir %>&fechaPago=" + fechaPago + "&CentroEjecutor=" + ejecutor + "&idPagina=" +GetIdPagina(), "AbrirVentana_Pago");
                oWnd.center();
                oWnd.Maximize();
            }
            function AbrirVentana_Pagos(Id, notaGuardar, notaModificable) {
                //debugger;
                var oWnd = radopen("CapPagos.aspx?Id=" + Id + "&PermisoGuardar=" + notaGuardar + "&PermisoModificar=" + notaModificable + "&PermisoEliminar=<%= _PermisoEliminar %>&PermisoImprimir=<%= _PermisoImprimir %>&idPagina=" +GetIdPagina(), "AbrirVentana_Pago");
                oWnd.center();
                oWnd.Maximize();
            }
            function AbrirVentana_PagosExt(Id, notaGuardar, notaModificable) {
                //debugger;
                var oWnd = radopen("CapPagos.aspx?Ext=true&Id=" + Id + "&PermisoGuardar=" + notaGuardar + "&PermisoModificar=" + notaModificable + "&PermisoEliminar=<%= _PermisoEliminar %>&PermisoImprimir=<%= _PermisoImprimir %>&idPagina=" + GetIdPagina(), "AbrirVentana_Pago");
                oWnd.center();
                oWnd.Maximize();
            }

                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        */
                        ...
                        if (DateTime.Now > dpFechaFin.SelectedDate)
                        {
                            dpFechaIni.DbSelectedDate = Sesion.CalendarioFin;
                            dpFechaFin.DbSelectedDate = Sesion.CalendarioFin;
                        ...
                        {
                            dpFechaIni.DbSelectedDate = DateTime.Now;
                            dpFechaFin.DbSelectedDate = DateTime.Now;
                        }

    ...
    public partial class ProEntradaVirtual : System.Web.UI.Page
    {
        ...
        protected void rgProductos_ItemDataBound(object sender, GridItemEventArgs e)
        {
            try
            {
                ...
                if ((e.Item is GridEditFormItem) && (e.Item.IsInEditMode))
                {
                    ...
                    RadTextBox txtClave = (RadTextBox)editItem["Prd_Descripcion"].FindControl("txtClave");
                    ...
                    if (updatebtn != null)
                    {
                        RadTextBox txtId_Prd = (RadTextBox)editItem.FindControl("txtClave");
                ...
                if (e.Item is GridEditableItem && e.Item.IsInEditMode)
                {
                    ...
                    RadTextBox dataField = (RadTextBox)form["Id_Prd"].FindControl("txtClave");
        ...
        protected void cmbProductoDet_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                RadTextBox txtProducto = (RadTextBox)sender;

                try
                {
                    cnProducto.ConsultaProducto(ref prd, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, Convert.ToInt64((sender as RadTextBox).Text),0);
                }
                catch (Exception ex)
                {
                ...
                ((sender as RadTextBox).Parent.Parent.FindControl("txtProductoNombre") as RadTextBox).Text = prd.Prd_Descripcion;
                ((sender as RadTextBox).Parent.Parent.FindControl("txtCosto") as RadNumericTextBox).Text = prd.Prd_AAA.ToString();
        ...
        private string Guardar(bool enviar)
        {
            ...
            try
            {
                ...
                foreach (DataRow row in dt2.Rows)
                {
                    ...
                    vpep.Id_Env = id;
                    vpep.Id_Prd = Convert.ToInt64(row["Id_Prd"]);
        ...
        private DataTable PoblarTablaPro()
        {
            ...
            { //poblar la tabla virtual con columnas vacias:
                ...
                dt2.Columns.Add("Id_Prd", System.Type.GetType("System.Int64"));
        ...
        private DataTable PoblarTablaDetalleMov()
        {
            ...
            { //poblar la tabla virtual con columnas vacias:
                ...
                dtDetalleMov.Columns.Add("Id_Prd", System.Type.GetType("System.Int64"));
        ...
        protected void BtnAutorizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //JFCV Inicio validar que si ya esta autorizada no ejecute de nuevo el proceso 


               int folioentrada =   Convert.ToInt32(hiddenId.Value)  ;

                EntradaVirtual v = null;

                new CN_EntradaVirtual().ConsultaVentanaEntradaVirtual(ref v, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, folioentrada);
                ...
                if (Estatus == "A")
                {
                    ...
                    Alerta("La Entrada ya estaba autorizada");
                    return;
                }

                if (v.Id_UAutorizo != sesion.Id_U)
                {
                    RadTabStrip1.Tabs[1].Enabled = false;
                    RadTabStrip1.Tabs[2].Enabled = false;
                    Alerta("No tiene permisos para autorizar");
                    return;
                }


                //JFCV Fin validar que si ya esta autorizada no ejecute de nuevo el proceso 
        ...
        protected void BtnDevolucion_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridDataItem item in rgDevParcial.MasterTableView.Items)
                {
                    ...
                    vpep.Id_Es = entsal.Id_Es;
                    vpep.Id_Prd = Convert.ToInt64(item["Id_Prd"].Text);
        ...
        private void PerformInsert_rgProductos(GridCommandEventArgs e)
        {
            try
            {
                ...
                if (
                   ((RadTextBox)gi.FindControl("txtClave")).Text == "" ||
                ...
                Id_Prd = Convert.ToInt64(((RadTextBox)gi.FindControl("txtClave")).Text);
        ...
        private void Update_rgProductos(GridCommandEventArgs e)
        {
            try
            {
                ...
                if (((RadTextBox)gi.FindControl("txtClave")).Text == "" ||
                    ((RadNumericTextBox)gi.FindControl("txtCantidad")).Text == "" ||
                    ((RadNumericTextBox)gi.FindControl("txtPreVta")).Text == "")
                {
                    this.Alerta("Todos los campos son requeridos");

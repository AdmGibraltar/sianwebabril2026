                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadNumericTextBox ID="TextId_Prd" runat="server" Width="50px"  MaxLength="16"
                                        ...
                                        <td>
                                            ...
                                            Estatus: <asp:Label ID="lblEstatusPrd" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label52" runat="server" Text="Picking"></asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server" Width="50px" Enabled="false"
                                                MaxLength="9">
                                                <NumberFormat DecimalDigits="0" GroupSeparator="" />
                                                <ClientEvents OnKeyPress="handleClickEvent" />
                                            </telerik:RadNumericTextBox>

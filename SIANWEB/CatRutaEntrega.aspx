            ...
            <tr>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label9" runat="server" Text="Auxiliar de almacén"></asp:Label>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                            <td colspan="2">
                                <telerik:RadComboBox ID="cmbAuxiliar" runat="server" 
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cmbAuxiliar"
                                ...
                                <telerik:RadGrid ID="rg1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    <MasterTableView>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn UniqueName="Aux_Nombre" HeaderText="Auxiliar almacén" DataField="Aux_Nombre">
                                                <HeaderStyle Width="300px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="Id_Aux" HeaderText="Auxiliar almacén" DataField="Id_Aux" Visible="false">
                                                <HeaderStyle Width="300px" />
                                            </telerik:GridBoundColumn>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function LimpiarControles() {
                ...
                LimpiarComboSelectIndex0($find('<%= cmbAuxiliar.ClientID %>'));

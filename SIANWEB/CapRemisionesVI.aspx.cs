...
namespace SIANWEB
{
    public partial class CapRemisionesVI : System.Web.UI.Page
    {
        #region Variables
        ...
        private void EnviarCorreo(int Id_Rem)
        {
            try
            {
                ...
                cuerpo_correo.Append("<center><br>");
                cuerpo_correo.Append("<a href='" + Request.Url.ToString().Replace(url[url.Length - 1], "") + "CapRemisionesVI.aspx?tdm=" + 2 + "&Id_Rem=" + Id_Rem + "&Accion=2&email=1&PermisoGuardar=false&PermisoModificar=false&PermisoEliminar=false&PermisoImprimir=false'" + ">");

...
namespace SIANWEB
{
    public partial class VentanaComentariosTerritorios : System.Web.UI.Page
    {
        ...
        {
            if (RadEditorComentarios.Content == String.Empty)
            {
                RAM1.Alert("Este campo es necesario para procesar la solicitud.");
                return;
            }
            else
            {
                ...
                RAM1.Alert("Para poder proceder con esta solicitud en el Cliente es importante presionar el botón guardar en el catalogo de Clientes.");

<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" 
    AutoEventWireup="true" CodeBehind="GC_RepCumplimientoVtaInstalada_index.aspx.cs" Inherits="SIANWEB.GC.GC_RSCASC_index" %>
            ...
            <tr>
                ...
                <td style="width:100px;">
                    <select id="cmbMes" class="form-control" style="width:150px;" >
                        <option value="1" data-mes="1">Enero</optio>
                ...
                <td style="width:150px;">Rik / RSC / Asesor</td>
                ...
                <td style="width:50px;">
                    <select id="ddlTerritoriosDe" class="form-control" style="width:100px;">
                        <option value="3" data-tipoterr="3">Rik</option>
                        <option value="0" data-tipoterr="0">Todos</option>
                         <option value="1" data-tipoterr="1">Asesor</option>
                         <option value="2" data-tipoterr="2">Rsc</option>
                    </select>   
                </td>
                <td style="width:150px;">
                ...
                <td style="width:50px;">
                    <button id="btnCargarListado" type="button" class="btn btn-primary btn-sm" 
                        onclick="RepCumplimientoVI.btnAplicar_Click();">
                ...
                <td style="width:100px;" >
                    <button type="button" class="btn btn-default btn-sm hidden" 
                        onclick="RepCumplimientoVI.Exportar_Excel();">
                                <i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;Bajar reporte
                                       ...
                                       <div class="dropdown inline"  >
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1" style="cursor:pointer;" >                                
                                            <li><a data-desglosado="0" onclick="RepCumplimientoVI.btnExportaExcel_Click(this);" >No Desglosado</a></li>
                                            <li><a data-desglosado="1" onclick="RepCumplimientoVI.btnExportaExcel_Click(this);" >Desglosado</a></li>
                                          </ul>
                                        </div>
        ...
        <thead>
            <tr>                
                ...
                <th class="text-center" style="width:100px;">
                    ...
                    data-col_id="10" 
                        data-orden="10" 
                        data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);" 
                    >Núm Cte<br>No. Prod.</label>                    
                </th>   
                ...
                <th class="text-center">                    
                    ...
                    id="ColumnaOrden_11"
                    data-col_id="11" 
                    data-orden="11" data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);" 
                    >Cliente<br>Descripción</label>                
                </th>   
                
                <!--th class="text-center rd_col_100">
                    <label class="LinkCte" 
                    id="ColumnaOrden_1"
                    data-col_id="1" data-orden="1" data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);" 
                ...
                <th class="text-center rd_col_100">
                    ...
                    data-orden="9" 
                    data-dir="0" 
                    onclick="RepCumplimientoVI.PreCargaIndice(this);" 
                ...
                <th class="text-center rd_col_100">
                    ...
                    title="Promedio Trimestre Anterior Vs Venta Instalada"
                        data-col_id="7" data-orden="7" data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);">
                    Prom. trim .ant vs VI
                    </label>                    
                </th>                    
                <th class="text-center rd_col_100">
                    ...
                    title="% Cumplimiento Acys Vs Promedio Trimestre Anterior"
                        data-col_id="8" data-orden="8" data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);">
                ...
                <!--th class="text-center rd_col_100" >
                    <label class="LinkCte"
                    id="ColumnaOrden_9"
                    data-col_id="9" data-orden="9" data-dir="0" onclick="RepCumplimientoVI.PreCargaIndice(this);">
            ...
            <div class="modal-body">                                    
                ...
                <table id="tblSeleccionUsuarioBuscar">                    
                    <tbody>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" onclick="RepCumplimientoVI.btnBuscarRepresentante();">Buscar</button>                
                        </td>
                    </tbody>
                </table>

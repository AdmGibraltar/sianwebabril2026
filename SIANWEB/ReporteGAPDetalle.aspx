<%@ Page Title="Reporte GAP"   Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master"
    CodeBehind="ReporteGAPDetalle.aspx.cs" Inherits="SIANWEB.ReporteGAPDetalle" %>
...
<%--Filtros de busqueda --%>
            ...
            <div class="col-md-12" style="margin-top: 5px;">
                <div class="col-md-4">
                    <div class="col-md-4">
                        <asp:Label ID="Label5" runat="server" Text="Zona" />
                    </div>
                    <div class="col-md-8">

                        <dx:BootstrapComboBox ID="cmbZona" runat="server" AutoPostBack="true">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="col-md-4">
                            <asp:Label ID="Label6" runat="server" Text="Matriz" />
                        </div>
                        <div class="col-md-8">
                            <dx:BootstrapComboBox ID="cmbMatriz" runat="server" AutoPostBack="true">
                            </dx:BootstrapComboBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12" style="margin-top: 5px;">
                    ...
                    <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-md-8">
                               <dx:BootstrapComboBox ID="CmbTipoRepresentante" runat="server" AutoPostBack="true">
                            </dx:BootstrapComboBox>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12" style="margin-top: 5px;">
                <div class="col-md-4">
                    <div class="form-group">
                            <div class="col-md-4">
                                <asp:Label ID="Label1" runat="server" Text="Año y Mes" />
                            </div>
                            <div class="col-md-8">
                ...
                <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label3" runat="server" Text="No. Representante" />
                        </div>
                        <div class="col-md-2">
                            
                             <dx:BootstrapTextBox ID="txtRik" runat="server" ClientInstanceName="txtRik"  >
                             </dx:BootstrapTextBox> 
                        ...
                        <ContentTemplate>
                            <div id="Div1" class="col-md-12" runat="server" style="margin-top: 5px;">
                                <dx:bootstrapgridview id="grdServicio" clientinstancename="grid" runat="server" width="100%"
                                    ...
                                    enablecallbacks="true" keyfieldname="IdLeads" showfilterrow="True"
                                    ...
                                    <settings showfooter="True" OnCustomSummaryCalculate="grdServicio_CustomSummaryCalculate" />
                                    <columns>
                                        ...
                                        <dx:bootstrapgridviewtextcolumn width="100px" fieldname="GAPIngresos_Monto" caption="Gap de Ingresos $" visible="true" sortorder="Ascending">
                                            <propertiestextedit displayformatstring="c" />
                                        </dx:bootstrapgridviewtextcolumn>
                                        ...
                                        <dx:bootstrapgridviewtextcolumn width="100px" fieldname="PrecioVenta" caption="Precio de Venta" visible="true">
                                            <propertiestextedit displayformatstring="c" />
                                        </dx:bootstrapgridviewtextcolumn>
                            ...
                            <dx:bootstrapgridviewtextcolumn Width="50px" FieldName="GAPMgRed_Porc" Caption="% Gap Mg Red" Visible="true">
                            <PropertiesTextEdit DisplayFormatString="p0" />
                            </dx:bootstrapgridviewtextcolumn>--%>
                                        <dx:bootstrapgridviewtextcolumn width="100px" fieldname="MgRed_Monto" caption="Margen CDI $" visible="true">
                                            <propertiestextedit displayformatstring="c" />
                                        </dx:bootstrapgridviewtextcolumn>
                                        <dx:bootstrapgridviewtextcolumn width="50px" fieldname="MgRed_Porc" caption="Margen CDI %" visible="true">
                                            <propertiestextedit displayformatstring="p0" />
                                        </dx:bootstrapgridviewtextcolumn>
                            ...
                            ,  ,   ,  ,  MgRedPO_Porc   ,    ,    ,IdUsuario  , FechaAlta  , FechaUltMod  , Mes  , Año  ,FechaInicial  , FechaFinal  ,    
                                        ...
                                        <dx:bootstrapgridviewtextcolumn fieldname="NomEstatus" caption="Estatus" width="100px" visible="true" />
                                        <dx:bootstrapgridviewcommandcolumn caption="Editar" width="150px">
                                            <custombuttons>

                                                <dx:bootstrapgridviewcommandcolumncustombutton iconcssclass="fa fa-pencil" />
                                            </custombuttons>

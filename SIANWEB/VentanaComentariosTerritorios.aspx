...
<body>
    ...
    <div>
        ...
        <table id="Table1" style="font-family: verdana; font-size: 8pt" runat="server">
            <tr  colspan = "3">               
                <td class="style1">
                    <asp:Label ID="Label1" runat="server" Text="Se debe especificar el motivo del cambio solicitado, este dato es obligatorio." 
            ...
            <tr>
             ...
             <td class="style1">
                 ...
                 <telerik:RadEditor RenderMode="Lightweight" runat="server" SkinID="BasicSetOfTools" ID="RadEditorComentarios" EmptyMessage="Ejemplo: Motivo de cambio, quien solicita el cambio, detalle de que territorio tenia originalmente el cliente y a cual pasa."
             ...
             <tr>
                 ...
                 &nbsp;&nbsp;
                 <asp:Button ID="btnCancelar" runat="server" Text="Salir" onclick="btnCancelar_Click" Visible = "false"/>
                 </td>
            </tr>
        </table>

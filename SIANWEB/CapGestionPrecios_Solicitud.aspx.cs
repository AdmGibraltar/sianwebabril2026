    ...
    public partial class CapGestionPrecios_Solicitud : System.Web.UI.Page
    {
        ...
        private List<SolConvenio> GetList()
        {
            try
            {
                ...
                int id_tipobusqueda = int.Parse(this.cmbTipoBusqueda.SelectedValue);
                conv.Filtro_TipoFiltro = int.Parse(this.cmbTipoBusqueda.SelectedValue);

                conv.Filtro_Valor = TxtId_Sol.Text == "" ? "-1" : TxtId_Sol.Text;
                conv.Filtro_Id_Cat = this.CmbId_Cat.SelectedValue;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GraficoVentas.aspx.cs" Inherits="SIANWEB.GraficoVentas" %>
    ...
    <div runat="server" id="divPrincipal">
        ...
        <table style="font-family: Verdana; font-size: 12pt;">
            <tr>
                ...
                <td style=" background-color:#FFFFFF; font-variant:small-caps;"><a href='#'>Venta Instalada</a></td>
                <td style=" width:10px">&nbsp;</td>
                    ...
                    <telerik:RadGrid ID="rgVentas" runat="server" AutoGenerateColumns="false" GridLines="Both"
                            ...
                            <MasterTableView DataKeyNames="Ordern" DataMember="listEmbudo">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="RSC" UniqueName="RowDesc" DataField="RowDesc" Display="true">

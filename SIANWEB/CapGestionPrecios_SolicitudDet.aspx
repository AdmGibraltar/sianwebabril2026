        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function CloseWindowA(mensaje) {
                    var cerrarWindow = radalert(mensaje, 380, 150);
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Nosol" runat="server" Text="Concesionario:" Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                                ...
                                <td>
                                    &nbsp;                                    
                                        ...
                                        <tr>
                                <td>
                                   <asp:Label ID="LblConvkey" runat="server" Text="Convenio Key:" Font-Bold="True"></asp:Label></td>
                                <td>
                                  <asp:Label ID="LblPC_NoConvenioKey" runat="server" ></asp:Label></td>
                                <td>
                                    &nbsp;
                                </td>
                                <td>
                                ...
                                <td>
                                    &nbsp;                                    
                                        ...
                                        <tr>
                                <td>
                                   <asp:Label ID="Label5" runat="server" Text="Convenio proveedor:" Font-Bold="True"></asp:Label></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <tr>
                                <td>
                                   <asp:Label ID="Label6" runat="server" Text="Nombre de convenio:" Font-Bold="True"></asp:Label></td>
                                <td>

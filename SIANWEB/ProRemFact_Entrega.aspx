<%@ Page Title="Remisiones y Facturas en entrega" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master" AutoEventWireup="true" CodeBehind="~/ProRemFact_Entrega.aspx.cs" Inherits="SIANWEB.ProRemFact_Entrega" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadAjaxManager ID="RAM1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rgEmbarques">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="divPrincipal" LoadingPanelID="RadAjaxLoadingPanel1"
                        UpdatePanelHeight="100%" />
                </UpdatedControls>            
            ...
            <tr>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                    <asp:ListItem Text="Por documento" Value="1">Por documento</asp:ListItem>
                                    <asp:ListItem Text="Por embarque" Value="2">Por embarque</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <td>
                                 <select runat="server" id="TipoDoc">
                                     <option value="">Todos</option>
                                    <option value="Remision">Remisiones</option>
                                    <option value="Factura">Facturas</option>
                                </select>

                                <input id="txtNoEmbarque" visible="false" type="text" value="" runat="server"  />
                            </td>
                             <td>
                                <asp:Label ID="lblNoDocumento" runat="server" Text="Número documento"></asp:Label>
                            </td>
                            <td>
                                <input id="txtNoDocumento" visible="true" type="text" value="" runat="server"  />
                            </td>
                         </tr>
                        <tr runat="server" id="tr_cliente">
                            <td>
                        ...
                        <tr runat="server" id="tr_rangocliente">
                            <td>
                    ...
                    <asp:Panel ID="Panel1" runat="server" Width="950px">
                         <telerik:RadGrid ID="rgRemisiones" runat="server" AutoGenerateColumns="False" Width="900px"  Visible="true"
                        GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="rgRemisiones_ItemDataBound"                         
                         OnItemCommand="rgRemisiones_ItemCommand" OnPageIndexChanged="rgRemisiones_PageIndexChanged"                     
                            ...
                            <MasterTableView ClientDataKeyNames="Id_Doc">
                            <RowIndicatorColumn>
                            ...
                            <ExpandCollapseColumn>
                                ...
                                <Columns>                                            
                                    <telerik:GridBoundColumn DataField="Id_Doc" HeaderText="Id_Doc" UniqueName="Id_Doc" Visible="false">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Id_Emb" HeaderText="Embarque" UniqueName="Id_Emb">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="TipoDoc" HeaderText="Tipo Doc." UniqueName="TipoDoc">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Numero" HeaderText="Documento" UniqueName="Numero"> 
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridButtonColumn CommandName="Autorizar" HeaderText="Entregar" ConfirmDialogType="RadWindow" 
                                        ConfirmText="¿Desea confirmar la entrega de la [[TIPODOC]] <b>#[[ID]]</b> ? <br />" Text="Autorizar entrega" ConfirmDialogHeight="150px" ConfirmDialogWidth="350px"
                     ...
                     <PagerStyle NextPagesToolTip="Páginas siguientes" PrevPagesToolTip="Páginas anteriores" FirstPageToolTip="Primera página" LastPageToolTip="Última página" PageSizeLabelText="Cantidad de registros"
                        ...
                        <telerik:RadGrid ID="rgEmbarques" runat="server" AutoGenerateColumns="False" Width="900px"  Visible="false"
                        GridLines="None" OnNeedDataSource="rgEmbarques_NeedDataSource" OnItemDataBound="rgEmbarques_ItemDataBound"                         
                         OnItemCommand="rgEmbarques_ItemCommand" OnPageIndexChanged="rgEmbarques_PageIndexChanged"                     
                            PageSize="15" AllowPaging="True" MasterTableView-NoMasterRecordsText="No se encontraron registros.">
                            ...
                            <ExpandCollapseColumn>
                                ...
                                <Columns>                                            
                                    <telerik:GridBoundColumn DataField="Id_Emb" HeaderText="Id_Emb" UniqueName="Id_Emb" Visible="false">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Id_Emb" HeaderText="Embarque" UniqueName="Id_Emb">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" />
                                    ...
                                    <telerik:GridBoundColumn DataField="Camioneta" HeaderText="Camioneta" UniqueName="Camioneta"> 
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                         <ItemStyle HorizontalAlign="Left" />
                                    </telerik:GridBoundColumn> 
                                    <telerik:GridButtonColumn CommandName="Autorizar" HeaderText="Entregar" ConfirmDialogType="RadWindow" 
                                        ConfirmText="¿Desea confirmar la entrega del Embarque <b>#[[ID]]</b> ? <br />" Text="Autorizar entrega" ConfirmDialogHeight="150px" ConfirmDialogWidth="350px"
                                        UniqueName="Autorizar" Visible="true" ButtonType="ImageButton" ImageUrl="~/Imagenes/blank.png" ButtonCssClass ="aceptar">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridButtonColumn>                                     

                        ...
                        <tr>
                            <td>
                                <telerik:RadGrid ID="rgDocumentos" runat="server" AutoGenerateColumns="False" GridLines="None"
                                    ...
                                    OnPageIndexChanged="rgDocumentos_PageIndexChanged" OnItemDataBound="rgDocumentos_ItemDataBound"
                                    OnItemCommand="rgDocumentos_ItemCommand">
                                    <MasterTableView NoMasterRecordsText="No se encontraron registros.">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="Id_Emp2" HeaderText="Id_Emp2" Display="false" UniqueName="Id_Emp2">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Cd2" HeaderText="Id_Cd2" Display="false" UniqueName="Id_Emp">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Id_Det" HeaderText="Id_Det" Display="false" UniqueName="Id_Emp">
                                            </telerik:GridBoundColumn>

        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function AbrirVentana_SolicitudAt(Unq, TipoOp) {
                    //debugger;
                    var oWnd = radopen("CapGestionPrecios_SolicitudAt.aspx?Unq=" + Unq + "&TipoOp=" + TipoOp, "AbrirVentana_AtSolicitud", 800, 550);
                    ...
                    <td>
                        <table style="font-family: Verdana; font-size: 8pt">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="cmbTipoBusqueda" runat="server" Width="153px" LoadingMessage="Cargando..." >
                                       <Items>
                                                 <telerik:RadComboBoxItem runat="server" Selected="True"  Text="-- Todos --" Value="-1" />
                                                 <telerik:RadComboBoxItem runat="server"  Text="No. Solicitud" Value="1" />
                                                 <telerik:RadComboBoxItem runat="server"  Text="Convenio Key" Value="2" />
                                                 <telerik:RadComboBoxItem runat="server"  Text="Convenio proveedor" Value="3" />
                                ...
                                <td>
                                    <asp:Label ID="Nosol" runat="server" Text="Valor"></asp:Label>
                                </td>
                                <td>
                                ...
                                <td>
                                 ...
                                 <td class="style4">
                                <asp:Label ID="Label4" Text="Categoría:" runat="server" display="false">
                                </asp:Label>
                                    </td>
                                    <td class="style1">
                                        <telerik:RadComboBox ID="CmbId_Cat" MaxHeight="300px" runat="server" Width="150px"
                                            AutoPostBack="true" OnSelectedIndexChanged="CmbId_Cat_SelectedIndexChanged" display="false">
                                        </telerik:RadComboBox>
                                    </td>
...
<CommandItemSettings ExportToPdfText="Export to Pdf"></CommandItemSettings>
                                <Columns>
                                 <telerik:GridBoundColumn DataField="Sol_Unique" HeaderText="Sol_Unique" UniqueName="Sol_Unique" Display="False">
                                    ...
                                    <telerik:GridBoundColumn DataField="CD_Nombre" HeaderText="Concesionario" UniqueName="Cd_Nombre">
                                    ...
                                    <telerik:GridButtonColumn CommandName="Enviar" HeaderText="Enviar" ConfirmDialogType="RadWindow"
                                        ...
                                        Display="False" ButtonType="ImageButton" ImageUrl="~/Imagenes/blank.png" ButtonCssClass="email_grid"
                                    ...
                                    <telerik:GridButtonColumn CommandName="Eliminar" HeaderText="Cancelar" ConfirmDialogType="RadWindow"
                                        ...
                                        ConfirmDialogWidth="350px" Text="Baja" UniqueName="Eliminar" Display="True" ButtonType="ImageButton"

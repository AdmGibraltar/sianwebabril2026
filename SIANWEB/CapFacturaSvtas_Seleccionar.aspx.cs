...
{ 
    public partial class CapFacturaSvtas_Seleccionar : System.Web.UI.Page 
    {
        ...
        {
            get { return (List<FacturaSvtaAlmacenDet>)Session[Session.SessionID + "ListaFacturaSvtaAlmacenDet"+ strIdPag]; }
            set { Session[Session.SessionID + "ListaFacturaSvtaAlmacenDet" + strIdPag] = value; }
        }

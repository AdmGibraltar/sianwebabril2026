    ...
    public partial class Ventana_EnviarPagos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    this.HFIDPagTimPag.Value = Page.Request.QueryString["IDPagTimPag"].ToString();
                    ConsultaCorreo();
        ...
        private void ConsultaCorreo()
        {
            try
            {
                ...
                this.TxtCorreos.Text = string.IsNullOrEmpty(cte.Cte_PagoCorreos) ? cte.Cte_Email : cte.Cte_PagoCorreos;
        ...
        private void ObtenerPDFXML()
        {
            try
            {
                ...
                pagoDetComplemento.Id_PagDetTimb = Convert.ToInt32(HFIDPagTimPag.Value);

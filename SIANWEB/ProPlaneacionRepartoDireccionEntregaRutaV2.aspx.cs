...
namespace SIANWEB
{
    public partial class ProPlaneacionRepartoDireccionEntregaRutaV2 : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static ResponseAjax AgregarDirEntrega(int ruta)
        {
            ...
            var list = new Pedido();
            new CN_CapPedido().ActualizaPedidoDireccionEntrega(pedido, MySesion.Emp_Cnx, ref list);
            response.Message = "Ruta asignada correctamente";

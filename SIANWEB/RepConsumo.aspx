<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.Master" 
    AutoEventWireup="true" CodeBehind="RepConsumo.aspx.cs" Inherits="SIANWEB.RepConsumo" %>
            ...
            <table border="0" style="height:150px" cellspacing="1">
                <tr>
                    ...
                    <td rowspan="2" valign="top">&nbsp;
                        <asp:Label ID="lblProductos" runat="server" Text="Producto(s):" />
                    </td>
                    <td rowspan="2" valign="top">
                        <asp:TextBox ID="txtLProdctos" runat="server" Width="200px" Height="50px" Rows="3" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    ...
                    <td valign="top">
                        <!-- <asp:ListItem Value="4" Text="Devoluciones de Mercancia"></asp:ListItem> -->
                        <asp:DropDownList ID="cmbTipoDocto" runat="server">
                            <asp:ListItem Value="0" Text="Todos" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="1" Text="Facturas"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Remisiones"></asp:ListItem>
                            <asp:ListItem Value="3" Text="Notas de Crédito"></asp:ListItem>
                            <asp:ListItem Value="5" Text="Entradas/Salidas"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
        ...
        <td colspan="3">
            <div style="height: 600px; overflow-y: scroll;"  class="FixHeader container" >
                <table style='width: 1000px; border:2px solid black;  ' id='tbldatos' class="table"  >
                    <thead>
                        <tr>
                            <th colspan="2" nowrap class="LN">Documento</th>
                            <th colspan="2" nowrap class="LN">Cliente</th>
                            <th rowspan="2" class="LN">Fecha</th>
                            <th colspan="2" class="LN">Producto</th>
                            <th rowspan="2" class="LN">Cantidad</th>
                            <th rowspan="2" class="LN">Costo</th>
                            <th rowspan="2" class="LN">Total</th>
                        </tr>
                        <tr align="center">
                            <td class="LN">Documento</td>
                            <td class="LN">NumDoc</td>
                            <td class="LN">Código</td>
                            <td class="LN">Nombre</td>

                            <td class="LN">Id</td>
                            <td class="LN">Producto</td>

...
namespace SIANWEB
{
    public partial class ProRemisiones_Entrega : System.Web.UI.Page
    {
        #region Eventos
            ...
            try
            {
                if (e.CommandName.ToString() == "Autorizar")
                {
                    ...
                    if (item >= 0)
                    {
                        ...
                        factura.Id_Fac = Convert.ToInt32(rgRemisiones.Items[item]["Id_Rem"].Text);
                        factura.Id_Cte = remisiones.Num_Cliente;

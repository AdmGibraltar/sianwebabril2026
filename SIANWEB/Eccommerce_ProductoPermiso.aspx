<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage01_bootstrap.Master" AutoEventWireup="true" CodeBehind="Eccommerce_ProductoPermiso.aspx.cs" Inherits="SIANWEB.Eccommerce_ProductoPermiso" %>
                ...
                <div class="col-md-12" style="margin-top: 15px;">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="col-md-12">
                                <div class="col-md-10">
                                    <h3 class="panel-title">Prodúcto Visible en Portal Key</h3>
                                </div>
                                <div class="col-md-2">
                                      <button type="submit" runat="server" class="btn btn-success btn-sm" id="btnExcel"
                        ...
                        <div class="panel-body">
                            <div class="col-md-12" style="margin-top: 5px;">
                                ...
                                <div class="col-md-8">
                                    <dx:BootstrapGridView ID="GrdProductoPermiso" ClientInstanceName="grid" runat="server"
                                        KeyFieldName="Id_Prd" Width="840px" AutoGenerateColumns="False">
                                        ...
                                        <Columns>
                                            <dx:BootstrapGridViewTextColumn FieldName="Id_Prd" CssClasses-HeaderCell="centerText" Caption="Núm. Producto" />
                                            <dx:BootstrapGridViewTextColumn FieldName="Nombre_Producto" CssClasses-HeaderCell="centerText" Caption="Producto" />
                                            <dx:BootstrapGridViewCheckColumn FieldName="Activo" CssClasses-HeaderCell="centerText" CssClasses-DataCell="centerText" Width="20px" Caption="Activo" />
                                            <dx:BootstrapGridViewDataColumn Width="40px" FieldName="btnCampo"  Caption="Activar/desactivar">
                                                <DataItemTemplate>
                                                    <button type="button" id="BtnPermiso" class="btn btn-link" title="Presiona para activar o desactivar la visibilidad del código en el Portal Key" runat="server" onserverclick="BtnPermiso_ServerClick">

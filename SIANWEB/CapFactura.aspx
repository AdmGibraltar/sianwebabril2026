...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            //RBM 07-2019
            //Se agrega para regresar los valores seleccionados por el grid de busqueda
            //Inicio
            function Cliente(param) {
                var ajaxManager = $find("<%= RAM1.ClientID %>");
                ajaxManager.ajaxRequest(param);
            ...
            //alerta de precios autorización jfcv 
            function AbrirVentana_AutorizaciondePrecios() {
                var oWnd = radopen("Ventana_AutorizacionPrecios.aspx", "Ventana_AutorizacionPrecios");
                oWnd.setSize(800, 415);
                oWnd.center();
            }

            //JFCV Alertas convenios de precios validar antes de grabar 
            function AbrirVentana_AlertaAutorizacionPrecios() {
                var oWnd = radopen("Ventana_AutorizacionPrecios.aspx", "Ventana_AutorizacionPrecios");
                oWnd.setSize(1024, 640);
                oWnd.center();
            }

            //JFCV ejecuta grabar cuando regresa desde la pantalla de alerta d eprecios 
        ...
        <Windows>
            ...
            <telerik:RadWindow ID="AbrirVentana_BuscarIndicadores" runat="server" Behaviors="Move, Close"
                ...
                KeepInScreenBounds="True" Overlay="True" Title="Buscar" Modal="True">
                   ...
                   <telerik:RadWindow ID="AbrirVentana_AlertaPrecios" runat="server"  Behaviors="Move"
                Opacity="100" VisibleStatusbar="False" Width="600px" Height="415px" Animation="Fade"
    ...
    <div class="formulario" id="divPrincipal" runat="server">
        <table id="TblEncabezado" runat="server" width="99%">
            ...
            <tr>
            <td><asp:Label ID="IVATEXTO" runat="server"></asp:Label></td>
            <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
            <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
            <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
            <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                    ...
                                    <div id="formularioDatosGenerales" runat="server">
                                        ...
                                        <table border="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="LblORdenCompra" runat="server" Text="Orden compra"></asp:Label>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtOrdenCompra" runat="server" Width="250px" Enabled="false"> 
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                      &nbsp;
                                        ...
                                        <table border="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label13" runat="server" Text="UsoCFDI"></asp:Label>
                                                </td> 
                                                <td>
                                                        <telerik:RadComboBox ID="ddUsoCfdi" runat="server" ChangeTextOnKeyBoardNavigation="true"
                                                            DataTextField="Descripcion" Width="167px" DataValueField="Id" Filter="Contains"
                                ...
                                <telerik:RadPane ID="RadPane1" runat="server" Height="455px" OnClientResized="onResize"
                                    ...
                                    <telerik:RadGrid ID="rgFacturaDet" runat="server" GridLines="None" AllowPaging="false"
                                        ...
                                        <MasterTableView Name="Master" CommandItemDisplay="Top" DataKeyNames="Id_Fac,Id_FacDet,Id_Prd,Id_CteExt,Id_Ter,Id_Rem,Rem_Cant"
                                            ...
                                            <Columns>
                                                 <telerik:GridBoundColumn DataField="Prd_Activo" HeaderText="Prd_Activo" UniqueName="Prd_Activo"
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Núm." DataField="Id_Prd" UniqueName="Id_PrdN"
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtId_Prd" runat="server" Width="50px" MaxLength="16"
                                                            MinValue="1" MaxValue="999999999999999" Text='<%# Eval("Id_Prd") %>' OnTextChanged="txtProducto_TextChanged"
                                                ...
                                                <telerik:GridTemplateColumn DataField="Fac_Precio" HeaderText="Precio" UniqueName="Fac_Precio">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtFac_Precio" runat="server" Width="100%" MaxLength="9"
                                                            MinValue="0" Text='<%# Eval("Fac_Precio") %>' OnTextChanged="txtPrecio_TextChanged" AutoPostBack="true">
                                                            <NumberFormat DecimalDigits="2" GroupSeparator="" />
                                                            <ClientEvents OnKeyPress="handleClickEvent" />
                                                        </telerik:RadNumericTextBox>
                                                    </EditItemTemplate>
                                              ...
                                              <telerik:GridTemplateColumn HeaderText="Consecutivo" DataField="Id_Cons_AdeDet"  UniqueName="Id_Cons_AdeDet" Visible="false" >
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadNumericTextBox ID="txtId_PrdAde" runat="server" Width="50px"
                                                            MaxLength="16" MinValue="1" MaxValue="999999999999999" Text='<%# Eval("Id_Prd") %>'  >
                                                            <NumberFormat DecimalDigits="0" GroupSeparator="" />
...
<telerik:RadComboBoxItem Text="24112100 - Toneles, cubas y bidones" Value= "24112100" />
                                                        </Items>
                                                    </telerik:RadComboBox>
...
<telerik:RadComboBoxItem Text="XUN - Unidad" Value= "XUN" />
    ...
    <script type="text/javascript">
        Sys.Application.add_load(function () {
            var txtCliente = $find("<%= txtCliente.ClientID %>");
            var txtClienteNombre = $find("<%= txtClienteNombre.ClientID %>");
            var imgBuscar = document.getElementById("<%= imgBuscar.ClientID %>");

            var txtTerritorio = $find("<%= txtTerritorio.ClientID %>");
            var cmbTerritorio = $find("<%= cmbTerritorio.ClientID %>");

            function disableRadInput(ctrl) {
                if (!ctrl) return;
                if (ctrl.set_enabled) ctrl.set_enabled(false);
                if (ctrl.get_inputDomElement) {
                    var el = ctrl.get_inputDomElement();
                    if (el) {
                        el.readOnly = true;
                        el.tabIndex = -1;
                    }
            ...
            function disableDom(el) {
                if (el) el.disabled = true;
            }

            // ----- Grupo Cliente -----
            function lockClienteIfFilled() {
                var hasCliente = txtCliente && txtCliente.get_value && txtCliente.get_value() !== "";
                var hasNombre = txtClienteNombre && txtClienteNombre.get_value && txtClienteNombre.get_value() !== "";

                if (hasCliente && hasNombre) {
                    disableRadInput(txtCliente);
                    if (txtClienteNombre.set_enabled) txtClienteNombre.set_enabled(false);
                    var elNom = txtClienteNombre.get_inputDomElement ? txtClienteNombre.get_inputDomElement() : null;
                    if (elNom) { elNom.readOnly = true; elNom.tabIndex = -1; }

                    disableDom(imgBuscar);
                }
            }

            // ----- Grupo Territorio -----
            function lockTerritorioIfFilled() {
                var hasTerritorio = txtTerritorio && txtTerritorio.get_value && txtTerritorio.get_value() !== "";
                var hasCmb = false;
                if (cmbTerritorio) {
                    hasCmb = (typeof cmbTerritorio.get_selectedItem === "function" && cmbTerritorio.get_selectedItem() !== null)
                        || (typeof cmbTerritorio.get_text === "function" && cmbTerritorio.get_text() !== "");
                }

                if (hasTerritorio && hasCmb) {
                    disableRadInput(txtTerritorio);
                    if (cmbTerritorio.set_enabled) cmbTerritorio.set_enabled(false);
                }
            }

            lockClienteIfFilled();
            lockTerritorioIfFilled();

            if (txtCliente && typeof txtCliente.add_valueChanged === "function") {
                txtCliente.add_valueChanged(lockClienteIfFilled);
            }
            if (cmbTerritorio && typeof cmbTerritorio.add_selectedIndexChanged === "function") {
                cmbTerritorio.add_selectedIndexChanged(lockTerritorioIfFilled);
            }
        });

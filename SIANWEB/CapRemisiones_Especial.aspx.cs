...
namespace SIANWEB
{
    public partial class CapRemisiones_Especial : System.Web.UI.Page
    {
        ...
        {
            get { return (List<RemisionDet>)Session["ListaProductosRemisionEspecial" + Session.SessionID + uniqueKey]; }
            set { Session["ListaProductosRemisionEspecial" + Session.SessionID + uniqueKey] = value; }
        }
        private FacturaEspecial RemisionEspecial
        {
            get { return (FacturaEspecial)Session["RemisionEspecial" + Session.SessionID + uniqueKey]; }
            set { Session["RemisionEspecial" + Session.SessionID + uniqueKey] = value; }
        }
        ...
        protected void rgRemisionEspecialDet_InsertCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                remisionDet.Id_Prd = Convert.ToInt64((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
                ...
                remisionDet.Producto.Id_Prd = Convert.ToInt64((insertedItem["Id_Prd"].FindControl("cmbProducto") as RadComboBox).SelectedValue);
        ...
        private void Inicializar()
        {
            try
            {
                ...
                if (Session["RemEspecialGuardada" + Session.SessionID + uniqueKey] != null)
                {
        ...
        private void CalcularTotales()
        {
            ...
            Session["RemEspecialGuardada" + Session.SessionID + uniqueKey] = 2;
        }
        private void Guardar()
        {
            try
            {
                ...
                if (Session["fTotal" + Session.SessionID + uniqueKey] != null)
                {
                    if (txtTotal.Text.Length > 0)
                    {
                        decimal fTotalRemisionOriginal = decimal.Round(decimal.Parse(Session["fTotal" + Session.SessionID + uniqueKey].ToString()), 2);
        ...
        //protected void ListaProductosRemisionEspecial_EliminarProducto(long id_Prd, string descripcion)
        //{
        //    List<RemisionDet> lista = this.ListaProductosRemisionEspecial;

    ...
    public partial class ProOrdCompra_GenMax : System.Web.UI.Page
    {
        ...
        protected void txtId_PrdInicial_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (productoInicial > 0)
                    clsProducto.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, sesion.Id_Cd_Ver, productoInicial, 1);
                else
                {
        ...
        protected void txtId_PrdFinal_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (productoFinal > 0)
                    clsProducto.ConsultaProducto(ref producto, sesion.Emp_Cnx, sesion.Id_Emp, sesion.Id_Cd_Ver, sesion.Id_Cd_Ver, productoFinal, 1);
                else
                {
                    txtId_PrdFinal.Text = "";
                    txtProductoFin.Text = "";

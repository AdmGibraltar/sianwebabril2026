<%@ Page Title="Autorización Tipo Cliente" Language="C#" CodeBehind="Ventana_AutorizacionTipoCliente.aspx.cs" Inherits="SIANWEB.Ventana_AutorizacionTipoCliente" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        <script type="text/javascript">
            ...
            function CloseWindow(id_u, id_cd, nombre) {
                GetRadWindow().Close();
                GetRadWindow().BrowserWindow.autorizarTipoCliente(id_u, id_cd, nombre);
            }
        </script>

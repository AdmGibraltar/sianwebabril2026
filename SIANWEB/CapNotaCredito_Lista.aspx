...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server"> 
        <script type="text/javascript">
            ...
            //IVAN G
            function AbrirVentana_CancelarNotaCreditoVencido(Id_Emp, Id_Cd, Id_Ncr, Id_NcrSerie, Ncr_Estatus) {

                var oWnd = radopen("CapCancelarNCreditoVencido.aspx?Id_Ncr=" + Id_Ncr
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    + "&Id_NcrSerie=" + Id_NcrSerie
                    + "&Ncr_Estatus=" + Ncr_Estatus
                    , "AbrirVentana_NotaCreditoCancelacion");

...
namespace SIANWEB
{
    public partial class CapFacturaSvtas : System.Web.UI.Page
    {
        ...
        {
            get { return (List<FacturaSvtaAlmacenDet>)Session[Session.SessionID + "ListaFacturaSvtaAlmacenDet"+ Page.Request.QueryString["IdPag"].ToString()]; }
            set { Session[Session.SessionID + "ListaFacturaSvtaAlmacenDet"+ Page.Request.QueryString["IdPag"].ToString()] = value; }
        }
            ...
            try
            {
                ...
                if (sesion != null)
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        this.Inicializar(Id_Emp, Id_Cd, Id_Fva, IdPag);
        ...
        private void Inicializar(int Id_Emp, int Id_Cd, int Id_Fva, int IdPag)
        {
            Sesion sesion = (Sesion)Session["Sesion" + Session.SessionID];
            Session["ListaFacturaSvtaAlmacenDet"+ IdPag.ToString()] = new List<FacturaSvtaAlmacenDet>();

<%@ Page Title="Embarque de documentos" Language="C#" MasterPageFile="~/MasterPage/MasterPage01.master"
    AutoEventWireup="true" CodeBehind="ProEmbarques_Lista.aspx.cs" Inherits="SIANWEB.ProEmbarques_Lista" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function AbrirVentana_Impresion(Id_Emp, Id_Cd, Id_Emb) {
                var oWnd = radopen("ProEmbarques_Imprimir.aspx?Id_Emb=" + Id_Emb
                  ...
                  , "Abrir_EmbarqueImpresion");
                oWnd.center();
            }
            function AbrirVentana(Id_Emp, Id_Cd, Id, embModificable) {
                var oWnd = radopen("ProEmbarques.aspx?Id=" + Id
                    + "&Id_Cd=" + Id_Cd
                    + "&Id_Emp=" + Id_Emp
                    + "&embModificable=" + embModificable
                    + "&PermisoGuardar=<%= _PermisoGuardar %>&PermisoModificar=<%= _PermisoModificar %>"
                    + "&PermisoEliminar=<%= _PermisoEliminar %>&PermisoImprimir=<%= _PermisoImprimir %>"
                    , "AbrirVentana_Embarques");
                // oWnd.center();
                oWnd.Maximize();
            }
            //--------------------------------------------------------------------------------------------------
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RAM1">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgEmbarques" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <table style="font-family: Verdana; font-size: 8pt">
            <tr>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <Items>
                                <telerik:RadComboBoxItem runat ="Server" Text = "-- Todos --" Value ="0" Selected="true"  ></telerik:RadComboBoxItem>
                                <telerik:RadComboBoxItem runat ="Server" Text = "Logistica" Value ="1"   ></telerik:RadComboBoxItem>
                    ...
                    <telerik:RadGrid ID="rgEmbarques" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        OnNeedDataSource="rgEmbarques_NeedDataSource" OnPageIndexChanged="rg_PageIndexChanged"
                        ...
                        <MasterTableView ClientDataKeyNames="Id_Emb">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Id_Emb" HeaderText="Embarque" UniqueName="Id_Emb">
                                 ...
                                 <telerik:GridBoundColumn DataField="Emb_DestinoStr" HeaderText="Destino" UniqueName="Emb_DestinoStr">
                                    <HeaderStyle HorizontalAlign="Center" width ="90px"/>
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Emb_Fecha" HeaderText="Fecha" UniqueName="Emb_Fecha"

                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbanio" runat="server" Width="150px"  AutoPostBack="True" OnSelectedIndexChanged="CmbAno_SelectedIndexChanged">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbmes" runat="server" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="CmbMes_SelectedIndexChanged">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox onpaste="return false" ID="txtProducto" runat="server" Width="148px"
                                    MaxLength="200">
                                    <ClientEvents  OnBlur="RangoEnterosSeparacionGuionYComas_OnBlur" />
                                </telerik:RadTextBox>
                            </td>
                            <td>
                                &nbsp;

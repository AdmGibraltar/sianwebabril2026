...
namespace SIANWEB
{
    public partial class CatUsuario : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (e.CommandName.ToString() == "Modificar")
                {
                    ...
                    if (item >= 0)
                    {
                        ...
                        if (this.RadGrid1.Items[item]["Id_Tu"].Text == "2" || this.RadGrid1.Items[item]["Id_Tu"].Text == "3")
                        {
                            CargarRik(3);
        ...
        private void Guardar()
        {
            try
            {
                ...
                if (Centinela == 1)
                {
                    ...
                    // SEP03-2019 RFH
                    if (cmbRepresentante.SelectedValue == "")
                    {
                        usuario.Id_Rik = -1;
                    }
                    else
                    {
                        usuario.Id_Rik = (usuario.Id_TU == 2 || usuario.Id_TU == 3 || usuario.Id_TU == 4 || usuario.Id_TU == 16) ? Convert.ToInt32(cmbRepresentante.SelectedValue) : -1;
                    }                   
        ...
        */
        ...
        //
        // 26JUN2019 RFH
        // Se crea nuevo version del SP spCatRik_Combo_Todos de la version spCatRik_Combo para consultar 
        // los registro de RespresentateRik que deben desplegar en el combo.
        //
        private void CargarRik(int idTipoRik)
        {
            try
            {
                ...
                cmbRepresentante.Items.Clear();
                cNComun.LlenaCombo<Comun>(iParameters, sesion.Emp_Cnx, "spCatRik_Combo_Todos", ref cmbRepresentante, "Id", "Descripcion");
                cmbRepresentante.SelectedIndex = 0;
            }
            catch (Exception ex)
            {
